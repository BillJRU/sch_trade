...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.КакОткрывать.СписокВыбора.Добавить(0, НСтр("ru='Для просмотра';uk='Для перегляду'"));
		Элементы.КакОткрывать.СписокВыбора.Добавить(1, НСтр("ru='Для редактирования';uk='Для редагування'"));
