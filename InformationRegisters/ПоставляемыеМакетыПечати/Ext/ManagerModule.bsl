...
Процедура ОбновитьКонтрольнуюСуммуМакетов(Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(МакетыТребующиеОбновленияКонтрольнойСуммы) Тогда
		СписокОшибок.Вставить(0, НСтр("ru='Не удалось записать сведения о макетах печатных форм расширений:';uk='Не вдалося записати відомості про макети друкованих форм розширень:'"));
