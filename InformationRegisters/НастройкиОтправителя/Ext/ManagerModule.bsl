...
// Определяет конечные точки, для которых в текущей информационной системе назначен заданный канал сообщений.
//
// Параметры:
//  КаналСообщений - Строка - Идентификатор адресного канала сообщений.
//
// Возвращаемое значение:
//  Массив из ПланОбменаСсылка.ОбменСообщениями - массив элементов конечных точек.
//
