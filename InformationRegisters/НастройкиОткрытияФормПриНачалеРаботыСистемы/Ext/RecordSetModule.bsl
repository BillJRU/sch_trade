...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Пока Выборка.Следующий() Цикл
		...
		ТекстСообщения = НСтр("ru='Пользователю ""%Пользователь%"" назначено более одной формы, открываемой по умолчанию.';uk='Користувачу ""%Пользователь%"" призначено більше однієї форми, що відкривається по умовчанню.'");
