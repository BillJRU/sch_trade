...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ПоясняющийОшибкуТекст);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<форма недоступна (недостаточно прав)>';uk='<форма недоступна (недостатньо прав)>'"));
...
Процедура ОткрытьФормуЗаписиРегистра()
	...
	Если НЕ ТекущиеДанные.ФормаДоступна Тогда
		...
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Пользователю недоступна роль ""%1"".';uk='Користувачу недоступна роль ""%1"".'"),
