...
Процедура ОбновитьКонтрольнуюСуммуМакетов() Экспорт
	...
	Для Каждого ОписаниеМакета Из ОбрабатываемыеМакеты Цикл
		...
		Исключение
			...
			ТекстОшибки = НСтр("ru='Не удалось записать сведения о макете';uk='Не вдалося записати відомості про макет'") + Символы.ПС
				+ Макет.ПолноеИмя() + Символы.ПС
				+ ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
			
			ЗаписьЖурналаРегистрации(НСтр("ru='Контроль изменения поставляемых макетов';uk='Контроль зміни поставляємих макетів'",ОбщегоНазначения.КодОсновногоЯзыка()),
	...
	Если ЗначениеЗаполнено(СписокОшибок) Тогда
		СписокОшибок.Вставить(0, НСтр("ru='Не удалось записать сведения о макетах печатных форм конфигурации:';uk='Не вдалося записати відомості про макети друкованих форм конфігурації:'"));
