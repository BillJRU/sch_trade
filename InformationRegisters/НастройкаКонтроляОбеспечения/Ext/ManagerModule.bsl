...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.ЧитаемыеОбъекты = "РегистрСведений.НастройкаКонтроляОбеспечения";
	Обработчик.ИзменяемыеОбъекты = "РегистрСведений.НастройкаКонтроляОбеспечения";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Обновляет записи в регистре ""Настройка контроля обеспечения"". Удаляет некорректные записи, содержащие группы номенклатуры.';uk='Оновлює записи в регістрі ""Настройка контролю постачання"". Видаляє неправильні записи, що містять групи номенклатури.'");
