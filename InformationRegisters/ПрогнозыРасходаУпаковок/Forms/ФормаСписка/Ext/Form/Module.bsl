...
Процедура УстановитьОтборы()
	...
	ИначеЕсли ЗначениеЗаполнено(Склад)
		...
		ТекстЗаголовка = НСтр("ru='На складе ""%Склад%"" не используется прогнозирование расхода упаковок.';uk='На складі ""%Склад%"" не використовується прогнозування витрати упаковок.'");
