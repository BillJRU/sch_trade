...
Процедура ПриОткрытии(Отказ)
	...
	ШаблонПользовательскийСайт = НСтр("ru='сайта поддержки пользователей системы ""BAS""';uk='сайта підтримки користувачів системи ""BAS""'");
	...
	Если Не ПустаяСтрока(РасположениеКомплектаПравил.ПутьКФайлуКомплектаПравилВКаталогеШаблонов)
		...
		ТекстПредложения = НСтр("ru='Для открытия каталога необходимо необходимо установить расширение для работы с BAF.';uk='Для відкриття каталогу необхідно встановити розширення для роботи з BAF.'");
...
#Если ВебКлиент Тогда
	...
	ВызватьИсключение НСтр("ru='Операция в веб-клиенте не предусмотрена';uk='Операція у вебклієнті не передбачена'");
