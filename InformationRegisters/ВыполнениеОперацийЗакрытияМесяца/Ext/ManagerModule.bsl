...
|;uk='%1 закриття місяця:
|%2
|Виконання операцій закриття місяця зупинено.'"),
			?(ОдноЗадание, НСтр("ru='Обнаружено активное задание';uk='Виявлено активне завдання'"), НСтр("ru='Обнаружены активные задания';uk='Виявлені активні завдання'")),
		 ...
		 И ПравоДоступа("Редактирование", Метаданные.РегистрыСведений.ВыполнениеОперацийЗакрытияМесяца) Тогда
			ТекстОшибки = ТекстОшибки + Символы.ПС
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Возможно %1 аварийно, в этом случае информацию об %2 необходимо актуализировать вручную.';uk='Можливо %1 аварійно, в цьому випадку інформацію про %2 необхідно актуалізувати вручну.'"),
					?(ОдноЗадание, НСтр("ru='задание завершено';uk='завдання завершено'"), НСтр("ru='задания завершены';uk='завдання завершені'")),
					?(ОдноЗадание, НСтр("ru='активном задании';uk='активному завданні'"), НСтр("ru='активных заданиях';uk='активних завданнях'")));
		КонецЕсли;
		
		ТекстОшибки = ТекстОшибки + Символы.ПС
			+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Подробнее см. в форме ""%1"", ""Еще"" - ""Активные сеансы закрытия месяца""';uk='Детальніше див. У формі ""%1"", ""Ще"" - ""Активні сеанси закриття місяця""'"),
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			ЗакрытиеМесяцаСервер.ИмяСобытияЖурналаРегистрации(
				НСтр("ru='Установка признака выполнения расчета';uk='Встановлення ознаки виконання розрахунку'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка())),
