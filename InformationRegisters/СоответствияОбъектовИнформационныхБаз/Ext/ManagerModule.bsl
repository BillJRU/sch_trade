...
Процедура ДобавитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	Для Каждого ПроверяемыйРеквизит Из ПроверяемыеРеквизиты Цикл
		Если СтруктураЗаписи.Свойство(ПроверяемыйРеквизит)
			...
			ОписаниеСобытия = НСтр("ru='Добавление записи регистра сведений ""Соответствия объектов информационных баз""';uk='Додавання запису регістра відомостей ""Відповідності об''єктів інформаційних баз""'",ОбщегоНазначения.КодОсновногоЯзыка());
