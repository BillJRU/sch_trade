...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДействиеНадРегламентнымЗаданием = "СоздатьЗадания" Тогда
		...
		Элементы.СоздатьЗадания.Заголовок = НСтр("ru='Создать задания';uk='Створити задачу'");
	Иначе
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьОбособленноеОбеспечениеЗаказов") Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru='Создание заданий на подпитку зон быстрого отбора';uk='Створення завдань на підживлення зон швидкого відбору'");
	КонецЕсли;
...
Функция СгенерироватьНаименованиеРегламентногоЗадания(Склад, Помещение, ПравилоСозданияЗаданий)
	...
	НаименованиеРегламентногоЗадания = 
		НСтр("ru='Создание заданий на перемещение ""%Правило%"" для склада ""%ПредставлениеСклада%""';uk='Створення завдань на переміщення ""%Правило%"" для складу ""%ПредставлениеСклада%""'");
	НаименованиеРегламентногоЗадания = 
...
Функция СформироватьНаименованиеПравилаДляРегЗадания(ПравилоСозданияЗаданий)
	Если ПравилоСозданияЗаданий = 
		...
		Возврат НСтр("ru='Размещение обособленных товаров';uk='Розміщення відокремлених товарів'");
	ИначеЕсли ПравилоСозданияЗаданий = 
		Перечисления.ПравилаСозданияЗаданийНаОтборРазмещение.ПодпиткаЗонБыстрогоОтбора Тогда
		Возврат НСтр("ru='Подпитка зон быстрого отбора';uk='Підживлення зон швидкого відбору'");
	КонецЕсли;
	Возврат "";
КонецФункции
