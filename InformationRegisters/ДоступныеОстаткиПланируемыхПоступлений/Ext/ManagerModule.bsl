...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("082cf6e8-04c0-4c3b-afee-0a648808c1b9");
	...
	Обработчик.Комментарий = НСтр("ru='Пересчитывает ожидаемые остатки в РС ""Доступные остатки планируемых поступлений"".';uk='Перераховує очікувані залишки в РВ ""Доступні залишки планованих надходжень"".'");
