...
Функция НастройкиТранспорта(Знач Корреспондент) Экспорт
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса") Тогда
		ВызватьИсключение НСтр("ru='Не определен менеджер настроек транспорта обмена сообщениями.';uk='Не визначено менеджер настройок транспорту обміну повідомленнями.'");
	КонецЕсли;
...
Функция НастройкиТранспортаWS(Знач Корреспондент) Экспорт
	...
	Если Не ЗначениеЗаполнено(СтруктураНастроек.WSURLВебСервиса) Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не заданы настройки подключения веб-сервиса для корреспондента ""%1"".';uk='Не задані настройки підключення вебсервісу для кореспондента ""%1"".'"),
