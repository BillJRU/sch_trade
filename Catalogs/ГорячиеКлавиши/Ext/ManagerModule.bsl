...
Процедура ЗаполнитьТабличныйДокументПоДаннымОбъекта(ТабличныйДокумент, ДанныеОбъекта)
	...
	БыстрыеТовары = ДанныеОбъекта.БыстрыеТовары.Получить(); // см. Справочники.ГорячиеКлавиши.ФормаЭлемента.БыстрыеТовары
	...
	КомандыФормы = ДанныеОбъекта.КомандыФормы.Получить(); // см. Справочники.ГорячиеКлавиши.ФормаЭлемента.КомандыФормы
