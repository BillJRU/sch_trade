...
Функция ПредставлениеСочетанияКлавиш(НоваяСтрока, Данные, Имя, Сочетание)
	...
	НайденныеСтроки = Данные.КомандыФормы.НайтиСтроки(СтруктураСочетаний); // см. Справочники.ГорячиеКлавиши.ФормаЭлемента.КомандыФормы
	Если НайденныеСтроки.Количество() > 0 Тогда
		НоваяСтрока[Имя+"_"] = НайденныеСтроки[0].Заголовок;
	КонецЕсли;
	
	НайденныеСтроки = Данные.БыстрыеТовары.НайтиСтроки(СтруктураСочетаний); // см. Справочники.ГорячиеКлавиши.ФормаЭлемента.БыстрыеТовары
	Если НайденныеСтроки.Количество() > 0 Тогда
		НоваяСтрока[Имя+"_"] = НайденныеСтроки[0].Заголовок;
	КонецЕсли;
