	...
	Если Выборка.Количество() > 1 Тогда
		...
		Иначе
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Управление доступом.Нарушение однозначности поставляемого профиля';uk='Управління доступом.Порушення однозначності профілю, що поставляє'",ОбщегоНазначения.КодОсновногоЯзыка()),
