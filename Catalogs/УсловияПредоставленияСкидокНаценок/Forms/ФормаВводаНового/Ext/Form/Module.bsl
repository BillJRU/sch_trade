...
Процедура УстановитьНастройкиЭлементовВариантовУсловийПоНоменклатуре(Форма, ИмяГруппы)
	...
	ПолеФормыСегментНоменклатуры = Форма.Элементы["СегментНоменклатуры" + ИмяГруппы]; // ПолеФормы
	ПолеФормыСписокНоменклатуры = Форма.Элементы["СписокНоменклатуры" + ИмяГруппы]; // ПолеФормы
	ПолеФормыОтбор = Форма.Элементы["Отбор" + ИмяГруппы]; // ПолеФормы
