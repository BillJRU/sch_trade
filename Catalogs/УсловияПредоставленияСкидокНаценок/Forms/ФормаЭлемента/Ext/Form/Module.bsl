...
Процедура УстановитьНастройкиЭлементовВариантовУсловийПоНоменклатуре(Форма, ИмяГруппы)
	...
	Форма.Элементы["СегментНоменклатуры" + ИмяГруппы].Доступность = (Форма.Объект.ВариантОтбораНоменклатуры = ПредопределенноеЗначение("Перечисление.ВариантыОтбораНоменклатурыДляРасчетаСкидокНаценок.СегментНоменклатуры"))
																	И НЕ Форма.Элементы["ВариантОтбораНоменклатуры" + ИмяГруппы + "СегментНоменклатуры"].ТолькоПросмотр;
	Форма.Элементы["СписокНоменклатуры" + ИмяГруппы].Доступность = (Форма.Объект.ВариантОтбораНоменклатуры = ПредопределенноеЗначение("Перечисление.ВариантыОтбораНоменклатурыДляРасчетаСкидокНаценок.СписокНоменклатуры"))
																	И НЕ Форма.Элементы["ВариантОтбораНоменклатуры" + ИмяГруппы + "СписокНоменклатуры"].ТолькоПросмотр;
	Форма.Элементы["Отбор" + ИмяГруппы].Доступность = (Форма.Объект.ВариантОтбораНоменклатуры = ПредопределенноеЗначение("Перечисление.ВариантыОтбораНоменклатурыДляРасчетаСкидокНаценок.ОтборКомпоновкиДанных"))
																	И НЕ Форма.Элементы["ВариантОтбораНоменклатуры" + ИмяГруппы + "ОтборКомпоновкиДанных"].ТолькоПросмотр;
