...
Процедура УстановитьОсновнымКомпонентом(Команда)
	...
	Если Компонент <> Неопределено Тогда
		ЗаполнитьОсновнойКомпонент(Компонент.Номенклатура, Компонент.Характеристика);
	Иначе
		ПоказатьПредупреждение(, НСтр("ru='Основная комплектующая не установлена. Для установки основной комплектующей необходимо выбрать строку в списке комплектующих.';uk='Основна комплектуюча не встановлена. Для встановлення основної комплектуючої необхідно вибрати рядок в списку комплектуючих.'"));
	КонецЕсли;
КонецПроцедуры
...
Процедура НастроитьЭлементыФормы()
	...
	ПодсказкаОсновнаяКомплектующая = НСтр("ru='Текущая позиция является основным компонентом сборки, по которому определяется страна происхождения и номера ГТД';uk='Поточна позиція є основним компонентом збирання, за яким визначається країна походження та номери ВМД'");
	Если Не ВедетсяУчетПоГТД Тогда
		ПодсказкаОсновнаяКомплектующая = НСтр("ru='Текущая позиция является основным компонентом сборки';uk='Поточна позиція є основним компонентом збірки'");
	КонецЕсли;
