...
Процедура ПередЗаписью(Отказ)
	...
	// Актуальность кеша необходимо сбрасывать если используется/использовался внешний отчет.
	// В противном случае, состояние кеша актуально.
	Если Не ЭтоГруппа Тогда
		Если ОбщегоНазначения.РазделениеВключено() Или ОбщегоНазначенияКлиентСервер.РежимОтладки() Тогда   	
