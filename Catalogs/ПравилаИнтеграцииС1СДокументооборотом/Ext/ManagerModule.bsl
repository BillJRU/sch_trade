...
Функция ПолучитьРеквизитыОбъектаДО(ТипОбъектаДО, Параметры = Неопределено) Экспорт 
		...
		Если ДоступенПакетныйЗапрос Тогда
			...
			Исключение // Возможно, этого вида документа уже нет в ДО.
				...
				ИнтеграцияС1СДокументооборотВызовСервера.ЗаписатьПредупреждение(
					СтрШаблон(НСтр("ru='Не найден в BAS Документообороте ранее существовавший вид документа %1';uk='Не знайдений в BAS Документообігу раніше існуваший вид документа %1'"),
	...
	Если ТипОбъектаДО = "DMIncomingDocument" Тогда
		...
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда 
			ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru='Вид документа';uk='Вид документу'"), "DMIncomingDocumentType", Истина);
		КонецЕсли;
			
		ДобавитьРеквизит(Реквизиты, "correspondent", НСтр("ru='Отправитель';uk='Відправник'"), "DMCorrespondent", Истина);
		ДобавитьРеквизит(Реквизиты, "externalNumber", НСтр("ru='№ отправителя';uk='№ відправника'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "externalDate", НСтр("ru='Дата отправителя';uk='Дата відправника'"), "Дата");
		
		Если НастройкиТипа.organizationEnabled = Истина Тогда 
			ДобавитьРеквизит(Реквизиты, "organization", НСтр("ru='Организация';uk='Організація'"), "DMOrganization", Истина);
		КонецЕсли;
		
		Если НастройкиВида = Неопределено Или НастройкиВида.sumEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "sum", НСтр("ru='Сумма';uk='Сума'"), "Число");
			ДобавитьРеквизит(Реквизиты, "currency", НСтр("ru='Валюта';uk='Валюта'"), "DMCurrency");
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "title", НСтр("ru='Наименование';uk='Найменування'"), "Строка", Истина);
		ДобавитьРеквизит(Реквизиты, "summary", НСтр("ru='Содержание';uk='Зміст'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regNumber", НСтр("ru='Регистрационный номер';uk='Реєстраційний номер'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regDate", НСтр("ru='Дата регистрации';uk='Дата реєстрації'"), "Дата");
		
		ДобавитьРеквизит(Реквизиты, "signer", НСтр("ru='Подписал';uk='Підписав'"), "DMContactPerson");
		ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru='Адресат';uk='Адресат'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru='Подразделение';uk='Підрозділ'"), "DMSubdivision");
		
		Если НастройкиВида = Неопределено Или НастройкиВида.performanceDateEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "performanceDate", НСтр("ru='Срок исполнения';uk='Строк виконання'"), "Дата");
		КонецЕсли;
		
		Если НастройкиТипа.accessLevelEnabled  = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "accessLevel", НСтр("ru='Гриф доступа';uk='Гриф доступу'"), "DMAccessLevel", Истина);
		КонецЕсли;
		
		Если НастройкиТипа.activityMatterEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "activityMatter", НСтр("ru='Вопрос деятельности';uk='Питання діяльності'"), "DMActivityMatter", Истина);
		КонецЕсли;
		
		// Проекты.
		Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3.CORP") Тогда
			Если НастройкиТипа.projectsEnabled = Истина Тогда
				ДобавитьРеквизит(Реквизиты, "project", НСтр("ru='Проект';uk='Проєкт'"), "DMProject");
			КонецЕсли;
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "deliveryMethod",  НСтр("ru='Способ получения';uk='Спосіб отримання'"), "DMDeliveryMethod");
		
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru='Комментарий';uk='Коментар'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru='Ответственный';uk='Відповідальний'"), "DMUser");
		
	// Исходящий документ.
	ИначеЕсли ТипОбъектаДО = "DMOutgoingDocument" Тогда
		
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru='Вид документа';uk='Вид документу'"), "DMOutgoingDocumentType", Истина);
		КонецЕсли;
			
		ДобавитьРеквизит(Реквизиты, "correspondent", НСтр("ru='Получатель';uk='Одержувач'"), "DMCorrespondent", Истина);
		
		Если НастройкиВида = Неопределено Или НастройкиВида.externalNumberEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "externalNumber", НСтр("ru='№ получателя';uk='№ одержувача'"), "Строка");
			ДобавитьРеквизит(Реквизиты, "externalDate", НСтр("ru='Дата получателя';uk='Дата одержувача'"), "Дата");
		КонецЕсли;
		...
		ДобавитьРеквизит(Реквизиты, "title", НСтр("ru='Заголовок';uk='Заголовок'"), "Строка", Истина);
		ДобавитьРеквизит(Реквизиты, "summary", НСтр("ru='Содержание';uk='Зміст'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regNumber", НСтр("ru='Регистрационный номер';uk='Реєстраційний номер'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "regDate", НСтр("ru='Дата регистрации';uk='Дата реєстрації'"), "Дата");
		
		ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru='Адресат';uk='Адресат'"), "DMContactPerson");
		ДобавитьРеквизит(Реквизиты, "sent", НСтр("ru='Отправлен';uk='Відправлений'"), "Булево");
		ДобавитьРеквизит(Реквизиты, "sendDate", НСтр("ru='Дата отправки';uk='Дата відправлення'"), "Дата");
		
		ДобавитьРеквизит(Реквизиты, "signer", НСтр("ru='Подписал';uk='Підписав'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "author", НСтр("ru='Подготовил';uk='Підготував'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru='Подразделение';uk='Підрозділ'"), "DMSubdivision");
		...
		ДобавитьРеквизит(Реквизиты, "deliveryMethod", НСтр("ru='Способ отправки';uk='Спосіб відправлення'"), "DMDeliveryMethod");
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru='Комментарий';uk='Коментар'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru='Ответственный';uk='Відповідальний'"), "DMUser");
	...
	ИначеЕсли ТипОбъектаДО = "DMInternalDocument" Тогда
		...
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "documentType", НСтр("ru='Вид документа';uk='Вид документу'"), "DMInternalDocumentType", Истина);
		КонецЕсли;
		
		ДобавитьРеквизит(Реквизиты, "folder", НСтр("ru='Папка';uk='Папка'"), "DMInternalDocumentFolder", Истина);
		...
		Если (НастройкиВида = Неопределено
			...
			ДобавитьРеквизит(Реквизиты, "addressee", НСтр("ru='Адресат';uk='Адресат'"), "DMUser", Истина);
		КонецЕсли;
		...
		Если НастройкиВида = Неопределено Или НастройкиВида.sumEnabled = Истина Тогда 
			...
			Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("2.1.8.1.CORP") Тогда
				ДобавитьРеквизит(Реквизиты, "VAT", НСтр("ru='В т.ч. НДС';uk='В т. ч. ПДВ'"), "Число");
			КонецЕсли;
			ДобавитьРеквизит(Реквизиты, "currency", НСтр("ru='Валюта';uk='Валюта'"), "DMCurrency");
		КонецЕсли;
		...
		ДобавитьРеквизит(Реквизиты, "signer", НСтр("ru='Утвердил';uk='Затвердив'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "author", НСтр("ru='Подготовил';uk='Підготував'"), "DMUser");
		ДобавитьРеквизит(Реквизиты, "subdivision", НСтр("ru='Подразделение';uk='Підрозділ'"), "DMSubdivision");
		...
		Если НастройкиВида = Неопределено Или НастройкиВида.correspondentEnabled = Истина Тогда 
			Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
				ДобавитьРеквизит(Реквизиты, "correspondent", НСтр("ru='Корреспондент';uk='Кореспондент'"), "DMCorrespondent", Истина);
			Иначе
				ДобавитьРеквизит(Реквизиты, "correspondent", НСтр("ru='Контрагент';uk='Контрагент'"), "DMCorrespondent", Истина);
			КонецЕсли;
			ДобавитьРеквизит(Реквизиты, "contactPerson", НСтр("ru='Контактное лицо';uk='Контактна особа'"), "DMContactPerson");
		КонецЕсли;
		
		Если НастройкиВида = Неопределено Или НастройкиВида.durationEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты,
				"beginDate", НСтр("ru='Дата начала действия';uk='Дата початку дії'"), "Дата");
			ДобавитьРеквизит(Реквизиты,
				"endDate", НСтр("ru='Дата окончания действия';uk='Дата закінчення дії'"), "Дата");
			ДобавитьРеквизит(Реквизиты,
				"openEnded", НСтр("ru='Бессрочный';uk='Безстроковий'"), "Булево");
			ДобавитьРеквизит(Реквизиты,
				"prolongationProcedure", НСтр("ru='Порядок продления';uk='Порядок продовження'"), "DMProlongationProcedure");
		КонецЕсли;
		...
		Если НастройкиВида <> Неопределено
			...
			ДобавитьТаблицу(Реквизиты, "cashFlowRows.rows", НСтр("ru='Статьи движения денежных средств';uk='Статті руху грошових коштів'"));
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "item", НСтр("ru='Статья';uk='Стаття'"), "DMCashFlowItem");
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "total", НСтр("ru='Сумма';uk='Сума'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты, "cashFlowRows.rows", "VAT", НСтр("ru='Сумма НДС';uk='Сума ПДВ'"), "Число");
		...
		Если НастройкиВида <> Неопределено
			...
			ДобавитьТаблицу(Реквизиты, "productRows.rows", НСтр("ru='Товары и услуги';uk='Товари і послуги'"));
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "product", НСтр("ru='Товар, услуга';uk='Товар, послуга'"), "DMProduct");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "price", НСтр("ru='Цена';uk='Ціна'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "quantity", НСтр("ru='Количество';uk='Кількість'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "measurementUnit", НСтр("ru='Единица измерения';uk='Одиниця вимірювання'"), "DMMeasurementUnit");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "VATRate", НСтр("ru='Ставка НДС';uk='Ставка ПДВ'"), "DMVATRate");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "VAT", НСтр("ru='Сумма НДС';uk='Сума ПДВ'"), "Число");
			ДобавитьРеквизитТаблицы(Реквизиты,
				"productRows.rows", "total", НСтр("ru='Сумма';uk='Сума'"), "Число");
	...
	ИначеЕсли ТипОбъектаДО = "DMCorrespondent" Тогда
		...
		ДобавитьРеквизит(Реквизиты, "name", НСтр("ru='Наименование';uk='Найменування'"), "Строка", Истина);
		Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
			ДобавитьРеквизит(Реквизиты,
				"legalPrivatePerson",
				НСтр("ru='Вид корреспондента';uk='Вид кореспондента'"),
				"DMLegalPrivatePerson",
				Истина);
		Иначе
			ДобавитьРеквизит(Реквизиты,
				"legalPrivatePerson",
				НСтр("ru='Вид контрагента';uk='Вид контрагента'"),
				"DMLegalPrivatePerson",
				Истина);
		КонецЕсли;
		ДобавитьРеквизит(Реквизиты, "inn", НСтр("ru='ИНН';uk='ІПН'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "okpo", НСтр("ru='Код по ЕДРПОУ';uk='Код за ЄДРПОУ'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "comment", НСтр("ru='Комментарий';uk='Коментар'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "fullName", НСтр("ru='Полное наименование';uk='Повне найменування'"), "Строка");
		ДобавитьРеквизит(Реквизиты, "privatePerson", НСтр("ru='Физическое лицо';uk='Фізична особа'"), "DMPrivatePerson");
		ДобавитьРеквизит(Реквизиты, "responsible", НСтр("ru='Ответственный';uk='Відповідальний'"), "DMUser");
	...
	Если ТипОбъектаДО = "DMIncomingDocument"
		...
		Если НастройкиТипа.statusEnabled = Истина И НастройкиТипа.statusChangeEnabled = Истина Тогда
			ДобавитьРеквизит(Реквизиты, "statusApproval", НСтр("ru='Состояние согласования';uk='Стан погодження'"), "DMDocumentStatus");
			ДобавитьРеквизит(Реквизиты, "statusConfirmation", НСтр("ru='Состояние утверждения';uk='Стан затвердження'"), "DMDocumentStatus");
			ДобавитьРеквизит(Реквизиты, "statusConsideration", НСтр("ru='Состояние рассмотрения';uk='Стан розгляду'"), "DMDocumentStatus");
			ДобавитьРеквизит(Реквизиты, "statusPerformance", НСтр("ru='Состояние исполнения';uk='Стан виконання'"), "DMDocumentStatus");
			ДобавитьРеквизит(Реквизиты, "statusRegistration", НСтр("ru='Состояние регистрации';uk='Стан реєстрації'"), "DMDocumentStatus");
		КонецЕсли;
	КонецЕсли;
	Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("2.1.16.2.CORP")
		...
		ДобавитьРеквизит(Реквизиты, "statusSigning", НСтр("ru='Состояние подписания';uk='Стан підписання'"), "DMDocumentStatus");
	КонецЕсли;
...
Функция СоответствиеСвойствXDTOиРеквизитовФормыОбъектаДО(ТипОбъекта) Экспорт
	...
	ИначеЕсли ТипОбъекта = "DMCorrespondent" Тогда
		...
		Результат.Вставить("okpo", "КодПоЕДРПОУ");
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					...
					Иначе
						ВызватьИсключение СтрШаблон(
							НСтр("ru='В правилах интеграции указано недопустимое имя реквизита-источника данных заполнения: %1';uk='У правилах інтеграції вказано неприпустиме ім''я реквізиту-джерела даних заповнення: %1'"), 
...
//   Форма - УправляемаяФорма - форма объекта BAS Документооборота.
								...
								Если МетаданныеИсточника.Реквизиты.Найти(ИмяРеквизитаОбъектаИС) = Неопределено
									...
									Если Не Найден Тогда
										ТекстСообщения = СтрШаблон(
											НСтр("ru='Не найден реквизит %1, указанный в правиле интеграциии с BAS Документооборотом.
|Проверьте правило интеграции или обратитесь к администратору.'
|;uk='Не знайдено реквізит %1, зазначений у правилі інтеграції з BAS Документообігом. 
|Перевірте правило інтеграції або зверніться до адміністратора.'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
					...
					Иначе // обычный реквизит объекта
						...
						Исключение // в случае отсутствия реквизита выдадим понятное сообщение об ошибке
							...
							Если МетаданныеИсточника.Реквизиты.Найти(ИмяРеквизитаОбъектаИС) = Неопределено
								...
								Если Не Найден Тогда
									ТекстСообщения = СтрШаблон(
										НСтр("ru='Не найден реквизит %1, указанный в правиле интеграции с BAS Документооборотом.
|Проверьте правило интеграции или обратитесь к администратору.'
|;uk='Не знайдено реквізит %1, зазначений у правилі інтеграції з BAS Документообігом. 
|Перевірте правило інтеграції або зверніться до адміністратора.'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
										ПравилоРеквизита.ИмяРеквизитаОбъектаИС);
	...
	Пока ВыборкаПравила.Следующий() Цикл
		...
		Пока НомерРеквизита <= Правило.ПравилаЗаполненияРеквизитовДО.Количество() - 1 Цикл
			...
			Если НайденныеРеквизиты.Количество() = 0 Тогда
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru='Очищено правило заполнения реквизита %1, отсутствующего в документе';uk='Очищено правило заповнення реквізиту %1, відсутнього в документі'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru='Очищено правило заполнения дополнительного реквизита, отсутствующего в документе';uk='Очищено правило заповнення додаткового реквізиту, відсутнього в документі'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
			...
			Если ПравилоРеквизита.Вариант = ВариантШаблон()
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru='Очищено правило заполнения реквизита %1, отсутствующего в шаблоне';uk='Очищено правило заповнення реквізиту %1, відсутнього в шаблоні'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru='Очищено правило заполнения дополнительного реквизита, отсутствующего в шаблоне';uk='Очищено правило заповнення додаткового реквізиту, відсутнього в шаблоні'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
					УровеньЖурналаРегистрации.Предупреждение,,
			...
			Если ПравилоРеквизита.Вариант = ВариантШаблон()
				...
				Если Не ПравилоРеквизита.ЭтоДополнительныйРеквизитДО Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("ru='Очищен признак ""Ключевой"" у реквизита %1, отсутствующего в шаблоне';uk='Очищена ознака ""Ключовий"" у реквізиту %1, відсутнього в шаблоні'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("ru='Очищен признак ""Ключевой"" у дополнительного реквизита, отсутствующего в шаблоне';uk='Очищена ознака ""Ключовий"" у додаткового реквізиту, відсутнього в шаблоні'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
					УровеньЖурналаРегистрации.Предупреждение,,
...
// Добавляет правило передачи реквизита в BAS Документооборот из интегрируемой системы.
//
// Параметры:
...
Процедура ДобавитьПравилоЗаполненияРеквизитаДО(Правило, Вариант, ИмяРеквизитаОбъектаДО, ЗначениеЗаполнения,
	...
	Иначе
		ВызватьИсключение СтрШаблон(
			НСтр("ru='Добавление правила заполнения реквизита с вариантом %1 в автоматическом режиме не поддерживается';uk='Додавання правила заповнення реквізиту з варіантом %1 в автоматичному режимі не підтримується'"),
			Вариант);
	КонецЕсли;
	
КонецПроцедуры

// Добавляет правило получения реквизита из BAS Документооборота в интегрируемую систему.
//
// Параметры:
//   Правило - СправочникСсылка.ПравилаИнтеграцииС1СДокументооборотом - ссылка на правило интеграции.
//   Вариант - ПеречислениеСсылка.ВариантыПравилЗаполненияРеквизитов - вариант заполнения реквизита.
...
Процедура ЗаполнитьПоРезультатуВыраженияНаВстроенномЯзыке(Объект, ИмяРеквизита, Результат)
	...
	Если ТипЗнч(Результат) = Тип("Строка")
		И Результат <> ""
		И ОбщегоНазначения.ЭтоПеречисление(МетаданныеРеквизита) Тогда
