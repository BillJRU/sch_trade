...
Процедура ОбновитьПредставление()
	...
	Если ЗначениеЗаполнено(ТипОбъектаДО) Тогда 
		...
		Если ТипОбъектаДО = "DMIncomingDocument" Тогда
			ПредставлениеОбъектаДО = НСтр("ru='Входящий документ';uk='Вхідний документ'");
		ИначеЕсли ТипОбъектаДО = "DMInternalDocument" Тогда
			ПредставлениеОбъектаДО = НСтр("ru='Внутренний документ';uk='Внутрішній документ'");
		ИначеЕсли ТипОбъектаДО = "DMOutgoingDocument" Тогда
			ПредставлениеОбъектаДО = НСтр("ru='Исходящий документ';uk='Вихідний документ'");
		ИначеЕсли ТипОбъектаДО = "DMCorrespondent" Тогда
			Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
				ПредставлениеОбъектаДО = НСтр("ru='Корреспондент';uk='Кореспондент'");
			Иначе
				ПредставлениеОбъектаДО = НСтр("ru='Контрагент';uk='Контрагент'");
			КонецЕсли;
		Иначе
