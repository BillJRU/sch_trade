...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоТаблица Тогда
		Заголовок =  НСтр("ru='Выбор таблицы BAS Документооборота';uk='Вибір таблиці BAS Документообігу'");
	Иначе
		Заголовок =  НСтр("ru='Выбор реквизита BAS Документооборота';uk='Вибір реквізиту BAS Документообігу'");
	КонецЕсли;
...
Процедура ЗаполнитьДеревоРеквизитов(РеквизитыОбъектаДО,
	...
	Для Каждого Реквизит Из РеквизитыОбъектаДО Цикл
		...
		Если Реквизит.ЭтоТаблица Тогда
			...
			НоваяСтрока.Тип = НСтр("ru='Таблица';uk='Таблиця'");
		Иначе
