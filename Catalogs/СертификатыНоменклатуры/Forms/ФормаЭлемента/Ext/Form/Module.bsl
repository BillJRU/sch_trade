...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "Запись_Файл" Тогда
		...
		НовоеИзображение.ПометкаУдаления                          = РеквизитыФайла.ПометкаУдаления;	
		НовоеИзображение.АдресФайлаВХранилище                     = РеквизитыФайла.АдресФайлаВХранилище;
		НовоеИзображение.ПриПолученииДанныхКартинкиВозниклаОшибка = РеквизитыФайла.ПриПолученииДанныхКартинкиВозниклаОшибка;
		
		ОбновитьАдресКартинки(РеквизитыФайла.АдресФайлаВХранилище, РеквизитыФайла.ПриПолученииДанныхКартинкиВозниклаОшибка);	
...
Процедура ПросмотретьИзображение()
	...
	Иначе
		...
		ОбщегоНазначенияКлиент.ОткрытьФайлВПрограммеПросмотра(Изображения[ТекущееИзображение-1].ПолноеИмя);
...
Функция РеквизитыИзображения(СсылкаНаФайл)
	...
	РеквизитыИзображения = Новый Структура("АдресФайлаВХранилище, ПометкаУдаления, ПриПолученииДанныхКартинкиВозниклаОшибка",
...
Процедура ОбновитьАдресКартинки(НовыйАдрес, ПриПолученииДанныхКартинкиВозниклаОшибка)
	...
	Иначе
		...
		Элементы.АдресКартинки.ТекстНевыбраннойКартинки = НСтр("ru='Добавить изображение';uk='Додати зображення'");
...
Процедура ДобавитьИзображениеНеПрисоединенноеПолучениеУниверсальногоВремениИзменения(ВремяИзменения, ДополнительныеПараметры) Экспорт
	...
	ОбновитьАдресКартинки(АдресФайлаВХранилище, Ложь);	
