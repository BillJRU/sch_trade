...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	Если Не Копирование 
		...
		ТекстПредупреждения = НСтр("ru='Для создания характеристик список нужно открывать из формы вида номенклатуры или номенклатуры.';uk='Для створення характеристик список потрібно відкривати з форми виду номенклатури або номенклатури.'");
	...
	Для Каждого КлючЗначение Из Строки Цикл
		...
		Если КоличествоКомплектующих > 0 Тогда
			ТекстКомплектующих = СтрокаСЧислом(
				НСтр("ru=';%1 комплектующая;;%1 комплектующие;%1 комплектующих;%1 комплектующие';uk=';%1 комплектує ;; %1 комплектуючі; %1 комплектуючих; %1 комплектуючі'"),
				КоличествоКомплектующих,
				ВидЧисловогоЗначения.Количественное);
		Иначе
			ТекстКомплектующих = НСтр("ru='Настроить';uk='Настроїти'");
		КонецЕсли;
