...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Замена строковых литералов в отборах настроек предопределенных макетов компоновки данных в справочнике ""Структура целей""';uk='Заміна строкових літералів в відборах настройок напередвизначений макетів компонування даних в довіднику ""Структура цілей""'");
