...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВидСообщения = "СообщениеSMS" Тогда
		...
		Заголовок = НСтр("ru='Шаблоны сообщений SMS';uk='Шаблони повідомлень SMS'");
	Иначе
	...
	Если РежимВыбора Тогда
		...
		Элементы.ФормаСформировать.Заголовок = НСтр("ru='Выбрать';uk='Обрати'");
...
Процедура ПослеФормированияИОтправкиСообщения(Результат, ПараметрыОтправки)
	...
	Иначе
		...
		ОписаниеОшибки = Результат.ОписаниеОшибки + Символы.ПС + НСтр("ru='Открыть форму отправки сообщения?';uk='Відкрити форму відправки повідомлення?'");
...
Процедура ЗаполнитьСписокДоступныхШаблонов()
	...
	Если НЕ РежимВыбора И НЕ ПодготовитьШаблон Тогда
		...
		ПерваяСтрока.Представление = НСтр("ru='<Без шаблона>';uk='<Без шаблону>'");
	КонецЕсли;
