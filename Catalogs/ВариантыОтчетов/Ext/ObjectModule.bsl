...
Процедура ПередЗаписью(Отказ)
	...
	Если Не Пользовательский И ПользователемИзмененаПометкаУдаления Тогда
		...
		Иначе
			ТекстОшибки = НСтр("ru='Снятие пометки удаления предопределенного варианта отчета запрещено.';uk='Зняття позначки вилучення напередвизначеного варіанту звіту заборонено.'");
		КонецЕсли;
