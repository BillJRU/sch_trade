...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПроцессыИспользуются И Не СделкаПроиграна И НЕ ОтветОФиксацииПроигрышаПолучен
		...
		ПоказатьВопрос(ОписаниеОповещенияВопрос ,НСтр("ru='Фиксация проигрыша сделки на текущем этапе. Продолжить?';uk='Фіксація програшу угоди на поточному етапі. Продовжити?'"),
