		...
		Если ТипЗнч(ДанныеЗаполнения) = Тип("СправочникСсылка.КонтактныеЛицаПартнеров") Тогда
			...
			Если Выборка.Следующий() Тогда
				...
				Если НЕ Выборка.Клиент Тогда
					...
					ТекстОшибки = НСтр("ru='%КонтактноеЛицо% не является контактным лицом партнера - клиента. Ввод сделки на основании доступен только для клиента.';uk='%КонтактноеЛицо% не є контактною особою партнера - клієнта. Введення угоди на підставі доступне тільки для клієнта.'");
