...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТипЗначения.СписокВыбора.Добавить("", НСтр("ru='<Все типы>';uk='<Всі типи>'"));
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<пустое значение>';uk='<пусте значення>'"));
...
Функция УдалитьДублиСервер()
	...
	ПараметрыВыполненияВФоне.НаименованиеФоновогоЗадания = НСтр("ru='Удаление дублей ключей реестра документов';uk='Вилучення дублів ключів реєстру документів'");
...
Функция СоздатьКлючиСервер()
	...
	ПараметрыВыполненияВФоне = ДлительныеОперации.ПараметрыВыполненияВФоне(ЭтотОбъект.УникальныйИдентификатор);
	ПараметрыВыполненияВФоне.НаименованиеФоновогоЗадания = НСтр("ru='Создание ключей рееста документов';uk='Створення ключів рєєст документів'");
	ПараметрыВыполненияВФоне.ЗапуститьВФоне = Истина;
...
Функция ПроверитьНеобходимостьПереотраженияДокументовВРеестреСервер()
	...
	ПараметрыВыполненияВФоне = ДлительныеОперации.ПараметрыВыполненияВФоне(ЭтотОбъект.УникальныйИдентификатор);
	ПараметрыВыполненияВФоне.НаименованиеФоновогоЗадания = НСтр("ru='Проверка корректности отражения документов в реестре';uk='Перевірка коректності відображення документів в реєстрі'");
	ПараметрыВыполненияВФоне.ЗапуститьВФоне = Истина;
...
Функция ИсправитьОшибкиОтраженияДокументовВРеестреСервер()
	...
	ПараметрыВыполненияВФоне = ДлительныеОперации.ПараметрыВыполненияВФоне(ЭтотОбъект.УникальныйИдентификатор);
	ПараметрыВыполненияВФоне.НаименованиеФоновогоЗадания = НСтр("ru='Исправление отражения документов в реестре документов';uk='Виправлення відображення документів в реєстрі документів'");
	ПараметрыВыполненияВФоне.ЗапуститьВФоне = Истина;
