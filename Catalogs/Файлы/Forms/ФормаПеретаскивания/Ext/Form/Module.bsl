...
#Если ВебКлиент Тогда
	ТекстПредупреждения =
		НСтр("ru='В веб-клиенте импорт файлов недоступен. Используйте команду ""Добавить"" в списке файлов.';uk='У вебклієнті імпорт файлів недоступний. Використовуйте команду ""Додати"" у списку файлів.'");
