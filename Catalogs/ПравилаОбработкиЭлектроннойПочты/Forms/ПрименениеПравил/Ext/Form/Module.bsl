...
Процедура Применить(Команда)
	...
	Если ДлительнаяОперация.Статус = "Выполнено" Тогда
		...
		Если Не ПустаяСтрока(ТекстСообщенияПользователю) Тогда
			ПоказатьОповещениеПользователя(НСтр("ru='Применение правил обработки';uk='Застосування правил обробки'"), ,ТекстСообщенияПользователю, БиблиотекаКартинок.Информация32);
		КонецЕсли;
...
Функция ПрименитьПравилаНаСервере()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Применение правил';uk='Застосування правил'") + " ";
