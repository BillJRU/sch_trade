...
Процедура ПрименитьПравила(Команда)
	...
	Иначе
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Не установлен отбор по владельцу(учетной записи) правил.';uk='Не встановлений відбір за власником (облікового запису) правил.'"));
		Возврат;
	КонецЕсли;
