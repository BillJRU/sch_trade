...
Функция ПредставлениеПереноса(ДатаИсточник, ДатаПриемник)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='с %1 %2 на %3 %4';uk='з %1 %2 на %3 %4'"),
...
Функция ДеньНеделиВФормулировкеСКакогоПереносим(Дата)
	...
	Соответствие.Вставить(1, НСтр("ru='понедельника';uk='понеділка'"));
	Соответствие.Вставить(2, НСтр("ru='вторника';uk='вівторка'"));
	Соответствие.Вставить(3, НСтр("ru='среды';uk='середи'"));
	Соответствие.Вставить(4, НСтр("ru='четверга';uk='четверга'"));
	Соответствие.Вставить(5, НСтр("ru='пятницы';uk='п''ятниці'"));
	Соответствие.Вставить(6, НСтр("ru='субботы';uk='суботи'"));
	Соответствие.Вставить(7, НСтр("ru='воскресенья';uk='неділі'"));
...
Функция ДеньНеделиВФормулировкеНаКакойПереносим(Дата)
	...
	Соответствие = Новый Соответствие;
	Соответствие.Вставить(1, НСтр("ru='понедельник';uk='понеділок'"));
	Соответствие.Вставить(2, НСтр("ru='вторник';uk='вівторок'"));
	Соответствие.Вставить(3, НСтр("ru='среду';uk='середу'"));
	Соответствие.Вставить(4, НСтр("ru='четверг';uk='четвер'"));
	Соответствие.Вставить(5, НСтр("ru='пятницу';uk='п''ятницю'"));
	Соответствие.Вставить(6, НСтр("ru='субботу';uk='суботу'"));
	Соответствие.Вставить(7, НСтр("ru='воскресенье';uk='неділя'"));
