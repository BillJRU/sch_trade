...
Процедура ПроверитьПриоритет(Отказ)
	...
	Если Выборка.Следующий() Тогда
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='Справочник.КлючевыеОперации.МодульОбъекта.ПередЗаписью';uk='Справочник.КлючевыеОперации.МодульОбъекта.ПередЗаписью'",ОбщегоНазначения.КодОсновногоЯзыка()),
