...
Процедура УстановитьОписаниеОшибкиАутентификации(Описание)
	...
	Текст.Добавить(НСтр("ru='Перейдите к ';uk='Перейдіть до'"), Тип("ТекстФорматированногоДокумента"));
	ЭлементСсылки = Текст.Добавить(НСтр("ru='настройкам учетной записи электронной почты';uk='настройкам облікового запису електронної пошти'"), Тип("ТекстФорматированногоДокумента"));
	Текст.Добавить(НСтр("ru=' для корректировки логина, пароля.';uk='для коригування логіна, пароля.'"), Тип("ТекстФорматированногоДокумента"));
