...
|;uk='Перерахунок ""[ЕдИзм1]"" в ""[ЕдИзм2]"" для номенклатури ""[Номенклатура]"" не підтримується - занадто великий коефіцієнт перерахунку.'");
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Представление = НСтр("ru='Изменение цвета текста единиц измерения с недопустимым коэффициентом';uk='Зміна кольору тексту одиниць вимірювання з неприпустимим коефіцієнтом'");
