...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СтруктураНастроек") Тогда
		...
		Если Параметры.СтруктураНастроек.Свойство("РежимРедактирования") Тогда
			Элементы.ЗаполнитьДокумент.Заголовок = НСтр("ru='Сохранить';uk='Зберегти'");
...
Процедура УстановитьВидимостьСтраницФормыИДоступностьЭлементов(РежимРедактирования, ЗаполнятьПоДефициту)
	...
	Если ТипПлана = Перечисления.ТипыПланов.ПланПродаж Тогда
		...
		Если ЗаполнятьПартнера Тогда
			...
			Вариант.Представление = НСтр("ru='по товарам, приобретенным клиентом';uk='за товарами, придбаними клієнтом'");
			Вариант.Описание = НСтр("ru='Вся номенклатура, приобретенная выбранным в документе клиентом.';uk='Вся номенклатура, придбана вибраним в документі клієнтом.'");
		
		Иначе
		
			Вариант.Представление = НСтр("ru='по товарам, приобретенным всеми клиентами';uk='за товарами, придбаними всіма клієнтами'");
			Вариант.Описание = НСтр("ru='Вся номенклатура, приобретенная всеми клиентами.';uk='Вся номенклатура, придбана усіма клієнтами.'");
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьАссортимент") Тогда
			...
			Вариант.Представление = НСтр("ru='по ассортименту';uk='за асортиментом'");
			Вариант.Описание = НСтр("ru='Позволяет заполнить номенклатуру по ассортименту, разрешенному к продаже.';uk='Дозволяє заповнити номенклатуру за асортиментом, дозволеним до продажу.'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
		
		КонецЕсли; 
		
	ИначеЕсли ТипПлана = Перечисления.ТипыПланов.ПланПродажПоКатегориям Тогда
		Элементы.ГруппаВариантЗаполненияСостава.Заголовок = НСтр("ru='Заполнять состав товарных категорий по:';uk='Заповнювати склад товарних категорій за:'");
		
		Если ЗаполнятьСклад Тогда
			
			Вариант = Новый Структура("Источник, Представление, Описание");
			Вариант.Источник = "ТоварныеКатегорииСкладаФормат";
			Вариант.Представление = НСтр("ru='по всем товарным категориям';uk='по всіх товарних категоріях'");
			Вариант.Описание = НСтр("ru='Все товарные категории, которые участвовали в продажах на складе (в формате магазина).';uk='Всі товарні категорії, які брали участь в продажах на складі (у форматі магазину).'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
		...
		Иначе
			...
			Вариант.Представление = НСтр("ru='по всем товарным категориям';uk='по всіх товарних категоріях'");
			Вариант.Описание = НСтр("ru='Вся товарные категории, которые участвовали в продажах.';uk='Вся товарні категорії, які брали участь в продажах.'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
		...
		Вариант.Представление = НСтр("ru='по формуле';uk='за формулою'");
		Вариант.Описание = НСтр("ru='Товарные категории будут получены из операндов (источников), указанных в формуле ниже.';uk='Товарні категорії будуть отримані з операндів (джерел), зазначених у формулі нижче.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
		
		Вариант = Новый Структура("Источник, Представление, Описание");
		Вариант.Источник = "Отбор";
		Вариант.Представление = НСтр("ru='по отбору';uk='за відбором'");
		Вариант.Описание = НСтр("ru='Позволяет заполнить товарные категории по произвольным отборам, установленным в документе.';uk='Дозволяє заповнити товарні категорії за довільними відборами, встановленими в документі.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
	...
	ИначеЕсли ТипПлана = Перечисления.ТипыПланов.ПланСборкиРазборки Тогда
		...
		Вариант.Представление = НСтр("ru='по собираемым комплектам';uk='по зібраних комплектах'");
		Вариант.Описание = НСтр("ru='Номенклатура, для которой создан хотя бы один вариант комплектации.';uk='Номенклатура, для якої створений хоча б один варіант комплектації.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
		
		Вариант = Новый Структура("Источник, Представление, Описание");
		Вариант.Источник = "СборкаКомплекты";
		Вариант.Представление = НСтр("ru='по признаку использования в сборке';uk='за ознакою використання в збиранні'");
		Вариант.Описание = НСтр("ru='Позволяет заполнить номенклатуру, которая когда-либо собиралась.';uk='Дозволяє заповнити номенклатуру, яка коли-небудь збиралася.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
	...
	ИначеЕсли ТипПлана = Перечисления.ТипыПланов.ПланВнутреннихПотреблений Тогда
		...
		Вариант.Представление = НСтр("ru='по признаку списания на расходы';uk='за ознакою списання на витрати'");
		Вариант.Описание = НСтр("ru='Позволяет заполнить товары, которые когда-либо списывались на обеспечение внутренних потребностей.';uk='Дозволяє заповнити товари, які коли-небудь списувалися на забезпечення внутрішніх потреб.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
	...
	ИначеЕсли ТипПлана = Перечисления.ТипыПланов.ПланЗакупок Тогда
		...
		Если ЗаполнятьПартнера Тогда
			Вариант.Представление = НСтр("ru='по номенклатуре поставщика';uk='за номенклатурою постачальника'");
			Вариант.Описание = НСтр("ru='Позволяет заполнить по зарегистрированной номенклатуре поставщика.';uk='Дозволяє заповнити по зареєстрованій номенклатурі постачальника.'");
		Иначе
			Вариант.Представление = НСтр("ru='по всей номенклатуре поставщиков';uk='по всій номенклатурі постачальників'");
			Вариант.Описание = НСтр("ru='Позволяет заполнить по зарегистрированной номенклатуре всех поставщиков.';uk='Дозволяє заповнити по зареєстрованій номенклатурі всіх постачальників.'");
		КонецЕсли;
		ВариантыЗаполненияСостава.Добавить(Вариант);
		...
		Если ЗаполнятьПартнера Тогда
			Вариант.Представление = НСтр("ru='по товарам, приобретенным у поставщика';uk='за товарами, придбаним у постачальника'");
			Вариант.Описание = НСтр("ru='Вся номенклатура, приобретенная у выбранного поставщика.';uk='Вся номенклатура, придбана у вибраного постачальника.'");
		Иначе
			Вариант.Представление = НСтр("ru='по товарам, приобретенным у всех поставщиков';uk='за товарами, придбаними у всіх постачальників'");
			Вариант.Описание = НСтр("ru='Вся номенклатура, приобретенная у всех поставщиков.';uk='Вся номенклатура, придбана у всіх постачальників.'");
		КонецЕсли;
		ВариантыЗаполненияСостава.Добавить(Вариант);
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьАссортимент") Тогда
			...
			Вариант.Представление = НСтр("ru='по ассортименту';uk='за асортиментом'");
			Вариант.Описание = НСтр("ru='Позволяет заполнить номенклатуру по ассортименту, разрешенному к закупкам.';uk='Дозволяє заповнити номенклатуру за асортиментом, дозволеним до купівель.'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
	...
	Если (ТипПлана = Перечисления.ТипыПланов.ПланПродаж
		...
		Если Не ЗаполнятьПоДефициту Тогда
			Вариант = Новый Структура("Источник, Представление, Описание");
			Вариант.Источник = "Формула";
			Вариант.Представление = НСтр("ru='из формулы';uk='з формули'");
			Вариант.Описание = НСтр("ru='Номенклатура будет получена из операндов, указанных в формуле ниже, имеющих не нулевое количество.';uk='Номенклатура буде отримана з операндів, зазначених у формулі нижче, що мають не нульову кількість.'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
		КонецЕсли;
		...
		Если Не РежимРедактирования Тогда
			...
			Вариант.Представление = НСтр("ru='не менять';uk='не міняти'");
			Вариант.Описание = НСтр("ru='Состав номенклатуры из плана не меняется.';uk='Склад номенклатури з плану не змінюється.'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
			
			Вариант = Новый Структура("Источник, Представление, Описание");
			Вариант.Источник = "Отбор";
			Вариант.Представление = НСтр("ru='по отбору';uk='за відбором'");
			Вариант.Описание = НСтр("ru='Позволяет заполнить номенклатуру по произвольным отборам, установленным в документе.';uk='Дозволяє заповнити номенклатуру за довільним відбором, встановленим в документі.'");
			ВариантыЗаполненияСостава.Добавить(Вариант);
		КонецЕсли;
	...
	Если ЗаполнятьПоДефициту Тогда
		...
		Вариант.Представление = НСтр("ru='по дефициту';uk='за дефіцитом'");
		Вариант.Описание = НСтр("ru='Заполняет номенклатуру по которой имеется дефицит, сформированный другими планам.';uk='Заповнює номенклатуру по якій є дефіцит, сформований іншими планами.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
	...
	Для каждого Вариант Из ВариантыЗаполненияСостава Цикл
		...
		ЭлементВариантЗаполненияСоставаПояснение.Заголовок = Вариант.ОПисание;
		Индекс = Индекс + 1;
	КонецЦикла;
...
Процедура ЗадатьПроизвольнуюФормулу(Результат, ДополнительныеПараметры) Экспорт
	...
	Если СмещениеРедактируемое <> 0 
		...
		ТекстВопроса = НСтр("ru='В формуле присутствует операнд по вычислению планируемого остатка, данные могут быть получены только из текущего периода. Изменить текущие настройки смещения и продолжить?';uk='У формулі присутній операнд з обчислення планованого залишку, дані можуть бути отримані тільки з поточного періоду. Змінити поточні настройки зсуву і продовжити?'");
		ПоказатьВопрос(
...
Процедура СформироватьПредставлениеОтбораНоменклатуры()
	...
	Если ЗначениеЗаполнено(ПредставлениеОтбора) Тогда
		МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='<изменить>';uk='<змінити>'"),,,,"Фильтр"));
	Иначе
		МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='<не установлен>';uk='<не встановлений>'"),,,,"Фильтр"));
	КонецЕсли;
