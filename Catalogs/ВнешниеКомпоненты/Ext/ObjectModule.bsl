...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоУникальнаяКомпонента() Тогда 
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Внешняя компонента с таким идентификатором ""%1"" и датой ""%2"" уже загружена в программу.';uk='Зовнішня компонента з таким ідентифікатором ""%1"" і датою ""%2"" вже завантажена в програму.'"),
			Идентификатор,
			ДатаВерсии);
	КонецЕсли;
