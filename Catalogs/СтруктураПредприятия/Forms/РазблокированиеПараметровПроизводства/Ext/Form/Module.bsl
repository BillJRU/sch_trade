...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("КомплекснаяАвтоматизация") Тогда
		...
		Элементы.ПроизводствоБезЗаказаЗаголовок.Заголовок = НСтр("ru='Производство';uk='Виробництво'");
		
		Элементы.ВариантСписанияЗатратНаВыпускиБезЗаказовЗаголовок.Заголовок =
			НСтр("ru='Вариант списания затрат на выпуск';uk='Варіант списання витрат на випуск'");
