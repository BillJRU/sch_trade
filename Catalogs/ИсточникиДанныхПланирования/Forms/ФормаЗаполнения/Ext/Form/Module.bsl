...
Процедура ЗаполнитьДокументСохранить(Команда)
	...
	Если НЕ ПравилоКорректно Тогда
		ТекстВопроса = НСтр("ru='Правила содержат ошибки. Продолжить заполнение документа или вернуться к редактированию правила?';uk='Правила містять помилки. Продовжити заповнення документа або повернутися до редагування правила?'");
		Кнопки = Новый СписокЗначений;
...
Процедура НастроитьФорму()
	...
	Элементы.ГруппаУпрощеннаяНастройка.ТолькоПросмотр = Не ДоступностьРедактированияНастроекЗаполнения;
