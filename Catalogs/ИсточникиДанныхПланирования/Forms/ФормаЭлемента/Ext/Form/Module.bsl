...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru='Компоновка настроек источника данных планирования';uk='Компонування настройок джерела даних планування'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
