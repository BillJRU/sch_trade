...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Предопределенный Тогда
		ТекстИсключения = НСтр("ru='Это служебная политика учета серий, редактирование запрещено.';uk='Це службова політика обліку серій, редагування заборонено.'");
	...
	Если ИспользуетсяПроизводство21 Тогда
		...
		Если ИспользуетсяПроизводство22 Тогда
			Элементы.УказыватьПриПроизводствеПродукции.Заголовок = НСтр("ru='при вводе выходных изделий в маршрутных листах и этапах производства';uk='при введенні вихідних виробів в маршрутних листах і етапах виробництва'");
		Иначе
			Элементы.УказыватьПриПроизводствеПродукции.Заголовок = НСтр("ru='при вводе выходных изделий в маршрутных листах';uk='при введенні вихідних виробів в маршрутних листах'");
		КонецЕсли;
		
	Иначе
		
		Если ИспользуетсяПроизводство22 Тогда
			Элементы.УказыватьПриПроизводствеПродукции.Заголовок = НСтр("ru='при выпуске продукции';uk='при випуску продукції'");
		КонецЕсли;
...
Процедура УстановитьДоступностьНаСервере()
	...
	УстановитьДоступностьНаСервереЛокализация(ИспользоватьОрдернуюСхемуПриОтраженииИзлишковНедостач);
...
&НаСервере
Процедура УстановитьДоступностьНаСервереЛокализация(ИспользоватьОрдернуюСхемуПриОтраженииИзлишковНедостач)
