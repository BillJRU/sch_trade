...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Не ЗакрытьФормуПринудительно
		...
		Если ЗавершениеРаботы Тогда
			ТекстПредупреждения = НСтр("ru='Настройка заполнения условий ответственного хранения будет прервана.';uk='Настройка заповнення умов відповідального зберігання буде перервана.'");
			Возврат;
		КонецЕсли;
		...
		ПоказатьВопрос(
			...
			НСтр("ru='Реквизиты были изменены. Закрыть без сохранения реквизитов?';uk='Реквізити були змінені. Закрити без збереження реквізитів?'"),
			СписокКнопок);
