...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЗавершениеРаботы
		...
		Отказ = Истина;
		ТекстПредупреждения = НСтр("ru='Работа помощника по заполнению реквизита ""Помещение"" в справочниках будет прервана.';uk='Робота помічника з заповнення реквізиту ""Приміщення"" в довідниках буде перервана.'");
		Возврат;
