...
Процедура НастроитьСписок(Номенклатура = Неопределено, ОтключениеОтбора = Ложь)
	...
	МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Если номенклатура уже была задействована в программе (в документах, настройках и т.п.), то произвольное изменение вида номенклатуры может привести к проблемам. Показаны виды номенклатуры, которые можно выбрать без привнесения проблем.';uk='Якщо номенклатура вже була задіяна в програмі (в документах, настройках тощо), то довільна зміна виду номенклатури може призвести до проблем. Показані види номенклатури, які можна вибрати без привнесення проблем.'")));
	
	Если Пользователи.РолиДоступны("РедактированиеРеквизитовОбъектов") Тогда
		МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Показать все виды номенклатуры';uk='Показати всі види номенклатури'"),
								,
								,
								,
								"ОтключитьОтбор"));
