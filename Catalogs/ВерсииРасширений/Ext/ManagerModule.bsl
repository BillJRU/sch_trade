...
// а также из формы установки расширений конфигурации в режиме платформы BAF.
//
	...
	Исключение
		...
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось удалить расширение ""%1"" по причине:
                       |%2'
                       |;uk='Не вдалося вилучити розширення ""%1"" через:
                       |%2'"),
			УдаляемоеРасширение,
		...
		Исключение
			...
			ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='После удаления, при обработке случая удаления всех расширений, произошла ошибка:
                           |%1'
                           |;uk='Після видалення, при обробці випадку видалення всіх розширень, сталася помилка:
