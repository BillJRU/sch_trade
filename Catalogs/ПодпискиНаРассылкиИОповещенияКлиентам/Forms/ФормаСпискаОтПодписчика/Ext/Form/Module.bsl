...
Процедура РедактироватьПодписку(ТекущиеДанные)
	...
	Если ТекущиеДанные.Принудительная Тогда
		ТекстПредупреждения = НСтр("ru='Для принудительных групп рассылок и оповещений подписки не настраиваются.';uk='Для примусових груп розсилок і сповіщень підписки не налаштовуються.'");
...
Процедура Подписаться(Команда)
	...
	Если МассивКПодписке.Количество() > 0 Тогда
		...
		ТекстПояснения  = НСтр("ru='Подписка выполнена для %1 из %2 групп рассылок и оповещений.';uk='Підписка виконана для %1 з %2 груп розсилок і сповіщень.'");
	...
	Иначе
		...
		ТекстПояснения  = НСтр("ru='Нет групп рассылок и оповещений для которых необходимо выполнить подписку';uk='Немає груп розсилок та сповіщень для яких необхідно виконати підписку'");
...
Процедура ОтменитьПодписку(Команда)
	...
	Если МассивКОтменеПодписки.Количество() > 0 Тогда
		...
		ТекстОповещения = НСтр("ru='Отмена подписок';uk='Скасування підписок'");
		ТекстПояснения  = НСтр("ru='Подписка отменена для %1 из %2 групп рассылок и оповещений.';uk='Підписка скасована для %1 з %2 груп розсилок і сповіщень.'");
		ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстПояснения,
	...
	Иначе
		...
		ТекстПояснения  = НСтр("ru='Нет групп рассылок и оповещений для которых необходимо отменять подписку';uk='Немає груп розсилок та сповіщень для яких необхідно скасувати підписку'");
