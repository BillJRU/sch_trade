...
Процедура ПереключитьСписокНаборов()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		НеиспользуемыеНаборы, "ОбщиеДополнительныеСведения", НСтр("ru='Неиспользуемые дополнительные сведения';uk='Не використовувані додаткові відомості'"), Истина);
	
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		НеиспользуемыеНаборы, "ОбщиеДополнительныеРеквизиты", НСтр("ru='Неиспользуемые дополнительные реквизиты';uk='Не використовувані додаткові реквізити'"), Истина);
...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		...
		КомандаСоздать.Подсказка          = НСтр("ru='Создать уникальное сведение';uk='Створити унікальну відомість'");
		КомандаСоздать.Заголовок          = НСтр("ru='Новое';uk= 'Нову'");
		...
		Элементы.ПоказатьНеиспользуемыеРеквизиты.Заголовок = НСтр("ru='Показать неиспользуемые сведения';uk='Показати невикористовувані відомості'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ru='Общее';uk= 'Загальна'");
	...
	Иначе
		...
		Элементы.ПоказатьНеиспользуемыеРеквизиты.Заголовок = НСтр("ru='Показать неиспользуемые реквизиты';uk='Показати невикористовувані реквізити'");
...
Процедура ИзменитьПометкуУдаления()
	...
	Если Элементы.Свойства.ТекущиеДанные <> Неопределено Тогда
		...
		Если ЭтоНаборыДополнительныхСведений Тогда
			Если Не ПоказатьНеиспользуемыеРеквизиты Тогда
				ТекстВопроса = НСтр("ru='Исключить сведение из набора?';uk='Виключити відомість з набору?'");
		...
		Иначе
			Если Не ПоказатьНеиспользуемыеРеквизиты Тогда
				ТекстВопроса = НСтр("ru='Исключить реквизит из набора?';uk='Виключити реквізит з набору?'");
