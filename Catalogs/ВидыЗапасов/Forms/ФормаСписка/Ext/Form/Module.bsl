...
Функция ЗапуститьЗаданиеЗаменитьДублиВидовЗапасовСервер(ПараметрыЗадания)
	...
	НаименованиеЗадания = НСтр("ru='Замена дублей видов запасов';uk='Заміна дублів видів запасів'");
...
Процедура ЗавершениеЗаданияЗаменитьДублиВидовЗапасовСервер(АдресХранилища)
	...
	ТекстЗаголовка = НСтр("ru='Дубли видов запасов заменены';uk='Дублі видів запасів замінені'");
	ТекстСообщения = НСтр("ru='Операция по замене дублирующихся элементов справочника ""Виды запасов"" завершена.';uk='Операція з заміни дублюючихся елементів довідника ""Види запасів"" завершена.'");
...
Функция ЗапуститьЗаданиеОбновитьИнформациюОбУстаревшихВидахЗапасов(ПараметрыЗадания)
	...
	НаименованиеЗадания = НСтр("ru='Обновление информации об устаревших видах запасов с остатками';uk='Оновлення інформації про застарілі види запасів із залишками'");
...
Процедура ЗавершениеЗаданияОбновитьИнформациюОбУстаревшихВидахЗапасов(АдресХранилища)
	...
	Картинка = БиблиотекаКартинок.Информация32;
	ТекстЗаголовка = НСтр("ru='Информация обновлена';uk='Інформація оновлена'");
	ТекстСообщения = НСтр("ru='Обновление информации об устаревших видах запасов с остатками завершено';uk='Оновлення інформації про застарілі види запасів із залишками завершено'");
