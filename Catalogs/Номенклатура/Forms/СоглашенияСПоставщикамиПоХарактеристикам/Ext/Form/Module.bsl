...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.СписокДействиеПредставление Тогда
		...
		Иначе
			ТекстИсключения = НСтр("ru='Неопределено действие перехода по гиперссылке.';uk='Не визначено дію переходу за гіперпосиланням.'");
...
Процедура ЗаполнитьСписок()
	...
	Для Каждого СтрТабл Из Соглашения Цикл
		...
		Если Не СтрТабл.ЕстьСоглашения Тогда
			...
			ЗаголовокГиперссылки = НСтр("ru='Создать соглашение';uk='Створити оферту'");
		ИначеЕсли Не СтрТабл.ЕстьСоглашениеПоХарактеристики Тогда
			ГиперссылкаСоглашения = "СоглашенияВыбрать";
			ЗаголовокГиперссылки = НСтр("ru='Выбрать в существующем соглашении';uk='Вибрати в існуючій оферті'");
		Иначе
			...
			ЗаголовокГиперссылки = НСтр("ru='Выбрано в %КоличествоСоглашений%';uk='Вибрано в %КоличествоСоглашений%'");
