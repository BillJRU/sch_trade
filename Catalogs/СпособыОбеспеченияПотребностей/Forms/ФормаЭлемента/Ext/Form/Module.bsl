...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ОдинИсточник = 1 И Не ЗначениеЗаполнено(Объект.ИсточникОбеспеченияПотребностей) Тогда
		...
		ИначеЕсли Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.Перемещение Тогда
			ТекстСообщения = НСтр("ru='Поле ""Распределительный центр"" не заполнено';uk='Поле ""Розподільний центр"" не заповнене'");
		КонецЕсли;
...
Процедура СформироватьЗаголовкиПоясняющихНадписей()
	...
	Если Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.Покупка Тогда
		ПояснениеТипаОбеспечения = НСтр("ru='Данный способ обеспечения позволяет формировать заказы поставщику.';uk='Даний спосіб забезпечення дозволяє формувати замовлення постачальнику.'");
	ИначеЕсли Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.Перемещение Тогда
		ПояснениеТипаОбеспечения = НСтр("ru='Данный способ обеспечения позволяет формировать заказы на перемещение.';uk='Даний спосіб забезпечення дозволяє формувати замовлення на переміщення.'");
	ИначеЕсли Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.СборкаРазборка Тогда
		ПояснениеТипаОбеспечения = НСтр("ru='Данный способ обеспечения позволяет формировать заказы на сборку.';uk='Даний спосіб забезпечення дозволяє формувати замовлення на збирання.'");
	ИначеЕсли Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.Производство Тогда
		ПояснениеТипаОбеспечения = НСтр("ru='Данный способ обеспечения позволяет формировать заказы на производство.';uk='Даний спосіб забезпечення дозволяє формувати замовлення на виробництво.'");
	ИначеЕсли Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.ПроизводствоНаСтороне Тогда
		ПояснениеТипаОбеспечения = НСтр("ru='Данный способ обеспечения позволяет формировать заказы переработчику.';uk='Даний спосіб забезпечення дозволяє формувати замовлення переробнику.'");
	Иначе
...
Функция ЗаполнитьСписокВыбораТипаОбеспечения()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСборкуРазборку")
		...
		СписокВыбора.Добавить(Перечисления.ТипыОбеспечения.СборкаРазборка, НСтр("ru='Сборка';uk='Збирання'"));
	КонецЕсли;
