...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Замена строковых литералов в отборах настроек предопределенных макетов компоновки данных в справочнике ""Варианты анализа целевых показателей""';uk='Заміна строкових літералів в відборах настройок напередвизначених макетів компонування даних в довіднику ""Варіанти аналізу цільових показників""'");
