...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	Если Не Копирование Тогда
		...
		ИначеЕсли ЗначениеЗаполнено(ПараметрыШаблона)
			...
			ТекстПредупреждения = НСтр("ru='Невозможно добавить новую серию, так как в настройках вида номенклатуры выключена возможность использования серий.';uk='Неможливо додати нову серію, тому що в настройках виду номенклатури виключена можливість використання серій.'");
