	...
	Если ЗначениеЗаполнено(ТекущиеДанные.Ссылка) Тогда
		...
		Если ТекущиеДанные.Статус = ПредопределенноеЗначение("Перечисление.СтатусыКартЛояльности.Действует")
			...
			Если ЗначениеЗаполнено(Организация) И Организация <> ТекущиеДанные.Организация Тогда
				Если ТипКода = ПредопределенноеЗначение("Перечисление.ТипыКодовКарт.Штрихкод") Тогда
					ТекстСообщения = НСтр("ru='Карта ""%1"" со штрихкодом ""%2"" зарегистрирована на другую организацию ""%3"".';uk='Карта ""%1"" зі штрихкодом ""%2"" зареєстрована на іншу організацію ""%3"".'");
				Иначе
					ТекстСообщения = НСтр("ru='Карта ""%1"" со магнитным кодом ""%2"" зарегистрирована на другую организацию ""%3"".';uk='Карта ""%1"" з магнітним кодом ""%2"" зареєстрована на іншу організацію ""%3"".'");
				КонецЕсли;
