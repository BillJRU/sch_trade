...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КодЯзыкаАльтернативный = ?(КодЯзыкаПечать = "uk", "ru", "uk");
	...
	КомандаПечати.Представление = ?(КодЯзыкаПечать = "ru", НСтр("ru='Анкета (Microsoft Word, русский язык)';uk='Анкета (Microsoft Word, російська мова)'"), НСтр("ru='Анкета (Microsoft Word, украинский язык)';uk='Анкета (Microsoft Word, українська мова)'"));
	...
	КомандаПечати.Представление = ?(КодЯзыкаПечать = "ru", НСтр("ru='Анкета (OpenOffice.org Writer, русский язык)';uk='Анкета (OpenOffice.org Writer, російська мова)'"), НСтр("ru='Анкета (OpenOffice.org Writer, украинский язык)';uk='Анкета (OpenOffice.org Writer, українська мова)'"));
    КомандаПечати.ДополнительныеПараметры.Вставить("ПараметрыВывода", ПараметрыВывода);
	КомандаПечати.ТребуетсяРасширениеРаботыСФайлами = Истина;
