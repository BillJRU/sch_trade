...
#Если ВебКлиент Тогда
	ТекстСообщения = НСтр("ru='Создание резервной копии не доступно в веб-клиенте.';uk='Створення резервної копії не доступно у вебклієнті.'");
		...
		Исключение
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Нет прав на запись в каталог с резервными копиями.
                    ...
                    |;uk='Немає прав на запис в каталог з резервними копіями.
                    |Не вдалося створити тестовий файл %1 з причини: %2'"),
...
#Если Не ВебКлиент И Не МобильныйКлиент Тогда
	...
	ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(
		...
		"Информация", 
		НСтр("ru='Выполняется резервное копирование информационной базы:';uk='Виконується резервне копіювання інформаційної бази:'") + " " + ИмяГлавногоФайлаСкрипта);
...
Функция СформироватьТекстЗаставки()
	...
	ПараметрыТекста["[ЗаголовокЗаставки]"] = ПодготовитьТекстСообщения(НСтр("ru='Резервное копирование информационной базы...';uk='Резервние копіювання інформаційної бази...'"));
	ПараметрыТекста["[ТекстЗаставки]"] = 
		ПодготовитьТекстСообщения(НСтр("ru='Пожалуйста, подождите.
                                        ...
                                        |<br /> Виконується резервне копіювання бази.
	...
	ПараметрыТекста["[Шаг2СозданиеРезервнойКопии]"] = ПодготовитьТекстСообщения(НСтр("ru='Создание резервной копии информационной базы';uk='Створення резервної копії інформаційної бази'"));
	ПараметрыТекста["[Шаг3ОжиданиеЗавершения]"] = ПодготовитьТекстСообщения(НСтр("ru='Ожидание завершения резервного копирования';uk='Очікування завершення резервного копіювання'"));
	...
	ПараметрыТекста["[ПроцессПрерван]"] = ПодготовитьТекстСообщения(НСтр("ru='Внимание: процесс резервного копирования был прерван, и информационная база осталась заблокированной.';uk='Увага: процес резервного копіювання був перерваний, і інформаційна база залишилася заблокованою.'"));
