...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Описание Из НастройкиИспользованияСерий.ОписанияИспользованияРеквизитовСерии Цикл
		...
		Иначе
			...
			ПолеФормыСерии        = Элементы["Серии" + Описание.ИмяРеквизита]; // ПолеФормы
...
Процедура УстановитьУсловноеОформление()
	...
	Для Каждого Описание Из НастройкиИспользованияСерий.ОписанияИспользованияРеквизитовСерии Цикл
		...
		Если Описание.Использование 
			...
			ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
			ПолеФормыСерии = Элементы["Серии" + Описание.Ключ]; // ПолеФормы
...
Функция СохранитьСериюПоСтроке(СтрТаблИдентификатор)
	...
	Если ПравоДобавленияСерий Тогда
		...
		Если СправочникОбъект <> Неопределено Тогда
			...
			Для Каждого Описание Из НастройкиИспользованияСерий.ОписанияИспользованияРеквизитовСерии Цикл
				Если Описание.Использование Тогда
					СправочникОбъект[Описание.ИмяРеквизита] = СтрТабл[Описание.ИмяРеквизита];
				КонецЕсли;
			КонецЦикла;
