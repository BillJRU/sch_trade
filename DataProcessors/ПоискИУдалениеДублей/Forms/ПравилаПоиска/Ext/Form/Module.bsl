...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Правила поиска дублей ""%1""';uk='Правила пошуку дублів ""%1""'"), Параметры.ПредставлениеОбластиОтбора);
...
Процедура УчитыватьПрикладныеПравилаПриИзменении(Элемент)
	...
	ТекстВопроса   = НСтр("ru='Внимание: поиск и удаление дублей элементов без учета поставляемых ограничений
                                ...
                                |;uk='Увага: пошук і вилучення дублів елементів без урахування обмежень, що поставляються,
