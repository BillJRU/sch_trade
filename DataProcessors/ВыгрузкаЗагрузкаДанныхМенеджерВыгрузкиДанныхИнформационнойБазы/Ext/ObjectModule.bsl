...
Процедура ВыгрузитьДанныеОбъектаМетаданных()
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаМетаданных';uk='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаМетаданных'",ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		ТекущийОбъектМетаданных,
		,
		СтрШаблон(НСтр("ru='Начало выгрузки данных объекта метаданных: %1';uk='Початок вивантаження даних об''єкта метаданих: %1'",ОбщегоНазначения.КодОсновногоЯзыка()),
	...
	ЗаписьЖурналаРегистрации(
        ...
        |Вивантажено об''єктів: %2'",ОбщегоНазначения.КодОсновногоЯзыка()),
