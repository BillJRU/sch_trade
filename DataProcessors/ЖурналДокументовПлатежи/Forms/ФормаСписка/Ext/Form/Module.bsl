...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИменаСобытийОбновленияСпискаПлатежей.Добавить("Загрузка_ОбменСБанками");
	ИменаСобытийОбновленияСпискаПлатежей.Добавить("Запись_ЛистКассовойКниги");
...
Процедура СписокОперацийКПоступлениюОтборНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("Перечисление.ХозяйственныеОперации.Форма.ФормаВыбораОперации",
		Новый Структура("СписокОпераций, Заголовок", СписокОперацийПоступления, НСтр("ru='Основания платежа';uk='Підстави платежу'")), Элемент);
...
Процедура СписокОперацийКОплатеОтборНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("Перечисление.ХозяйственныеОперации.Форма.ФормаВыбораОперации",
		Новый Структура("СписокОпераций, Заголовок", СписокОперацийОплаты, НСтр("ru='Основания платежа';uk='Підстави платежу'")), Элемент);
...
Процедура ИнициализироватьРеквизиты()
	...
	ЖурналПлатежей.Параметры.УстановитьЗначениеПараметра("ИдОбъектаЛистКассовойКниги",
		ОбщегоНазначения.ИдентификаторОбъектаМетаданных("Документ.ЛистКассовойКниги"));
...
Функция СписокТипыДокументов()
	...
	Список.Добавить(Тип("ДокументСсылка.ОтражениеРасхожденийПриИнкассацииДенежныхСредств"),
		НСтр("ru='Отражение расхождений при инкассации ДС';uk='Відображення розбіжностей при інкасації ГК'"));
...
Функция ЗаполнитьТипыПлатежногоДокументаПоступления()
	...
	ТипыПлатежногоДокументаПоступления.Добавить(НСтр("ru='Платежное поручение входящее';uk='Платіжне доручення вхідне'"));
	ТипыПлатежногоДокументаПоступления.Добавить(НСтр("ru='Инкассовое поручение входящее';uk='Інкасове доручення вхідне'"));
	ТипыПлатежногоДокументаПоступления.Добавить(НСтр("ru='Платежное требование входящее';uk='Платіжна вимога вхідна'"));
	ТипыПлатежногоДокументаПоступления.Добавить(НСтр("ru='Платежный ордер входящий';uk='Платіжний ордер вхідний'"));
...
Функция ЗаполнитьТипыПлатежногоДокументаСписания()
	...
	ТипыПлатежногоДокументаСписания.Добавить(НСтр("ru='Платежное поручение исходящее';uk='Платіжне доручення вихідне'"));
	ТипыПлатежногоДокументаСписания.Добавить(НСтр("ru='Инкассовое поручение исходящее';uk='Інкасове доручення вихідне'"));
	ТипыПлатежногоДокументаСписания.Добавить(НСтр("ru='Платежное требование исходящее';uk='Платіжна вимога вихідна'"));
	ТипыПлатежногоДокументаСписания.Добавить(НСтр("ru='Платежный ордер исходящий';uk='Платіжний ордер вихідний'"));
	ТипыПлатежногоДокументаСписания.Добавить(НСтр("ru='Банковский ордер исходящий';uk='Банківський ордер вихідний'"));
