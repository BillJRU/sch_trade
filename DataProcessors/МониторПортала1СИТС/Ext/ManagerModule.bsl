...
Процедура ПолучитьДанныеМонитора(ПараметрыЗадания, АдресРезультата) Экспорт
	...
	Если ПустаяСтрока(ИнформацияОбОбновлении.ИмяОшибки) Тогда
		РезультатОперации.Данные.updateInfo.updateAvailable = ИнформацияОбОбновлении.Конфигурация.ДоступноОбновление;
		РезультатОперации.Данные.ДоступноОбновление = ИнформацияОбОбновлении.Конфигурация.ДоступноОбновление;
	Иначе
		МониторПортала1СИТС.ЗаписатьОшибкуВЖурналРегистрации(
