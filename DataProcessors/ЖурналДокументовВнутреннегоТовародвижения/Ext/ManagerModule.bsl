...
Функция ОписаниеОперацийИТиповДокументов(ТЗХозОперацииИТипыДокументов) Экспорт
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (сборки товаров)';uk='Внутрішні документи (збирання товарів)'");
	...
	Строка.ЗаголовокФормыПереоформления	= НСтр("ru='Переоформление сборки товаров по выбранным распоряжениям';uk='Переоформлення збирання товарів за вбраними розпорядженням'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (разборки товаров)';uk='Внутрішні документи (розбирання товарів)'");
	Строка.ЗаголовокФормыПереоформления	= НСтр("ru='Переоформление разборки товаров по выбранным распоряжениям';uk='Переоформлення розбирання товарів по вибраним розпорядженням'");
	...
	Строка.ЗаголовокФормыПереоформления	= НСтр("ru='Переоформление списания товаров по выбранным распоряжениям';uk='Переоформлення списання товарів за вибраними розпорядженням'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (перемещения товаров)';uk='Внутрішні документи (переміщення товарів)'");
	...
	Строка.ЗаголовокФормыПереоформления	= НСтр("ru='Переоформление перемещения товаров по выбранным распоряжениям';uk='Переоформлення переміщення товарів за вибраними розпорядженням'");
	...
	Строка.ЗаголовокФормыПереоформления	= НСтр("ru='Переоформление перемещения товаров между филиалами по выбранным распоряжениям';uk='Переоформлення переміщення товарів між філіями по обраним розпорядженням'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (акты о расхождениях после перемещения)';uk='Внутрішні документи (акти про розбіжності після переміщення)'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (прочие оприходования товаров)';uk='Внутрішні документи (інші оприбуткування товарів)'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Внутренние документы (складские акты)';uk='Внутрішні документи (складські акти)'");
