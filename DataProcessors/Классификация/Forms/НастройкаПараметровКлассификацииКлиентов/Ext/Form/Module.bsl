...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ДекорацияABCКлассификацияОписание.Заголовок = СтрШаблон(НСтр("ru='По данным за период: %1.';uk='За даними за період: %1.'"),
		ОбеспечениеКлиентСервер.ОписаниеНастройки(ПериодABCКлассификации, КоличествоПериодовABCКлассификации));
	Элементы.ДекорацияXYZКлассификацияОписание.Заголовок = СтрШаблон(НСтр("ru='По данным за период: %1.';uk='За даними за період: %1.'"),
