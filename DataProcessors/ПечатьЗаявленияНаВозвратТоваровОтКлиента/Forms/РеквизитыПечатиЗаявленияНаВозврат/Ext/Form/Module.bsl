...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность И Не СохранитьПараметры И НЕ ЗавершениеРаботы Тогда
		...
		ПоказатьВопрос(
			...
			НСтр("ru='Реквизиты печати заявления на возврат были изменены. Закрыть без сохранения реквизитов?';uk='Реквізити друку заяви на повернення були змінені. Закрити без збереження реквізитів?'"),
			СписокКнопок);
...
Процедура ЗаполнитьПричиныВозвратаСписокВыбора()
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "%ТаблицаВозвратов%", ТекстТаблицыВозвратов);
