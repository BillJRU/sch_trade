...
Процедура КритичностьПриИзменении(Элемент)
	...
	Если Критичность = "Ошибка" Тогда
		ОтборПоУровню.Добавить("Ошибка", НСтр("ru='Ошибка';uk='Помилка'"));
	ИначеЕсли Критичность = "Предупреждение" Тогда
		ОтборПоУровню.Добавить("Предупреждение", НСтр("ru='Предупреждение';uk='Попередження'"));
	ИначеЕсли Критичность = "Информация" Тогда
		ОтборПоУровню.Добавить("Информация", НСтр("ru='Информация';uk='Інформація'"));
	ИначеЕсли Критичность = "Примечание" Тогда
		ОтборПоУровню.Добавить("Примечание", НСтр("ru='Примечание';uk='Примітка'"));
	КонецЕсли;
...
Процедура ВыгрузитьЖурналДляПередачиВТехподдержку(Команда)
	...
	ПараметрыСохраненияФайла.Диалог.Фильтр = НСтр("ru='Данные журнала регистрации';uk='Дані журналу реєстрації'") + "(*.xml)|*.xml";
