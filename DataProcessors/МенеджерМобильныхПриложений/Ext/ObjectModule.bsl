...
Процедура ЗаписатьМобильноеПриложение(ИмяМобильногоПриложения, ВерсияМобильногоПриложения, МобильноеПриложение, ИспользуемыеМетаданные) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='Ошибка записи мобильного приложения';uk='Помилка запису мобільного додатка'",КодОсновногоЯзыка),
...
Функция ПолучитьДанные(ИмяПользователя, КодМобильногоКомпьютера, Знач НачальнаяИнициализацияИБ = Ложь, ПараметрыОбменаДанными = "") Экспорт
	...
	Если УзелОбмена.ВерсияМобильногоПриложения.Пустая() Тогда
		ТекстСообщения = НСтр("ru='не указана используемая версия мобильного приложения';uk='не вказано використовувану версію мобільного додатка'");
...
Процедура ЗаписатьДанные(ИмяПользователя, КодМобильногоКомпьютера, ДанныеМобильногоПриложения, ПараметрыОбменаДанными = "") Экспорт
	...
	Исключение
		...
		ТекстСообщения = ИнформацияОбОшибке().Описание;
		ЗаписьЖурналаРегистрации(НСтр("ru='Ошибка записи данных, полученных от мобильного приложения';uk='Помилка запису даних, отриманих від мобільного додатка'",КодОсновногоЯзыка),
									УровеньЖурналаРегистрации.Ошибка,
									,
									,
									ТекстСообщения);
...
Процедура ЗарегистрироватьПолучениеДанных(ИмяПользователя, КодМобильногоКомпьютера, ПараметрыОбменаДанными = "") Экспорт
	...
	Исключение
		...
		ТекстСообщения = ИнформацияОбОшибке().Описание;
		ЗаписьЖурналаРегистрации(НСтр("ru='Ошибка при регистрации получения данных от мобильного приложения';uk='Помилка при реєстрації отримання даних від мобільного додатка'",КодОсновногоЯзыка),
									УровеньЖурналаРегистрации.Ошибка,
									,
									,
									ТекстСообщения);
