...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса") Тогда
		ВызватьИсключение НСтр("ru='Не поддерживается функциональность администрирования синхронизации данных в модели сервиса.';uk='Не підтримується функціональність адміністрування синхронізації даних в моделі сервісу.'");
	КонецЕсли;
