...
Функция СформироватьСписокТекущихДелВФоне()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Обновление списка текущих дел';uk='Оновлення списку поточних справ'");
	...
	ИначеЕсли Результат.Статус = "Выполнено" Тогда
		...
		Если ВыводитьОповещения Тогда
			Для Каждого ДелоСОповещением Из ДелаСОповещением Цикл
				...
				ПоказатьОповещениеПользователя(НСтр("ru='Текущие дела';uk='Поточні справи'"),
					ОбработкаОповещения,
