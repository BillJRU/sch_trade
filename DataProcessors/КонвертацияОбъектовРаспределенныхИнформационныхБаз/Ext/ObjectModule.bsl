		...
		Попытка
			...
			Если ЗначениеЗаполнено(ДублиПредопределенных) Тогда
				ЗаписьЖурналаРегистрации(
					НСтр("ru='Предопределенные элементы.Найдены не уникальные записи.';uk='Напередвизначені елементи.Знайдені не унікальні записи.'",ОбщегоНазначения.КодОсновногоЯзыка()),
...
Функция ШаблонОшибкиНеУникальностиЗаписей()
	Возврат
		НСтр("ru='Загрузка приоритетных данных не выполнена.
                   ...
                   |   - нажмите Выполнить.
                   |3. После этого запустите клиентское приложение BAF и выполните повторную синхронизацию данных.'
                   |;uk='Завантаження пріоритетних даних не виконано.
                   |%1
                   ...
                   |   - виберіть варіант ""Тестування та виправлення"", а не ""Тільки тестування"";
                   |   - натисніть кнопку Виконати.
                   |3. Після цього запустіть клієнтську прикладну програму BAF і потім знову виконайте синхронізацію даних.'");
КонецФункции
...
Функция ОшибкаОткрытияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru='Ошибка открытия файла сообщения обмена';uk='Помилка відкриття файлу повідомлення обміну'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ОшибкаНачалаЧтенияФайлаСообщенияОбмена()
	
	Возврат НСтр("ru='Ошибка при начале чтения файла сообщения обмена';uk='Помилка при початку читання файлу повідомлення обміну'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ОшибкаНачалаЗаписиФайлаСообщенияОбмена()
	
	Возврат НСтр("ru='Ошибка при начале записи файла сообщения обмена';uk='Помилка при початку запису файлу повідомлення обміну'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ОшибкаЧтенияФайлаСообщенияОбмена()
	
	Возврат НСтр("ru='Ошибка чтения файла сообщения обмена';uk='Помилка читання файлу повідомлення обміну'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ОшибкаВидаОбменаДанными()
	...
	Возврат НСтр("ru='Обмен не по правилам конвертации не поддерживается';uk='Обмін не за правилами конвертації не підтримується'",ОбщегоНазначения.КодОсновногоЯзыка());
