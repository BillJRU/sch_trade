...
|в сформованих замовленнях постачальникам.'");
		Возврат;
	КонецЕсли;
...
Процедура Назад(Команда)
	...
	ИначеЕсли СозданыЗаказы Тогда
		...
		ПоказатьОповещениеПользователя(
			НСтр("ru='Установка пометки удаления документов';uk='Встановлення позначки вилучення документів'"),
			,
			НСтр("ru='Сформированные заказы помечены на удаление.';uk='Сформовані замовлення позначені на вилучення.'"));
...
Процедура ПометитьНаУдаление(Команда)
	...
	Если Строки.Количество() = 1 И Действие = "ПометитьНаУдаление" Тогда
		...
		Текст = СтрШаблон(НСтр("ru='Пометить ""%1"" на удаление';uk='Позначити ""%1"" на вилучення'"), Строки[0]);

	ИначеЕсли Строки.Количество() = 1 И Действие = "СнятьПометкуУдаления" Тогда

		Текст = СтрШаблон(НСтр("ru='Снять с ""%1"" пометку удаления';uk='Зняти з ""%1"" позначку вилучення'"), Строки[0]);
