...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьПодразделения" 
	 ...
	 ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Если НаборКонстант.ИспользоватьПроизводствоНаСтороне Тогда
			...
			|- " + НСтр("ru='используется переработка на стороне';uk='використовується переробка на стороні'")
		КонецЕсли;
		Если НаборКонстант.ИспользоватьПроизводство Тогда
			ТекстОграничения = ТекстОграничения + "
			|- " + НСтр("ru='используется производство';uk='використовується виробництво'")
		КонецЕсли;                                          

		Если ЗначениеЗаполнено(ТекстОграничения) Тогда
			ТекстОграничения = НСтр("ru='Невозможно отключение подразделений:';uk='Неможливо відключення підрозділів:'")
				+ ТекстОграничения;
		КонецЕсли;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьНесколькоВалют"
		...
		Если ЗначениеЗаполнено(ТекстОграничения) Тогда
			ТекстОграничения = НСтр("ru='Невозможно отключение нескольких валют:';uk='Неможливо відключення кількох валют:'") + ТекстОграничения;
		КонецЕсли;
