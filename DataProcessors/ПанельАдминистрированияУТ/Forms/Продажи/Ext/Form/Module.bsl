...
Процедура ВключитьВерсионированиеЗаказовКлиентов(Команда)
	...
	Если Результат.Свойство("ВерсионированиеЗаказовКлиентовВключено") Тогда
		...
		Если Результат.ВерсионированиеЗаказовКлиентовВключено Тогда
			Пояснение = НСтр("ru='Для заказов клиентов установлен вариант версионирования ""Версионировать при проведении""';uk='Для замовлень клієнтів встановлений варіант версіонування ""Версіонувати при проведенні""'");
		Иначе
			Пояснение = НСтр("ru='Для заказов клиентов версионирование уже было включено';uk='Для замовлень клієнтів версіонування вже було включено'");
		КонецЕсли;
...
Процедура ВключитьВерсионированиеЗаявокНаВозврат(Команда)
	...
	Если Результат.Свойство("ВерсионированиеЗаявокНаВозвратВключено") Тогда
		...
		Если Результат.ВерсионированиеЗаявокНаВозвратВключено Тогда
			Пояснение = НСтр("ru='Для заявок на возврат установлен вариант версионирования ""Версионировать при проведении""';uk='Для заявок на повернення встановлений варіант версіонуванія ""Версіонувати при проведенні""'");
		Иначе
			Пояснение = НСтр("ru='Для заявок на возврат версионирование уже было включено';uk='Для заявок на повернення версіонування вже було включено'");
		КонецЕсли;
...
Процедура ВключитьВерсионированиеСоглашений(Команда)
	...
	Если Результат.Свойство("ВерсионированиеСоглашенийВключено") Тогда
		...
		Если Результат.ВерсионированиеСоглашенийВключено Тогда
			Пояснение = НСтр("ru='Для соглашений с клиентами установлен вариант версионирования ""Версионировать при проведении""';uk='Для оферт клієнтам встановлений варіант версіонування ""Версіонувати при проведенні""'");
		Иначе
			Пояснение = НСтр("ru='Для соглашений с клиентами версионирование уже было включено';uk='Для оферт клієнтам версіонування вже було включено'");
		КонецЕсли;
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьЗаказыКлиентов" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ИспользоватьЗаказыКлиентов.Доступность = 
			...
			И НЕ (НаборКонстант.ИспользоватьОказаниеАгентскихУслугПриЗакупке 
				И НаборКонстант.ВариантОбособленияТоваровВПродажах = Перечисления.ВариантыОбособленияТоваровВПродажах.ЗаказКлиента);
				
				Элементы.ГруппаКомментарийИспользоватьЗаказыПриАгентскойСхеме.Видимость = НаборКонстант.ИспользоватьОказаниеАгентскихУслугПриЗакупке 
				И НаборКонстант.ВариантОбособленияТоваровВПродажах = Перечисления.ВариантыОбособленияТоваровВПродажах.ЗаказКлиента;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьОказаниеАгентскихУслугПриЗакупке"
		...
		Если Не МожноИспользоватьОказаниеАгентскихУслугПриЗакупке Тогда
			УстановитьИспользованиеАгентскойСхемыПоЗакупкам(Ложь);
		КонецЕсли;
		...
		Если ЗначениеКонстанты Тогда
			...
			ТекущийВариантОбособления = НаборКонстант.ВариантОбособленияТоваровВПродажах;
			...
			ТекстПоЗаказуКлиента = НСтр("ru='По заказу клиента';uk='За замовленням клієнта'");
			ТекстПоДоговоруСКлиентом = НСтр("ru='По договору с клиентом';uk='За договором з клієнтом'");
			...
			Если Элементы.ВариантОбособленияТоваровУслугАгентскаяСхемаПоЗакупкам.СписокВыбора.ВыгрузитьЗначения().Найти(ТекущийВариантОбособления) = Неопределено Тогда
				УстановитьВариантОбособленияТоваровВПродажах(Элементы.ВариантОбособленияТоваровУслугАгентскаяСхемаПоЗакупкам.СписокВыбора.ВыгрузитьЗначения()[0]);
			Иначе
				НаборКонстант.ВариантОбособленияТоваровВПродажах = ТекущийВариантОбособления;
			КонецЕсли;
		...
		Иначе
			...
			Если ТекущийВариантОбособления = Перечисления.ВариантыОбособленияТоваровВПродажах.Договор Тогда
				...
				Если (НаборКонстант.ИспользоватьЗаказыКлиентов Или НаборКонстант.ИспользоватьЗаявкиНаВозвратТоваровОтКлиентов)
						И Константы.ФормироватьФинансовыйРезультат.Получить() Тогда
					УстановитьВариантОбособленияТоваровВПродажах(Перечисления.ВариантыОбособленияТоваровВПродажах.ЗаказКлиента);
				Иначе
					УстановитьВариантОбособленияТоваровВПродажах(Перечисления.ВариантыОбособленияТоваровВПродажах.ПустаяСсылка());
				КонецЕсли;	
			ИначеЕсли Не (НаборКонстант.ИспользоватьЗаказыКлиентов Или НаборКонстант.ИспользоватьЗаявкиНаВозвратТоваровОтКлиентов)
						И Константы.ФормироватьФинансовыйРезультат.Получить() Тогда
					УстановитьВариантОбособленияТоваровВПродажах(Перечисления.ВариантыОбособленияТоваровВПродажах.ПустаяСсылка());
			КонецЕсли;	
			
			Если НаборКонстант.ИспользоватьЗаказыКлиентов И Константы.ФормироватьФинансовыйРезультат.Получить()
					И НЕ НаборКонстант.ИспользоватьОказаниеАгентскихУслугПриЗакупке 
					И НЕ РеквизитПутьКДанным = "НаборКонстант.ВариантОбособленияТоваровВПродажах" Тогда
					УстановитьВариантОбособленияТоваровВПродажах(Перечисления.ВариантыОбособленияТоваровВПродажах.ЗаказКлиента);
			КонецЕсли;	
		...
		НеобходимостьВЗаказах = ЗначениеКонстанты И НаборКонстант.ВариантОбособленияТоваровВПродажах = Перечисления.ВариантыОбособленияТоваровВПродажах.ЗаказКлиента;
		
		Элементы.ГруппаКомментарийИспользоватьЗаказыПриАгентскойСхеме.Видимость = НеобходимостьВЗаказах;
		Элементы.ИспользоватьМобильноеПриложение1СЗаказыКлиентов.Доступность = НЕ НеобходимостьВЗаказах;
		Элементы.ВедетсяРаботаЧерезТорговыхПредставителей.Доступность = НЕ НеобходимостьВЗаказах;
		Элементы.ИспользоватьЗаказыКлиентов.Доступность = НЕ НеобходимостьВЗаказах;

		Элементы.ЛокализацияГруппаКомментарийИспользоватьДоговорыСКлиентамиПоАгентскимЗакупкам.Видимость = ЗначениеКонстанты;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьПередачуНаОтветственноеХранениеСПравомПродажи"
		...
		Элементы.ИспользоватьАктыРасхожденийПослеОтгрузкиПоПередачамХранителю.Доступность = ЗначениеКонстанты;
		Элементы.ИспользоватьАктыРасхожденийПослеПриемкиПоПоступлениямТоваровОтХранителя.Доступность = ЗначениеКонстанты;
...
Процедура УстановитьДоступностьВерсионированияЗаказовКлиентов()
	...
	Если НЕ ИспользоватьВерсионированиеОбъекта Тогда
		Элементы.ВключитьВерсионированиеЗаказовКлиентов.Заголовок = НСтр("ru='Включить версионирование';uk='Включити версіонування'");
	Иначе
		Элементы.ВключитьВерсионированиеЗаказовКлиентов.Заголовок = НСтр("ru='Версионирование включено';uk='Версіонування включено'");
...
Процедура УстановитьДоступностьВерсионированияЗаявокНаВозврат()
	...
	Если НЕ ИспользоватьВерсионированиеОбъекта Тогда
		Элементы.ВключитьВерсионированиеЗаявокНаВозврат.Заголовок = НСтр("ru='Включить версионирование';uk='Включити версіонування'");
	Иначе
		Элементы.ВключитьВерсионированиеЗаявокНаВозврат.Заголовок = НСтр("ru='Версионирование включено';uk='Версіонування включено'");
	КонецЕсли;
...
Процедура УстановитьДоступностьВерсионированияСоглашений()
	...
	Если НЕ ИспользоватьВерсионированиеОбъекта Тогда
		Элементы.ВключитьВерсионированиеСоглашений.Заголовок = НСтр("ru='Включить версионирование';uk='Включити версіонування'");
	Иначе
		Элементы.ВключитьВерсионированиеСоглашений.Заголовок = НСтр("ru='Версионирование включено';uk='Версіонування включено'");
	КонецЕсли;
...
&НаСервере 
Процедура УстановитьИспользованиеАгентскойСхемыПоЗакупкам(Использование)
	
	НаборКонстант.ИспользоватьОказаниеАгентскихУслугПриЗакупке = Использование;
	Константы.ИспользоватьОказаниеАгентскихУслугПриЗакупке.Установить(Использование);
	
КонецПроцедуры

&НаСервере
Процедура УстановитьВариантОбособленияТоваровВПродажах(ВариантОбособления)

	НаборКонстант.ВариантОбособленияТоваровВПродажах = ВариантОбособления;
	Константы.ВариантОбособленияТоваровВПродажах.Установить(ВариантОбособления);
