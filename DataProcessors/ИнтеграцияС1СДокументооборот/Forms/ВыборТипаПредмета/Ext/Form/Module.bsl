...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Предметы в ДО.
	ЗаголовокДО = ДобавитьЗаголовок(Дерево, НСтр("ru='В BAS Документообороте';uk='У BAS документообігу'"));
	...
	Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3.CORP") Тогда
		ДобавитьСтроку(ЗаголовокДО, "DMProject", НСтр("ru='Проект';uk='Проєкт'"));
	КонецЕсли;
	...
	Иначе
		ДобавитьСтроку(ЗаголовокДО, "DMCorrespondent", НСтр("ru='Контрагент';uk='Контрагент'"));
	КонецЕсли;
