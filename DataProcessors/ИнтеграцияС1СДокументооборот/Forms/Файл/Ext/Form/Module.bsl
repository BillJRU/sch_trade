...
Процедура ПолучитьОписаниеФайлаИЗаполнитьФорму()
	...
	Иначе
		ВызватьИсключение НСтр("ru='Не указан идентификатор файла.';uk='Не вказаний ідентифікатор файлу.'");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ID) Тогда
		Если ЗначениеЗаполнено(ВладелецФайла) Тогда
			Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='%1 (Присоединенный файл)';uk='%1 (Приєднаний файл)'"), Наименование);
		Иначе
			Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
	...
	Иначе // создание
		...
		Иначе
			Заголовок = НСтр("ru='Файл (создание)';uk='Файл (створення)'");
		КонецЕсли;
	КонецЕсли;
