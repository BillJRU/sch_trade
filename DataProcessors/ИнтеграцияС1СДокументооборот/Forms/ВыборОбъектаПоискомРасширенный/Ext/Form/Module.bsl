...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипОбъектаВыбора = "DMIncomingDocument" 
		...
		ДобавитьРеквизитПоиска("project", НСтр("ru='Проект';uk='Проєкт'"), "DMProject");
	...
	ИначеЕсли ТипОбъектаВыбора = "DMInternalDocument" Тогда
		...
		Иначе
			ДобавитьРеквизитПоиска("correspondent", НСтр("ru='Контрагент';uk='Контрагент'"), "DMCorrespondent");
		КонецЕсли;
