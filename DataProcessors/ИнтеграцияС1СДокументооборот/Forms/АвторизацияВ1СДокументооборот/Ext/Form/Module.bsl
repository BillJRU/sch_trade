...
Процедура ОК(Команда)
	...
	Если Не ЗначениеЗаполнено(ИмяПользователя)
		...
		ПоказатьПредупреждение(, НСтр("ru='Не заполнено имя пользователя BAS Документооборота.';uk='Не заповнене ім''я користувача BAS Документообігу.'"));
		Возврат;
	КонецЕсли;
	...
	Иначе
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ru='Не удалось подключиться к BAS Документообороту с указанным
|именем пользователя и паролем. Если вы уверены в их 
|правильности, обратитесь к администратору.'
|;uk='Не вдалося підключитися до BAS документообігу з вказаним 
