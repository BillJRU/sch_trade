...
Процедура ПутьККаталогуНачалоВыбораПослеПодключенияРасширения(Подключено, ПараметрыОповещения) Экспорт
	...
	Иначе // веб-клиент без расширение
		...
		ПоказатьПредупреждение(, НСтр("ru='Для выбора каталога в веб-клиенте необходимо установить расширение для работы с файлами.';uk='Для вибору каталогу у вебклієнті необхідно встановити розширення для роботи з файлами.'"));
