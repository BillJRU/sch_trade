...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Наборы.Количество() <= 1 Тогда
		Элементы.УдалитьВсеСтрокиНаборов.Заголовок = НСтр("ru='Удалить все строки набора';uk='Вилучити всі рядки набору'");
		Сообщение = НСтр("ru='Удаляемые строки входят в набор:';uk='Рядки, що вилучаються, входять у набір:'");
	Иначе
		Элементы.УдалитьВсеСтрокиНаборов.Заголовок = НСтр("ru='Удалить все строки наборов';uk='Вилучити всі рядки наборів'");
		Сообщение = НСтр("ru='Удаляемые строки входят в наборы:';uk='Рядки, що вилучаються, входять у набори:'");
	КонецЕсли;
