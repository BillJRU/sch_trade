...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Отказ = Истина;
		ВызватьИсключение НСтр("ru='Для корректной работы необходим режим толстого, или тонкого клиента.';uk='Для коректної роботи необхідний режим товстого, або тонкого клієнта.'");
...
Процедура ПрименитьОграниченияНастроек()
	...
	Для каждого КлючИЗначение Из ЭлементыОграничений Цикл
		Элемент = Элементы[КлючИЗначение.Ключ]; // ПолеФормы
