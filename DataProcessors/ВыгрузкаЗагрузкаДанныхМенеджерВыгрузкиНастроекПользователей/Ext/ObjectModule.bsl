		...
		Пока Продолжать Цикл
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
					НСтр("ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';uk='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена'",ОбщегоНазначения.КодОсновногоЯзыка()),
					...
					СтрШаблон(НСтр("ru='Выгрузка настройки пропущена, т.к. настройка не может быть прочитана:
                                              ...
                                              |Ключ об''єкта=%2
                                              |Користувач=%3
                                              |Представлення=%4'",ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура ВыгрузитьЭлементНастроек(ПотокЗаписи, Знач КлючНастроек, Знач КлючОбъекта, Знач Пользователь, Знач Представление, Знач Настройки)
	...
	Если НайтиНедопустимыеСимволыXML(КлючНастроек) > 0
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';uk='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена'",ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Предупреждение,,,
			НСтр("ru='Выгрузка настройки пропущена, т.к. в ключевых параметрах содержатся недопустимые символы.';uk='Вивантаження настройки пропущене, оскільки в ключових параметрах містить неприпустимі символи.'",ОбщегоНазначения.КодОсновногоЯзыка()));
