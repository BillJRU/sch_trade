...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "Обработки.ЗаполнениеГрафиковРаботы.СоздатьКалендарьПятидневка";
...
// Создает график работы на основе производственного календаря по шаблону "Пятидневка".
//
Процедура СоздатьКалендарьПятидневка() Экспорт
