...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность И Не СохранитьПараметры И НЕ ЗавершениеРаботы Тогда
		...
		ПоказатьВопрос(
			...
			НСтр("ru='Реквизиты печати акта выполненных работ были изменены. Закрыть без сохранения реквизитов?';uk='Реквізити друку акту виконаних робіт були змінені. Закрити без збереження реквізитів?'"),
			СписокКнопок);
