...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность И Не СохранитьПараметры И НЕ ЗавершениеРаботы Тогда
		...
		ПоказатьВопрос(
			...
			НСтр("ru='Параметры помощника продаж были изменены. Закрыть без сохранения параметров?';uk='Параметри помічника продажів були змінені. Закрити без збереження параметрів?'"),
			СписокКнопок);
		Возврат;
...
Процедура УстановитьЗаголовкиПрогнозированияПродажПоУмолчанию(Форма)
	...
	Элементы.ОтображатьРекомендацииКПокупке.Заголовок = НСтр("ru='Прогнозировать продажу клиенту';uk='Прогнозувати продаж клієнту'");
	Элементы.СпособПрогнозированияПродаж.Заголовок = НСтр("ru='Способ прогнозирования продаж';uk='Спосіб прогнозування продажів'");
...
Процедура УстановитьЗаголовкиПрогнозированияПродажПоПередачеТоваров(Форма)
	...
	Элементы.ОтображатьРекомендацииКПокупке.Заголовок = НСтр("ru='Прогнозировать передачу товаров клиенту';uk='Прогнозувати передачу товарів клієнту'");
	Элементы.СпособПрогнозированияПродаж.Заголовок = НСтр("ru='Способ прогнозирования передачи товаров';uk='Спосіб прогнозування передачі товарів'");
...
Процедура ИнициализироватьВариантыОформленияДокументовПродажи()
	...
	Если ИспользоватьПередачуТоваровХранение Тогда
