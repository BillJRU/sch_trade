...
Функция ЗаписатьВерсиюФайла(Знач ПараметрОбъект = Неопределено)
	...
	Исключение
		...
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru='Файлы.Ошибка записи версии присоединенного файла';uk='Файли.Помилка запису версії приєднаного файлу'",ОбщегоНазначения.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка, , ,
