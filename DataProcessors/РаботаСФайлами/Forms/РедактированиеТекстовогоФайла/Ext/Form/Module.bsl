...
Процедура СохранитьКак(Команда)
	...
	Фильтр = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Все файлы (*.%1)|*.%1';uk='Всі файли (*.%1)|*.%1'"), РасширениеФайла());
...
#Если ВебКлиент Тогда
	ПоказатьПредупреждение(, НСтр("ru='Сравнение версий файлов в веб-клиенте недоступно.';uk='Порівняння версій файлів у вебклієнті недоступно.'"));
	Возврат;
