...
Функция ПроверитьЗаданиеНаСервере(ИдентификаторЗадания)
	...
	Если Задание = Неопределено Тогда
		...
		Результат.КраткоеПредставлениеОшибки = НСтр("ru='Задание не найдено.';uk='Завдання не знайдено.'");
		Результат.ПодробноеПредставлениеОшибки = НСтр("ru='Задание не найдено.';uk='Завдання не знайдено.'");
...
Процедура ОтменитьЗадание(ИдентификаторЗадания)
	...
	Если Задание <> Неопределено И Задание.Состояние = СостояниеФоновогоЗадания.Активно Тогда
		Попытка
			Задание.Отменить();
		Исключение
			Событие = НСтр("ru='Проверка и корректировка данных';uk='Перевірка і коригування даних'",ОбщегоНазначения.КодОсновногоЯзыка());
