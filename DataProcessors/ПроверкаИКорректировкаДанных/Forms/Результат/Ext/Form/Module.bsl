	...
	Если ЗначениеЗаполнено(Параметры.ТабличныйДокумент) Тогда
		...
		Если Метаданные.Справочники.Найти(ИмяСправочника) <> Неопределено
			...
			Попытка
				...
				Исключение
					ВызватьИсключение НСтр("ru='Файл уже удален, возможно в другом сеансе была запущена проверка.';uk='Файл вже вилучений, можливо в іншому сеансі була запущена перевірка.'");
				КонецПопытки;
