...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Шаг.КнопкаНазад.Заголовок = НСтр("ru='Прервать';uk='Перервати'");
	Шаг.КнопкаНазад.Подсказка = НСтр("ru='Вернуться к выбору основного элемента';uk='Повернутися до вибору основного елемента'");
...
Функция ЗапуститьФоновоеЗадание(Знач ПараметрыМетода, Знач УникальныйИдентификатор)
	...
	НаименованиеМетода = НСтр("ru='Поиск и удаление дублей: Замена ссылок';uk='Пошук і вилучення дублів: Заміна посилань'");
