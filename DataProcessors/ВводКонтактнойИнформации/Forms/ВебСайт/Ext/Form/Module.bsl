...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ВидКонтактнойИнформации) Тогда
		ВызватьИсключение НСтр("ru='Команда не может быть выполнена для указанного объекта из-за некорректного внедрения контактной информации.';uk='Команда не може бути виконана для зазначеного об''єкта через некоректне впровадження контактної інформації.'");
	КонецЕсли;
