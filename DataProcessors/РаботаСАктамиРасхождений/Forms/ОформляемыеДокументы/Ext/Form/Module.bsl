...
Процедура СформироватьОтчет()
	...
	Если ВыборкаШапка.ЕстьОшибкиСтатус Тогда
		ВывестиОшибку(НСтр("ru='Для оформления документов по результатам расхождений необходимо перевести документ в статус ""Отрабатывается"" или ""Отработано"".';uk='Для оформлення документів за результатами розбіжностей необхідно перевести документ в статус ""Відпрацьовується"" або ""Відпрацьовано"".'"), Макет);
		Возврат;
	КонецЕсли;
	...
	ИначеЕсли ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеПриемки") Тогда
		...
		ИначеЕсли ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
			...
			ПраваДоступаНаТаблицы.Вставить("ЧтениеЗаказПоставщику",
							ПравоДоступа("Чтение", Метаданные.Документы.ЗаказПоставщику));
...
Процедура ЗаполнитьТаблицыСозданныхДокументов(РезультатЗапроса, ТипОснованияАктаОРасхождении, СоответствиеНаборовДанных)
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(ТипОснованияАктаОРасхождении) Тогда
			...
			Допоставки.Загрузить(РезультатЗапроса[4].Выгрузить());
		Иначе
		...
		ИначеЕсли Описание.ИмяКоманды = "Подтвердить" Тогда	
			...
			Если Описание.СтатусЭДО = "Получен" Тогда
				...
				Если ЕстьПравоОбменаЭДО Тогда
					...
					ЦветНадписи = ЦветаСтиля.ЦветГиперссылки;
					ТекстГиперссылки = НСтр("ru='Подтвердить';uk='Підтвердити'");
					ИспользоватьГиперссылку = Истина;
				
				Иначе
					
					ЦветНадписи = ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет;
					ТекстГиперссылки = НСтр("ru='Вам недоступно подтверждение электронного документа.';uk='Вам недоступно підтвердження електронного документа.'");
			...
			ИначеЕсли Описание.СтатусЭДО = "УтверждениеВОбработке" Тогда
				...
				ЦветНадписи = ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет;
				ТекстГиперссылки = НСтр("ru='Подтверждение инициировано.';uk='Підтвердження ініційовано.'");
				
			ИначеЕсли Описание.СтатусЭДО = "Утвержден" Тогда
				
				ЦветНадписи = ЦветаСтиля.РезультатУспехЦвет;
				ТекстГиперссылки = НСтр("ru='Электронный документ подтвержден.';uk='Електронний документ підтверджений.'");
				
			ИначеЕсли Описание.СтатусЭДО = "ОтклонениеВОбработке" Тогда
				
				ЦветНадписи = ЦветаСтиля.ПоясняющийОшибкуТекст;
				ТекстГиперссылки = НСтр("ru='Инициировано отклонение электронного документа, что не соответствует выбранному способу отработки расхождений';uk='Ініційовано відхилення електронного документа, що не відповідає обраному способу відпрацювання розбіжностей'");
				
			ИначеЕсли Описание.СтатусЭДО = "Отклонен" Тогда
				
				ЦветНадписи = ЦветаСтиля.ПоясняющийОшибкуТекст;
				ТекстГиперссылки = НСтр("ru='Электронный документ отклонен, что не соответствует выбранному способу отработки расхождений';uk='Електронний документ відхилений, що не відповідає вибраному способу відпрацювання розбіжностей'");
		...
		ИначеЕсли Описание.ИмяКоманды = "Отклонить" Тогда
			...
			Если Описание.СтатусЭДО = "Получен" Тогда
				...
				Если ЕстьПравоОбменаЭДО Тогда
					...
					ЦветНадписи = ЦветаСтиля.ЦветГиперссылки;
					ТекстГиперссылки = НСтр("ru='Отклонить';uk='Відхилити'");
					ИспользоватьГиперссылку = Истина;
				
				Иначе
					
					ЦветНадписи = ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет;
					ТекстГиперссылки = НСтр("ru='Вам недоступно отклонение электронного документа.';uk='Вам недоступно відхилення електронного документа.'");
			...
			ИначеЕсли Описание.СтатусЭДО = "УтверждениеВОбработке" Тогда
				...
				ЦветНадписи = ЦветаСтиля.ПоясняющийОшибкуТекст;
				ТекстГиперссылки = НСтр("ru='Инициировано подтверждение электронного документа, что не соответствует выбранному способу отработки расхождений.';uk='Ініційовано підтвердження електронного документа, що не відповідає обраному способу відпрацювання розбіжностей.'");
				
			ИначеЕсли Описание.СтатусЭДО = "Утвержден" Тогда
				
				ЦветНадписи = ЦветаСтиля.ПоясняющийОшибкуТекст;
				ТекстГиперссылки = НСтр("ru='Электронный документ подтвержден, что не соответствует выбранному способу отработки расхождений';uk='Електронний документ підтверджений, що не відповідає вибраному способу відпрацювання розбіжностей'");
				
			ИначеЕсли Описание.СтатусЭДО = "ОтклонениеВОбработке" Тогда
				
				ЦветНадписи = ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет;
				ТекстГиперссылки = НСтр("ru='Инициировано отклонение электронного документа.';uk='Ініційовано відхилення електронного документа.'");
				
			ИначеЕсли Описание.СтатусЭДО = "Отклонен" Тогда
				
				ЦветНадписи = ЦветаСтиля.РезультатУспехЦвет;
				ТекстГиперссылки = НСтр("ru='Электронный документ отклонен.';uk='Електронний документ відхилений.'");
...
Функция ТекстШапки(ТипДокумента, Описание , ХозяйственнаяОперация = Неопределено)
	...
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХранения" Тогда
		ТекстШапки = НСтр("ru='Документ ""Отгрузка товаров с хранения"" для довозврата недовозращенного товара';uk='Документ ""Відвантаження товарів зі зберігання"" для доповернення недоповернутого товару'");
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХраненияПоПриемке" Тогда
		ТекстШапки = НСтр("ru='Документ ""Отгрузка товаров с хранения"" для возврата перепоставленного товара';uk='Документ ""Відвантаження товарів зі зберігання"" для повернення перепоставленного товару'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровСХранения" Тогда
		ТекстШапки = НСтр("ru='Отразить расхождения в документе ""Отгрузка товаров с хранения""';uk='Відобразити розбіжності в документі ""Відвантаження товарів зі зберігання""'");
	ИначеЕсли ТипДокумента = "ИсправлениеПередачи" Тогда
		ТекстШапки = НСтр("ru='Отразить расхождения в документе ""Передача товаров хранителю""';uk='Відобразити розбіжності в документі ""Передача товарів зберігачу""'");
	ИначеЕсли ТипДокумента = "ПередачаТоваровХранителю" Тогда
		ТекстШапки = НСтр("ru='Документ ""Передача товаров хранителю"" для передачи недопоставленного товара';uk='Документ ""Передача товарів зберігачу"" для передачі недопоставленого товару'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранениеДопоставкаПоПриемке" Тогда
		ТекстШапки = НСтр("ru='Документ ""Приемка товаров на хранение"" для поступления недопоставленного товара';uk='Документ ""Приймання товарів на зберігання"" для надходження недопоставленого товару'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранение" Тогда
		ТекстШапки = НСтр("ru='Документ ""Приемка товаров на хранение"" для поступления перепоставленного товара';uk='Документ ""Приймання товарів на зберігання"" для надходження перепоставленного товару'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтХранителя" Тогда
		ТекстШапки = НСтр("ru='Отразить расхождения в документе ""Поступление товаров от хранителя""';uk='Відобразити розбіжності в документі ""Надходження товарів від зберігача""'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтХранителяДовозврат" Тогда
		ТекстШапки = НСтр("ru='Документ ""Поступление товаров от хранителя"" по недовозвращенным товарам';uk='Документ ""Надходження товарів від зберігача"" по недоповернутих товарах'");
	...
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслуг" Тогда 
		ТекстШапки = НСтр("ru='Документ ""Приобретение товаров и услуг"" для поступления перепоставленного товара';uk='Документ ""Придбання товарів і послуг"" для надходження перепоставленного товару'");
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслугДопоставкаПоПоступлению" Тогда
		ТекстШапки = НСтр("ru='Документ ""Приобретение товаров и услуг"" для поступления недопоставленного товара';uk='Документ ""Придбання товарів і послуг"" для надходження недопоставленого товару'");
	...
	ИначеЕсли ТипДокумента = "ИсправлениеПоступления" Тогда
		ТекстШапки = НСтр("ru='Отразить расхождения в документе ""Приобретение товаров и услуг""';uk='Відобразити розбіжності в документі ""Придбання товарів і послуг""'");
	ИначеЕсли ТипДокумента = "ИсправлениеПриемкиТоваровНаХранение" Тогда
		ТекстШапки = НСтр("ru='Отразить расхождения в документе ""Приемка товаров на хранение""';uk='Відобразити розбіжності в документі ""Приймання товарів на зберігання""'");
	...
	Если ТипДокумента = "ЭлектронныйДокументПодтверждение" Тогда
		ТекстШапки = НСтр("ru='Подтвердить полученный электронный документ';uk='Підтвердити отриманий електронний документ'");
	ИначеЕсли ТипДокумента = "ЭлектронныйДокументОтклонение" Тогда
		ТекстШапки = НСтр("ru='Отклонить полученный электронный документ';uk='Відхилити отриманий електронний документ'");	
	КонецЕсли;
...
Функция ТекстЛегенды(ТипДокумента, ХозяйственнаяОперация = Неопределено)
	...
	ИначеЕсли ТипДокумента = "ИсправлениеЗаявкаНаВозвратТоваров" Тогда
		Возврат НСтр("ru='Необходимо скорректировать документы ""Заявка на возврат товаров от клиента"", отменив строки с товарами, по которым были выявлены недостачи при возврате. Следует выполнить для строк акта о расхождениях с вариантом отработки ""Оформить"".';uk='Необхідно скоригувати документи ""Заявка на повернення товарів від клієнта"", скасувавши рядки з товарами, по яких були виявлені нестачі при поверненні. Слід виконати для рядків акта про розбіжності з варіантом відпрацювання ""Оформити"".'");
	ИначеЕсли ТипДокумента = "РеализацияТоваровИУслуг" Тогда
	...
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслуг" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Приобретение товаров и услуг"" по излишкам, отмеченным к возврату поставщиком. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';uk='Необхідно оформити документ ""Придбання товарів і послуг» відповідно до залишків, зазначених до повернення постачальником. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і повернути"".'");
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХранения" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Отгрузка товаров с хранения"" по недостачам, отмеченным к допоставке поставщику. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".';uk='Необхідно оформити документ ""Відвантаження товарів зі зберігання"" за недостачами, зазначеними до допоставки постачальнику. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і допоставить"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровСХранения" Тогда
		Возврат НСтр("ru='Необходимо скорректировать документ ""Отгрузка товаров с хранения"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';uk='Необхідно скоригувати документ ""Відвантаження товарів зі зберігання"", відобразивши в ньому кількість за фактом. Слід виконати для рядків акта про розбіжності з варіантами відпрацювання: ""Оформити і повернути"", ""Оформити"", ""Оформити і допоставити"".'");
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХраненияПоПриемке" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Отгрузка товаров с хранения"" по перепоставленному товару, отмеченному к возврату поставщику. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';uk='Необхідно оформити документ ""Відвантаження товарів зі зберігання"" по перепоставленному товару, зазначеному до повернення постачальнику. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і повернути"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеПередачи" Тогда
		Возврат НСтр("ru='Необходимо скорректировать документ ""Передача товаров хранителю"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';uk='Необхідно скоригувати документ ""Передача товарів зберігачу"", відобразвши в ньому кількість за фактом. Слід виконати для рядків акта про розбіжності з варіантами відпрацювання: ""Оформити і повернути"", ""Оформити"", ""Оформити і допоставити"".'");
	ИначеЕсли ТипДокумента = "ПередачаТоваровХранителю" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Передача товаров хранителю"" по недостачам, отмеченным к допоставке клиенту. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".';uk='Необхідно оформити документ ""Передача товарів зберігачу"" по недостачах, зазначеним до допоставки клієнту. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і допоставить"".'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранение" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Приемка товаров на хранение"" по излишкам, отмеченным к возврату поставщиком. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".';uk='Необхідно оформити документ ""Приймання товарів на зберігання"" по залишках, зазначених до повернення постачальником. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і повернути"".'");
	ИначеЕсли ТипДокумента = "ПриемкаТоваровНаХранениеДопоставкаПоПриемке" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Приемка товаров на хранение"" по недостачам, для которых требуется допоставка. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';uk='Необхідно оформити документ ""Приймання товарів на зберігання"" по нестачах, для яких потрібна допоставка. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і очікувати допоставку"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтХранителя" Тогда
		Возврат НСтр("ru='Необходимо скорректировать документ ""Поступление товаров от хранителя"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и допоставить"".';uk='Необхідно скоригувати документ ""Надходження товарів від зберігача"", відобразивши в ньому кількість за фактом. Слід виконати для рядків акта про розбіжності з варіантами відпрацювання: ""Оформити і повернути"", ""Оформити"", ""Оформити і допоставити"".'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтХранителяДовозврат" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Поступление товаров от хранителя"" по недостачам, отмеченным к довозврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';uk='Необхідно оформити документ ""Надходження товарів від зберігача"" по нестачах, зазначених до доповернення клієнтом. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і очікувати допоставку"".'");
	ИначеЕсли ТипДокумента = "ПриобретениеТоваровУслугДопоставкаПоПоступлению" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Приобретение товаров и услуг"" по недостачам, для которых требуется допоставка. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и ожидать допоставку"".';uk='Необхідно оформити документ ""Придбання товарів і послуг"" по нестачах, для яких потрібна допоставка. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Оформити і очікувати допоставку"".'");
	ИначеЕсли ТипДокумента = "ПеремещениеТоваров" Тогда
	...
	ИначеЕсли ТипДокумента = "СписаниеНедостачТоваров" Тогда
		Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПриемНаХранениеСПравомПродажи Тогда
			Возврат НСтр("ru='Необходимо оформить документ ""Списание недостач товаров"" для списания  непризнанных недостач. Оформляется на строки акта о расхождениях с вариантом отработки ""Списать недостачи"".';uk='Необхідно оформити документ ""Списання нестач товарів"" для списання невизнаних нестач. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""Списати нестачі"".'");
		Иначе
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "СписаниеЗадолженности" Тогда
		Возврат НСтр("ru='Необходимо оформить документ ""Списание задолженности"" для отражения задолженности сторонней компании по недостачам, произошедшим по ее вине. Оформляется на строки акта о расхождениях с вариантом отработки ""По вине сторонней компании"" в случае, если установлен флаг ""По вине сторонней компании"".';uk='Необхідно оформити документ ""Списання заборгованості"" для відображення заборгованості сторонньої компанії по нестач,ах що сталися з її вини. Оформляється на рядки акта про розбіжності з варіантом відпрацювання ""З вини сторонньої компанії"" в разі, якщо встановлено прапор ""З вини сторонньої компанії"".'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковТоваров" Тогда
	...
	ИначеЕсли ТипДокумента = "ИсправлениеПоступления" Тогда
		Возврат НСтр("ru='Необходимо скорректировать документ ""Приобретение товаров и услуг"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и ожидать допоставку"".';uk='Необхідно скоригувати документ ""Придбання товарів і послуг"", відобразивши в ньому кількість за фактом. Слід виконати для рядків акта про розбіжності з варіантами відпрацювання: ""Оформити і повернути"", ""Оформити"", ""Оформити і очікувати допоставку"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеПриемкиТоваровНаХранение" Тогда
		Возврат НСтр("ru='Необходимо скорректировать документ ""Приемка товаров на хранение"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"", ""Оформить и ожидать допоставку"".';uk='Необхідно скоригувати документ ""Приймання товарів на зберігання"", відобразивши в ньому кількість за фактом. Слід виконати для рядків акта про розбіжності з варіантами відпрацювання: ""Оформити і повернути"", ""Оформити"", ""Оформити і очікувати допоставку"".'");
	ИначеЕсли ТипДокумента = "ВозвратТоваровПоставщикуПоПоступлению" Тогда
	...
	ИначеЕсли ТипДокумента = "ЭлектронныйДокументПодтверждение" Тогда
		Возврат НСтр("ru='Необходимо подтвердить полученный электронный документ, так как для отражения расхождения оформляется документ ""Корректировка поступления"".';uk='Необхідно підтвердити отриманий електронний документ, njve oj для відображення розбіжності складається акт ""Коригування надходження"".'");
	ИначеЕсли ТипДокумента = "ЭлектронныйДокументОтклонение" Тогда
		Возврат НСтр("ru='Необходимо отклонить полученный электронный документ, так как для отражения расхождения изменяется исходный документ поступления.';uk='Необхідно відхилити отриманий електронний документ, тому що для відображення розбіжності змінюється вихідний документ надходження.'");
	КонецЕсли;
...
Функция ТекстЗапросаАктОРасхожденияхПослеВозвратаОтХранителя(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	|	Действия.ПоВинеСтороннейКомпании КАК ПоВинеСтороннейКомпании,
	|	ВЫБОР
	|		КОГДА Действия.Основание.Распоряжение = ЗНАЧЕНИЕ(Документ.ЗаявкаНаВозвратТоваровОтКлиента.ПустаяСсылка)
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ КАК ПоЗаказам,
	|	Действия.Склад КАК Склад,
...
Процедура ВывестиИсправлениеПриемкаТоваровНахранение(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ИсправлениеПриемкиТоваровНаХранение", 1, Макет, МассивОформленныхДокументов, , Ложь, Описание);
...
Процедура ВывестиИсправлениеОтгрузкаТоваровСХранения(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ИсправлениеОтгрузкаТоваровСХранения", 1, Макет, МассивОформленныхДокументов, , Ложь,
		Описание);
...
Процедура ВывестиДокументПриемкаТоваровНаХранение(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ПриемкаТоваровНаХранение", 2, Макет, МассивОформленныхДокументов, Неопределено, Истина,
		Описание);
...
Процедура ВывестиДокументДопоставкиПоПриемкеТоваровНахранение(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ПриемкаТоваровНаХранениеДопоставкаПоПриемке", 2, Макет, МассивОформленныхДокументов, ,
		Истина, Описание)
...
Процедура ВывестиДокументОтгрузкаТоваровСХраненияДляВозвратаНедопоставленногоТовара(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ОтгрузкаТоваровСХранения", 2, Макет, МассивОформленныхДокументов, Неопределено, Истина,
		Описание);
...
Функция ТекстЗапросаАктОРасхожденияхПослеПередачиТоваровХранителю()
	...
	|
	|ВЫБРАТЬ
	|	ТоварыВозврата.ДокументРеализации КАК Передача,
	|	ТоварыВозврата.Ссылка             КАК ДокументВозврата
	|ИЗ
	|	Документ.ВозвратТоваровОтКлиента.Товары КАК ТоварыВозврата
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Действия КАК Действия
	|		ПО ТоварыВозврата.ДокументРеализации = Действия.Передача
	|ГДЕ
	|	НЕ &ИспользоватьЗаявкиНаВозврат
	|	И ТоварыВозврата.Ссылка.Проведен
	|;
	|
	|//////////////////////////////////////////////////////////////////////////////// 3
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
...
Процедура ВывестиИсправлениеДокументаЗаказПоПередаче(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ЗаказКлиента", 2, Макет, МассивОформленныхДокументов, Неопределено, Ложь, Описание);
...
Процедура ВывестиДокументВозвратаПоПередаче(СтрокаДействия, Макет, Описание)
	...
	ВывестиДокументКОформлению("ДокументВозврата", 2, Макет, МассивОформленныхДокументов, Неопределено, Истина,Описание);
