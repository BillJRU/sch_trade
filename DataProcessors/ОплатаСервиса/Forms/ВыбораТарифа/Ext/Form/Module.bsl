...
Процедура ТекстПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
    ...
    Если ДанныеСобытия.Anchor.dataset = Неопределено Тогда
        ...
        Сообщение.Текст = НСтр("ru='Не заданы параметры ''data-''.';uk='Не задані параметри ''data-''.'");
        Сообщение.Сообщить();     
        Возврат;
    КонецЕсли; 
    ...
    Исключение
        Сообщение = Новый СообщениеПользователю;
        Сообщение.Текст = НСтр("ru='Не определен параметр ''data-tariff''.';uk='Не визначено параметр ''data-tariff''.'");
        Сообщение.Сообщить(); 
    КонецПопытки; 
    ...
    Исключение
        Сообщение = Новый СообщениеПользователю;
        Сообщение.Текст = НСтр("ru='Не определен параметр ''data-period''.';uk='Не визначено параметр ''data-period''.'");
        Сообщение.Сообщить(); 
    КонецПопытки; 
