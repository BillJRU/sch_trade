...
Функция ДанныеКлассификатораПоИдентификатору(Знач ПараметрыПоиска)
	...
	Результат.Вставить("КраткоеПредставлениеОшибки", НСтр("ru='Поле не содержит адресных сведений для выбора';uk='Поле не містить адресних відомостей для вибору'"));
	Результат.Вставить("Отказ", Ложь);
	...
	Если ДанныеКлассификатора.Отказ Тогда
		...
		Результат.КраткоеПредставлениеОшибки = НСтр("ru='Автоподбор и проверка адреса недоступны:';uk='Автоматичний вибір та перевірка адреси недоступні:'") + Символы.ПС + ДанныеКлассификатора.КраткоеПредставлениеОшибки;
		Результат.Отказ = Истина;
		Возврат Результат;
