...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Заголовок = НСтр("ru='Выбрать земельный участок';uk='Вибрати земельну ділянку'");
		Элементы.Найти.Подсказка = НСтр("ru='Поиск по номеру земельного участка';uk='Пошук по номеру земельної ділянки'");
		Элементы.Найти.ПодсказкаВвода = НСтр("ru='Номер земельного участка';uk='Номер земельної ділянки'");
	КонецЕсли;
