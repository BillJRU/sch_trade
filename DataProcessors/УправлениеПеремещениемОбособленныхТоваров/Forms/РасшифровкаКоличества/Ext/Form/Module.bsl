...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Режим = "РАСПРЕДЕЛЕНИЕ_ОСТАТКОВ" Тогда
		...
		Заголовок = СтрШаблон(НСтр("ru='График перемещения товаров со склада: %1';uk='Графік переміщення товарів зі складу: %1'"), Параметры.СкладОтправитель);
		Элементы.ТоварРасшифровкаСклад.Заголовок = НСтр("ru='Склад-получатель';uk='Склад-одержувач'");
	...
	ИначеЕсли Параметры.Режим = "ОБЕСПЕЧЕНИЕ_ПОТРЕБНОСТЕЙ" Тогда
		...
		Заголовок = СтрШаблон(НСтр("ru='График перемещения товаров на склад: %1';uk='Графік переміщення товарів на склад: %1'"), Параметры.СкладПолучатель);
		Элементы.ТоварРасшифровкаСклад.Заголовок = НСтр("ru='Склад-отправитель';uk='Склад-відправник'");
