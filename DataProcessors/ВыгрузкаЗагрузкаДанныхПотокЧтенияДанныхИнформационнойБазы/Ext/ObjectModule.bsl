...
Функция ПрочитатьФрагментПотока()
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='Выгрузка/загрузка данных.Ошибка чтения XML';uk='Вивантаження/завантаження даних.Помилка читання XML'",ИнтеграцияПодсистемБТС.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка, , , ТекстЖР);
		ВызватьИсключение;
	КонецПопытки;
