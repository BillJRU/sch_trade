...
Процедура УстановитьКорневуюПапкуФайловДокументооборота(Элемент)
	...
	ПараметрыФормы.Вставить("Заголовок",
		НСтр("ru='Выбор папки файлов';uk='Вибір папки файлів'"));
...
Процедура ОбновитьНастройкиОбновленияСвязанныхРеквизитов(Расписание = Неопределено)
	...
	СтрокаСсылки = Новый ФорматированнаяСтрока(
		НСтр("ru='Изменить расписание';uk='Змінити розклад'"),,,, "ИзменитьРасписание");
	МассивСтрок.Добавить(СтрокаСсылки);
	
	МассивСтрок.Добавить("  ");
	
	СтрокаСсылки = Новый ФорматированнаяСтрока(
		НСтр("ru='Ввести имя пользователя и пароль';uk='Ввести ім''я користувача та пароль'"),,,,
