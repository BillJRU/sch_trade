...
Функция ХозяйственныеОперацииИДокументы()
	...
	Строка.ЗаголовокРабочегоМеста       = НСтр("ru='Авансовые отчеты';uk='Авансові звіти'");
...
Функция СформироватьГиперссылкуКОформлению(Параметры) Экспорт
	...
	ТекстГиперссылкиПоАвансам = НСтр("ru='Авансы и закупки';uk='Аванси і купівлі'");
...
Функция СформироватьГиперссылкуСмТакжеВРаботе(Параметры) Экспорт
	...
	ТекстГиперссылкиАвансовыеОтчеты = НСтр("ru='Авансовые отчеты';uk='Авансові звіти'");
	...
	ТекстГиперссылкиДокументыЗакупки = НСтр("ru='Документы закупки';uk='Документи купівлі'");
