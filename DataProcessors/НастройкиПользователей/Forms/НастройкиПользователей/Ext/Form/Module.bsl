	...
	Если КоличествоНастроек = 1
	   И КоличествоПользователей = Неопределено Тогда
		...
		ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='""%1"" очищена пользователю ""%2""';uk='""%1"" очищена користувачу ""%2""'"), НазваниеНастройки, Строка(ПользовательСсылка));
		
	ИначеЕсли КоличествоПользователей = Неопределено Тогда
		ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Очищено %1 пользователю ""%2""';uk='Очищено %1 користувачу ""%2""'"), ПрописьПредмета, Строка(ПользовательСсылка));
	КонецЕсли;
