...
Функция ХозяйственныеОперацииИДокументы()
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы закупки (накладные по приемке)';uk='Документи купівлі (накладні з приймання)'");
	...
	СтрокаЗакупкаЧерезПодотчетноеЛицо.ЗаголовокРабочегоМеста                = НСтр("ru='Документы закупки через подотчетное лицо';uk='Документи купівлі через підзвітну особу'");
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы закупки (расхождения)';uk='Документи купівлі (розбіжності)'");
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы закупки (корректировки)';uk='Документи купівлі (коригування)'");
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы закупки (накладные)';uk='Документи купівлі (накладні)'");
	...
	Строка.ЗаголовокРабочегоМеста                = НСтр("ru='Документы закупки (возвраты поставщикам)';uk='Документи купівлі (повернення постачальникам)'");
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы закупки (приемка на хранение)';uk='Документи купівлі (приймання на зберігання)'");
	Строка.МенеджерРасчетаГиперссылкиКОформлению = "Обработка.ЖурналДокументовЗакупки";
	...
	Строка.ЗаголовокРабочегоМеста                = НСтр("ru='Документы закупки (отгрузки с хранения)';uk='Документи купівлі (відвантаження зі зберігання)'");
	...
	Строка.ЗаголовокРабочегоМеста                = НСтр("ru='Документы закупки (выкупы товаров)';uk='Документи купівлі (викупи товарів)'");
	...
	Строка.КлючНазначенияИспользования           = "СписаниеПринятыхНаХранениеТоваров";
	Строка.ХозяйственнаяОперация                 = Перечисления.ХозяйственныеОперации.СписаниеПринятыхТоваровЗаСчетПоклажедателя;
	Строка.ДобавитьКнопкуСоздать                 = Истина;
	Строка.ТипДокумента                          = Тип("ДокументСсылка.СписаниеПринятыхНаХранениеТоваров");
	Строка.ПолноеИмяДокумента                    = "Документ.СписаниеПринятыхНаХранениеТоваров";
	Строка.ЗаголовокРабочегоМеста                = НСтр("ru='Документы закупки (списания с хранения)';uk='Документи купівлі (списання зі зберігання)'");
	Строка.МенеджерРасчетаГиперссылкиКОформлению = "Документ.СписаниеПринятыхНаХранениеТоваров";
	
	СтрокаСписание = ХозяйственныеОперацииИДокументы.Добавить();
	ЗаполнитьЗначенияСвойств(СтрокаСписание, Строка);
	СтрокаСписание.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеПринятыхТоваровНаРасходы;
	...
	Строка.ИспользуютсяСтатусы          = Истина;
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы закупки (ГТД)';uk='Документи купівлі (ВМД)'");
...
Функция СформироватьГиперссылкуКОформлению(Параметры) Экспорт
	...
	ТекстГиперссылкаПоПоступлениям = НСтр("ru='Поступления товаров';uk='Надходження товарів'");
	ТекстГиперссылкиПоЗаказам = НСтр("ru='Приобретения';uk='Придбання'");
	ТекстГиперссылкиПоПриемке = НСтр("ru='Контроль ордеров';uk='Контроль ордерів'");
