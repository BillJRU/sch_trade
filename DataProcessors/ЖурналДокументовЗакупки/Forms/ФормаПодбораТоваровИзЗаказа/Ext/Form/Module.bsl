...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользуетсяОперацияРаздельнойЗакупки Тогда
		Элементы.ТаблицаТоваровКоличествоУпаковокВОрдере.Заголовок = НСтр("ru='В поступлениях';uk='У надходженнях'");
	КонецЕсли;
...
Процедура ПерезаполнитьКоличествоПодобрано(СЗаполнением = Ложь, ТоварыНакладной = Неопределено)
	...
	СоставИсключаемыхПолей = "Количество, КоличествоУпаковок, Сумма, СуммаСНДС";
