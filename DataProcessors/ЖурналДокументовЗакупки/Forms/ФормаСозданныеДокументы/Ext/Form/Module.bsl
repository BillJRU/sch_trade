...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Не ЗакрытьБезВопроса Тогда
		...
		ТекстВопроса = НСтр("ru='Выберите действие, которое необходимо произвести с созданными документами';uk='Виберіть дію, яку необхідно провести зі створеними документами'");
...
Процедура Назад(Команда)
	...
	Если СписокСозданныеДокументы.Количество() > 0 Тогда
		...
		ТекстВопроса = НСтр("ru='Удалить сформированные документы?';uk='Вилучити сформовані документи?'");
...
Процедура НастроитьЭлементыФормы()
	...
	Если ОтправительСклад И ОтправительПодразделение Тогда
		Элементы.СписокСозданныеДокументыСклад.Заголовок = НСтр("ru='Отправитель';uk='Відправник'");
	ИначеЕсли ОтправительПодразделение Тогда
		Элементы.СписокСозданныеДокументыСклад.Заголовок = НСтр("ru='Подразделение';uk='Підрозділ'");
	КонецЕсли; 
