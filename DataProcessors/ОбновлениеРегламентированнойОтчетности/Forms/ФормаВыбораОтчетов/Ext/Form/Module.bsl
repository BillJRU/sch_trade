...
КонецПроцедуры // ДеревоМеткаВыбораПриИзменении()
...
Функция ПроверкаВыбораОтчетов()
	...
	Если мЕстьВыбранные = 0 Тогда
		...
		Сообщение.Текст = НСтр("ru='Не выбраны отчеты для обновления!';uk='Не вибрані звіти для оновлення!'");
