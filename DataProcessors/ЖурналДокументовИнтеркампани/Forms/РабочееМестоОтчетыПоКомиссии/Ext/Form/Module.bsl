...
Процедура УстановитьОтборПоПериоду()
	...
	Если Не ЗначениеЗаполнено(Период.ДатаНачала)
		...
		ВызватьИсключение НСтр("ru='Дата начала периода и дата окончания периода должны находиться в пределах одного месяца';uk='Дата початку періоду і дата закінчення періоду повинні знаходитися в межах одного місяця'");
