...
Функция СформироватьГиперссылкуКОформлению(Параметры) Экспорт
	...
	ТекстГиперссылки    = НСтр("ru='Отчеты по комиссии';uk='Звіти з комісії'");
	ТекстОтчетОПродажах = НСтр("ru='Отчет о продажах';uk='Звіт про продажі'");
	ТекстОтчетОСписании = НСтр("ru='Отчет о списании';uk='Звіт про списання'");
...
Функция ХозяйственныеОперацииИДокументы()
	...
	Строка.ЗаголовокРабочегоМеста      = НСтр("ru='Документы между организациями (возвраты)';uk='Документи між організаціями (повернення)'");
	...
	Строка.ЗаголовокРабочегоМеста      = НСтр("ru='Документы между организациями (отчеты по комиссии)';uk='Документи між організаціями (звіти з комісії)'");
	...
	Строка.ЗаголовокРабочегоМеста      = НСтр("ru='Документы между организациями (отчеты по комиссии о списании)';uk='Документи між організаціями (звіти з комісії про списання)'");
	Строка.МенеджерРасчетаГиперссылкиКОформлению = "Обработка.ЖурналДокументовИнтеркампани";
	...
	Строка.ЗаголовокРабочегоМеста      = НСтр("ru='Документы между организациями (передачи)';uk='Документи між організаціями (передачі)'");
