...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияУдалитьСообщениеДляСопоставления.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
        ...
        |;uk='При завантаженні повідомлення для співставлення виникла помилка.
        |Рекомендується повторно вивантажити дані з програми ""%1"" і запустити синхронізацію в цій програмі.
        |Також, можна видалити повідомлення для співставлення. В цьому випадку синхронізація буде працювати в звичайному режимі.'"),
