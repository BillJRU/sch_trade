	...
	Если Параметры.ПолученоСообщениеДляСопоставленияДанных Тогда
		...
		Если ПустаяСтрока(СтруктураДанных.ИмяФайлаСообщенияОбмена) Тогда
			...
			СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Сообщение для сопоставления с идентификатором %1 не найдено по пути %2.';uk='Повідомлення для співставлення з ідентифікатором %1 не знайдено за шляхом %2.'"),
