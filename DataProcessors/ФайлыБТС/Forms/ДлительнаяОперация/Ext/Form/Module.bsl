...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ПрерываниеРазрешено Тогда
		Элементы.ДекорацияПоясняющийТекстДлительнойОперации.Подсказка = НСтр("ru='Операцию нельзя прервать до окончания выполнения';uk='Операцію не можна перервати до закінчення виконання'");
