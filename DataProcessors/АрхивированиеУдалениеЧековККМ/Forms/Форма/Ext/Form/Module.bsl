...
Процедура ОповеститьПользователяОРезультатахВыполненияЗадания()
	...
	Если НЕ ПараметрыОбработкиЧеков.ОбработкаВыполнена Тогда
		...
		Иначе
			СообщениеОбОшибкеАрхивация = НСтр("ru='Архивация чеков ККМ завершена с ошибками. См. журнал регистрации.';uk='Архівування чеків ККМ завершено з помилками. Див. журнал реєстрації.'");
