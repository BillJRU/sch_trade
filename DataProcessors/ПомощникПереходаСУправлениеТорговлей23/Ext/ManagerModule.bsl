...
Функция СформироватьСписокЗарегистрированныхБаз(АдресФайлаСоСпискомИБ, ТолькоФайловыеБазы) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru='Помощник перехода с Управление торговлей.Удаление временных файлов';uk='Помічник переходу з Управління торгівлею. Вилучення тимчасових файлів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
	...
	КореньИБ.ИнформационнаяБаза = НСтр("ru='Информационные базы';uk='Інформаційні бази'");
