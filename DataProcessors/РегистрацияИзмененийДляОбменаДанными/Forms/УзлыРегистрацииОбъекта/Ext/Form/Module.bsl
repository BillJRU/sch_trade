...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(Расшифровка) Тогда
		Заголовок = СтрЗаменить(НСтр("ru='Регистрация %1';uk='Реєстрація %1'"), "%1", ТекущийОбъект.ПредставлениеСсылки(ОбъектСтрокой));
	Иначе
		Заголовок = СтрЗаменить(НСтр("ru='Регистрация %1 (%2)';uk='Реєстрація %1 (%2)'"), "%1", ТекущийОбъект.ПредставлениеСсылки(ОбъектСтрокой));
