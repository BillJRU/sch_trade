...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если (ИмяСобытия = "Запись_РеализацияТоваровУслуг"
		...
		ИЛИ ИмяСобытия = "Запись_СписаниеТоваровУХранителя"
...
Процедура СмТакжеВРаботеОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("ЗаголовокФормы", НСтр("ru='Доверенности на получение денежных средств';uk='Довіреності на одержання грошових коштів'"));
...
Функция ОписаниеОперацийИТиповДокументов()
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы продажи (накладные)';uk='Документи продажу (накладні)'");
	...
	Строка.ДокументПредставление		= НСтр("ru='Акт о расхождениях после отгрузки';uk='Акт про розбіжності після відвантаження'");
	Строка.ИспользуютсяСтатусы			= Истина;
	Строка.КлючНазначенияИспользования	= "АктыОРасхожденияхПослеОтгрузки";
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы продажи (расхождения)';uk='Документи продажу (розбіжності)'");
	...
	Строка.ДокументПредставление		= НСтр("ru='Акт о расхождениях после поступления';uk='Акт про розбіжності після надходження'");
	Строка.ИспользуютсяСтатусы			= Истина;
	...
	Строка.ЗаголовокРабочегоМеста = НСтр("ru='Документы продажи (корректировки)';uk='Документи продажу (коригування)'");
	Строка = ТЗХозОперацииИТипыДокументов.Добавить();
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Документы продажи (отчеты комитентам о закупке)';uk='Документи продажу (звіти комітентах про купівлю)'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Документы отгрузки (отгрузки комитентам о закупках)';uk='Документи відвантаження (відвантаження комітентам про купівлі)'");
	...
	Строка.ТипДокумента					= Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки");
	Строка.ПолноеИмяДокумента			= "Документ.АктОРасхожденияхПослеОтгрузки";
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Акт о расхождениях после отгрузки';uk='Акт про розбіжності після відвантаження'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Документы продажи (выкупы хранителем)';uk='Документи продажу (викупи зберігачем)'");
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Документы продажи (передачи на хранение)';uk='Документи продажу (передачі на зберігання)'");
	Строка.МенеджерРасчетаГиперссылкиКОформлению = "Обработка.ЖурналДокументовПродажи";
	...
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Документы продажи (поступления от хранителя)';uk='Документи продажу (надходження від зберігача)'");
	Строка.МенеджерРасчетаГиперссылкиКОформлению = "Обработка.ЖурналДокументовПродажи";
	...
	СтрокаОперацииИТипа = ТЗХозОперацииИТипыДокументов.Добавить();
	Строка = СтрокаОперацииИТипа;
	Строка.КлючНазначенияИспользования	= "СписаниеТоваровУХранителя";
	Строка.ХозяйственнаяОперация		= Перечисления.ХозяйственныеОперации.СписаниеТоваровУХранителя;
	Строка.ДобавитьКнопкуСоздать		= Истина;
	Строка.ТипДокумента					= Тип("ДокументСсылка.СписаниеТоваровУХранителя");
	Строка.ПолноеИмяДокумента			= "Документ.СписаниеТоваровУХранителя";
	Строка.ЗаголовокРабочегоМеста		= НСтр("ru='Документы продажи (списания у хранителя)';uk='Документи продажу (списання у зберігача)'");
...
Процедура НастроитьФормуПоВыбраннымОперациямИДокументам(ТЗХозОперацииИТипыДокументов)
	...
	ДанныеРабочегоМеста = ОбщегоНазначенияУТ.ДанныеРабочегоМеста(ТЗХозОперацииИТипыДокументов,
		КлючНазначенияФормыПоУмолчанию(), НСтр("ru='Документы продажи (все)';uk='Документи продажу (всі)'"));
...
Процедура ОбновитьГиперссылкуКОформлению()
	...
	ТекстИдетОбновлениеДанных = НСтр("ru='К оформлению: <идет обновление данных>';uk='До оформлення: <йде оновлення даних>'");
	КОформлению = Новый ФорматированнаяСтрока(ТекстИдетОбновлениеДанных);
	
	Элементы.СмТакжеВРаботе.Видимость = Истина;
	ТекстИдетОбновлениеДанных = НСтр("ru='См. также: <идет обновление данных>';uk='Див. також: <йде оновлення даних>'");
...
Процедура ОбновитьГиперссылкуКОформлениюЗавершение()
	...
	Если Не ЗначениеЗаполнено(Результат.КОформлению) Тогда
		ТекстИдетОбновлениеДанных = НСтр("ru='К оформлению: нет';uk='До оформлення: немає'");
		КОформлению = Новый ФорматированнаяСтрока(ТекстИдетОбновлениеДанных);
	Иначе
