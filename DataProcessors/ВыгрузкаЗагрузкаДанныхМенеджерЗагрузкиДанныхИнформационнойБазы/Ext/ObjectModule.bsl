	...
	Для Каждого ОбъектМетаданных Из ТекущиеЗагружаемыеТипы Цикл
		...
		Иначе
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена';uk='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена'",ОбщегоНазначения.КодОсновногоЯзыка()),
				...
				СтрШаблон(НСтр("ru='Загрузка данных объекта метаданных %1 пропущена, т.к. он включен в
                          ...
                          |список об''єктів метаданих, що виключаються з вивантаження і завантаження даних'",ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура ЗагрузитьДанныеОбъектаИнформационнойБазы(Знач ОбъектМетаданных)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных';uk='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных'",ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		ОбъектМетаданных,
		,
		СтрШаблон(НСтр("ru='Начало загрузки данных объекта метаданных: %1';uk='Початок завантаження даних об''єкта метаданих: %1'",ОбщегоНазначения.КодОсновногоЯзыка()),
			ОбъектМетаданных.ПолноеИмя()));
	...
	ЗаписьЖурналаРегистрации(
        ...
        |Завантажено об''єктів: %2'",ОбщегоНазначения.КодОсновногоЯзыка()),
	...
	Если Не Отказ Тогда
		...
		Если ОбщегоНазначенияБТС.ЭтоНезависимыйНаборЗаписей(МетаданныеОбъекта) Тогда
			...
			Исключение
				...
				Комментарий = СтрШаблон(НСтр("ru='Объекта метаданных %1 с представлением ""%2"" не загружен по причине: %3';uk='Об''єкта метаданих %1 з представленням ""%2"" не завантажений з причини: %3'",ОбщегоНазначения.КодОсновногоЯзыка()),
				                        МетаданныеОбъекта.ПолноеИмя(),
				                        Строка(Объект),
				                        ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
				
				ЗаписьЖурналаРегистрации(
					НСтр("ru='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных.Ошибка';uk='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных.Ошибка'",ОбщегоНазначения.КодОсновногоЯзыка()),
