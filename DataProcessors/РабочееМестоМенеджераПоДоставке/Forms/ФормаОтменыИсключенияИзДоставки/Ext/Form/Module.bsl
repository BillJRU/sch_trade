...
Функция ВернутьВДоставкуНаСервере()
	...
	Для Каждого ИДСтроки Из Элементы.Список.ВыделенныеСтроки Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru='Не удалось вернуть %Распоряжение% в список доставки.';uk='Не вдалося повернути %Распоряжение% в список доставки.'");
			...
			ЗаписьЖурналаРегистрации(НСтр("ru='Не удалось вернуть распоряжение в список доставки.';uk='Не вдалося повернути розпорядження в список доставки.'",КодОсновногоЯзыка),
