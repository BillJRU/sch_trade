...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ТипЗначения = Тип("Строка") Тогда
		...
		Заголовок = НСтр("ru='Установите значение отбора';uk='Встановіть значення відбору'");
	...
	Иначе
		...
		Заголовок = НСтр("ru='Установите интервал значений отбора';uk='Встановіть інтервал значень відбору'");
		...
		Если Параметры.ТипЗначения = Тип("Дата") Тогда
			...
			Если ЗначениеЗаполнено(Параметры.МинимальноеЗначение)
				...
				Элементы.ДекорацияМинЗначДата.Заголовок = НСтр("ru='Минимальное значение:';uk='Мінімальне значення:'") + " "
					+ ?(ЗначениеЗаполнено(Параметры.МинимальноеЗначение), Параметры.МинимальноеЗначение, "   " + НСтр("ru='не задано';uk='не задано'"));
				Элементы.ДекорацияМаксЗначДата.Заголовок = НСтр("ru='Максимальное значение:';uk='Максимальне значення:'") + " "
					+ ?(ЗначениеЗаполнено(Параметры.МаксимальноеЗначение), Параметры.МаксимальноеЗначение, "   " + НСтр("ru='не задано';uk='не задано'"));
			КонецЕсли;
		...
		Иначе
			...
			Если ЗначениеЗаполнено(Параметры.МинимальноеЗначение)
				...
				Элементы.ДекорацияМинЗнач.Заголовок = НСтр("ru='Минимальное значение:';uk='Мінімальне значення:'") + " "
					+ ?(ЗначениеЗаполнено(Параметры.МинимальноеЗначение), Параметры.МинимальноеЗначение, НСтр("ru='не задано';uk='не задано'"));
				Элементы.ДекорацияМаксЗнач.Заголовок = НСтр("ru='Максимальное значение:';uk='Максимальне значення:'") + " "
					+ ?(ЗначениеЗаполнено(Параметры.МаксимальноеЗначение), Параметры.МаксимальноеЗначение, НСтр("ru='не задано';uk='не задано'"));
...
Процедура ОК(Команда)
	...
	Если Элементы.СтраницыВидовОтборов.ТекущаяСтраница = Элементы.СтраницаВводаИнтервала Тогда
		...
		Если НеверныйИнтервал Тогда
			ПоказатьПредупреждение(Неопределено, НСтр("ru='Указан неверный диапазон значений';uk='Введено недійсний діапазон значень'"));
			Возврат;
		КонецЕсли;
