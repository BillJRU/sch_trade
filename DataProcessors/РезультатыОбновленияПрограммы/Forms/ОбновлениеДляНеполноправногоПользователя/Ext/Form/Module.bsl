...
Функция ЗапускОбновленияНаСервере()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Фоновое обновление информационной базы под ограниченными правами';uk='Фонове оновлення інформаційної бази під обмеженими правами'");
...
Процедура ПродолжитьОбратныйОтсчет()
	...
	Иначе
		НовыйЗаголовок = (
			НСтр("ru='Завершить работу';uk='Завершити роботу'")
			+ " ("
