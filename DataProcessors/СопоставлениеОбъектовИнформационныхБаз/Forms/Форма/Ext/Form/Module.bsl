...
Процедура ЗавершениеФоновогоЗадания(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = Неопределено Тогда
		ЗафиксироватьОшибку(НСтр("ru='Фоновое задание отменено администратором.';uk='Фонове завдання скасовано адміністратором.'"));
		ПерейтиНазад();
...
Процедура ЗафиксироватьОшибку(ПодробноеПредставлениеОшибки)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru='Помощник сопоставления объектов.Анализ данных';uk='Помічник співставлення об''єктів.Аналіз даних'",ОбщегоНазначения.КодОсновногоЯзыка()),
