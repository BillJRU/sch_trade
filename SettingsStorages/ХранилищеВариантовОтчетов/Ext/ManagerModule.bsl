...
Функция ДобавитьВариантыВнешнегоОтчета(ВариантыОтчета, ПолноеИмяОтчета, ИмяОтчета) Экспорт 
	...
	Исключение
		ШаблонСообщения = НСтр("ru='Не удалось получить список предопределенных вариантов внешнего отчета ""%1"":%2%3';uk='Не вдалося отримати список напередвизначених варіантів зовнішнього звіту ""%1"":%2%3'");
