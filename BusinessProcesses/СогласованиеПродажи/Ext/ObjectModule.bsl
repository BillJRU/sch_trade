...
Процедура СтартПередСтартом(ТочкаМаршрутаБизнесПроцесса, Отказ)
	...
	ШаблонСообщений = НСтр("ru='Не указан %РольСогласующего%. Указать можно в разделе НСИ и Администрирование - Продажи - Согласование';uk='Не вказаний %РольСогласующего%. Вказати можна в розділі НДІ та адміністрування - Продажі - Погодження'");
