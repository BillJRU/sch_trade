...
Процедура СтартПередСтартом(ТочкаМаршрутаБизнесПроцесса, Отказ)
	...
	ШаблонСообщений = НСтр("ru='Не указан %РольСогласующего%. Указать можно в разделе НСИ и Администрирование - Закупки';uk='Не вказаний %РольСогласующего%. Вказати можна в розділі НДІ та адміністрування - Купівлі'");
		...
		Попытка
			...
			Если ПредметОбъект.Статус = Перечисления.СтатусыЗаказовПоставщикам.НеСогласован Тогда
				Если НЕ ПредметОбъект.УстановитьСтатус("Подтвержден", ) Тогда
					ТекстОшибкиСтатус = НСтр("ru='Невозможно изменить статус';uk='Неможливо змінити статус'");
