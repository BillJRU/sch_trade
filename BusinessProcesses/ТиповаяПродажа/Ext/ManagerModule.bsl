...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаСсылка) Экспорт
	...
	Если ТочкаМаршрутаСсылка = БизнесПроцессы.ТиповаяПродажа.ТочкиМаршрута.ПервичныйКонтакт
	   ...
	   Или ТочкаМаршрутаСсылка = БизнесПроцессы.ТиповаяПродажа.ТочкиМаршрута.ПодготовкаПредложения
...
Функция ОписаниеТочки(ТочкаМаршрутаБизнесПроцесса) Экспорт
	...
	Если ТочкаМаршрутаБизнесПроцесса = БизнесПроцессы.ТиповаяПродажа.ТочкиМаршрута.ПервичныйКонтакт Тогда
		Возврат ?(ПолучитьФункциональнуюОпцию("ИспользоватьПочтовыйКлиент"), "- " + НСтр("ru='запланируйте и проведите первичный контакт (обязательный);';uk='заплануйте і проведіть первинний контакт (обов''язковий);'") + Символы.ПС
...
|- з''ясуйте дані про контактні особи, потенційно зацікавлені у купівлі запропонованої номенклатури.'");
...
|%3'
|;uk='%1, %2 перенаправив (а) задачу: %3'");
