...
Процедура УстановитьТекстДекорацииКоличествоВзаимодействий(Форма)
	...
	Если Форма.ПравоПросмотраВзаимодействий Тогда
		...
		ТекстИнфомации = СтрШаблон(НСтр("ru='Взаимодействия (%1)';uk='Взаємодії (%1)'"), Строка(КоличествоВзаимодействий));
		
	Иначе
		
		ТекстИнфомации = НСтр("ru='Нет прав для просмотра взаимодействий';uk='Немає прав для перегляду взаємодій'");
		
	КонецЕсли;
	
	Форма.Элементы.ДекорацияВзаимодействия.Заголовок = ТекстИнфомации;
