...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		Если Не ЗначениеЗаполнено(СтрокаТЧ.Номенклатура) Тогда
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не заполнено поле ""Номенклатура"" в строке %1 списка ""Товары""';uk='Не заповнене поле ""Номенклатура"" в рядку %1 списку ""Товари""'"), НомерСтрокиДляПользователя);
		...
		Если ИспользоватьХарактеристикиНоменклатуры И Не ЗначениеЗаполнено(СтрокаТЧ.Характеристика) И СтрокаТЧ.ХарактеристикиИспользуются Тогда
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не заполнено поле ""Характеристика"" в строке %1 списка ""Товары""';uk='Не заповнене поле ""Характеристика"" в рядку %1 списку ""Товари""'"), НомерСтрокиДляПользователя);
