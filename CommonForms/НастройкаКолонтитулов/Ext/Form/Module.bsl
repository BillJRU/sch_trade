...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЭтоИндивидуальныеНастройки Тогда  
		Элементы.ФормаОК.Заголовок = НСтр("ru='Сохранить';uk='Зберегти'");
	КонецЕсли;
...
Процедура ОпределитьПоведениеВМобильномКлиенте()
	...
	Элементы.ТекстСлеваСверху.ПодсказкаВвода = НСтр("ru='Слева сверху';uk='Зліва зверху'");
	Элементы.ТекстВЦентреСверху.ПодсказкаВвода = НСтр("ru='В центре сверху';uk='У центрі зверху'");
	Элементы.ТекстСправаСверху.ПодсказкаВвода = НСтр("ru='Справа сверху';uk='Справа зверху'");
	
	Элементы.ТекстСлеваСнизу.ПодсказкаВвода = НСтр("ru='Слева снизу';uk='Зліва знизу'");
	Элементы.ТекстВЦентреСнизу.ПодсказкаВвода = НСтр("ru='В центре снизу';uk='У центрі знизу'");
	Элементы.ТекстСправаСнизу.ПодсказкаВвода = НСтр("ru='Справа снизу';uk='Справа знизу'");
