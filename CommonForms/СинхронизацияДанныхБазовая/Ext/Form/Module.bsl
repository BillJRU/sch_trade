...
Функция СостояниеСинхронизацииДанных(СтрокаПриложение)
	...
	Если Не СтрокаПриложение.НастройкаЗавершена Тогда
		Состояние.Представление = НСтр("ru='Настройка синхронизации данных не завершена';uk='Настройка синхронізації даних не завершена'");
		Состояние.Картинка = 3;
		
		Если СтрокаПриложение.ПолученоСообщениеДляСопоставленияДанных Тогда
			Состояние.Представление = НСтр("ru='Настройка синхронизации данных еще завершена, получены данные для сопоставления';uk='Настройка синхронізації даних ще завершена, отримані дані для співставлення'");
		КонецЕсли;
	Иначе
