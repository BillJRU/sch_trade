...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		Отказ = Истина;
		ВызватьИсключение НСтр("ru='Операция не доступна в мобильном клиенте, необходимо использовать тонкий клиент.';uk='Операція недоступна в мобільному клієнті, необхідно використовувати тонкий клієнт.'");
	КонецЕсли;
