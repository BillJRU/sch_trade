...
Процедура УстановитьНадписи()
	...
	Если РежимПроверки = "Изменение" Тогда
		...
		ЗаголовокПояснения = НСтр("ru='Для изменения телефона и/или адреса электронной почты укажите их новые значения в полях ниже.';uk='Для зміни телефону та/або адреси електронної пошти вкажіть їх нові значення в полях нижче.
|
|'");
		ЗаголовокФормы = НСтр("ru='Настройки получения временных паролей';uk='Настройки отримання тимчасових паролів'");
	...
	Иначе
		ПояснениеПодтвержденияИзменений = НСтр("ru='Необходимо будет ввести номер телефона и его подтвердить, введя отправленный код.
            |'
            |;uk='Необхідно буде ввести номер телефону і його підтвердити, ввівши відправлений код.'");
		ЗаголовокПояснения = НСтр("ru='Для подтверждения телефона и/или адреса электронной почты укажите их значения в полях ниже.';uk='Для підтвердження телефону і/або адреси електронної пошти вкажіть їх значення в полях нижче.'");
		ЗаголовокФормы = НСтр("ru='Подтверждение настроек для получения временных паролей';uk='Підтвердження настройок для отримання тимчасових паролів'");
