...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если ОбменВыполняется Тогда
		...
		ПоказатьВопрос(Новый ОписаниеОповещения("ПередЗакрытиемЗавершение", ЭтотОбъект), 
			НСтр("ru='После закрытия обмен с оборудованием выполняться не будет. Закрыть и остановить обмен?';uk='Після закриття обмін з обладнанням виконуватися не буде. Закрити і зупинити обмін?'"), 
