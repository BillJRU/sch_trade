...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ХозяйственнаяОперация)
		...
		Если ЭтоДокументПоступлениеТоваров Тогда
			НадписьИнфоЗаголовок = НСтр("ru='По выбранным распоряжениям уже оформлены поступления. Необходимо скорректировать имеющиеся поступления с учетом ордера командой ""Перезаполнить выбранное"" или оформить новое поступление на оставшиеся неоформленными товары командой ""Оформить новое"".';uk='За вибраним розпорядженням вже оформлені надходження. Необхідно скоригувати наявні надходження з урахуванням ордера командою ""Перезаповнити вибране"" або оформити нове надходження на решту неоформлених товарів командою ""Оформити нове"".'");
			
			ПерезаполнитьЗаголовок = НСтр("ru='Перезаполнить выбранное';uk='Перезаповнити вибране'");
			ОформитьНовуюЗаголовок = НСтр("ru='Оформить новое';uk='Оформити нове'");
			
			ТоварыНакладнойЗаголовок	= НСтр("ru='Расхождения между поступлениями и ордерами';uk='Розбіжності між надходженнями і ордерами'");
			НакладнаяЗаголовок			= НСтр("ru='Поступление';uk='Надходження'");
			
			ОформленныеНакладныеЗаголовок = НСтр("ru='Поступления';uk='Надходження'");
		Иначе
			НадписьИнфоЗаголовок = НСтр("ru='По выбранным распоряжениям уже оформлены накладные. Необходимо скорректировать имеющиеся накладные с учетом поступления командой ""Перезаполнить выбранную"" или оформить новую накладную на оставшиеся неоформленными товары командой ""Оформить новую"".';uk='За вибраним розпорядженням вже оформлені накладні. Необхідно скоригувати наявні накладні з урахуванням надходження командою ""Перезаповнити вибрану"" або оформити нову накладну на решту неоформлених товарів командою ""Оформити нову"".'");
			
			ПерезаполнитьЗаголовок = НСтр("ru='Перезаполнить выбранную';uk='Перезаповнити вибрану'");
			ОформитьНовуюЗаголовок = НСтр("ru='Оформить новую';uk='Оформити нову'");
			
			ТоварыНакладнойЗаголовок	= НСтр("ru='Расхождения между накладными и поступлениями';uk='Розбіжності між накладними та надходженнями'");
			НакладнаяЗаголовок			= НСтр("ru='Накладная';uk='Накладна'");
			
			ОформленныеНакладныеЗаголовок = НСтр("ru='Накладные';uk='Накладні'");
		КонецЕсли;
...
Процедура НадписьЗаголовокЗаказыНажатие(Элемент, СтандартнаяОбработка)
	...
	ОткрытьФорму(
		...
		Новый Структура("СписокДокументов, Заголовок",
			СписокЗаказов,
			НСтр("ru='Распоряжения (%КоличествоДокументов%)';uk='Розпорядження (%КоличествоДокументов%)'")
		),
...
Процедура НастроитьФормуПриСоздании()
	...
	Иначе
		НадписьЗаголовокЗаказы = НСтр("ru='Всего распоряжений';uk='Усього розпоряджень'") + ": " + Параметры.Заказы.Количество();
