...
Процедура ОпределитьПоведениеВМобильномКлиенте()
	...
	ПодстрокаПоиска = НСтр("ru='нажмите на отчете правой кнопкой мыши и';uk='натисніть на звіті правою кнопкою миші і'");
	ПодстрокаЗамены = НСтр("ru='в контекстном меню';uk='в контекстному меню'");
...
Процедура ОпределитьПодсистемыИЗаголовок(Параметры)
	...
	ЗаголовокПанели = ?(ЗаданЗаголовок, Параметры.Заголовок, НСтр("ru='Отчеты';uk='Звіти'"));
