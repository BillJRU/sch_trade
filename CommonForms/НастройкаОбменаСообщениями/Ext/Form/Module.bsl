...
Процедура ОбновитьДанныеМонитора()
	...
	ИндексСтрокиСписокСостоянияУзлов = ИндексТекущейСтроки("СписокСостоянияУзлов");
...
Функция ИндексТекущейСтроки(ИмяТаблицы)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		ДанныеТаблицыФормы = ЭтотОбъект[ИмяТаблицы]; // ДанныеФормыКоллекция
		ИндексСтроки = ДанныеТаблицыФормы.Индекс(ТекущиеДанные);
...
Процедура ВыполнитьПозиционированиеКурсора(ИмяТаблицы, ИндексСтроки)
	...
	Если ИндексСтроки <> Неопределено Тогда
		...
		ДанныеТаблицыФормы = ЭтотОбъект[ИмяТаблицы]; // ДанныеФормыКоллекция
		Если ДанныеТаблицыФормы.Количество() <> 0 Тогда
			
			Если ИндексСтроки > ДанныеТаблицыФормы.Количество() - 1 Тогда
				
				ИндексСтроки = ДанныеТаблицыФормы.Количество() - 1;
				
			КонецЕсли;
			
			// позиционируем курсор
			ТаблицаФормы = Элементы[ИмяТаблицы]; // ТаблицаФормы
			ТаблицаФормы.ТекущаяСтрока = ДанныеТаблицыФормы[ИндексСтроки].ПолучитьИдентификатор();
