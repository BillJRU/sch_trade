...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВозвратМеждуОрганизациями Тогда
		Заголовок = НСтр("ru='Подбор товаров по документам передачи в';uk='Підбір товарів за документами передачі в'");
	Иначе
		Заголовок = НСтр("ru='Подбор товаров по документам продажи в';uk='Підбір товарів за документами продажу в'");
	КонецЕсли;
...
Процедура ЗаполнитьНомераГТДПоРаспоряжениям()
	...
	НоменклатураСервер.ЗаполнитьНоменклатуруГТД(ТаблицаТоваров, "ПоРаспоряжениям", ПараметрыЗаполнения);
