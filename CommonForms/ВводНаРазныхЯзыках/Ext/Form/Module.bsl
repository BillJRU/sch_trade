...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Реквизит = Неопределено Тогда
		ШаблонОшибки = НСтр("ru='При открытии формы ВводНаРазныхЯзыках в параметре ИмяРеквизита указан не существующий реквизит %1';uk='При відкритті форми ВводНаРазныхЯзыках в параметрі ИмяРеквизита вказано неіснуючий реквізит %1'");
	...
	Иначе
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='%1 на разных языках';uk='%1 на різних мовах'"), Реквизит.Представление());
