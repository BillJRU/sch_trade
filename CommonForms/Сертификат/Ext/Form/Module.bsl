...
Процедура ЗаполнитьСвойстваСубъекта(Сертификат)
	...
	ПредставленияСвойств["ОбщееИмя"] = НСтр("ru='Общее имя';uk='Загальне ім''я'");
	ПредставленияСвойств["Страна"] = НСтр("ru='Страна';uk='Країна'");
	ПредставленияСвойств["Регион"] = НСтр("ru='Регион';uk='Регіон'");
	ПредставленияСвойств["НаселенныйПункт"] = НСтр("ru='Населенный пункт';uk='Населений пункт'");
	ПредставленияСвойств["Улица"] = НСтр("ru='Улица';uk='Вулиця'");
	ПредставленияСвойств["Организация"] = НСтр("ru='Организация';uk='Організація'");
	ПредставленияСвойств["Подразделение"] = НСтр("ru='Подразделение';uk='Підрозділ'");
	ПредставленияСвойств["ЭлектроннаяПочта"] = НСтр("ru='Электронная почта';uk='Електронна пошта'");
