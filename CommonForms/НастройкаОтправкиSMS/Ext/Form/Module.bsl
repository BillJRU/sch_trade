...
Процедура ЗаполнитьСпособыАвторизации(Форма)
	...
	СпособыАвторизацииПоУмолчанию.Добавить("ПоКлючу", НСтр("ru='По ключу (рекомендуется)';uk='За допомогою ключа (рекомендується)'"));
	СпособыАвторизацииПоУмолчанию.Добавить("ПоЛогинуИПаролю", НСтр("ru='По логину и паролю';uk='За логіном і паролем'"));
...
Процедура УстановитьТекстИнструкцииПоПодключениюУслуги()
    ...
    |;uk='Для підключення послуги відправки SMS необхідно укласти договір з провайдером <a href = ""%1"">%2</a> .
    |Ім''я відправника слід заповнювати тільки в разі, якщо воно передбачено договором.
    |З питань оплати послуги та проблемам авторизації слід звертатися до провайдера послуги.'");
