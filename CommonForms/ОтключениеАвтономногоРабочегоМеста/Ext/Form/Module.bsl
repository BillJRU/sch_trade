...
Процедура УдалитьАвтономноеРабочееМесто(Отказ, СообщениеОбОшибке = "")
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Удаление автономного рабочего места';uk='Вилучення автономного робочого місця'");
...
Функция Подключаемый_Ожидание_ОбработкаДлительнойОперации(Отказ, ПерейтиДалее)
	...
	Если Отказ Тогда
		...
		ПоказатьПредупреждение(, СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='При удалении автономного рабочего места возникли ошибки: %1';uk='При видаленні автономного робочого місця виникли помилки: %1'"), СообщениеОбОшибке));
