...
Процедура СохранитьКак(Команда)
	...
	Иначе
		Заголовок = НСтр("ru='Выберите каталог для сохранения исправлений конфигурации';uk='Виберіть каталог для збереження виправлень конфігурації'");
	...
	ПараметрыСохранения.Диалог.Заголовок = НСтр("ru='Выберите файл для сохранения исправления конфигурации';uk='Виберіть файл для збереження виправлення конфігурації'");
	ПараметрыСохранения.Диалог.Фильтр    = НСтр("ru='Файлы исправлений конфигурации (*.cfe)|*.cfe|Все файлы (*.*)|*.*';uk='Файли виправлення конфігурації (*.cfe) |*.cfe|Всі файли (*.*)|*.*'");
...
Процедура УдалитьРасширения(ВыделенныеСтроки)
	...
	Если ИдентификаторыРасширений.Количество() > 1 Тогда
		ТекстВопроса = НСтр("ru='Удалить выделенные исправления?';uk='Видалити виділені виправлення?'");
	Иначе
		ТекстВопроса = НСтр("ru='Удалить исправление?';uk='Видалити виправлення?'");
	КонецЕсли;
