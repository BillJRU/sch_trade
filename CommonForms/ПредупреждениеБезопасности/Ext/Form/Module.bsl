...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РезервноеКопированиеИБ") Тогда
		...
		Элементы.ПредупреждениеПередУдалениемРасширенияСДаннымиРезервноеКопирование.Заголовок = 
			СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru='Перед удалением расширения рекомендуется
                ...
                |;uk='Перед видаленням розширення рекомендується
                |<a href=""%1"">створити резервну копію інформаційної бази</a> .'"),
	...
	Если Параметры.МножественныйВыбор Тогда 
		Элементы.ПредупреждениеПередУдалениемРасширенияСДаннымиТекстУдалить.Заголовок = НСтр("ru='Удалить выделенные расширения?';uk='Вилучити виділені розширення?'");
	Иначе 
		Элементы.ПредупреждениеПередУдалениемРасширенияСДаннымиТекстУдалить.Заголовок = НСтр("ru='Удалить расширение?';uk='Вилучити розширення?'");
	КонецЕсли;
	...
	Если ТекущаяСтраница = Элементы.ПередУдалениемРасширенияСДанными
	 ...
	 Или ТекущаяСтраница = Элементы.ПередОтключениемРасширенияСДанными Тогда
		Заголовок = НСтр("ru='Предупреждение';uk='Попередження'");
	КонецЕсли;
