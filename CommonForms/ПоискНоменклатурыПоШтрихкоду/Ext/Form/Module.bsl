///////////////////////////////////////////////////////////////////////////////////////////////////////
// Форма предназначена для поиска номенклатуры в информационной базе и сервисе Сервис:Номенклатура по штрихкоду.
...
// без использования функциональности сервиса Сервис:Номенклатура.
//
...
Процедура НастроитьФормуПриДлительнойОперации(ЭтоНачалоДлительнойОперации, Режим)
	...
	Если Режим = "Поиск" Тогда
		Элементы.НадписьДлительнойОперации.Заголовок = НСтр("ru='Поиск номенклатуры';uk='Пошук номенклатури'");
		Элементы.ЗаписатьИЗакрыть.Доступность = Истина;
	ИначеЕсли Режим = "Загрузка" Тогда	
		Элементы.НадписьДлительнойОперации.Заголовок = НСтр("ru='Загрузка номенклатуры';uk='Завантаження номенклатури'");
...
|;uk='При записі штрихкодів сталася помилка.
|Додатковий опис:
|%ДополнительноеОписание%'");
...
Процедура НастроитьФормуПриСоздании()
	...
	Если Не ИспользуетсяСервис1СНоменклатура Тогда
		Элементы.ПояснениеКФорме.Заголовок = 
			НСтр("ru='Отсканируйте штрихкод товара для поиска номенклатуры и последующего переноса ее в документ.';uk='Відскануте штрихкод товару для пошуку номенклатури і подальшого перенесення її в документ.'")
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет);
	Элемент.Оформление.УстановитьЗначениеПараметра("ТолькоПросмотр", Истина);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<номенклатура не найдена>';uk='<номенклатура не знайдена>'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет);
	Элемент.Оформление.УстановитьЗначениеПараметра("ТолькоПросмотр", Истина);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<поиск не производился>';uk='<пошук не проводився>'"));
