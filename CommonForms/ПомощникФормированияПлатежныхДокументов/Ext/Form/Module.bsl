...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Не ЗакрытьБезВопроса Тогда
		...
		ТекстВопроса = НСтр("ru='Работа по созданию документов не была завершена. Закрыть форму?';uk='Робота зі створення документів не була завершена. Закрити форму?'");
...
Процедура ОтменитьИУдалить(Команда)
	...
	ПараметрыОжидания.Вставить("ТекстСообщения", НСтр("ru='Удаление платежных документов...';uk='Вилучення платіжних документів ...'"));
...
Процедура УстановитьЗаголовок()
	...
	Если ДокументыПоступления Тогда
		Элементы.СозданныеДокументыПолучательПлательщик.Заголовок = НСтр("ru='Плательщик';uk='Платник'");
	Иначе
		Элементы.СозданныеДокументыПолучательПлательщик.Заголовок = НСтр("ru='Получатель';uk='Одержувач'");
	КонецЕсли;
	
	Если ОплатаНаличными Тогда
		Элементы.СозданныеДокументыБанковскийСчетКасса.Заголовок = НСтр("ru='Касса';uk='Каса'");
	Иначе
		Элементы.СозданныеДокументыБанковскийСчетКасса.Заголовок = НСтр("ru='Банковский счет';uk='Банківський рахунок'");
	КонецЕсли;
...
Процедура ЗагрузитьСозданныеДокументы()
	...
	Иначе
		ВызватьИсключение НСтр("ru='При создании документов произошла исключительная ситуация. Обратитесь к администратору системы.';uk='При створенні документів сталася виняткова ситуація. Зверніться до адміністратора системи.'");
		Возврат;
	КонецЕсли;
