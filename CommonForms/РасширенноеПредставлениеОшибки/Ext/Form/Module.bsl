...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПустаяСтрока(ТекстОшибкиКлиент)
		...
		Если Элементы.ИнструкцияКлиент.Заголовок <> НСтр("ru='Подробнее';uk='Докладніше'")
			И Элементы.ИнструкцияСервер.Заголовок <> НСтр("ru='Подробнее';uk='Докладніше'") Тогда
...
Процедура УстановитьЭлементы(ТекстОшибки, ОшибкаНаСервере = Ложь)
	...
	Если Не ПустаяСтрока(ТекстОшибки) Тогда
		...
		Если ЭтоИзвестнаяОшибка Тогда
			...
			Элементы["Инструкция" + Суффикс].Заголовок = НСтр("ru='Подробнее';uk='Докладніше'");
