...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НастроитьПодтверждение.Заголовок = ПолучитьЗаголовокНастроек(ИспользоватьТокен, НСтр("ru='Изменить получателя';uk='Змінити одержувача'"));
	Элементы.НастроитьПодтверждение.РасширеннаяПодсказка.Заголовок = ?(ИспользоватьТокен, 
				НСтр("ru='Изменить настройки подтверждения операций с ключом';uk='Змінити настройки підтвердження операцій з ключем'"), "");
...
Процедура Подключаемый_ОбработчикОбратногоОтсчета()
	...
	Иначе
		...
		НовыйЗаголовок	= НСтр("ru='Изменить адрес';uk='Змінити адресу'");
...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.СпособДоставкиПаролей = "phone" Тогда
		...
		КонецЕсли;
		НовыйЗаголовок = НСтр("ru='Изменить номер';uk='Змінити номер'");
