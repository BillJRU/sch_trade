...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru='Параметры прокси-сервера на сервере BAF';uk='Параметри проксі-сервера на сервері BAF'");
...
#Если ВебКлиент Тогда
		ПоказатьПредупреждение(, НСтр("ru='В веб-клиенте параметры прокси-сервера необходимо задавать в настройках браузера.';uk='У вебклієнтіі параметри проксі-сервера необхідно задавати в настройках браузера.'"));
		Отказ = Истина;
		Возврат;
#КонецЕсли
...
Процедура ЗаписатьНастройкиПроксиСервераВИнформационнуюБазу(НастройкаПроксиНаКлиенте, НастройкаПроксиСервера)
	...
	Иначе                                                                      
		ПолучениеФайловИзИнтернетаСлужебный.СохранитьНастройкиПроксиНаСервереПлатформы(НастройкаПроксиСервера);
	КонецЕсли;
