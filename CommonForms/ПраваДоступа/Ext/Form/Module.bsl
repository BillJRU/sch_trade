		...
		Если Добавить Тогда
			ОписаниеОшибки =
				НСтр("ru='Недостаточно прав для включения пользователя в группу доступа,
                           ...
                           |;uk='Недостатньо прав для включення користувача у відповідну групу доступу,
                           |(не відповідальний за учасників групи доступу чи відсутні права адміністратора).'");
		Иначе
			ОписаниеОшибки =
				НСтр("ru='Недостаточно прав для исключения пользователя из группы доступа,
                           |(не ответственный за участников группы доступа или нет прав администратора).'
                           |;uk='Недостатньо прав для виключення користувача з групи доступу,
                           |(не відповідальний за учасників групи доступу чи відсутні права адміністратора).'");
		КонецЕсли;
		Возврат;
	КонецЕсли;
	...
	Если ОбщегоНазначения.РазделениеВключено()
	   ...
	   И ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса.ПользователиВМоделиСервиса") Тогда
		...
		Если НЕ ДействияСПользователемСервиса.ИзменениеАдминистративногоДоступа Тогда
			ВызватьИсключение
				НСтр("ru='Недостаточно прав доступа для изменения состава администраторов.';uk='Недостатньо прав доступу для зміни складу адміністраторів.'");
		КонецЕсли;
	КонецЕсли;
