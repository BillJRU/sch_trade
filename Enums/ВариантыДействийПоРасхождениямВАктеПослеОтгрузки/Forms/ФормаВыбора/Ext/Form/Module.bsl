...
Процедура СформироватьЗаголовки(ТипАкта, КоличествоУпаковокРасхождения, СпособОтраженияРасхождений, ГрупповоеИзменение, СтрокаПоЗаказу)
	...
	ИначеЕсли ТипАкта = "Передача" Тогда
		...
		// Недостачи
		Элементы.ДекорацияНедостачиСогласованы.Заголовок   = НСтр("ru='Недостачи при передаче согласованы с партнером';uk='Нестачі при передачі погоджені з партнером'");
		Элементы.ДекорацияНедостачиНеСогласованы.Заголовок = НСтр("ru='Недостачи при передаче не согласованы с партнером';uk='Нестачі при передачі не погоджені з партнером'");
		
		Если СтрокаПоЗаказу
			Или (ГрупповоеИзменение
				И ИспользоватьЗаказыКлиентов) Тогда
			
			Элементы.ДопоставкаНеТребуетсяДекорация.Заголовок = НСтр("ru='Передача уменьшается на недопоставленный товар с последующей отменой недопоставленных строк заказа';uk='Передача зменшується на недопоставлений товар з подальшим скасуванням недопоставлених рядків замовлення'");
			
		Иначе
			Элементы.ДопоставкаНеТребуетсяДекорация.Заголовок = НСтр("ru='Передача уменьшается на недопоставленный товар';uk='Передача зменшується на недопоставлений товар'");
		КонецЕсли;
		
		Элементы.ТребуетсяДопоставкаДекорация.Заголовок = НСтр("ru='Передача уменьшается на недопоставленный товар с последующим оформлением новой передачи недопоставленного товара';uk='Передача зменшується на недопоставлений товар з подальшим оформленням нової передачі недопоставленого товару'");
		
		Элементы.НедостачаНеПризнанаДекорация.Заголовок = НСтр("ru='Недопоставленный товар не отгружается со склада, документы не переоформляются';uk='Недопоставлений товар не відвантажується зі складу, документи не переоформлюються'");
		Элементы.ОтгрузитьСейчасДекорация.Заголовок = НСтр("ru='Недопоставленный товар отгружается со склада, документы не переоформляются';uk='Недопоставлений товар відвантажується зі складу, документи не переоформлюються'");
		
		// Излишки
		Элементы.ДекорацияИзлишкиСогласованы.Заголовок   = НСтр("ru='Излишки при передаче согласованы с партнером';uk='Надлишки при передачі погоджені з партнером'");
		Элементы.ДекорацияИзлишкиНеСогласованы.Заголовок = НСтр("ru='Излишки при передаче не согласованы с партнером';uk='Надлишки при передачі не погоджені з партнером'");
		
		Элементы.ПокупкаПерепоставленногоДекорация.Заголовок = НСтр("ru='Передача увеличивается на перепоставленный товар';uk='Передача збільшується на перепоставленний товар'");
		
		Если ИспользоватьЗаявкиНаВозврат Тогда
			Элементы.ВозвратПерепоставленногоДекорация.Заголовок = НСтр("ru='Передача увеличивается на перепоставленный товар с последующим оформлением заявки на возврат перепоставленного товара';uk='Передача збільшується на перепоставленний товар з подальшим оформленням заявки на повернення перепоставленного товару'");
		Иначе
			Элементы.ВозвратПерепоставленногоДекорация.Заголовок = НСтр("ru='Передача увеличивается на перепоставленный товар с последующим оформлением поступления перепоставленного товара';uk='Передача збільшується на перепоставленний товар з подальшим оформленням надходження перепоставленного товару'");
		КонецЕсли;
	...
	ИначеЕсли ТипАкта = "ОтветственноеХранение" Тогда
		...
		// Недостачи
		Элементы.ДекорацияНедостачиСогласованы.Заголовок   = НСтр("ru='Недостачи при отгрузке с ответственного хранения согласованы с поставщиком';uk='Нестачі при відвантаженні з відповідального зберігання погоджені з постачальником'");
		Элементы.ДекорацияНедостачиНеСогласованы.Заголовок = НСтр("ru='Недостачи при отгрузке с ответственного хранения не согласованы с поставщиком';uk='Нестачі при відвантаженні з відповідального зберігання не погоджені з постачальником'");
		
		Элементы.ДопоставкаНеТребуетсяДекорация.Заголовок = НСтр("ru='Отгрузка товаров поклажедателю уменьшается на недопоставленный товар';uk='Відвантаження товарів поклажодавцю зменшується на недопоставлений товар'");
		Элементы.ТребуетсяДопоставкаДекорация.Заголовок = НСтр("ru='Отгрузка товаров поклажедателю уменьшается на недопоставленный товар с последующим оформлением новой отгрузки недопоставленного товара';uk='Відвантаження товарів поклажодавцю зменшується на недопоставлений товар з подальшим оформленням нового відвантаження недопоставленого товару'");
		Элементы.НедостачаНеПризнанаДекорация.Заголовок = НСтр("ru='Недопоставленный товар не отгружается со склада, документы не переоформляются';uk='Недопоставлений товар не відвантажується зі складу, документи не переоформлюються'");
		Элементы.ОтгрузитьСейчасДекорация.Заголовок = НСтр("ru='Недопоставленный товар отгружается со склада, документы не переоформляются';uk='Недопоставлений товар відвантажується зі складу, документи не переоформлюються'");
		
		// Излишки
		Элементы.ДекорацияИзлишкиСогласованы.Заголовок   = НСтр("ru='Излишки при отгрузке с ответственного хранения согласованы с поставщиком';uk='Надлишки при відвантаженні з відповідального зберігання погоджені з постачальником'");
		Элементы.ДекорацияИзлишкиНеСогласованы.Заголовок = НСтр("ru='Излишки при отгрузке с ответственного хранения не согласованы с поставщиком';uk='Надлишки при відвантаженні з відповідального зберігання не погоджені з постачальником'");
		
		Элементы.ПокупкаПерепоставленногоДекорация.Заголовок = НСтр("ru='Отгрузка товаров поклажедателю увеличивается на перепоставленный товар';uk='Відвантаження товарів поклажодавцю збільшується на перепоставленний товар'");
		Элементы.ВозвратПерепоставленногоДекорация.Заголовок = НСтр("ru='Отгрузка товаров поклажедателю увеличивается на перепоставленный товар с последующим оформлением поступления перепоставленного товара';uk='Відвантаження товарів поклажодавцю збільшується на перепоставленний товар з подальшим оформленням надходження перепоставленного товару'");
		Элементы.ПерепоставленноеДаритсяДекорация.Заголовок = НСтр("ru='Перепоставленный товар не возвращается на склад, документы не переоформляются';uk='Перепоставлений товар не повертається на склад, документи не переоформлюються'");
		Элементы.ОприходоватьСейчасДекорация.Заголовок = НСтр("ru='Перепоставленный товар возвращается на склад, документы не переоформляются';uk='Перепоставлений товар повертається на склад, документи не переоформлюються'");
