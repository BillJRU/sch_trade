...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ВложеннаяСхемаПоПоставщикам.Схема.НаборыДанных.НаборДанных1.Запрос = ТекстЗапроса;
	...
	ВложеннаяСхемаПоПодразделениям.Схема.НаборыДанных.НаборДанных1.Запрос = ТекстЗапроса;
	...
	ВложеннаяСхемаПоСкладам.Схема.НаборыДанных.НаборДанных1.Запрос = ТекстЗапроса;
