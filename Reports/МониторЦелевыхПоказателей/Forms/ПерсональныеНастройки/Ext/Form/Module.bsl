...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ВыполняетсяЗакрытие И Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ru='Настройки были изменены. Записать изменения настроек?';uk='Настройки були змінені. Записати зміни настройок?'");
...
Процедура КоличествоКолонокМонитораПоказателейПриИзменении(Элемент)
	...
	УстановитьПользовательскийПараметр(ЭтаФорма,
...
Функция ПреобразоватьТаблицуСохраняемыхВариантовАнализаВХранилищеЗначения()
	...
	ИменаКолонок = "ВариантАнализа, Доступность, ВариантОтображения, Детали, ИтогТаблицы";
	Возврат Новый ХранилищеЗначения(СохраняемыеВариантыАнализа.Выгрузить(, ИменаКолонок));
...
Процедура УстановитьНадписьКоличествоКолонокМонитораПоказателей(КоличествоКолонокМонитораПоказателей, Элементы)
	Если КоличествоКолонокМонитораПоказателей = 1 Тогда
		Элементы.НадписьКоличествоКолонокМонитораПоказателей.Заголовок = НСтр("ru='колонку';uk='колонку'");
...
Процедура ОбновитьПользовательскиеНастройкиКомпоновщика()
	...
	ОписанияВариантов = ОбщегоНазначения.ТаблицаЗначенийВМассив(ВыбранныеВариантыАнализаРасширенные);
	ДопСвойства = Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.ДополнительныеСвойства;
	ДопСвойства.Вставить("ВыбранныеВариантыАнализаРасширенные", ОписанияВариантов);
КонецПроцедуры
...
Функция ПользовательскиеНастройкиСтруктура()
	...
	Если ДопСвойства.Свойство("ВыбранныеВариантыАнализаРасширенные", ВыбранныеВариантыАнализаРасширенные) Тогда
