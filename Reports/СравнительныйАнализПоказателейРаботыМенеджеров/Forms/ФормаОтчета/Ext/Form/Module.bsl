...
Функция ОтборыИНастройкиЗаполненыНеправильно()
	...
	Если НЕ ВыводитьДиаграммы И НЕ ВыводитьТаблицы Тогда
		...
		ТекстСообщения = НСтр("ru='В настройках формирования отчета, на закладке ""Прочее"", необходимо выбрать хотя бы один из следующих режимов вывода - таблицы или диаграммы.';uk='В настройках формування звіту, на закладці ""Інше"", необхідно вибрати хоча б один з наступних режимів виведення - таблиці або діаграми.'");
