...
Процедура ВывестиЛегенду(ТаблицаОтчета,ИмяНабораДанных,ЕстьДополнительныйПериод,ПараметрыФормирования, ВалютаУправленческогоУчета, СтруктураПериодовФормированияОтчета, Макет)
	...
	Если ЕстьДополнительныйПериод И (НЕ ПараметрыФормирования.ВыводитьДиаграммы) Тогда
		...
		ТекстЛегенды = ТекстЛегенды
		               + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Выполняется сравнение с данными за период с %1 по %2';uk='Виконується порівняння з даними за період з %1 по %2'") + " ",
...
|;uk='Інформація про продажі за період з %1 по %2 у валюті управлінського обліку (%3). 
...
|;uk='Інформація про прибуток, отриманий за період з %1 по %2 у валюті управлінського обліку (%3). 
...
|;uk='Інформація про грошові кошти, що надійшли, за вирахуванням собівартості продажів в період з %1 по %2 
|у валюті управлінського обліку (%3). Сортування проводиться в порядку спадання показника.'"),
			                                                                       ДатаНачала,
			                                                                       ДатаОкончания,
			                                                                       ВалютаУправленческогоУчета);
...
|;uk='Інформація про втрати, понесені компанією в результаті недотримання договірних строків оплати клієнтами
|у період з %1 по %2 у валюті управлінського обліку (%3). Показник розраховується за формулою: 
...
|;uk='Інформація про отриманий прибуток і наданих ручних знижки в період з %1 по %2 у валюті управлінського обліку (%3).
...
|;uk='Інформація про виграні і програні угоди, що завершилися в період з %1 по %2.
|Сортування проводиться в порядку убування частки виграних угод.'"),
			                                                                       ДатаНачала,
			                                                                       ДатаОкончания);
			
		Иначе
			ТекстЛегенды = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Информация о выигранных и проигранных сделках, завершившихся в период с %1 по %2.';uk='Інформація про виграні і програні угоди, що завершилися в період з %1 по %2.'"),
			                                                                       ДатаНачала,
			                                                                       ДатаОкончания);
...
|іншим взаємодії, зареєстрованими у період з %1 по %2.
...
|Сортировка производится в порядке убывания продаж.'
|;uk='Інформація про суму продажів на одну завершену угоду в період з %1 по %2 у валюті управлінського обліку (%3). 
|Сортування проводиться в порядку убування продажів.'"),
			                                                                       ДатаНачала,
			                                                                       ДатаОкончания,
			                                                                       ВалютаУправленческогоУчета);
...
|Сортировка производится в порядке убывания продаж.'
|;uk='Інформація про суму продажів на одну зареєстровану взаємодію в період з %1 по %2 у валюті управлінського обліку (%3). 
|Сортування проводиться в порядку убування продажів.'"),
			                                                                       ДатаНачала,
			                                                                       ДатаОкончания,
			                                                                       ВалютаУправленческогоУчета);
...
|;uk='Інформація про 5 таких, що найбільш часто зустрічаються при програші угод в період з %1 по %2
...
|;uk='Інформація про 5 таких, що найбільш часто зустрічаються для закритих в період з %1 по %2 угод
...
|Інформація виводиться у валюті управлінського обліку (%3)'"),
	...
	ИначеЕсли ИмяНабораДанных = "ДинамикаКлиентскойБазы" Тогда
		...
		ТекстЛегенды = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Информация о новых, вернувшихся и потерянных в период с %1 по %2 клиентах';uk='Інформація про нових, таких, що повернулися і втрачених в період з %1 по %2 клієнтів'"),
			                                                                  ДатаНачала,
			                                                                  ДатаОкончания);
		Иначе
...
|;uk='Інформація про продажі новим клієнтам за період з %1 по %2 у валюті управлінського обліку (%3). 
...
|;uk='Інформація про кількість претензій клієнтів, які виникли в період з %1 по %2. 
...
|;uk='Інформація про 5 таких, що найбільш часто зустрічаються для зареєстрованих в період з %1 по %2 претензій клієнтів
...
Функция ТаблицаДанныхДляТабличногоВывода(ИмяНабора,ТаблицаДанных,ЕстьДополнительныйПериод)
	...
	Если НЕ ЕстьДополнительныйПериод Тогда
		...
		ИначеЕсли ИмяНабора = "ПричиныПроигрышаСделок" ИЛИ ИмяНабора = "ОсновныеЭтапыПотерь" 
			...
			КолонкаТаблицы1.Заголовок = ЗаголовокПоказателя(ИмяНабора+"ЗначениеПоказателя");
	...
	Иначе
		...
		Если ИмяНабора = "Прибыль" ИЛИ ИмяНабора = "Продажи" 
			...
			КолонкаТаблицы1.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 в текущем периоде';uk='%1 у поточному періоді'"),ЗаголовокПоказателя(ИмяНабора));
			КолонкаТаблицы2.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 в предыдущем периоде';uk='%1 у попередньому періоді'"),ЗаголовокПоказателя(ИмяНабора));
			КолонкаТаблицы3.Заголовок = НСтр("ru='Абсолютное изменение';uk='Абсолютна зміна'");
			КолонкаТаблицы4.Заголовок = НСтр("ru='Относительное изменение(%)';uk='Відносна зміна(%)'");
		...
		ИначеЕсли ИмяНабора = "ПричиныПроигрышаСделок" ИЛИ ИмяНабора = "ОсновныеЭтапыПотерь" 
			...
			КолонкаТаблицы0.Заголовок = ЗаголовокПоказателя(ИмяНабора + "ИмяПоказателяТекущий");
			КолонкаТаблицы1.Заголовок = ЗаголовокПоказателя(ИмяНабора + "ЗначениеПоказателяТекущий");
			КолонкаТаблицы2.Заголовок = ЗаголовокПоказателя(ИмяНабора + "ИмяПоказателяПредыдущий");
			КолонкаТаблицы3.Заголовок = ЗаголовокПоказателя(ИмяНабора + "ЗначениеПоказателяПредыдущий");
...
Функция ЗаголовокПоказателя(ИмяПоказателя)
	...
	ИначеЕсли ЗаголовокПоказателя = "Прибыль" Тогда
		...
		ЗаголовокПоказателя = НСтр("ru='Прибыль';uk='Прибуток'");
		
	ИначеЕсли ЗаголовокПоказателя = "Продажи" Тогда
		
		ЗаголовокПоказателя = НСтр("ru='Продажи';uk='Продажі'");
	...
	Если ЭтоВыводЗаголовкаТекущегоПериода Тогда
		...
		ЗаголовокПоказателя = ЗаголовокПоказателя + " " + НСтр("ru='в текущем периоде';uk='в поточному періоді'");
	
	ИначеЕсли ЭтоВыводЗаголовкаПредыдущегоПериода Тогда
	
		ЗаголовокПоказателя = ЗаголовокПоказателя + " " + НСтр("ru='в предыдущем периоде';uk='в попередньому періоді'");
