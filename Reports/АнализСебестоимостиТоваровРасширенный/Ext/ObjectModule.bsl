...
Функция ТекстЗапросаЗарегистрированныеВводыОстатков()
	...
	|ГДЕ
	|	ВводОстатков.ХозяйственнаяОперация В (
	...
	|ГДЕ
	|	ВводОстатковТоваров.ХозяйственнаяОперация В (
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковСобственныхТоваров),
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковТоваровПереданныхНаКомиссию),
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковВозвратнойТарыПринятойОтПоставщиков),
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхВПроизводство),
	...
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхПереработчикам)
	|		)
	|	И ВводОстатковТоваров.Дата МЕЖДУ &НачалоПериода И &КонецПериода
...
Функция ТекстЗапросаСебестоимостьТоваровОстаткиИОбороты()
    ...
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяНачальныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСНачальныйОстаток 
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглНачальныйОстаток
	|		ИНАЧЕ
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяПриход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРасход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяКонечныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглКонечныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСНачальныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСНачальныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСКонечныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСКонечныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСНачальныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСНачальныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСКонечныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСКонечныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСНачальныйОстаток
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСНачальныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСКонечныйОстаток
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСКонечныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыУпрНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСНачальныйОстаток
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСНачальныйОстаток 
    |				+ СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыРеглНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСНачальныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСНачальныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				СебестоимостьТоваровОстатки.СтоимостьБезНДСНачальныйОстаток
	|				+ СебестоимостьТоваровОстатки.ДопРасходыБезНДСНачальныйОстаток
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяПриход
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыУпрПриход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСПриход 
    |				+ СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглПриход
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыРеглПриход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСПриход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				СебестоимостьТоваровОстатки.СтоимостьБезНДСПриход
	|				+ СебестоимостьТоваровОстатки.ДопРасходыБезНДСПриход
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРасход
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыУпрРасход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСРасход 
    |				+ СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглРасход
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыРеглРасход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСРасход
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				СебестоимостьТоваровОстатки.СтоимостьБезНДСРасход
	|				+ СебестоимостьТоваровОстатки.ДопРасходыБезНДСРасход
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьУпрБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ДопРасходыУпрБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыУпрКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеУпрБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеУпрБезНДСКонечныйОстаток
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглБезНДСКонечныйОстаток 
    |				+ СебестоимостьТоваровОстатки.ДопРасходыРеглБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.СтоимостьЗабалансоваяРеглКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ТрудозатратыРеглКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПостоянныеРеглБезНДСКонечныйОстаток
    |				+ СебестоимостьТоваровОстатки.ПостатейныеПеременныеРеглБезНДСКонечныйОстаток
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				СебестоимостьТоваровОстатки.СтоимостьБезНДСКонечныйОстаток
	|				+ СебестоимостьТоваровОстатки.ДопРасходыБезНДСКонечныйОстаток
	...
	|	ВЫБОР 
    |		КОГДА &ДанныеОтчета = 1 ИЛИ &ДанныеОтчета = 2 ИЛИ &ДанныеОтчета = 3 ИЛИ &ДанныеОтчета = 5
	|			ТОГДА 0
    |		КОГДА &ДанныеОтчета = 4 
    |			ТОГДА СебестоимостьТоваровОстатки.СтоимостьРеглНачальныйОстаток 
    |				+ СебестоимостьТоваровОстатки.ДопРасходыРеглНачальныйОстаток
...
Функция ТекстЗапросаЗакупкиОбороты()
    ...
    |			ТОГДА ЗакупкиОбороты.СтоимостьБезНДСОборот 
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА ЗакупкиОбороты.СуммаРеглБезНДСОборот
	|		ИНАЧЕ
...
Функция ТекстЗапросаВыручкаИСебестоимостьПродажОбороты()
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.СтоимостьУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.СтоимостьРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.ДопРасходыУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.ДопРасходыРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПостоянныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПостоянныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.СтоимостьУпрБезНДСОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ДопРасходыУпрБезНДСОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ТрудозатратыУпрОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПостоянныеУпрБезНДСОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ВыручкаИСебестоимостьПродажОбороты.СтоимостьРеглБезНДСОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ДопРасходыРеглБезНДСОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ТрудозатратыРеглОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПостоянныеРеглБезНДСОборот
    |				+ ВыручкаИСебестоимостьПродажОбороты.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				ВыручкаИСебестоимостьПродажОбороты.СтоимостьБезНДСОборот
	|				+ ВыручкаИСебестоимостьПродажОбороты.ДопРасходыБезНДСОборот
...
Функция ТекстЗапросаДвиженияНоменклатураНоменклатураОборотыПриход()
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.СтоимостьУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.СтоимостьРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.ДопРасходыУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.ДопРасходыРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.ПостатейныеПостоянныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.ПостатейныеПостоянныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.СтоимостьУпрБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ДопРасходыУпрБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ТрудозатратыУпрОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ПостатейныеПостоянныеУпрБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыПриход.СтоимостьРеглБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ДопРасходыРеглБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ТрудозатратыРеглОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ПостатейныеПостоянныеРеглБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				ДвиженияНоменклатураНоменклатураОборотыПриход.СтоимостьБезНДСОборот
	|				+ ДвиженияНоменклатураНоменклатураОборотыПриход.ДопРасходыБезНДСОборот
...
Функция ТекстЗапросаДвиженияНоменклатураНоменклатураОборотыРасход()
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.СтоимостьУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.СтоимостьРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.ДопРасходыУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.ДопРасходыРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПостоянныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПостоянныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.СтоимостьУпрБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ДопРасходыУпрБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ТрудозатратыУпрОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПостоянныеУпрБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураНоменклатураОборотыРасход.СтоимостьРеглБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ДопРасходыРеглБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ТрудозатратыРеглОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПостоянныеРеглБезНДСОборот
    |				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				ДвиженияНоменклатураНоменклатураОборотыРасход.СтоимостьБезНДСОборот
	|				+ ДвиженияНоменклатураНоменклатураОборотыРасход.ДопРасходыБезНДСОборот
...
Функция ТекстЗапросаДвиженияНоменклатураДоходыРасходыОбороты()
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.ДопРасходыУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.ДопРасходыРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПостоянныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПостоянныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.СтоимостьУпрБезНДСОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ДопРасходыУпрБезНДСОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ТрудозатратыУпрОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПостоянныеУпрБезНДСОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПеременныеУпрБезНДСОборот
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДвиженияНоменклатураДоходыРасходыОбороты.СтоимостьРеглБезНДСОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ДопРасходыРеглБезНДСОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ТрудозатратыРеглОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПостоянныеРеглБезНДСОборот
    |				+ ДвиженияНоменклатураДоходыРасходыОбороты.ПостатейныеПеременныеРеглБезНДСОборот
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
...
Функция ТекстЗапросаДополнениеВводОстатков()
	...
	|	ДополнениеВводОстатков.РазделУчета КАК РазделУчета,  
	|	
	|	// Аналитика оборотов
	|	NULL КАК СтатьяДоходов,
	|	NULL КАК СтатьяРасходов,
	...
	|	ВЫБОР
	|		КОГДА ЗарегистрированныеВводыОстатков.Ссылка.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхВПроизводство)
	|		ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ХозяйственнаяОперацияРасхода,
	|
    ...
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяПриход
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.СтоимостьУпрБезНДСПриход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.СтоимостьРеглБезНДСПриход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяРасход
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.СтоимостьУпрБезНДСРасход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяРасход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.СтоимостьРеглБезНДСРасход 
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.ДопРасходыУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.ДопРасходыРеглБезНДСПриход
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.ДопРасходыУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.ДопРасходыРеглБезНДСРасход
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПостоянныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПостоянныеРеглБезНДСПриход
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПостоянныеУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПостоянныеРеглБезНДСРасход
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПеременныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПеременныеРеглБезНДСПриход
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПеременныеУпрБезНДСРасход
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА ДополнениеВводОстатков.ПостатейныеПеременныеРеглБезНДСРасход
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.СтоимостьУпрБезНДСПриход + ДополнениеВводОстатков.ДопРасходыУпрБезНДСПриход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяПриход
    |				+ ДополнениеВводОстатков.ТрудозатратыУпрПриход
    |				+ ДополнениеВводОстатков.ПостатейныеПостоянныеУпрБезНДСПриход
    |				+ ДополнениеВводОстатков.ПостатейныеПеременныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.СтоимостьРеглБезНДСПриход
    |				+ ДополнениеВводОстатков.ДопРасходыРеглБезНДСПриход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяРеглПриход
    |				+ ДополнениеВводОстатков.ТрудозатратыРеглПриход
    |				+ ДополнениеВводОстатков.ПостатейныеПостоянныеРеглБезНДСПриход
    |				+ ДополнениеВводОстатков.ПостатейныеПеременныеРеглБезНДСПриход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				ДополнениеВводОстатков.СтоимостьБезНДСПриход
	|				+ ДополнениеВводОстатков.ДопРасходыБезНДСПриход
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА ДополнениеВводОстатков.СтоимостьУпрБезНДСПриход
    |				+ ДополнениеВводОстатков.ДопРасходыУпрБезНДСПриход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяПриход
    |				+ ДополнениеВводОстатков.ТрудозатратыУпрПриход
    |				+ ДополнениеВводОстатков.ПостатейныеПостоянныеУпрБезНДСПриход
    |				+ ДополнениеВводОстатков.ПостатейныеПеременныеУпрБезНДСПриход
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА ДополнениеВводОстатков.СтоимостьРеглБезНДСРасход
    |				+ ДополнениеВводОстатков.ДопРасходыРеглБезНДСРасход
    |				+ ДополнениеВводОстатков.СтоимостьЗабалансоваяРеглРасход
    |				+ ДополнениеВводОстатков.ТрудозатратыРеглРасход
    |				+ ДополнениеВводОстатков.ПостатейныеПостоянныеРеглБезНДСРасход
    |				+ ДополнениеВводОстатков.ПостатейныеПеременныеРеглБезНДСРасход
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	|				ДополнениеВводОстатков.СтоимостьБезНДСРасход
	|				+ ДополнениеВводОстатков.ДопРасходыБезНДСРасход
...
Функция ТекстЗапросаСебестоимостьТоваровОборотыПоЗаписям()
	...
	|	СебестоимостьТоваровЗаписи.РазделУчета КАК РазделУчета,
	|	
	|	// Аналитика оборотов
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровЗаписи.СтоимостьУпрБезНДС
    |				+ СебестоимостьТоваровЗаписи.СтоимостьЗабалансовая
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровЗаписи.СтоимостьРеглБезНДС
    |				+ СебестоимостьТоваровЗаписи.СтоимостьЗабалансоваяРегл
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровЗаписи.ДопРасходыУпрБезНДС
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровЗаписи.ДопРасходыРеглБезНДС
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровЗаписи.ПостатейныеПостоянныеУпрБезНДС
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровЗаписи.ПостатейныеПостоянныеРеглБезНДС
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5 
    |			ТОГДА СебестоимостьТоваровЗаписи.ПостатейныеПеременныеУпрБезНДС
    |		КОГДА &ДанныеОтчета = 6
    |			ТОГДА СебестоимостьТоваровЗаписи.ПостатейныеПеременныеРеглБезНДС
	|		ИНАЧЕ 
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
    ...
    |		КОГДА &ДанныеОтчета = 5
    |			ТОГДА СебестоимостьТоваровЗаписи.СтоимостьУпрБезНДС
    |			+ СебестоимостьТоваровЗаписи.ДопРасходыУпрБезНДС
    |			+ СебестоимостьТоваровЗаписи.СтоимостьЗабалансовая
    |			+ СебестоимостьТоваровЗаписи.ТрудозатратыУпр
    |			+ СебестоимостьТоваровЗаписи.ПостатейныеПостоянныеУпрБезНДС
    |			+ СебестоимостьТоваровЗаписи.ПостатейныеПеременныеУпрБезНДС
    |		КОГДА &ДанныеОтчета = 6 
    |			ТОГДА СебестоимостьТоваровЗаписи.СтоимостьРеглБезНДС
    |				+ СебестоимостьТоваровЗаписи.ДопРасходыРеглБезНДС
    |				+ СебестоимостьТоваровЗаписи.СтоимостьЗабалансоваяРегл
    |				+ СебестоимостьТоваровЗаписи.ТрудозатратыРегл
    |				+ СебестоимостьТоваровЗаписи.ПостатейныеПостоянныеРеглБезНДС
    |				+ СебестоимостьТоваровЗаписи.ПостатейныеПеременныеРеглБезНДС
	|		ИНАЧЕ
	|			ВЫБОР КОГДА &ПоПредприятию ТОГДА
	...
	|	СебестоимостьТоваровЗаписи.РазделУчета.*,
	|	СебестоимостьТоваровЗаписи.СтатьяДоходов.* КАК СтатьяДоходов,
	|	СебестоимостьТоваровЗаписи.СтатьяРасходовСписания.* КАК СтатьяРасходов,
	|	(ВЫБОР
	|		КОГДА НЕ СебестоимостьТоваровЗаписи.СтатьяДоходов.Ссылка ЕСТЬ NULL
