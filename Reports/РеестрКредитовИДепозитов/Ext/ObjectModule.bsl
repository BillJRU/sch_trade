...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьНесколькоВалют") Тогда
		...
		Макет6.Параметры.Валюта.Выражение = "Представление(ПараметрыДанных.ВалютаВзаиморасчетов)";
		Макет6.Параметры.ОплатаВВалюте.Выражение = "Представление(ПараметрыДанных.ВалютаВзаиморасчетов)";
	КонецЕсли;
