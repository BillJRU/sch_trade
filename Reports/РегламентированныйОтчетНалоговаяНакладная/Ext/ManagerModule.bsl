...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена приказом Минфина Украины от 31.12.2015 г.  № 1307 (в редакции Приказа № 400 от 09.08.2024)';uk= 'Затверджена наказом Мінфіну України від 31.12.2015 р. № 1307 (у редакції Наказу № 400 від 09.08.2024)'");
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20241001 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "", '2024-10-01'		,"1307"				,"ФормаОтчета2024УФ");
