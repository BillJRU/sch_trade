...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если МакетКомпоновки.НаборыДанных.Количество() = 0 Тогда
		ВызватьИсключение НСтр("ru='Отчет не сформирован. Включите хотя бы одну группировку в ""Структуре отчета"".';uk='Звіт не сформований. Увімкніть хоча б одне групування в ""Структурі звіту"".'") ;
	КонецЕсли;
