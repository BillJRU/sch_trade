...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПараметрВидОперацииПриемка", НСтр("ru='Приемка';uk='Приймання'"));
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПараметрВидОперацииКонтроль", НСтр("ru='Контроль';uk='Контроль'"));
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПараметрВидОперацииПересчет", НСтр("ru='Пересчет';uk='Перерахунок'"));
