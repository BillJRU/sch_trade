...
Процедура УстановитьОбязательныеНастройки(ПользовательскиеНастройкиМодифицированы)
	...
	Если ПараметрСтрокаАктивыМинусПассивы <> Неопределено Тогда
		КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаАктивыМинусПассивы", НСтр("ru='Активы минус пассивы';uk='Активи мінус пасиви'"));
	КонецЕсли;
	...
	Если ПараметрСтрокаБалансНеНарушен <> Неопределено Тогда
		КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаБалансНеНарушен", НСтр("ru='Баланс не нарушен';uk='Баланс не порушений'"));
	КонецЕсли;
