...
Процедура УстановитьОбязательныеНастройки(ПользовательскиеНастройкиМодифицированы)
	...
	// Строковые литералы
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаРекомендацияОформитеПоступлениеТоваров", НСтр("ru='Оформите поступление товаров';uk='Оформіть надходження товарів'"));
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаРекомендацияОформитеПриобретениеТоваровИУслуг", НСтр("ru='Оформите приобретение товаров и услуг';uk='Оформіть придбання товарів і послуг'"));
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаРекомендацияОформитеТаможеннуюДекларациюНаИмпорт", НСтр("ru='Оформите таможенную декларацию на импорт';uk='Оформіть митну декларацію на імпорт'"));
...
Функция ВидыОперацийИСинонимы()
	...
	ВидыОперацийИСинонимы.Вставить("ТоварыВПути", НСтр("ru='Товары в пути';uk='Товари в дорозі'"));
	ВидыОперацийИСинонимы.Вставить("НеотфактурованнаяПоставка", НСтр("ru='Неотфактурованная поставка';uk='Невідфактурована поставка'"));
