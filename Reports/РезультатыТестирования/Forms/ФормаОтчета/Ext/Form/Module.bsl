...
Процедура ИмяФайлаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ДиалогВыбораФайла.Фильтр = НСтр("ru='Файл результатов сравнения (*.xml;*.txt)|*.xml;*.txt';uk='Файл результатів порівняння (* .xml; *. Txt) | * .xml; *. Txt'");
...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка, ДополнительныеПараметры)
	...
	ТекстСообщения = НСтр("ru='Представление: %Представление%|| Значение: %Значение%|| Тип: %Тип%';uk='Представлення:%Представление%|| Значення: %Значение%|| Тип: %Тип%'");
