...
Процедура НастроитьПараметрыОтборыПоФункциональнымОпциям(КомпоновщикНастроекФормы)
	...
	Если Не ИспользоватьЛизинг Тогда
		КомпоновкаДанныхСервер.УдалитьГруппировкуИзВсехНастроекОтчета(КомпоновщикНастроекФормы, "Лизинг");
	КонецЕсли;
	...
	Для каждого ЭлементСтруктуры Из КомпоновщикНастроекФормы.Настройки.Структура Цикл
		Если ТипЗнч(ЭлементСтруктуры) = Тип("НастройкиВложенногоОбъектаКомпоновкиДанных") Тогда
			...
			Если ЭлементСтруктуры.ИдентификаторОбъекта = "КредитыДепозиты" И Не ИспользоватьДоговорыКредитовИДепозитов
				Или ЭлементСтруктуры.ИдентификаторОбъекта = "Лизинг" И Не ИспользоватьЛизинг Тогда
