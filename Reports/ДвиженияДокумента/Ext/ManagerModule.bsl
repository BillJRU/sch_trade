...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта_Горизонталь.Описание = НСтр("ru='Горизонтальное размещение колонок с измерениями, ресурсами и реквизитами регистров.';uk='Горизонтальне розміщення колонок з вимірами, ресурсами і реквізитами регістрів.'");
	НастройкиВарианта_Горизонталь.НастройкиДляПоиска.КлючевыеСлова = НСтр("ru='Движения документа';uk='Рухи документа'");
	
	НастройкиВарианта_Вертикаль = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Дополнительный");
	НастройкиВарианта_Вертикаль.Описание = НСтр("ru='Вертикальное размещение колонок с измерениями, ресурсами и реквизитами позволяет расположить данные более компактно, для просмотра регистров с большим количеством колонок.';uk='Вертикальне розміщення колонок з вимірами, ресурсами і реквізитами дозволяє розташувати дані більш компактно, для перегляду регістрів з великою кількістю колонок.'");
	НастройкиВарианта_Вертикаль.НастройкиДляПоиска.КлючевыеСлова = НСтр("ru='Движения документа';uk='Рухи документа'");
...
Функция ДобавитьКомандуОтчетОДвиженияхДокумента(КомандыОтчетов, Параметры, ДокументыСОтчетомОДвижениях = Неопределено) Экспорт
	...
	Команда.Представление      = НСтр("ru='Движения документа';uk='Рухи документа'");
