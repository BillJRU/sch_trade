...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЗначениеЗаполнено(ДатаТекущегоСреза) Тогда
		Отказ = Истина;
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Не заполнена дата текущего среза. Данное значение заполняется автоматически при выборе даты анализа, ближайшими значением периода расчета ABC и XYZ классификации.';uk='Не заповнена дата поточного зрізу. Дане значення заповнюється автоматично при виборі дати аналізу, найближчими значенням періоду розрахунку ABC і XYZ класифікації.'"),,"ДатаТекущегоСреза");
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ДатаПредыдущегоСреза) Тогда
		Отказ = Истина;
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Не заполнена дата предыдущего среза.';uk='Не заповнена дата попереднього зрізу.'"),,"ДатаПредыдущегоСреза");
	КонецЕсли;
