...
|;uk='Звіт призначений для виведення інформації по складах, які використовують ордерну схему при відображенні надлишків, нестач, пересортиці і псування.
|На складі %Склад% на %Дата% не використовується відповідна ордерна схема.'");
