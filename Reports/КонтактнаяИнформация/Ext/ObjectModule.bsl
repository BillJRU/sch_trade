...
Процедура ДобавитьВЗапросОтбор(Запрос)
	...
	Для каждого Параметр Из МакетКомпоновкиДанных.ЗначенияПараметров Цикл
		Если Параметр.Имя = "СтрокаAX" Тогда
			Запрос.Параметры.Вставить("СтрокаAX", НСтр("ru='AX';uk='AX'"));
		ИначеЕсли Параметр.Имя = "СтрокаAY" Тогда
			Запрос.Параметры.Вставить("СтрокаAY", НСтр("ru='AY';uk='AY'"));
		ИначеЕсли Параметр.Имя = "СтрокаAZ" Тогда
			Запрос.Параметры.Вставить("СтрокаAZ", НСтр("ru='AZ';uk='AZ'"));
		ИначеЕсли Параметр.Имя = "СтрокаBX" Тогда
			Запрос.Параметры.Вставить("СтрокаBX", НСтр("ru='BX';uk='BX'"));
		ИначеЕсли Параметр.Имя = "СтрокаBY" Тогда
			Запрос.Параметры.Вставить("СтрокаBY", НСтр("ru='BY';uk='BY'"));
		ИначеЕсли Параметр.Имя = "СтрокаBZ" Тогда
			Запрос.Параметры.Вставить("СтрокаBZ", НСтр("ru='BZ';uk='BZ'"));
		ИначеЕсли Параметр.Имя = "СтрокаCX" Тогда
			Запрос.Параметры.Вставить("СтрокаCX", НСтр("ru='CX';uk='CX'"));
		ИначеЕсли Параметр.Имя = "СтрокаCY" Тогда
			Запрос.Параметры.Вставить("СтрокаCY", НСтр("ru='CY';uk='CY'"));
		ИначеЕсли Параметр.Имя = "СтрокаCZ" Тогда
			Запрос.Параметры.Вставить("СтрокаCZ", НСтр("ru='CZ';uk='CZ'"));
		ИначеЕсли Параметр.Имя = "СтрокаНеКлассифицирован" Тогда
			Запрос.Параметры.Вставить("СтрокаНеКлассифицирован", НСтр("ru='Не классифицирован';uk='Не класифікований'"));
		Иначе
