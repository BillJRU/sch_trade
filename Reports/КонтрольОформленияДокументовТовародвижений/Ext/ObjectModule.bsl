...
Процедура УстановитьОбязательныеНастройки(ПользовательскиеНастройкиМодифицированы)
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаТипОтклоненияОформлениеФинансовыхДокументов", НСтр("ru='Оформление финансовых документов';uk='Оформлення фінансових документів'"));
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаТипОтклоненияОформлениеСкладскихДокументов", НСтр("ru='Оформление складских документов';uk='Оформлення складських документів'"));
...
Функция ВидыОперацийИСинонимы()
	...
	ВидыОперацийИСинонимы.Вставить("ОтгрузкаКлиентам", НСтр("ru='Отгрузка клиентам';uk='Відвантаження клієнтам'"));
	ВидыОперацийИСинонимы.Вставить("ВозвратыТоваровОтКлиентов", НСтр("ru='Возвраты товаров от клиентов';uk='Повернення товарів від клієнтів'"));
	ВидыОперацийИСинонимы.Вставить("ПриемкаОтПоставщиков", НСтр("ru='Приемка от поставщиков';uk='Приймання від постачальників'"));
	ВидыОперацийИСинонимы.Вставить("ВозвратыТоваровПоставщикам", НСтр("ru='Возвраты товаров поставщикам';uk='Повернення товарів постачальникам'"));
	ВидыОперацийИСинонимы.Вставить("ОформлениеИзлишковИНедостач", НСтр("ru='Оформление излишков и недостач';uk='Оформлення надлишків і нестач'"));
	ВидыОперацийИСинонимы.Вставить("ВнутреннееПотреблениеТоваров", НСтр("ru='Внутреннее потребление товаров';uk='Внутрішнє споживання товарів'"));
	ВидыОперацийИСинонимы.Вставить("ПеремещениеТоваров", НСтр("ru='Перемещение товаров';uk='Переміщення товарів'"));
	ВидыОперацийИСинонимы.Вставить("СборкаРазборкаТоваров", НСтр("ru='Сборка (разборка) товаров';uk='Збирання (розбирання) товарів'"));
	ВидыОперацийИСинонимы.Вставить("ПрочееОприходованиеТоваров", НСтр("ru='Прочее оприходование товаров';uk='Інше оприбуткування товарів'"));
	ВидыОперацийИСинонимы.Вставить("ПередачаМатериаловВПроизводство", НСтр("ru='Передача материалов в производство';uk='Передача матеріалів у виробництво'"));
	ВидыОперацийИСинонимы.Вставить("ВозвратыМатериаловИзПроизводства", НСтр("ru='Возвраты материалов из производства';uk='Повернення матеріалів з виробництва'"));
	ВидыОперацийИСинонимы.Вставить("ПриемкаГотовойПродукции", НСтр("ru='Приемка готовой продукции';uk='Приймання готової продукції'"));
	ВидыОперацийИСинонимы.Вставить("ПереработкаСырьяУПереработчика", НСтр("ru='Переработка сырья у переработчика';uk='Переробка сировини у переробника'"));
	ВидыОперацийИСинонимы.Вставить("ВозвратыСырьяОтПереработчиков", НСтр("ru='Возвраты сырья от переработчиков';uk='Повернення сировини від переробників'"));
	ВидыОперацийИСинонимы.Вставить("ПоступленияПродукцииОтПереработчиков", НСтр("ru='Поступления продукции от переработчиков';uk='Надходження продукції від переробників'"));
	ВидыОперацийИСинонимы.Вставить("ПереработкаСырьяДавальца", НСтр("ru='Переработка сырья давальца';uk='Переробка сировини давальця'"));
	ВидыОперацийИСинонимы.Вставить("ВозвратыСырьяДавальцам", НСтр("ru='Возвраты сырья давальцам';uk='Повернення сировини давальцям'"));
	ВидыОперацийИСинонимы.Вставить("ПередачиПродукцииДавальцам", НСтр("ru='Передачи продукции давальцам';uk='Передачі продукції давальцям'"));
	ВидыОперацийИСинонимы.Вставить("ОтгрузкаПринятыхТоваровСХранения", НСтр("ru='Отгрузка принятых товаров с хранения';uk='Відвантаження прийнятих товарів зі зберігання'"));
	ВидыОперацийИСинонимы.Вставить("ПриемкаТоваровНаХранение", НСтр("ru='Приемка товаров на хранение';uk='Приймання товарів на зберігання'"));
	ВидыОперацийИСинонимы.Вставить("ПередачаТоваровХранителю", НСтр("ru='Передача товаров хранителю';uk='Передача товарів зберігачу'"));
