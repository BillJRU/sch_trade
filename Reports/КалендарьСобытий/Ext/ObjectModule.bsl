...
Процедура УстановитьЗначенияПараметровЗапроса(Запрос,СтруктураФормированияОтчета)
	...
	Запрос.УстановитьПараметр("Оплата", НСтр("ru='Оплатить';uk='Сплатити'"));
	...
	Запрос.УстановитьПараметр("ПолучениеОплаты", НСтр("ru='Получить оплату';uk='Отримати оплату'"));
...
Функция ДатаОкончанияПериодаФормирования(ПериодФормирования)
	...
	ИначеЕсли ПериодФормирования = "На три дня вперед" Тогда
		
		Возврат НачалоДня(ТекущаяДатаСеанса + 3 * СекундВДне);
		
	ИначеЕсли ПериодФормирования = "На неделю вперед" Тогда
		
		Возврат НачалоДня(ТекущаяДатаСеанса + 7 * СекундВДне);
		
	ИначеЕсли ПериодФормирования = "На месяц вперед" Тогда
		
		Возврат НачалоДня(ДобавитьМесяц(ТекущаяДатаСеанса,1) + СекундВДне);
		
	ИначеЕсли ПериодФормирования = "На год вперед" Тогда
...
Функция МассивИменОбъектовИсключаемыхИзТекстаЗапросаПрочиеЗадачиИсполнителя()
	
	МассивИменОбъектов = Новый Массив;
	МассивИменОбъектов.Добавить("Документ.ЭлектронноеПисьмоВходящее");
	МассивИменОбъектов.Добавить("Документ.ЭлектронноеПисьмоИсходящее");
	МассивИменОбъектов.Добавить("Документ.Встреча");
	МассивИменОбъектов.Добавить("Документ.ТелефонныйЗвонок");
	МассивИменОбъектов.Добавить("Документ.ЗапланированноеВзаимодействие");
	МассивИменОбъектов.Добавить("Документ.СверкаВзаиморасчетов");
	МассивИменОбъектов.Добавить("Документ.ЗаявкаНаРасходованиеДенежныхСредств");
	МассивИменОбъектов.Добавить("Документ.ВнутреннееПотреблениеТоваров");
	МассивИменОбъектов.Добавить("Документ.ЗаказНаВнутреннееПотребление");
	МассивИменОбъектов.Добавить("Документ.ДоверенностьВыданная");
	МассивИменОбъектов.Добавить("Документ.ВозвратТоваровПоставщику");
	МассивИменОбъектов.Добавить("Документ.РеализацияТоваровУслуг");
	МассивИменОбъектов.Добавить("Документ.ЗаявкаНаВозвратТоваровОтКлиента");
	МассивИменОбъектов.Добавить("Документ.ЗаказПоставщику");
	МассивИменОбъектов.Добавить("Документ.ЗаказКлиента");
	МассивИменОбъектов.Добавить("Документ.УстановкаЦенНоменклатуры");
	МассивИменОбъектов.Добавить("Справочник.СоглашенияСПоставщиками");
	МассивИменОбъектов.Добавить("Справочник.СоглашенияСКлиентами");
	МассивИменОбъектов.Добавить("Справочник.СделкиСКлиентами");
	МассивИменОбъектов.Добавить("Справочник.Проекты");
	МассивИменОбъектов.Добавить("Справочник.МаркетинговыеМероприятия");
	МассивИменОбъектов.Добавить("Справочник.ДоговорыКонтрагентов");
	
	CRMЛокализация.ДополнитьМассивИменОбъектовИсключаемыхИзТекстаЗапросаПрочиеЗадачиИсполнителя(МассивИменОбъектов);
...
Функция ТекстУсловияПоОбъектамИсключаемымИзТекстаЗапросаПрочиеЗадачиИсполнителя()
	...
	МассивИмен = МассивИменОбъектовИсключаемыхИзТекстаЗапросаПрочиеЗадачиИсполнителя();
	
	Для Каждого ИмяОбъекта Из МассивИмен Цикл
		
		ТекстУсловия = ТекстУсловия + "
			|		И НЕ ЗадачаИсполнителя.Предмет ССЫЛКА " + ИмяОбъекта;
...
Функция ТекстЗапросаПрочиеЗадачиИсполнителя(Запрос,СтруктураФормированияОтчета)
	...
	|		КОНЕЦ 
	|	%ТекстУсловияИсключаемыеПредметы%
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"%ТекстУсловияИсключаемыеПредметы%",ТекстУсловияПоОбъектамИсключаемымИзТекстаЗапросаПрочиеЗадачиИсполнителя());
...
Функция ТекстЗапросаРеализацииТоваровУслуг(Запрос,СтруктураФормированияОтчета)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСтатусыРеализацийТоваровУслуг") Тогда
		...
		|			,
		|			ОбъектРасчетов В (ВЫБРАТЬ ОбъектРасчетов ИЗ ВтОбъектыРасчетовРТИУ)) КАК РасчетыСКлиентами
	...
	ТекстЗапросОбъектыРасчетов = СтрЗаменить(ТекстЗапросОбъектыРасчетов,"%ТекстУсловияОтборЗаказ%",ТекстУсловияОтборЗаказ);
...
Функция ТекстЗапросаЗаявкиНаВозврат(Запрос,СтруктураФормированияОтчета)
	...
	Если СтруктураФормированияОтчета.ИспользуетсяНоваяАрхитектураРасчетов Тогда
		...
		|	И ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыКлиентом.АвансДоОбеспечения)
		|	И ДатаПлановогоПогашения < &ДатаОкончания И &ТекстУсловияОтборПланОплат) КАК РасчетыСКлиентамиПланОплатОстатки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК ОбъектыРасчетов
		|		ПО РасчетыСКлиентамиПланОплатОстатки.ОбъектРасчетов = ОбъектыРасчетов.Ссылка
		|ГДЕ
		...
		|ИЗ
		|	РегистрНакопления.РасчетыСКлиентамиПланОплат.Остатки(, ОбъектРасчетов.Объект ССЫЛКА Документ.ЗаявкаНаВозвратТоваровОтКлиента
		|	И ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыКлиентом.ПредоплатаДоОтгрузки)
		|	И ДатаПлановогоПогашения < &ДатаОкончания И &ТекстУсловияОтборПланОплат) КАК РасчетыСКлиентамиПланОплатОстатки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК ОбъектыРасчетов
		|		ПО РасчетыСКлиентамиПланОплатОстатки.ОбъектРасчетов = ОбъектыРасчетов.Ссылка
		|ГДЕ
		...
		|ИЗ
		|	РегистрНакопления.РасчетыСКлиентамиПланОплат.Остатки(, ОбъектРасчетов.Объект ССЫЛКА Документ.ЗаявкаНаВозвратТоваровОтКлиента
		|	И ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыКлиентом.КредитПослеОтгрузки)
		|	И ДатаПлановогоПогашения < &ДатаОкончания И &ТекстУсловияОтборПланОплат) КАК РасчетыСКлиентамиПланОплатОстатки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК ОбъектыРасчетов
		|		ПО РасчетыСКлиентамиПланОплатОстатки.ОбъектРасчетов = ОбъектыРасчетов.Ссылка
		|ГДЕ
		...
		|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.РасчетыСКлиентами.Остатки(
		|			,
		|			ОбъектРасчетов В (ВЫБРАТЬ ОбъектРасчетов ИЗ ВтОбъектыРасчетовЗаявкиНаВозврат)) КАК РасчетыСКлиентами
...
Функция ТекстЗапросаЗаказыПоставщикам(Запрос,СтруктураФормированияОтчета)
	...
	Если СтруктураФормированияОтчета.ИспользуетсяНоваяАрхитектураРасчетов Тогда
		...
		|	И ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыПоставщику.АвансДоПодтверждения)
		...
		|ИЗ
		|	РегистрНакопления.РасчетыСПоставщикамиПланОплат.Остатки(, ОбъектРасчетов.Объект ССЫЛКА Документ.ЗаказПоставщику
		|	И ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыПоставщику.ПредоплатаДоПоступления)
		|	И ДатаПлановогоПогашения < &ДатаОкончания И &ТекстУсловияОтборПланОплат) КАК РасчетыСПоставщикамиПланОплатОстатки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК ОбъектыРасчетов
		|		ПО РасчетыСПоставщикамиПланОплатОстатки.ОбъектРасчетов = ОбъектыРасчетов.Ссылка
		|ГДЕ
		...
		|ИЗ
		|	РегистрНакопления.РасчетыСПоставщикамиПланОплат.Остатки(, ОбъектРасчетов.Объект ССЫЛКА Документ.ЗаказПоставщику
		|	И ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыПоставщику.КредитПослеПоступления)
		|	И ДатаПлановогоПогашения < &ДатаОкончания И &ТекстУсловияОтборПланОплат) КАК РасчетыСПоставщикамиПланОплатОстатки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ОбъектыРасчетов КАК ОбъектыРасчетов
		|		ПО РасчетыСПоставщикамиПланОплатОстатки.ОбъектРасчетов = ОбъектыРасчетов.Ссылка
		|ГДЕ
		...
		|			,
		|			ОбъектРасчетов В (ВЫБРАТЬ ОбъектРасчетов ИЗ ВтОбъектыРасчетовЗаказыПоставщику)) КАК РасчетыСПоставщиками
		...
		|	И ЕСТЬNULL(РасчетыСПоставщиками.КОплатеОстаток, 0) = 0 %ТекстУсловияОтборДокумент%";
...
Функция ТекстЗапросаЗаказыКлиентов(Запрос,СтруктураФормированияОтчета)
	...
	Если СтруктураФормированияОтчета.ИспользуетсяНоваяАрхитектураРасчетов Тогда
		...
		|			ИЛИ ЗаказКлиента.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовКлиентов.КОбеспечению)) %ТекстУсловияОтборЗаказКлиента%) КАК ЗаказыКлиентовОстатки
		|	ПО
		...
		|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.РасчетыСКлиентами.Остатки(
		|			,
		|			ОбъектРасчетов В (ВЫБРАТЬ ОбъектРасчетов ИЗ ВтОбъектыРасчетовЗаказ)) КАК РасчетыСКлиентами
	...
	ТекстЗапросОбъектыРасчетов = СтрЗаменить(ТекстЗапросОбъектыРасчетов,"%ТекстУсловияОтбор%",ТекстУсловияОтбор);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"%ТекстУсловияОтборДокумент%",ТекстУсловияОтборДокумент);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"%ТекстУсловияОтборДокументОтгрузки%",ТекстУсловияОтборДокументОтгрузки);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"%ТекстУсловияОтборЗаказКлиента%",ТекстУсловияОтборЗаказКлиента);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"И &ТекстУсловияОтборПланОплат", ТекстУсловияОтборПланОплат);
	ОбработатьТекстПодзапросаПоВидуСобытия(ТекстЗапроса,СтруктураФормированияОтчета.ТекущийНомерПодзапросаПоВидамСобытий);
...
Функция ТекстЗапросаПроекты(Запрос,СтруктураФормированияОтчета)
	...
	Запрос.УстановитьПараметр("НачалоПроекта",НСтр("ru='Начать проект';uk='Почати проєкт'"));
	Запрос.УстановитьПараметр("ОкончаниеПроекта",НСтр("ru='Завершить проект';uk='Завершити проєкт'"));
...
Функция ТекстЗапросаЗадачиПоПланамПроектов(Запрос,СтруктураФормированияОтчета,СправочникВладелец)
	...
	Запрос.УстановитьПараметр("ЗапланироватьЗадачуПоПроекту",НСтр("ru='Запланировать задачу проекта';uk='Запланувати задачу проєкту'"));
	Запрос.УстановитьПараметр("ПриступитьКВыполнениюЗадачиПоПроекту",НСтр("ru='Начать выполнение задачи проекта';uk='Почати виконання задачі проєкту'"));
	Запрос.УстановитьПараметр("ВыполнениеЗадачиПоПроекту",НСтр("ru='Выполнить задачу проекта';uk='Виконати задачу проєкту'"));
	Запрос.УстановитьПараметр("ПроверитьВыполнениеЗадачиПоПроекту",НСтр("ru='Проверить выполнение задачи проекта';uk='Перевірити виконання задачі проєкту'"));
	Запрос.УстановитьПараметр("ЗакрытиеЗадачиПоПроекту",НСтр("ru='Закрыть задачу проекта';uk='Закрити задачу проєкту'"));
...
Функция ТекстЗапросаВстречи(Запрос, СтруктураФормированияОтчета)
	...
	Запрос.УстановитьПараметр("РассмотретьВстречу",НСтр("ru='Отработать результаты встречи';uk='Відпрацювати результати зустрічі'"));
	...
	Пока ВыборкаСтатус.Следующий() Цикл
		...
		Иначе
			Если ВыборкаСтатус.Статус = "Текущее" Тогда
				...
				ОбластьГруппировка.Параметры.Значение = НСтр("ru='Сегодня';uk='Сьогодні'") + " ( " + Формат(ТекущаяДатаСеанса(),"ДЛФ=DD") + " ) - " + ВыборкаСтатус.ДатаОбъектаСобытия;
...
Процедура ОтработатьАктуальностьРасчетов(ОбластьСтрока,Выборка)
	...
	Если Выборка.РасчетыНеактуальныСКлиентом ИЛИ Выборка.РасчетыНеактуальныСПоставщиком Тогда
		...
		ОбластьСобытиеЦветТекста = ЦветаСтиля.ЦветТекстаОтмененнойСтрокиДокумента;
...
Процедура ПреобразоватьПредставлениеПредмета(Описание,Выборка)
	...
	ИначеЕсли ТипЗнч(Выборка.Предмет) = Тип("СправочникСсылка.Проекты") Тогда
		...
		Описание = НСтр("ru='Проект';uk='Проєкт'") + " '" + Описание + "'";
	...
	ИначеЕсли ТипЗнч(Выборка.Предмет) = Тип("ДокументСсылка.ЭлектронноеПисьмоИсходящее") Тогда
		...
		Если ТипЗнч(Выборка.СсылкаНаОбъектСобытия) = Тип("ДокументСсылка.ЭлектронноеПисьмоИсходящее") Тогда
			Описание = НСтр("ru='Исходящее письмо';uk='Вихідний лист'") + " '" 
			           + ?(ПустаяСтрока(Выборка.Описание),НСтр("ru='Тема не указана';uk='Тема не вказана'") + " ",Выборка.Описание) 
			           + "' " + НСтр("ru='от';uk='від'") + " " + Выборка.ДатаОбъектаСобытия;
		Иначе
			Описание = НСтр("ru='Исходящее письмо';uk='Вихідний лист'") + " '" 
			           + ?(ПустаяСтрока(Выборка.ДопРеквизитОписание1),НСтр("ru='Тема не указана';uk='Тема не вказана'") +" ",Выборка.ДопРеквизитОписание1) 
			           + "' " + НСтр("ru='от';uk='від'") +" " + Выборка.ДопРеквизитОписание2;
		КонецЕсли;
	...
	ИначеЕсли ТипЗнч(Выборка.Предмет) = Тип("ДокументСсылка.ЗапланированноеВзаимодействие") Тогда
		...
		Иначе
			Описание = НСтр("ru='Запланированное взаимодействие';uk='Запланована взаємодія'") + " '"
			           + ?(ПустаяСтрока(Выборка.ДопРеквизитОписание1),НСтр("ru='Тема не указана';uk='Тема не вказана'") 
			           + " ",Выборка.ДопРеквизитОписание1) + "' " + НСтр("ru='от';uk='від'") + " " + Выборка.ДопРеквизитОписание2;
		КонецЕсли;
	...
	ИначеЕсли ТипЗнч(Выборка.Предмет) = Тип("СправочникСсылка.ЗадачиПроектов") Тогда
		...
		Если ТипЗнч(Выборка.ДопРеквизитОписание1) = Тип("СправочникСсылка.ПретензииКлиентов") Тогда
			Описание = НСтр("ru='Задача проекта по претензии клиента';uk='Задача проєкту по претензії клієнта'") + " '" + Описание + "'";
		ИначеЕсли ТипЗнч(Выборка.ДопРеквизитОписание1) = Тип("СправочникСсылка.СделкиСКлиентами") Тогда
			Описание = НСтр("ru='Задача проекта по сделке';uk='Задача проєкту по угоді'")  + " '" + Описание + "'";
		ИначеЕсли ТипЗнч(Выборка.ДопРеквизитОписание1) = Тип("СправочникСсылка.МаркетинговыеМероприятия") Тогда
			Описание = НСтр("ru='Задача проекта по маркетинговому мероприятию';uk='Задача проєкту з маркетингового заходу'")  + " '" + Описание + "'";
		Иначе
			Описание = НСтр("ru='Задача проекта';uk='Задача проєкту'") + " '" + Описание + "'";
		КонецЕсли;
...
Процедура ПреобразоватьЧтоСделать(ТипСобытия, Выборка)
	...
	Если ТипЗнч(Выборка.Предмет) = Тип("СправочникСсылка.ЗадачиПроектов") Тогда
		...
		ИначеЕсли ТипЗнч(Выборка.ДопРеквизитОписание1) = Тип("СправочникСсылка.МаркетинговыеМероприятия") Тогда
			ТипСобытия = ТипСобытия + НСтр("ru='по маркетинговому мероприятию';uk='по маркетинговому заходу'");
		КонецЕсли;
	КонецЕсли;
