...
Процедура Заполнить(Команда)
	...
	Если Не ЗначениеЗаполнено(ДатаНачалаИспользованияЗвит1С) Тогда
		ТекстСообщения = НСтр("ru='Выгрузка в систему ""FREDO ДокМен"" невозможна, ""FREDO ДокМен"" не используется для организации';uk='Вивантаження до системи ""FREDO ДокМен"" неможливе, ""FREDO ДокМен"" не використовується для організації'")
