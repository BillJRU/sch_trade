...
Функция СформироватьОтчетПоПродолжительностиРаботыРегламентныхЗаданий(ПараметрыЗаполнения) Экспорт
	...
	Если ВыводитьОтбор.Значение = ТипВыводаТекстаКомпоновкиДанных.Выводить
		...
		Если МинимальнаяПродолжительностьСеансовРегламентныхЗаданий > 0 Тогда
			РежимОтображенияИнтервалов = НСтр("ru='Отключено отображение интервалов с нулевой продолжительностью';uk='Відключено відображення інтервалів з нульовою тривалістю'");
		Иначе
			РежимОтображенияИнтервалов = НСтр("ru='Включено отображение интервалов с нулевой продолжительностью';uk='Включено відображення інтервалів з нульовою тривалістю'");
		КонецЕсли;
