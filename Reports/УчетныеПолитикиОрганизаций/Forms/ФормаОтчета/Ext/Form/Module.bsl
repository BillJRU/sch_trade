...
Процедура Сформировать(Команда)
	...
	Если ПоказатьОтличия И НЕ СписокОрганизаций.Количество() Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Для сравнения настроек учетной политики требуется выбрать организации.';uk='Для порівняння настройок облікової політики потрібно вибрати організації.'"),
			, 
