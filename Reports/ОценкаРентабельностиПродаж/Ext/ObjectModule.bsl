...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	СхемаКомпоновкиДанных.НаборыДанных.ДанныеДокумента.Запрос = СтрЗаменить(СхемаКомпоновкиДанных.НаборыДанных.ДанныеДокумента.Запрос,
	                                                                        "// ТекстЗапросаДокументаЛокализация",
	                                                                        ТекстДополненияДанныеДокумента);
	
	СхемаКомпоновкиДанных.НаборыДанных.СводныйРасчет.Запрос = СтрЗаменить(СхемаКомпоновкиДанных.НаборыДанных.СводныйРасчет.Запрос,
	                                                                      "// ТекстЗапросаДокументаЛокализация",
	                                                                      ТекстДополненияСводныйРасчет);
