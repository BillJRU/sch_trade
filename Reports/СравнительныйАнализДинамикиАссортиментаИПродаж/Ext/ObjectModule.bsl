...
Процедура ВывестиШапку(ТабличныйДокументРезультат, Макет)
	...
	Если ЭтоРасшифровка Тогда
		...
		ИначеЕсли НомерКолонкиРасшифровки = 7 Тогда
			МассивКолонок.Добавить(НСтр("ru='Общая представлен- ность периода анализа';uk='Загальна представленість періоду аналізу'"));
			МассивКолонок.Добавить(НСтр("ru='Средняя представлен- ность периода анализа';uk='Середня представленість періоду аналізу'"));
			МассивКолонок.Добавить(НСтр("ru='Общая представлен- ность периода сравнения';uk='Загальна представленість періоду порівняння'"));
			МассивКолонок.Добавить(НСтр("ru='Средняя представлен- ность периода сравнения';uk='Середня представленість періоду порівняння'"));
