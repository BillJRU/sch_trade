...
Функция ТекстЗапросаНабораДанных()
	...
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК Расход,
	|	ТМЦВЭксплуатации.НалоговоеНазначение КАК НалоговоеНазначение
	...
	|   ТМЦВЭксплуатацииКонечныйОстаток.НалоговоеНазначение
	|ИЗ
	|	РегистрНакопления.ТМЦВЭксплуатации.Обороты(
	|			,
	|			&ПериодОтчетаОкончание,
	...
	|   ТМЦВЭксплуатацииНачальныйОстаток.НалоговоеНазначение КАК НалоговоеНазначение
	...
	|   втОборотыЗаПериод.НалоговоеНазначение КАК НалоговоеНазначение
	...
	|			И втОборотыЗаПериод.НалоговоеНазначение = втОборотыЗаПериодИтоги.НалоговоеНазначение
	|СГРУППИРОВАТЬ ПО
	|	втОборотыЗаПериод.ПериодСекунда,
	|	втОборотыЗаПериод.ПериодМинута,
	|	втОборотыЗаПериод.ПериодЧас,
	...
	|   втОборотыЗаПериод.НалоговоеНазначение
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|   втОборотыСИтогами.НалоговоеНазначение КАК НалоговоеНазначение
	...
	|			И втОборотыСИтогами.НалоговоеНазначение = втНачальныйОстаток.НалоговоеНазначение
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|   втНачальныйОстаток.НалоговоеНазначение
	|ИЗ
	...
	|           И втНачальныйОстаток.НалоговоеНазначение = втОборотыСИтогами.НалоговоеНазначение
	|ГДЕ
	...
	|	втКонечныйОстаток.НалоговоеНазначение
	|ИЗ
	...
	|           И втКонечныйОстаток.НалоговоеНазначение = втОборотыСИтогами.НалоговоеНазначение
	|		ЛЕВОЕ СОЕДИНЕНИЕ втНачальныйОстаток КАК втНачальныйОстаток
	...
	|           И втКонечныйОстаток.НалоговоеНазначение = втНачальныйОстаток.НалоговоеНазначение
	|ГДЕ
	...
	|   ИтоговаяТаблица.НалоговоеНазначение КАК НалоговоеНазначение
	|ИЗ
