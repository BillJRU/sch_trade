...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если Выборка.Следующий() Тогда
		Шаблон = НСтр("ru='Запись не верна! Значение поля ""Организация"" не может быть пустым! (Регистр накопления: Активы и пассивы; Номер строки: %1)';uk='Запис не вірний! Значення поля ""Організація"" не може бути порожнім! (Регістр накопичення: Активи і пасиви; Номер рядка: %1)'");
