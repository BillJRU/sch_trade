...
Процедура ПриЗаполненииОграниченияДоступа(Ограничение) Экспорт
	...
	|	И ЗначениеРазрешено(ЗаказПоставщику.Склад)
...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("ad58773c-514a-43db-ba3b-ca3f9bf68121");
	...
	Обработчик.ИзменяемыеОбъекты = "РегистрНакопления.ЗаказыПоставщикам";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения в регистре ""Заказы поставщикам"" для заказов, находящихся в статусе ""Подтвержден"".';uk='Заповнює рухи в регістрі ""Замовлення постачальникам"" для замовлень, що знаходяться у статусі ""Підтверджено"".'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ТекстЗапросаАдаптированный = Документы.ЗаказПоставщику.АдаптированныйТекстЗапросаДвиженийПоРегистру(ИмяРегистра);
