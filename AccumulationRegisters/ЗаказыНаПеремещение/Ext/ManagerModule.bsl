...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Обновляет движения документа ""Перемещение товаров"" по регистру накопления ""Заказы на перемещение"".';uk='Оновлює рухи документу ""Переміщення товарів"" по регістру накопичення ""Замовлення на переміщення"".'");
