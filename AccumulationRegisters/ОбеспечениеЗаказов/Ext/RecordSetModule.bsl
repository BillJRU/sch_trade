...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ПроведениеДокументов.ЗарегистрироватьТаблицуКонтроля(ДополнительныеСвойства,
		"ОбеспечениеЗаказовИзменение", Выборка.Следующий() И Выборка.Количество > 0);
...
Процедура ДополнитьМассивЗаказовДляРасчетаСостояний(ДополнительныеСвойства)
	...
	Если Не ВнутреннееТовародвижение.ЗаписыватьПодчиненныеДанные(ДополнительныеСвойства.ДляЗаписиПодчиненныхДанных, "СостоянияЗаказов") Тогда
		ВнутреннееТовародвижение.ДобавитьСтруктуруЗаписиПодчиненныхДанных(ДополнительныеСвойства.ДляЗаписиПодчиненныхДанных, "СостоянияЗаказов");
	КонецЕсли;
