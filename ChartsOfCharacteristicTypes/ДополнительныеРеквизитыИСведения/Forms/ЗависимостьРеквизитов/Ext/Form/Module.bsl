...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(НаборСвойств) Тогда
		ТекстИсключения = НСтр("ru='Настройка видимости, доступности и обязательности заполнения
                          ...
                          |;uk='Настройка видимості, доступності і обов''язковості заповнення
                          |доступна тільки при відкритті додаткового реквізиту
                          |зі списку ""Додаткові реквізити"".'");
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Не равно';uk='Не дорівнює'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Равно';uk='Дорівнює'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Не заполнено';uk='Не заповнено'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Заполнено';uk='Заповнено'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='В списке';uk='У списку'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Не в списке';uk='Не в списку'"));
