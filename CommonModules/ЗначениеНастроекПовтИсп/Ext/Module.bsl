...
//
// Возвращаемое значение:
//	СправочникСсылка.ПодразделенияОрганизаций - Подразделение пользователя.
//
...
Функция ВсеРеквизитыНоменклатуры(ТипНоменклатуры,
    ...
    Возврат Справочники.Номенклатура.ВсеРеквизиты(
        ТипНоменклатуры,
    	ОсобенностьУчета,
    	ИспользованиеХарактеристик,
    	ИспользоватьСрокГодностиСерии,
...
//
Функция ВсеРеквизитыНоменклатурыТаблица(
    ТипНоменклатуры,
	ОсобенностьУчета,
	ИспользованиеХарактеристик,
	ИспользоватьСрокГодностиСерии,
    ...
    ВсеРеквизитыНоменклатурыСтруктура = ЗначениеНастроекПовтИсп.ВсеРеквизитыНоменклатуры(
        ТипНоменклатуры,
    	ОсобенностьУчета,
    	ИспользованиеХарактеристик,
    	ИспользоватьСрокГодностиСерии,
...
Функция ВидЗапасовПоОтборам(Организация,
    ...
    СтруктураАналитики.НалоговоеНазначение = НалоговоеНазначение;
...
Функция ПолучитьФлагАвторасчетНДС(Знач Организация, Знач Дата) Экспорт	
	НалогообложениеНДСПоУмолчанию     = НДСОбщегоНазначенияСервер.ПолучитьНалогообложениеНДС(Организация, Неопределено, Дата, Истина);
