...
//   ВыделенныеСтроки - Массив из Строка - идентификаторы строк табличной части.
//   ДоступныеВариантыОбеспечения - СписокЗначений из ПеречислениеСсылка.ВариантыОбеспечения - список доступных вариантов обеспечения.
// 
// Возвращаемое значение:
//   Структура - структура параметров.
//
Функция ПараметрыФормыИсполнениеЗаказа(ИдентификаторНастройки, ТабличнаяЧасть = Неопределено, ВыделенныеСтроки = Неопределено, ДоступныеВариантыОбеспечения = Неопределено) Экспорт

	
	ПараметрыФормы = Новый Структура();
	
	ПараметрыФормы.Вставить("Тип", ИдентификаторНастройки);
	ПараметрыФормы.Вставить("СписокВыбора", ПереченьВариантовОбеспеченияПоТабличнойЧасти(ТабличнаяЧасть, ВыделенныеСтроки, ДоступныеВариантыОбеспечения));
...
Функция ОписаниеНастройки(Период, КоличествоПериодов, Подпериод = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(КоличествоПериодов) Или Не ЗначениеЗаполнено(Период) Тогда
		...
		Возврат НСтр("ru='<период не указан>';uk='<період не вказано>'");
	...
	Если ЗначениеЗаполнено(Подпериод) Тогда
		...
		ИначеЕсли Подпериод = ПредопределенноеЗначение("Перечисление.Периодичность.Декада") Тогда
			...
			ПредставлениеНастройки = ПредставлениеНастройки + " " + НСтр("ru='(по декадам)';uk='(по декакдах)'");
		...
		ИначеЕсли Подпериод = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал") Тогда
			...
			ПредставлениеНастройки = ПредставлениеНастройки + " " + НСтр("ru='(по кварталам)';uk='(по кварталах)'");
...
Функция ПереченьВариантовОбеспеченияПоТабличнойЧасти(ТабличнаяЧасть, ВыделенныеСтроки, ДоступныеВариантыОбеспечения = Неопределено)
	...
	Возврат ПереченьВариантовОбеспечения(ТипОграничитель, ДоступныеВариантыОбеспечения);
