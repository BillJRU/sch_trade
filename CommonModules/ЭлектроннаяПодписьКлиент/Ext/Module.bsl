...
Процедура ЗаписатьСертификатВСправочник(ОбработчикЗавершения,
	...
	Контекст.Вставить("ЗаголовокОшибки", ?(Контекст.ДляШифрования = Истина,
		НСтр("ru='Не удалось пройти проверку шифрования по причине:';uk='Не вдалося пройти перевірку шифрування з причини:'"),
		НСтр("ru='Не удалось пройти проверку подписания по причине:';uk='Не вдалося пройти перевірку підписання з причини:'")));
	Контекст.Вставить("ЗаголовокФормы", ?(Контекст.ДляШифрования = Истина,
		НСтр("ru='Проверка шифрования и расшифровки';uk='Перевірка шифрування і розшифрування'"),
		НСтр("ru='Проверка установки электронной подписи';uk='Перевірка установки електронного підпису'")));
