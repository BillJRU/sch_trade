...
|;uk='Виконання складського завдання не завершено. 
|Робота мобільного робочого місця працівника складу буде перервана.'");
			
		Иначе
			ТекстПредупреждения = НСтр("ru='Работа мобильного рабочего места работника склада будет прервана.';uk='Робота мобільного робочого місця працівника складу буде перервана.'");
		КонецЕсли;
