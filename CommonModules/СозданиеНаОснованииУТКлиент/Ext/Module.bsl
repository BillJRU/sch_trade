...
Процедура ИнтеграцияС1СДокументооборотСоздатьПисьмоПроверитьПодключениеЗавершение(Результат, ОбъектИС) Экспорт
	...
	Иначе
		...
		ПоказатьПредупреждение(, НСтр("ru='Не настроено подключение к BAS Документообороту или сервис
|BAS Документооборота недоступен. Обратитесь к администратору.'
|;uk='Не встановлено підключення до BAS Документообігу або сервіс 
