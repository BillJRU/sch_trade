...
#Область ИндивидуальныеПараметрыИОтборы
	...
	Если ПоляРасшифровки.Свойство("Показатель") И ПоляРасшифровки.Количество() = 1 Тогда
		СписокОтчетов.Добавить("ОткрытьЗначение", НСтр("ru='Открыть значение';uk='Відкрити значення'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ПолученныеАвансы")
		...
		Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
			СписокОтчетов.Добавить("ВедомостьРасчетовСКлиентами", НСтр("ru='Ведомость расчетов с клиентами';uk='Відомість розрахунків з клієнтами'"));
		...
		Иначе
			СписокОтчетов.Добавить("РасчетыСКлиентами", НСтр("ru='Ведомость расчетов с клиентами';uk='Відомість розрахунків з клієнтами'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ВыданныеАвансы")
		...
		Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
			СписокОтчетов.Добавить("ВедомостьРасчетовСПоставщиками", НСтр("ru='Ведомость расчетов с поставщиками';uk='Відомість розрахунків з постачальниками'"));
		...
		Иначе
			СписокОтчетов.Добавить("РасчетыСПоставщиками", НСтр("ru='Ведомость расчетов с поставщиками';uk='Відомість розрахунків з постачальниками'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ЗадолженностьСобственныхОрганизаций") Тогда
		...
		Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
			СписокОтчетов.Добавить("ВедомостьРасчетовМеждуОрганизациями", НСтр("ru='Расчеты между организациями (по продажам)';uk='Розрахунки між організаціями (за продажами)'"));
		...
		Иначе
			СписокОтчетов.Добавить("РасчетыМеждуОрганизациями", НСтр("ru='Расчеты между организациями';uk='Розрахунки між організаціями'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ОбязательстваПередСобственнымиОрганизациями") Тогда
		Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
			СписокОтчетов.Добавить("ВедомостьРасчетовМеждуОрганизациями", НСтр("ru='Расчеты между организациями';uk='Розрахунки між організаціями'"));
			ПараметрыОтчетаРасшифровки.Вставить("ИмяОтчета", "ВедомостьРасчетовМеждуОрганизациями");
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ДенежныеСредстваБезналичные")
		...
		СписокОтчетов.Добавить("ВедомостьПоДенежнымСредствам", НСтр("ru='Ведомость по денежным средствам';uk='Відомість по грошових коштах'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ДенежныеСредстваУПодотчетныхЛиц") Тогда
		СписокОтчетов.Добавить("ВедомостьПоДенежнымСредствамУПодотчетныхЛиц",
			НСтр("ru='Ведомость по денежным средствам у подотчетных лиц';uk='Відомість по грошових коштах у підзвітних осіб'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ЗадолженностьПоКредитам")
		...
		СписокОтчетов.Добавить("ВедомостьРасчетовПоФинансовымИнструментам", НСтр("ru='Ведомость расчетов по финансовым инструментам';uk='Відомість розрахунків по фінансових інструментах'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ТоварыНаОптовыхСкладах")
		...
		СписокОтчетов.Добавить("АнализСебестоимостиТоваровРасширенный", НСтр("ru='Себестоимость товаров';uk='Собівартість товарів'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("ТоварыКОформлениюОтчетовКомитенту") Тогда
		СписокОтчетов.Добавить("СостояниеРасчетовСКомитентами", НСтр("ru='Состояние расчетов с комитентами';uk='Стан розрахунків з комітентами'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("НезавершенноеПроизводство") Тогда
		СписокОтчетов.Добавить("АнализЗатрат", НСтр("ru='Производственные затраты';uk='Виробничі витрати'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = СтатьяАктиваПассива("РасходыБудущихПериодов")
		...
		СписокОтчетов.Добавить("АнализДоходовРасходов", НСтр("ru='Доходы и расходы';uk='Доходи та витрати'"));
	...
	ИначеЕсли ПоляРасшифровки.Показатель = ПланыВидовХарактеристик.СтатьиАктивовПассивов.ПустаяСсылка() Тогда
		СписокОтчетов.Добавить("УправленческийБалансКонтроль", НСтр("ru='Контроль баланса';uk='Контроль балансу'"));
	...
	Иначе
		СписокОтчетов.Добавить("ОборотноСальдоваяВедомостьАктивовПассивов", НСтр("ru='Карточка актива/пассива';uk='Картка активу/пасиву'"));
