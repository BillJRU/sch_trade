...
Функция ПараметрыЗапроса() Экспорт 
	...
	ПараметрыЗапроса.Вставить("version", 5);
...
Функция МетодыИнтерфейсамМенеджераСервиса() Экспорт 
	...
	Методы.Вставить("АктивироватьТестовыйПериод",						"activatetrial");
	Методы.Вставить("СсылкаДляПолученияПраваИспользованияРасширения", 	"paytoextension"); 
	Методы.Вставить("ОтменитьОформлениеПодписки",						"cancelsubscription");
...
Функция СинонимыДопПараметровМетодов() Экспорт 
	...
	ДопПараметры.Вставить("ИдентификаторПериодаДействия", "periodid");
