...
Процедура ПроверитьВозможностьВызова()
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.БазоваяФункциональность") Тогда
		Подсистемы.Добавить(НСтр("ru='ТехнологияСервиса.БазоваяФункциональность';uk='ТехнологіяСервіса.БазоваФункціональність'"));
	КонецЕсли;
	
	Если Не ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса") Тогда
		Подсистемы.Добавить(НСтр("ru='СтандартныеПодсистемы.РаботаВМоделиСервиса.БазоваяФункциональностьВМоделиСервиса';uk='СтандартніПодсістеми.РоботаВМоделіСервіса.БазоваФункціональністьВМоделіСервіса'"));
	КонецЕсли;
	...
	ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Для работы Интернет-поддержки пользователей в модели сервиса необходимо встроить
            |%1:'
            |;uk='Для роботи Інтернет-підтримки користувачів в моделі сервісу необхідно вбудувати
            |%1:'"),
		?(Подсистемы.Количество() > 1,
			НСтр("ru='подсистемы';uk='підсистеми'"),
			НСтр("ru='подсистему';uk='підсистему'")));
