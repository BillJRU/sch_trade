		...
		Если ПользователиСлужебный.ОбъектАвторизацииИспользуется(ОбъектАвторизации, ВнешнийПользователь) Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Объект авторизации ""%1"" (%2)
                    ...
                    |;uk='Об''єкт авторизації ""%1"" (%2)
                    |встановлено для кількох зовнішніх користувачів.'"),
				ОбъектАвторизации,
				ТипЗнч(ОбъектАвторизации));
		КонецЕсли;
	Иначе
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Для внешнего пользователя ""%1"" не задан объект авторизации.';uk='Для зовнішнього користувача ""%1"" не заданий об''єкт авторизації.'"),
			ВнешнийПользователь);
	КонецЕсли;
