	...
	Попытка
		...
		Пока Выборка.Следующий() Цикл
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(НСтр("ru='Заметки пользователя.Изменение пометки удаления';uk='Нотатки користувача.Зміна позначки вилучення'",ОбщегоНазначения.КодОсновногоЯзыка()),
