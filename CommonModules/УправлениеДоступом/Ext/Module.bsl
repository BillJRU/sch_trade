...
//                       Чтобы получить идентификатор, нужно создать профиль в режиме клиентского приложения BAF и
...
Процедура ДобавитьОбработчикОбновленияДляВключенияУниверсальногоОграничения(Версия, Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Включение универсального ограничения доступа на уровне записей.';uk='Включення універсального обмеження доступу на рівні записів.'");
