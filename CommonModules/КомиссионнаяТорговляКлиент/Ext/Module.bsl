...
Процедура ОповеститьОбОкончанииРасчетаВознаграждения(СпособРасчетаВознаграждения) Экспорт
	...
	Если СпособРасчетаВознаграждения = ПредопределенноеЗначение("Перечисление.СпособыРасчетаКомиссионногоВознаграждения.НеРассчитывается") Тогда
		...
		НСтр("ru='Вознаграждение очищено.';uk='Винагорода очищено.'"),
		,
	...
	ИначеЕсли не ЗначениеЗаполнено(СпособРасчетаВознаграждения) Тогда
		ПоказатьОповещениеПользователя(
		НСтр("ru='Способ расчета не заполнен.';uk='Спосіб розрахунку не заповнений.'"),
		,
		НСтр("ru='Перед расчетом комиссионного вознаграждения, Способ расчета, в документе, необходимо заполнить.';uk='Перед розрахунком комісійної винагороди, Спосіб розрахунку, в документі, необхідно заповнити.'"),
		БиблиотекаКартинок.Информация32);
		
	Иначе
		ПоказатьОповещениеПользователя(
		НСтр("ru='Вознаграждение рассчитано.';uk='Винагорода розраховано.'"),
		,
