...
//
// Параметры:
//  Форма				 - РасширениеФормыДокумента	 - Форма документа:
//    * Объект - ДокументОбъект - владелец файла
...
Процедура ЗагрузитьИзExcel(Форма, ПрисоединенныйФайл, ПараметрыЗагрузкиИзExcel = Неопределено) Экспорт
	...
	Если НРЕГ(ДанныеФайла.Расширение) <> "xls"
		И НРЕГ(ДанныеФайла.Расширение) <> "xlsx" Тогда
		СообщениеОбОшибке  = НСтр("ru='Файл не является файлом формата Excel, выбор запрещен.';uk='Файл не є файлом формату Excel, вибір заборонений.'");
