...
//       Чтобы получить идентификатор, нужно в режиме клиентского приложения BAF выполнить метод платформы:
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru='Авансовые отчеты';uk='Авансові звіти'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	...
	Раздел.Представление = НСтр("ru='Банк';uk='Банк'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	...
	Раздел.Представление = НСтр("ru='Взаимозачеты и списания задолженности';uk='Взаємозаліки та списання заборгованості'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));
	...
	Раздел.Представление = НСтр("ru='Закупки, возвраты поставщикам, перемещения и сборки';uk='Купівлі, повернення постачальникам, переміщення та збирання'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));

	Раздел = Разделы.Добавить();
	Раздел.Имя  = "Касса";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("97e0cfbc-3a80-40d5-bbce-ce9c3e87e7d8");
	Раздел.Представление = НСтр("ru='Касса';uk='Каса'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	...
	Раздел.Представление = НСтр("ru='Планирование';uk='Планування'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	...
	Раздел.Представление = НСтр("ru='Продажи и возвраты от клиентов';uk='Продажі та повернення від клієнтів'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));

	Раздел = Разделы.Добавить();
	Раздел.Имя  = "Производство";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("8795bd29-84ab-47b5-a59f-4fff6b242bab");
	Раздел.Представление = НСтр("ru='Производство';uk='Виробництво'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));

	Раздел = Разделы.Добавить();
	Раздел.Имя  = "РегламентныеОперации";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("49fca300-0137-4f5e-bc8d-af6cc30545a3");
	Раздел.Представление = НСтр("ru='Регламентные операции (интеркампани и закрытие месяца)';uk='Регламентні операції (інтеркампані і закриття місяця)'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));

	Раздел = Разделы.Добавить();
	Раздел.Имя  = "СкладскиеОперации";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("f37d661e-6540-4890-8642-f7481ff1ee7b");
	Раздел.Представление = НСтр("ru='Складские операции (на ордерных складах)';uk='Складські операції (на ордерних складах)'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	...
	Раздел.Представление = НСтр("ru='Списания и оприходования товаров';uk='Списання та оприбуткування товарів'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));
	//-- НЕ БЗК
