...
Функция ЗарегистрированаЛицензияУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, ИмяЛицензии, КонтекстЛицензии = "") Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Проверка наличия лицензии уникальной услуги из приложения';uk='Перевірка наявності ліцензії унікальної послуги з програми'",КодЯзыка());
...
Функция ЗанятьЛицензиюУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, ИмяЛицензии, ИдентификаторОперации, КонтекстЛицензии = "") Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Заем лицензии уникальной услуги из приложения';uk='Позика ліцензії унікальної послуги з програми'",КодЯзыка());
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			ИмяЛицензии,
			,
		...
		Иначе
			ВызватьИсключение НСтр("ru='Код возврата веб-сервера:';uk='Код повернення вебсервера:'") + Строка(Ответ.КодСостояния);
		КонецЕсли;
...
Функция ОсвободитьЛицензиюУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, ИмяЛицензии, ИдентификаторОперации, КодОбластиДанных = Неопределено,
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Освобождение лицензии уникальной услуги из приложения';uk='Звільнення ліцензії унікальної послуги з програми'",КодЯзыка());
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			ИмяЛицензии,
			,
...
Функция ЗанятьЛицензииЛимитированнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, КоличествоЛицензий, КодОбластиДанных = Неопределено) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Заем лицензий лимитированной услуги из приложения';uk='Позика ліцензій лімітованої послуги з програми'",КодЯзыка());
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			,
			КоличествоЛицензий,
...
Функция ОсвободитьЛицензииЛимитированнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, КоличествоЛицензий, КодОбластиДанных = Неопределено) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Освобождение лицензий лимитированной услуги из приложения';uk='Звільнення ліцензій лімітованої послуги з програми'",КодЯзыка());
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
...
Функция ПодтвердитьОперацию(ИдентификаторОперации) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Фиксация операции';uk='Фіксація операції'",КодЯзыка());
...
Функция ОтменитьОперацию(ИдентификаторОперации) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Отмена операции';uk='Скасування операції'",КодЯзыка());
		ЗаголовокКомментария = НСтр("ru='Идентификатор операции:';uk='Ідентифікатор операції:'") + Строка(ИдентификаторОперации);
...
Функция КоличествоЛицензийУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Получение количества свободных лицензий уникальной услуги из приложения';uk='Отримання кількості вільних ліцензій унікальної послуги з програми'",КодЯзыка());
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			ИмяЛицензии,
			,
...
Функция КоличествоЛицензийЛимитированнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, КодОбластиДанных = Неопределено) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Получение количества доступных лицензий лимитированной услуги из приложения';uk='Отримання кількості доступних ліцензій лімітованої послуги з програми'",КодЯзыка());
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			,
			КоличествоЛицензий,
...
Функция ПредставлениеВалютыОплаты() Экспорт
	...
	ПредставлениеВалютыОплаты = НСтр("ru='UAH';uk='UAH'"); 
...
Функция ИмяСобытияЖР()
	...
	Возврат ТарификацияСлужебный.ИмяСобытияТарификации() + НСтр("ru='Операции с лицензиями.';uk='Операції з ліцензіями.'",КодЯзыка());
