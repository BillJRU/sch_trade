		...
		Если ТипЗнч(ЭлементИсточник) = Тип("ЗначениеПараметраКомпоновкиДанных") Тогда
			Если ЭлементИсточник.ЗначенияВложенныхПараметров.Количество() <> 0 Тогда
				ЗаполнитьЭлементы(ЭлементПриемник.ЗначенияВложенныхПараметров,
					ЭлементИсточник.ЗначенияВложенныхПараметров,
					ПриемникЗначения);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
...
//
// Параметры:
//	ПриемникЗначения	- ЗначенияПараметровДанныхКомпоновкиДанных -
//						- ПорядокКомпоновкиДанных - 
//						- УсловноеОформлениеКомпоновкиДанных - 
//						- ВариантыПользовательскогоПоляВыборКомпоновкиДанных -
//						- ПорядокКомпоновкиДанных -
//						- ОформляемыеПоляКомпоновкиДанных - коллекция элементов КД, куда копируются параметры.
//	ИсточникЗначения	- ЗначенияПараметровДанныхКомпоновкиДанных -
//						- ПорядокКомпоновкиДанных - 
//						- УсловноеОформлениеКомпоновкиДанных - 
//						- ВариантыПользовательскогоПоляВыборКомпоновкиДанных -
//						- ПорядокКомпоновкиДанных -
//						- ОформляемыеПоляКомпоновкиДанных - коллекция элементов КД, откуда копируются параметры
...
Процедура СкопироватьЭлементы(ПриемникЗначения, ИсточникЗначения, ОчищатьПриемник = Истина) Экспорт
	...
	КонецЕсли;
	ПриемникЭлементов = ПриемникЗначения.Элементы; // КоллекцияЗначенийПараметровКомпоновкиДанных -
	ИсточникЭлементов = ИсточникЗначения.Элементы; // КоллекцияЗначенийПараметровКомпоновкиДанных -
	...
	Для каждого ЭлементИсточник Из ИсточникЭлементов Цикл
		...
		Если ТипЗнч(ЭлементИсточник) = Тип("ЭлементПорядкаКомпоновкиДанных") Тогда
			...
			Коллекция = ПриемникЭлементов; // КоллекцияЭлементовПорядкаКомпоновкиДанных -
			Индекс = Коллекция.Индекс(ЭлементИсточник);
			ЭлементПриемник = Коллекция.Вставить(Индекс, ТипЗнч(ЭлементИсточник));
		Иначе
			
			Если СоздаватьПоТипу Тогда
				Коллекция = ПриемникЭлементов; // КоллекцияЭлементовОтбораКомпоновкиДанных - и другие.
				ЭлементПриемник = Коллекция.Добавить(ТипЗнч(ЭлементИсточник));
			Иначе
				Коллекция = ПриемникЭлементов; // КоллекцияЗначенийПараметровКомпоновкиДанных - и другие.
				ЭлементПриемник = Коллекция.Добавить();
			КонецЕсли;
		КонецЕсли;
		...
		ИначеЕсли ТипЗнч(ЭлементИсточник) = Тип("ПользовательскоеПолеВыборКомпоновкиДанных") Тогда
			Коллекция = ЭлементПриемник; // ПользовательскоеПолеВыборКомпоновкиДанных -
			СкопироватьЭлементы(Коллекция.Варианты, ЭлементИсточник.Варианты);
...
Процедура ДобавитьОтборыВПользовательскиеНастройки(КомпоновщикНастроек, КоллекцияЭлементовОтбора) Экспорт
	...
	Для Каждого ЭлементКДобавлению Из КоллекцияЭлементовОтбора Цикл
		...
		Иначе
			...
			ДобавитьОтбор(КомпоновщикНастроек,
				ЭлементКДобавлению.ЛевоеЗначение,
				ЭлементКДобавлению.ПравоеЗначение,
				ЭлементКДобавлению.ВидСравнения,
				ЭлементКДобавлению.Использование,
