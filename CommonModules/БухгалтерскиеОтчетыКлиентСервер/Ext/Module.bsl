...
Процедура УстановитьПараметрыФорматныеСтроки(Настройки) Экспорт
	...
	ФорматныеСтроки.Вставить("ФорматнаяСтрокаДата",  НСтр("ru='ДФ=dd.MM.yy';uk='ДФ=dd.MM.yy'"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрокаМесяц", НСтр("ru='ДФ = ''MMM yy''';uk='ДФ = ''MMM yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрока1Кв",   НСтр("ru='ДФ = ''""1 кв."" yy''';uk='ДФ = ''""1 кв."" yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрока2Кв",   НСтр("ru='ДФ = ''""2 кв."" yy''';uk='ДФ = ''""2 кв."" yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрока3Кв",   НСтр("ru='ДФ = ''""3 кв."" yy''';uk='ДФ = ''""3 кв."" yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрока4Кв",   НСтр("ru='ДФ = ''""4 кв."" yy''';uk='ДФ = ''""4 кв."" yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрока1Полугодие",   НСтр("ru='ДФ = ''""1 полугодие"" yy''';uk='ДФ = ''""1 півріччя"" yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрока2Полугодие",   НСтр("ru='ДФ = ''""2 полугодие"" yy''';uk='ДФ = ''""2 півріччя"" yy'''"));
	ФорматныеСтроки.Вставить("ФорматнаяСтрокаГод",   НСтр("ru='ДФ = ''yyyy''';uk='ДФ = ''yyyy'''"));
...
Функция ПолучитьПредставлениеПериода(НачалоПериода = '00010101', КонецПериода = '00010101', ТолькоДаты  = Ложь) Экспорт
	...
	ТекстПериод = "";
	ФорматнаяСтрокаПредставленияПериода = "ФП = Истина" + ";Л=" + МультиязычностьУкрПовтИсп.ОпределитьКодЯзыкаДляФормат(МультиязычностьУкрПовтИсп.КодЯзыкаИнтерфейса());
	
	Если ЗначениеЗаполнено(КонецПериода) Тогда 
		Если КонецПериода >= НачалоПериода Тогда
			ТекстПериод = ?(ТолькоДаты, "", " " + НСтр("ru='за';uk='за'")+ " ") 
				+ ПредставлениеПериода(НачалоДня(НачалоПериода), КонецДня(КонецПериода), ФорматнаяСтрокаПредставленияПериода);
		Иначе
			ТекстПериод = "";
		КонецЕсли;
	ИначеЕсли ЗначениеЗаполнено(НачалоПериода) И Не ЗначениеЗаполнено(КонецПериода) Тогда
		ТекстПериод = ?(ТолькоДаты, "", " " + НСтр("ru='за';uk='за'")+ " ") 
			+ ПредставлениеПериода(НачалоДня(НачалоПериода), КонецДня(Дата(3999, 11, 11)), ФорматнаяСтрокаПредставленияПериода);
