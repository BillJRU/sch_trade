...
//  ФормируемыеЗадачи           - Массив из Задача - массив формируемых задач.
//
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru='Сделки с клиентами';uk='Угоди з клієнтами'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
