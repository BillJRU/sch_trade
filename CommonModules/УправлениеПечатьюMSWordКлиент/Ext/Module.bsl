...
Функция СобытиеЖурналаРегистрации()
	Возврат НСтр("ru='Печать';uk='Друк'",ОбщегоНазначенияКлиент.КодОсновногоЯзыка());
КонецФункции
...
#Иначе		
	ТекстУточнения = НСтр("ru='Для вывода печатных форм в формате Microsoft Word требуется, чтобы на компьютере был установлен пакет Microsoft Office.';uk='Для виведення друкованих форм в форматі Microsoft Word потрібно, щоб на комп''ютері був встановлений пакет Microsoft Office.'");
#КонецЕсли
