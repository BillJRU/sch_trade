...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Исправление включения в график рабочих и предпраздничных дней, выпадающих на субботу или воскресенье.';uk='Виправлення включення в графік робочих і передсвяткових днів, що випадають на суботу або неділю.'");
