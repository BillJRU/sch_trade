...
Функция ВыгрузитьЗадания(ИдентификаторМобильногоУстройства) Экспорт
	...
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка заданий';uk='Відправлення завдань'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ВыгрузитьКлиентов(ИдентификаторМобильногоУстройства, ВсеКлиенты, УникальныйИдентификатор, АдресДанных) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка клиентов';uk='Відправлення клієнтів'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ВыгрузитьНастройки(ИдентификаторМобильногоУстройства) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка настроек';uk='Відправлення настройок'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ВыгрузитьОстатки(ИдентификаторМобильногоУстройства, АдресДанных) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка остатков на складах';uk='Відправлення залишків на складах'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ВыгрузитьПрайсЛист(ИдентификаторМобильногоУстройства, ВсеЦены = Ложь, АдресДанных = "") Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка цен';uk='Відправлення цін'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ВыгрузитьСправочники(ИдентификаторМобильногоУстройства) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка основных справочников';uk='Відправлення основних довідників'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ВыгрузитьСтатусыДокументов(ИдентификаторМобильногоУстройства, СообщениеОбмена, ТипДокумента) Экспорт
	...
	Если ТипДокумента = 0 Тогда
		КомментарийКОбмену = НСтр("ru='Отправка состояния заказов клиентов';uk='Відправлення стану замовлень клієнтів'",ОбщегоНазначения.КодОсновногоЯзыка());
	ИначеЕсли ТипДокумента = 1 Тогда
		КомментарийКОбмену = НСтр("ru='Отправка состояния заявок на возврат';uk='Відправлення стану заявок на повернення'",ОбщегоНазначения.КодОсновногоЯзыка());
	КонецЕсли;
...
Функция ЗагрузитьЗаданияТорговымПредставителям(ИдентификаторМобильногоУстройства, СообщениеОбмена, НастройкиЗадания) Экспорт
	...
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Получение заданий';uk='Отримання завдань'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ЗагрузитьЗаказыКлиентов(ИдентификаторМобильногоУстройства, СообщениеОбмена) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ЗагрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Получение заказов';uk='Отримання замовлень'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ЗагрузитьОплатыКлиентов(ИдентификаторМобильногоУстройства, СообщениеОбмена) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ЗагрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Получение регистрации оплат';uk='Отримання реєстрації оплат'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ЗагрузитьСправочники(ИдентификаторМобильногоУстройства, СообщениеОбмена) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ЗагрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Получение справочников';uk='Отримання довідників'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ЗаписьИдентификатораПодписчикаДоставляемыхУведомлений(ИдентификаторМобильногоУстройства, ИдентификаторПодписчикаДоставляемыхУведомлений) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ЗагрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Получение идентификатора подписчика push-уведомлений';uk='Отримання ідентифікатора підписника push-повідомлень'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция НачалоОбмена(ВерсияМобильногоПриложения, ИдентификаторМобильногоУстройства) Экспорт
	...
	Иначе
		...
		СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ЗагрузкаДанных);
		СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
		СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Начало обмена';uk='Початок обміну'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
|Дані були очищені.'");
		...
		Если НЕ ВерсияМобильногоПриложения = "3.0.7" Тогда
			...
			Исключение
				ЗаписьЖурналаРегистрации(НСтр("ru='Обмен Заказы';uk='Обмін Замовлення'",ОбщегоНазначения.КодОсновногоЯзыка()),
...
Функция КлючСообщенияЖурналаРегистрации(УзелИнформационнойБазы, ДействиеПриОбмене)
	...
	КлючСообщения = НСтр("ru='Обмен данными. [ИмяПланаОбмена]. Устройство: [ИмяУстройства]. [ДействиеПриОбмене]';uk='Обмін даними. [ИмяПланаОбмена]. Пристрій: [ИмяУстройства]. [ДействиеПриОбмене]'",ОбщегоНазначения.КодОсновногоЯзыка());
