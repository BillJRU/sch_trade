...
Процедура ПодобратьМногооборотнуюТару(Знач Форма,
	...
	Если Форма.Объект[ИмяТаблицы].Количество() = 0 Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru='В списке отсутствуют строки. Дозаполнение многооборотной тарой не требуется.';uk='У списку відсутні рядки. Дозаповнення многооборотной тарою не потрібно.'"));
