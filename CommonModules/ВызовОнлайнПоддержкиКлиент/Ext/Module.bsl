...
// Возвращает уникальный идентификатор клиента (приложение).
...
Процедура ВызватьОнлайнПоддержку() Экспорт
	...
	ТекстСообщения = НСтр("ru='Для запуска приложения необходимо установить расширение для работы с BAF.';uk='Для запуску додатка необхідно встановити розширення для роботи з BAF.'");
