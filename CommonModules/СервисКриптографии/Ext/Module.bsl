...
Функция ВызватьHTTPМетод(Соединение, МетодHTTP, Запрос)
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись в модели сервиса.Сервис криптографии.Выполнение запроса';uk='Електронний підпис моделі сервісу.Сервіс криптографії.Виконання запиту'",ОбщегоНазначения.КодОсновногоЯзыка()), 
...
Функция ИмяСобытияШифрование()
	...
	Возврат НСтр("ru='Сервис криптографии.Шифрование';uk='Сервіс криптографії.Шифрування'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияШифрованиеБлока()
	
	Возврат НСтр("ru='Сервис криптографии.Шифрование блока';uk='Сервіс криптографії.Шифрування блоку'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияРасшифровка()
	
	Возврат НСтр("ru='Сервис криптографии.Расшифровка';uk='Сервіс криптографії.Розшифровка'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияРасшифровкаБлока()
	
	Возврат НСтр("ru='Сервис криптографии.Расшифровка блока';uk='Сервіс криптографії.Розшифровка блоку'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияАутентификация()
	
	Возврат НСтр("ru='Сервис криптографии.Аутентификация';uk='Сервіс криптографії.Аутентифікація'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияСвойстваКриптосообщения()
	
	Возврат НСтр("ru='Сервис криптографии.Свойства криптосообщения';uk='Сервіс криптографії.Властивості криптоповідомлення'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияПроверкаСертификата()
	
	Возврат НСтр("ru='Сервис криптографии.Проверка сертификата';uk='Сервіс криптографії.Перевірка сертифіката'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияСвойстваСертификата()
	
	Возврат НСтр("ru='Сервис криптографии.Свойства сертификата';uk='Сервіс криптографії.Властивості сертифіката'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияПроверкаПодписи()
	
	Возврат НСтр("ru='Сервис криптографии.Проверка подписи';uk='Сервіс криптографії.Перевірка підпису'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияХеширование()
	
	Возврат НСтр("ru='Сервис криптографии.Хеширование';uk='Сервіс криптографії.Хешування'",ОбщегоНазначения.КодОсновногоЯзыка());
	
КонецФункции

Функция ИмяСобытияПодписание()
	
	Возврат НСтр("ru='Сервис криптографии.Подписание';uk='Сервіс криптографії.Підписання'",ОбщегоНазначения.КодОсновногоЯзыка());
