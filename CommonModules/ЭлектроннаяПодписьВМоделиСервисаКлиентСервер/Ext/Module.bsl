...
Функция ПолучитьОписаниеСпособовПодтвержденияКриптоопераций() Экспорт
	...
	Результат = НСтр("ru='Признак подтверждения операций с ключом пользователя, хранящимся в ""облаке"".
    |Подтверждение предполагает ввод временного пароля, высылаемого в SMS или на эл. почту.'
    |;uk='Ознака підтвердження операцій з ключем користувача, що зберігаються в ""хмарі"". 
    |Підтвердження передбачає введення тимчасового пароля, якого висилають в SMS або на ел. пошту.'");
