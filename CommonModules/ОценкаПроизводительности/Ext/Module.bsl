...
Процедура ЗафиксироватьДлительностьКлючевойОперации(Параметры)
	...
	Если БезопасныйРежим() <> Ложь Тогда
		ЗаписьЖурналаРегистрации(НСтр("ru='Работа подсистемы оценка производительности в безопасном режиме не поддерживается';uk='Робота підсистеми оцінка продуктивності в безпечному режимі не підтримується'",ОценкаПроизводительностиСлужебный.КодОсновногоЯзыка()),
	...
	Если Не ЗначениеЗаполнено(ДатаНачалаКлючевойОперации) Тогда
		ЗаписьЖурналаРегистрации(НСтр("ru='Невозможно зафиксировать замер с пустой датой начала';uk='Неможливо зафіксувати замір з порожньою датою початку'",ОценкаПроизводительностиСлужебный.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Информация,,,Строка(КлючеваяОперация));
...
Процедура ЗаписатьЗамерыВремени(МассивЗамеров)
	...
	Если НаборЗаписей.Количество() > 0 Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru='Не удалось сохранить замеры производительности';uk='Не вдалося зберегти заміри продуктивності'",ОценкаПроизводительностиСлужебный.КодОсновногоЯзыка()),
