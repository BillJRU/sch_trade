...
Функция СтандартныеИнтервалыОповещения()
	...
	Результат.Добавить(НСтр("ru='5 минут';uk='5 хвилин'"));
	Результат.Добавить(НСтр("ru='10 минут';uk='10 хвилин'"));
	Результат.Добавить(НСтр("ru='15 минут';uk='15 хвилин'"));
	Результат.Добавить(НСтр("ru='30 минут';uk='30 хвилин'"));
	Результат.Добавить(НСтр("ru='1 час';uk= '1 годину'"));
	Результат.Добавить(НСтр("ru='2 часа';uk='2 години'"));
	Результат.Добавить(НСтр("ru='4 часа';uk='4 години'"));
	Результат.Добавить(НСтр("ru='8 часов';uk='8 годин'"));
	Результат.Добавить(НСтр("ru='1 день';uk='1 день'"));
	Результат.Добавить(НСтр("ru='2 дня';uk='2 дні'"));
	Результат.Добавить(НСтр("ru='3 дня';uk='3 дні'"));
	Результат.Добавить(НСтр("ru='1 неделю';uk='1 тиждень'"));
	Результат.Добавить(НСтр("ru='2 недели';uk='2 тижня'"));
