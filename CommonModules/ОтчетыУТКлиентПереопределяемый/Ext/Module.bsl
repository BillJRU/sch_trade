...
Процедура ОбработкаРасшифровки(ЭтаФорма, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ПолноеИмяОтчета = "Отчет.ПлановаяИФактическаяСебестоимостьПродукции" Тогда
		...
		ПараметрыОтчета.Вставить("Заголовок", НСтр("ru='Фактическая себестоимость продукции';uk='Фактична собівартість продукції'"));
		...
		ПараметрыОтчета.Вставить("Заголовок", НСтр("ru='Плановая себестоимость продукции';uk='Планова собівартість продукції'"));
	...
	ИначеЕсли ПолноеИмяОтчета = "Отчет.ВедомостьРасчетовСКлиентами" Тогда
		...
		ПараметрыОтчета.Вставить("Заголовок", НСтр("ru='Карточка расчетов с клиентами';uk='Картка розрахунків з клієнтами'"));
	...
	ИначеЕсли ПолноеИмяОтчета = "Отчет.ВедомостьРасчетовСПоставщиками" Тогда
		...
		ПараметрыОтчета = Новый Структура;
		ПараметрыОтчета.Вставить("Имя", "Карточка");
		ПараметрыОтчета.Вставить("Заголовок", НСтр("ru='Карточка расчетов с поставщиками';uk='Картка розрахунків з постачальниками'"));
...
Процедура ОбработкаДополнительнойРасшифровки(ЭтаФорма, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ПолноеИмяОтчета = "Отчет.ТоварыСхемыОбеспечения" Тогда
		...
		ПараметрыДействия.Вставить("Заголовок", НСтр("ru='Изменить способ обеспечения потребностей';uk='Змінити спосіб забезпечення потреб'"));
...
Процедура ОбработатьРасшифровкуСтруктураСерииНоменклатуры(ЭтаФорма, Расшифровка, СтандартнаяОбработка)
	...
	ПредставлениеНастройки = НСтр("ru='Движение серии номенклатуры';uk='Рух серії номенклатури'");
	СписокОтчетов.Добавить("ДвижениеСерииНоменклатуры", ПредставлениеНастройки,, БиблиотекаКартинок.Отчет);
	
	ПредставлениеНастройки = НСтр("ru='Ведомость по сериям номенклатуры';uk='Відомість по серіях номенклатури'");
	СписокОтчетов.Добавить("ВедомостьПоСериямНоменклатуры", ПредставлениеНастройки,, БиблиотекаКартинок.Отчет);
	
	ПредставлениеНастройки = НСтр("ru='Применение серии номенклатуры';uk='Застосування серії номенклатури'");
...
Процедура ОбработатьРасшифровкуПрименениеСерииНоменклатуры(ЭтаФорма, Расшифровка, СтандартнаяОбработка)
	...
	ПредставлениеНастройки = НСтр("ru='Структура серии номенклатуры';uk='Структура серії номенклатури'");
