...
#Если ВебКлиент Тогда
	ВызватьИсключение НСтр("ru='Прокси не доступен в веб-клиенте.';uk='Проксі не доступний у вебклієнті.'");
#Иначе
...
#Если ВебКлиент Тогда
	...
	Результат.Вставить("Представление", НСтр("ru='Прокси не доступен в веб-клиенте.';uk='Проксі не доступний у вебклієнті.'"));
	Возврат Результат;
