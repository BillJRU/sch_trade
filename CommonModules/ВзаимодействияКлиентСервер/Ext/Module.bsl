...
Процедура ПриИзмененииОтбораТипВзаимодействий(Форма,ТипВзаимодействия) Экспорт
	...
	ГруппаОтбора = ОбщегоНазначенияКлиентСервер.СоздатьГруппуЭлементовОтбора(
		Отбор.Элементы, НСтр("ru='Отбор по типу взаимодействий';uk='Відбір за типом взаємодій'"), ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ);
...
Функция ТемаВзаимодействия(Тема) Экспорт
	...
	Возврат ?(ПустаяСтрока(Тема), НСтр("ru='<Без темы>';uk='<Без теми>'"), Тема);
