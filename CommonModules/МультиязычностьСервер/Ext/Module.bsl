...
Процедура ОбновитьПредставленияПредопределенныхЭлементов(Параметры, ОбъектМетаданных = Неопределено) Экспорт
	...
	Если Результат.ОбъектовОбработано = 0 И Результат.ПроблемныхОбъектов <> 0 Тогда
		...
		НСтр("ru='Процедуре ОбновитьПредставленияПредопределенныхЭлементов не удалось обработать некоторые элементы(пропущены): %1';uk='Процедурі ОбновитьПредставленияПредопределенныхЭлементов не вдалося обробити деякі елементи (пропущені): %1'"),
	...
	Иначе
		...
		НСтр("ru='Процедура ОбновитьПредставленияПредопределенныхЭлементов обработала очередную порцию элементов: %1';uk='Процедура ОбновитьПредставленияПредопределенныхЭлементов опрацювала чергову порцію елементів: %1'"),
...
Функция ОбновитьМультиязычныеСтрокиПредопределенныхЭлементов(СсылкиНаОбъекты, ОбъектМетаданных)
	...
	Пока СсылкиНаОбъекты.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось обработать элемент: %1 по причине: %2';uk='Не вдалося обробити елемент: %1 через: %2'"),
