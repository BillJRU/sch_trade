...
|;uk='Не вдалося виконати відкладене проведення по регістру ""Рухи Грошові кошти - Контрагент"" при розрахунках з клієнтами через'") + ":" + Символы.ПС + "%Причина%";
...
|;uk='Не вдалося виконати відкладене проведення по регістру ""Рухи Грошові кошти - Контрагент"" при розрахунках з постачальниками через'") + ":" + Символы.ПС + "%Причина%";
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Причина%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(),
			УровеньЖурналаРегистрации.Ошибка, , ТекстСообщения);
		ВызватьИсключение ТекстСообщения;
...
|через: %Причина%'");
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Отложенное проведение взаимозачета';uk='Відкладене проведення взаємозаліку'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
|по причине: %Причина%'
|;uk='Не вдалося виконати відкладене проведення по регістру ""Рухи Контрагент - Доходи / Витрати"" 
|по причині: %Причина%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Причина%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Отложенное проведение взаимозачета';uk='Відкладене проведення взаємозаліку'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
//
// Параметры:
//  СсылкаНаДокумент - ДокументСсылка - документ для которого необходимо сформировать движения по управленческому балансу
