	...
	Если КлючЗаписи <> Неопределено Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации() + "." 
				+ НСтр("ru='Обновление области данных';uk='Оновлення області даних'",ОбщегоНазначения.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	Если Не МонопольныйРежим() Тогда
		...
		Исключение
			...
			СтрокаСообщения = НСтр("ru='Не удалось установить монопольный режим. Описание ошибки: %1';uk='Не вдалося встановити монопольний режим. Опис помилки: %1'",ОбщегоНазначения.КодОсновногоЯзыка());
