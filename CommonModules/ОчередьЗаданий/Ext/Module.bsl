...
Функция ПолучитьТекстИсключенияДублированиеЗаданийСОдинаковымКлючом() Экспорт
	...
	Возврат НСтр("ru='Дублирование заданий с одинаковым значением поля ''Ключ'' не допустимо.';uk='Дублювання завдань з однаковим значенням поля ''Ключ'' не припустимо.'");
