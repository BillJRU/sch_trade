...
#Иначе
	ТекстУточнения = НСтр("ru='Для вывода печатных форм в формате OpenOffice.org Writer требуется, чтобы на компьютере был установлен пакет OpenOffice.org.';uk='Для виведення друкованих форм в форматі OpenOffice.org Writer потрібно, щоб на комп''ютері був встановлений пакет OpenOffice.org.'");
#КонецЕсли
