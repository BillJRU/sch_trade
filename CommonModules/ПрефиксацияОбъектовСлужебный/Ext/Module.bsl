...
Функция СобытиеЖурналаРегистрацииПерепрефиксацияОбъектов()
	...
	Возврат НСтр("ru='Префиксация объектов.Изменение префикса информационной базы';uk='Префіксація об''єктів.Зміна префікса інформаційної бази'",ОбщегоНазначения.КодОсновногоЯзыка());
