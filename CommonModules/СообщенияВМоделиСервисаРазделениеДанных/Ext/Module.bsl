...
Процедура УстановитьКлючОбластиПриВосстановленииИзВыгрузки(Знач Сообщение) Экспорт 
	
	РаботаВМоделиСервиса.УстановитьРазделениеСеанса(Истина, Сообщение.Body.Zone);
	
	УстановитьЗначениеКлючаОбласти(Сообщение);	
...
Процедура УстановитьЗначениеКлючаОбласти(Сообщение)
