...
Процедура ДобавитьРеквизитыФормыНастройки(Форма) Экспорт
	...
	РеквизитВыгружатьПрочиеФайлы = Новый РеквизитФормы("ВыгружатьФайлы", ТипБулево,,НСтр("ru='Прочие файлы';uk='Інші файли'"),Истина);
	РеквизитДатаНаСайте = Новый РеквизитФормы("ДополнительныйРеквизитЗаказаКлиентаДатаЗаказаНаСайте",
		ТипСведения,,НСтр("ru='Дата заказа на сайте';uk='Дата замовлення на сайті'"),Истина);
	РеквизитНомерНаСайте = Новый РеквизитФормы("ДополнительныйРеквизитЗаказаКлиентаНомерЗаказаНаСайте",
		ТипСведения,,НСтр("ru='Номер заказа на сайте';uk='Номер замовлення на сайті'"),Истина);
	РеквизитСоглашение = Новый РеквизитФормы("Соглашение", ТипСоглашение,,НСтр("ru='Соглашение';uk='Оферта'"),Истина);
	РеквизитОрганизация = Новый РеквизитФормы("Организация", ТипОрганизация,,НСтр("ru='Организация';uk='Організація'"),Истина);
	РеквизитСклад = Новый РеквизитФормы("Склад", ТипСклад,,НСтр("ru='Склад';uk='Склад'"),Истина);
	РеквизитМенеджер = Новый РеквизитФормы("Менеджер", ТипПользователи,,НСтр("ru='Менеджер';uk='Менеджер'"),Истина);
	РеквизитПричинаОтмены = Новый РеквизитФормы("ПричинаОтменыЗаказа", ТипПричина,,НСтр("ru='Причина отмены заказа';uk='Причина відміни замовлення'"),Истина);
	РеквизитСпособИдентификации = Новый РеквизитФормы("СпособИдентификацииКонтрагентов", ТипСпособИдентификации,,,Истина);
	РеквизитВидНоменклатурыТовар = Новый РеквизитФормы("ВидНоменклатурыТовар", ТипВидНоменклатуры,,НСтр("ru='Вид номенклатуры товар';uk='Вид номенклатури товар'"),Истина);
	РеквизитВидНоменклатурыУслуга = Новый РеквизитФормы("ВидНоменклатурыУслуга", ТипВидНоменклатуры,,НСтр("ru='Вид номенклатуры услуга';uk='Вид номенклатури послуга'"),Истина);
	РеквизитЕдиницаИзмерения = Новый РеквизитФормы("ЕдиницаИзмеренияНовойНоменклатуры", ТипЕдиницаИзмерения,,НСтр("ru='Единица измерения';uk='Одиниця вимірювання'"),Истина);
	РеквизитГруппаНоменклатуры = Новый РеквизитФормы("ГруппаДляНовойНоменклатуры", ТипГруппаНоменклатуры,,НСтр("ru='Группа номенклатуры';uk='Група номенклатури'"),Истина);
	
	РеквизитСоздаватьПартнеровДляНовыхКонтрагентов = Новый РеквизитФормы("СоздаватьПартнеровДляНовыхКонтрагентов",
		ТипБулево, ,НСтр("ru='Создавать партнеров для новых контрагентов';uk='Створювати партнерів для нових контрагентів'"),Истина);
	РеквизитГруппаДоступа = Новый РеквизитФормы("ГруппаДоступаПартнеров", ТипГруппаДоступа,, НСтр("ru='Группа доступа партнеров';uk='Група доступу партнерів'"), Истина);
	...
	РеквизитСоответствиеСтатусов = Новый РеквизитФормы("СоответствиеСтатусовЗаказов", ТипСоответствиеСтатусов, ,
		НСтр("ru='Соответствие статусов заказов';uk='Відповідність статусів замовлень'"), Истина);
	...
	РеквизитСтатусЗаказаВБазе = Новый РеквизитФормы("СтатусЗаказаВБазе", ТипСтатусЗаказаВБазе,
		"СоответствиеСтатусовЗаказов", НСтр("ru='Статус заказа в базе';uk='Статус замовлення в базі'"), Истина);
	РеквизитСтатусЗаказаНаСайте = Новый РеквизитФормы("СтатусЗаказаНаСайте", ТипСтрока,
		"СоответствиеСтатусовЗаказов", НСтр("ru='Статус заказа на сайте';uk='Статус замовлення на сайті'"), Истина);
	...
	ЗаголовокШаблон = НСтр("ru='Дополнительные реквизиты для поиска документов ""%1""';uk='Додаткові реквізити для пошуку документів ""%1""'");
	ЗаголовокГруппы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, НСтр("ru='Заказ клиент';uk='Замовлення клієнта'"));
	...
	ЗаголовокШаблон = НСтр("ru='Реквизиты для создания документов ""%1""';uk='Реквізити для створення документів ""%1""'");
	ЗаголовокГруппы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, НСтр("ru='Заказ клиент';uk='Замовлення клієнта'"));
	...
	ЗаголовокШаблон = НСтр("ru='Способ поиска существующих элементов справочника ""%1""';uk='Спосіб пошуку існуючих елементів довідника ""%1""'");
	ЗаголовокГруппы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, НСтр("ru='Контрагенты';uk='Контрагенти'"));
	...
	ЭлементСпособИдентификации.СписокВыбора.Добавить(Перечисления.СпособыИдентификацииКонтрагентов.Наименование, НСтр("ru='Наименование';uk='Найменування'"));
 	ЭлементСпособИдентификации.СписокВыбора.Добавить(Перечисления.СпособыИдентификацииКонтрагентов.КодПоЕДРПОУ, НСтр("ru='По коду ЕДРПОУ';uk='За кодом ЄДРПОУ'"));
	...
	ТекстПодсказки = Новый ФорматированнаяСтрока(НСтр("ru='При получении информации о новых контрагентах также будут создаваться новые партнеры.';uk='При отриманні інформації про нових контрагентів також будуть створюватися нові партнери.'")
	...
	ЗаголовокШаблон = НСтр("ru='Реквизиты для создания новых элементов справочника ""%1""';uk='Реквізити для створення нових елементів довідника ""%1""'");
	ЗаголовокГруппы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ЗаголовокШаблон, НСтр("ru='Номенклатура';uk='Номенклатура'"));
...
Процедура ЗаполнитьСтруктуруПолейАдресаПоЗначениюПолей(СкладАдрес, ЗначениеПолей) Экспорт
	...
	Если ЗначениеЗаполнено(СведенияОбАдресе) Тогда
		...
		Если НЕ ЗначениеЗаполнено(СкладАдрес.Страна) Тогда
			СкладАдрес.Страна = НСтр("ru='Украина';uk='Україна'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
		КонецЕсли;
...
Процедура ПриСозданииНаСервереФормаСоздатьСайт(Форма) Экспорт
	...
	Форма.Элементы.ВидЦен.Заголовок = НСтр("ru='Соглашение';uk='Оферта'");
