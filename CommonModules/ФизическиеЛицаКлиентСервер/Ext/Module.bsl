...
Функция ЧастиИмени(ФамилияИмяОтчество) Экспорт
	...
	Если ЧастиИмени.Количество() > 3 Тогда
		...
		ДополнительныеЧастиОтчества.Добавить("оглы");
		ДополнительныеЧастиОтчества.Добавить("улы");
		ДополнительныеЧастиОтчества.Добавить("уулу");
		ДополнительныеЧастиОтчества.Добавить("кызы");
		ДополнительныеЧастиОтчества.Добавить("гызы");
		ДополнительныеЧастиОтчества.Добавить("угли");
		ДополнительныеЧастиОтчества.Добавить("огли");
		ДополнительныеЧастиОтчества.Добавить("ули");
		ДополнительныеЧастиОтчества.Добавить("уулу");
		ДополнительныеЧастиОтчества.Добавить("кизи");
		ДополнительныеЧастиОтчества.Добавить("гизи");
		ДополнительныеЧастиОтчества.Добавить("углі");
...
Функция ФИОНаписаноВерно(Знач ФИО, ТолькоКириллица = Ложь) Экспорт
	...
	Возврат (Не ТолькоКириллица И СтроковыеФункцииКлиентСервер.ТолькоЛатиницаВСтроке(ФИО, Ложь, ДопустимыеСимволы))
		Или СтроковыеФункцииКлиентСерверУКР.ТолькоКириллицаВСтроке(ФИО, Ложь, ДопустимыеСимволы);
