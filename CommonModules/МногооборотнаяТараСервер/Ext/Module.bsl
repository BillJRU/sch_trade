...
Процедура ПроверитьУказаниеМногооборотнойТары(Объект, ПараметрыПроверкиУказанияМногооборотнойТары, Отказ) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ПараметрыПроверкиУказанияМногооборотнойТары.ЕстьЯчейки И ЗначениеЗаполнено(Выборка.Ячейка) Тогда
			ТекстСообщения = НСтр("ru='В списке %ИмяТЧ% для упаковок в ячейке %Ячейка%, поставляемых в многооборотной таре ""%Тара%"", указано недостаточное количество тары. Не хватает %Количество% %ЕдиницаИзмерения%.';uk='У списку %ИмяТЧ% для упаковок в осередку %Ячейка%, що поставляються в многооборотной тарі ""%Тара%"", зазначено недостатню кількість тари. Бракує %Кількість% % ЕдиницаИзмерения%.'");
...
Функция ПараметрыУстановкиУсловногоОформленияДляСтрокСМногооборотнойТарой() Экспорт
    ...
    ПараметрыУстановки.Вставить("ИмяПоляВводаНалоговоеНазначение", "ТоварыНалоговоеНазначение");
...
Процедура УстановитьУсловноеОформлениеДляСтрокСМногооборотнойТарой(ПараметрыУстановки) Экспорт
    ...
    ИмяПоляВводаНалоговоеНазначение = ПараметрыУстановки.ИмяПоляВводаНалоговоеНазначение;
    ...
    Если ЗначениеЗаполнено(ИмяПоляВводаНалоговоеНазначение) И ЭлементыФормы.Найти(ИмяПоляВводаНалоговоеНазначение) <> Неопределено Тогда
		...
		ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
		ПолеФормы = ЭлементыФормы[ИмяПоляВводаНалоговоеНазначение]; // ПолеФормы
		ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(ПолеФормы.Имя);
