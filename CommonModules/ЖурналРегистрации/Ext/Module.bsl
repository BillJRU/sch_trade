...
Процедура СформироватьПредставлениеОтбора(ПредставлениеОтбора, ОтборЖурналаРегистрации, 
	...
	Для Каждого ЭлементОтбора Из ОтборЖурналаРегистрации Цикл
		...
		ИначеЕсли ВРег(ИмяОграничения) = ВРег("Компьютер") Тогда
			ИмяОграничения = НСтр("ru='Компьютер';uk='Комп''ютер'");
		ИначеЕсли ВРег(ИмяОграничения) = ВРег("Комментарий") Тогда
			ИмяОграничения = НСтр("ru='Комментарий';uk='Коментар'");
		ИначеЕсли ВРег(ИмяОграничения) = ВРег("Метаданные") Тогда
			ИмяОграничения = НСтр("ru='Метаданные';uk='Метадані'");
		ИначеЕсли ВРег(ИмяОграничения) = ВРег("Данные") Тогда
			ИмяОграничения = НСтр("ru='Данные';uk='Дані'");
		ИначеЕсли ВРег(ИмяОграничения) = ВРег("Транзакция") Тогда
			ИмяОграничения = НСтр("ru='Транзакция';uk='Транзакція'");
		КонецЕсли;
		...
		Для Каждого ЭлементСписка Из СписокОграничений Цикл
			...
			Если (ВРег(ИмяОграничения) = ВРег("Сеанс")
				...
				Если ИмяОграничения = "Сеанс" Тогда
					ПредставлениеОграничения = НСтр("ru='Сеанс';uk='Сеанс'");
				Иначе
					ПредставлениеОграничения = НСтр("ru='Уровень';uk='Рівень'");
				КонецЕсли;
				
				Ограничение = НСтр("ru='%1: %2';uk='%1: %2'");
