...
Функция КаталогУстановкиПлатформы(НомерВерсии) Экспорт
		...
		ПолучениеОбновленийПрограммыВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось удалить устаревшие файлы исправлений (патчей):
                    |%1
                    |%2'
                    |;uk='Не вдалося вилучити застарілі файли виправлень (патчів):
                    |%1
                    |%2'"),
...
Функция ИмяСобытияЖурналаРегистрации(КодОсновногоЯзыка) Экспорт
	...
	Возврат НСтр("ru='Получение обновлений программы';uk='Отримання оновлень програми'",КодОсновногоЯзыка);
