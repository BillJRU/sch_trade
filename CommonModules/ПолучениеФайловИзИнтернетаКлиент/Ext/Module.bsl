...
#Если ВебКлиент Тогда
	ВызватьИсключение НСтр("ru='Скачивание файлов на клиент недоступно при работе в веб-клиенте.';uk='Завантаження файлів на клієнт недоступно при роботі в вебклієнті.'");
#Иначе
