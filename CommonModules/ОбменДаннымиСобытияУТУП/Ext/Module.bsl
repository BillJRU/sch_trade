...
Процедура ЗарегистрироватьДанныеПоДатеНачалаВыгрузкиИОрганизациям(Знач Получатель, ДатаНачалаВыгрузки, Организации = Неопределено, Данные = Неопределено) Экспорт
	...
	Для Каждого ЭлементСоставаПланаОбмена Из СоставПланаОбмена Цикл
		...
		Если ИспользоватьФильтрПоМетаданным
			...
			ИЛИ ЭлементСоставаПланаОбмена.Метаданные = Метаданные.Документы.РеализацияПодарочныхСертификатов 
			//-- НЕ БЗК
			Тогда
...
Процедура ОбменДаннымиСОтборамиКонтрольИзменения(Источник, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	Если Отказ Тогда
		...
		ТекстСообщения = НСтр("ru='Документ не может быть изменен в подчиненном узле распределенной информационной базы. %1';uk='Документ не може бути змінений в підпорядкованому вузлі розподіленої інформаційної бази. %1'");
