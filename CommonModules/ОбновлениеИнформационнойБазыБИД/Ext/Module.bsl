////////////////////////////////////////////////////////////////////////////////
// Обновление информационной базы Библиотеки интеграции с BAS Документооборотом
//
////////////////////////////////////////////////////////////////////////////////
...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "БиблиотекаИнтеграцииСBASДокументооборотом";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Проверка правил интеграции с BAS Документооборотом';uk='Перевірка правил інтеграції з BAS Документообігом'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.МонопольныйРежим = Ложь;
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыБИД.ПриОбновленииИнформационнойБазы";
	Обработчик.Комментарий = НСтр("ru='Проверка соответствия определяемых типов и плана обмена';uk='Перевірка відповідності визначених типів і плану обміну'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.6.1";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыБИД.ПерейтиНаВерсию_1_1_6_1";
	Обработчик.Комментарий = НСтр("ru='Обновление правил интеграции с BAS Документооборотом';uk='Оновлення правил інтеграції з BAS Документообігом'");
	...
	Пока ВыборкаПравила.Следующий() Цикл
		...
		Если ОбъектМетаданных = Неопределено Тогда
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru='Помечено на удаление правило для несуществующего объекта %1';uk='Відмічено для вилучення правило для неіснуючого об''єкту %1'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ПроверитьСоответствиеОпределяемыхТиповМеждуСобой(Ошибки) Экспорт
	...
	Для Каждого ТипЗначения Из Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.Тип.Типы() Цикл
		...
		Если ОбъектМетаданных = Неопределено Или
			...
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, но интеграция данного объекта с ДО не поддерживается.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, але інтеграція даного об''єкта з ДН не підтримується.'"),
					ТипЗначения));
			Продолжить;
		КонецЕсли;
		...
		Если Не ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, но в него должны быть включены только ссылочные типы.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, але до нього повинні бути включені тільки посилкові типи.'"),
					ТипЗначения));
			Продолжить;
		КонецЕсли;
		...
		Если ОбщегоНазначения.ЭтоСправочник(ОбъектМетаданных) Тогда
			...
			Если Не Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый.Тип.СодержитТип(Тип) Тогда
				Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Справочник ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, но отсутствует в типе ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый.';uk='Довідник "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, але відсутній в типі ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый.'"),
		...
		ИначеЕсли ОбщегоНазначения.ЭтоДокумент(ОбъектМетаданных) Тогда
			...
			Если Не Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый.Тип.СодержитТип(Тип) Тогда
				Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Документ ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, но отсутствует в типе ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый.';uk='Документ "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, але відсутній в типі ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый.'"),
					ОбъектМетаданных.Имя));
			КонецЕсли;
		КонецЕсли;
	...
	Для Каждого ТипЗначения Из Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый.Тип.Типы() Цикл
		...
		Если ОбъектМетаданных = Неопределено Или Не ОбщегоНазначения.ЭтоДокумент(ОбъектМетаданных) Тогда
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый, но в него должны быть включены только документы.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый, але до нього повинні бути включені тільки документи.'"),
					ТипЗначения));
			Продолжить;
		КонецЕсли;
		...
		Если ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый, но в него должны быть включены только типы ДокументОбъект.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый, але до нього повинні бути включені тільки типи ДокументОбъект.'"),
					ТипЗначения));
			Продолжить;
		КонецЕсли;
		...
		Если Не Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.Тип.СодержитТип(Тип) Тогда
			Ошибки.Добавить(СтрШаблон(
				НСтр("ru='Документ ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый, но отсутствует в типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.';uk='Документ "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотДокументыОбъектыПереопределяемый, але відсутній в типі ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.'"),
				ОбъектМетаданных.Имя));
		КонецЕсли;
	...
	Для Каждого ТипЗначения Из Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый.Тип.Типы() Цикл
		...
		Если ОбъектМетаданных = Неопределено Или Не ОбщегоНазначения.ЭтоСправочник(ОбъектМетаданных) Тогда
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый, но в него должны быть включены только справочники.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый, але до нього повинні бути включені тільки довідники.'"),
					ТипЗначения));
			Продолжить;
		КонецЕсли;
		...
		Если ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый, но в него должны быть включены только типы СправочникОбъект.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый, але до нього повинні бути включені тільки типи СправочникОбъект.'"),
					ТипЗначения));
			Продолжить;
		КонецЕсли;
		...
		Если Не Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.Тип.СодержитТип(Тип) Тогда
			Ошибки.Добавить(СтрШаблон(
				НСтр("ru='Справочник ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый, но отсутствует в типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.';uk='Довідник "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотСправочникиОбъектыПереопределяемый, але відсутній в типі ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.'"),
				ОбъектМетаданных.Имя));
		КонецЕсли;
...
Процедура ПроверитьСоответствиеОпределяемыхТиповИПланаОбмена(Ошибки) Экспорт
	...
	Для Каждого ЭлементСостава Из Метаданные.ПланыОбмена.ИнтеграцияС1СДокументооборотомПереопределяемый.Состав Цикл
		...
		Если Не ОбщегоНазначения.ЭтоСправочник(ОбъектМетаданных)
			...
			Ошибки.Добавить(СтрШаблон(
					НСтр("ru='Объект ""%1"" есть в плане обмена ИнтеграцияС1СДокументооборотомПереопределяемый, но интеграция данного объекта с ДО не поддерживается.';uk='Об''єкт "" %1"" є в плані обміну ИнтеграцияС1СДокументооборотомПереопределяемый, але інтеграція даного об''єкта з ДО не підтримується.'"),
					ПолноеИмя));
			Продолжить;
		КонецЕсли;
		...
		Если Не Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.Тип.СодержитТип(Тип) Тогда
			Ошибки.Добавить(СтрШаблон(
				НСтр("ru='Объект ""%1"" есть в плане обмена ИнтеграцияС1СДокументооборотомПереопределяемый, но отсутствует в типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.';uk='Об''єкт "" %1"" є в плані обміну ИнтеграцияС1СДокументооборотомПереопределяемый, але відсутня в типі ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.'"),
				ПолноеИмя));
		КонецЕсли;
	...
	Для Каждого ТипЗначения Из Метаданные.ОпределяемыеТипы.ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый.Тип.Типы() Цикл
		...
		Если Не Метаданные.ПланыОбмена.ИнтеграцияС1СДокументооборотомПереопределяемый.Состав.Содержит(ОбъектМетаданных) Тогда
			Ошибки.Добавить(СтрШаблон(
				НСтр("ru='Тип ""%1"" выбран в определяемом типе ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, но отсутствует в составе плана обмена ИнтеграцияС1СДокументооборотомПереопределяемый.';uk='Тип "" %1"" обраний в типі, що визначається ИнтеграцияС1СДокументооборотВсеСсылкиПереопределяемый, але відсутній в складі плану обміну ИнтеграцияС1СДокументооборотомПереопределяемый.'"),
				ТипЗначения));
		КонецЕсли;
