...
Функция УстановитьКоллекциюОтборовВФиксированныеНастройки(СвойстваВариантОтчета, СвойстваВариантаАнализа, ОписаниеВарианта)
	...
	Если ЗначениеЗаполнено(СвойстваВариантаАнализа.Ссылка.Владелец.СхемаКомпоновкиДанных)
		ИЛИ СвойстваВариантаАнализа.Ссылка.Владелец.ХранилищеСхемыКомпоновкиДанных.Получить() = Неопределено Тогда
		СхемаИНастройки = Справочники.СтруктураЦелей.ОписаниеИСхемаКомпоновкиДанныхЦелиПоИмениМакета(
			СвойстваВариантаАнализа.Ссылка.Владелец,
			СвойстваВариантаАнализа.Ссылка.Владелец.СхемаКомпоновкиДанных);
