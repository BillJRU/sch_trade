...
Функция ПравилаЗаполненияПоляТипЗаписи(ИмяДокументаДляОтбора = "") Экспорт
    ...
    Макет = РегистрыНакопления.СебестоимостьТоваров.ПолучитьМакет("UK_ПравилаЗаполненияРеквизитаТипЗаписи");
...
Функция УсловнаяПродажа(Знач НалоговоеНазначение, Знач КорНалоговоеНазначение) Экспорт
    
    ВидДеятельностиНДС      = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(НалоговоеНазначение, "ВидДеятельностиНДС");
    КорВидДеятельностиНДС   = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(КорНалоговоеНазначение, "ВидДеятельностиНДС");
    
    Если (ВидДеятельностиНДС = Перечисления.ВидыДеятельностиНДС.Необлагаемая 
            И КорВидДеятельностиНДС = Перечисления.ВидыДеятельностиНДС.Облагаемая)
        ИЛИ (НалоговоеНазначение = Справочники.НалоговыеНазначенияАктивовИЗатрат.НДС_НеоблагаемаяНеХозДеятельность
            И КорВидДеятельностиНДС = Перечисления.ВидыДеятельностиНДС.ПропорциональноОблагаемая)
...
Функция ВосстановлениеНДС(Знач НалоговоеНазначение, Знач КорНалоговоеНазначение) Экспорт
    
    ВидДеятельностиНДС      = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(НалоговоеНазначение, "ВидДеятельностиНДС");
    КорВидДеятельностиНДС   = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(КорНалоговоеНазначение, "ВидДеятельностиНДС");
    
    Если ВидДеятельностиНДС = Перечисления.ВидыДеятельностиНДС.Облагаемая 
        И КорВидДеятельностиНДС = Перечисления.ВидыДеятельностиНДС.Необлагаемая
...
#Область ИменаРегистров

Функция ИмяРегистраНакопленияСебестоимостьТоваров() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.СебестоимостьТоваров.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияВыручкаИСебестоимостьПродаж() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ВыручкаИСебестоимостьПродаж.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияПрочиеРасходы() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ПрочиеРасходы.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияПрочиеДоходы() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ПрочиеДоходы.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияПрочиеРасходыНезавершенногоПроизводства() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ПрочиеРасходыНезавершенногоПроизводства.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияДетализацияПартийТоваровДляНДС() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ДетализацияПартийТоваровДляНДС.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияДетализацияПартийТоваровДляНДС2_4() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ДетализацияПартийТоваровДляНДС2_4.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияДвиженияНоменклатураДоходыРасходы() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ДвиженияНоменклатураДоходыРасходы.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияДвиженияНоменклатураНоменклатура() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ДвиженияНоменклатураНоменклатура.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияПрочиеАктивыПассивы() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ПрочиеАктивыПассивы.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияРезервыПредстоящихРасходов() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.РезервыПредстоящихРасходов.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияФинансовыеРезультаты() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ФинансовыеРезультаты.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияЗакупки() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.Закупки.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияПартииПрочихРасходов() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.ПартииПрочихРасходов.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраНакопленияНДСУсловныеПродажи() Экспорт
    ИмяРегистра = Метаданные.РегистрыНакопления.НДСУсловныеПродажи.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ИмяРегистраСведенийСтоимостьТоваров() Экспорт
    ИмяРегистра = Метаданные.РегистрыСведений.СтоимостьТоваров.Имя;
    Возврат ИмяРегистра;
КонецФункции

Функция ЕстьИзмерениеИлиРеквизит(ИмяРегистраНакопления, ИмяИзмеренияИлиРеквизита) Экспорт
    
    МетаРегистр = Метаданные.РегистрыНакопления[ИмяРегистраНакопления];
	Если МетаРегистр.Реквизиты.Найти(ИмяИзмеренияИлиРеквизита) <> Неопределено
	 ИЛИ МетаРегистр.Измерения.Найти(ИмяИзмеренияИлиРеквизита) <> Неопределено Тогда
        Возврат Истина;
    КонецЕсли;
    Возврат Ложь;
