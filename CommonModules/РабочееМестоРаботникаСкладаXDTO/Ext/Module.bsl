...
Функция ТоварыЯчейкиПоШтрихкоду(Форма, Штрихкод) Экспорт
	...
	ПараметрыТоваровЯчейкиWS = Прокси.GetGoodsOfCellStoredByBarcode(Штрихкод, ИдСклада, ИдПомещения); // см. ПараметрыТоваровЯчейкиWS
...
//	ПараметрыЗадания - Структура,
//	ПараметрыЗаданияWS - см. РабочееМестоРаботникаСкладаПрограммныйИнтерфейс.ПараметрыЗадания
//	
...
//	Объект - ОбработкаОбъект.РабочееМестоРаботникаСклада,
//	ПараметрыЗадания - Структура,
//	ОтборРазмещенияТоваровWS - ДокументСсылка.ОтборРазмещениеТоваров - 
...
//	Объект - ОбработкаОбъект.РабочееМестоРаботникаСклада,
//	ПараметрыЗадания - Структура,
//	ПересчетТоваровWS - ДокументСсылка.ПересчетТоваров - 
...
//	Объект - ОбработкаОбъект.РабочееМестоРаботникаСклада,
//	ПараметрыЗадания - Структура,
//	ПриходныйОрдерНаТоварыWS - ДокументСсылка.ПриходныйОрдерНаТовары - 
...
//	Объект - ОбработкаОбъект.РабочееМестоРаботникаСклада,
//	ПараметрыЗадания - Структура,
//	РасходныйОрдерНаТоварыWS - ДокументСсылка.РасходныйОрдерНаТовары - 
...
// 		ДополнительныеПараметры - Структура, ЗначениеXDTO, Неопределено - содержит:
...
//
// Возвращаемое значение:
//	Структура - ПараметрыТоваровЯчейки XDTO-пакета WMSMobileClientExchange:
//		* Успешно - Булево
...
// Параметры:
//	СтрокаТоваров - СтрокаТаблицыЗначений,
//	ВидНоменклатурыWS - СправочникСсылка.ВидыНоменклатуры - 
...
// Параметры:
//	СтрокаТоваров - СтрокаТаблицыЗначений,
//	ЕдиницаИзмеренияWS - СправочникСсылка.УпаковкиЕдиницыИзмерения - 
...
// Параметры:
//	СтрокаТоваров - СтрокаТаблицыЗначений,
//	НоменклатураWS - СправочникСсылка.Номенклатура - 
...
//	ЯчейкаWS - СправочникСсылка.СкладскиеЯчейки - 
...
|;uk='Помилка підключення до вебсервісу.
|
...
|У параметрах з''єднання не вказаний користувач'");
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='Подключение к информационной базе';uk='Підключення до інформаційної бази'",КодОсновногоЯзыка),
...
|;uk='Помилка підключення до вебсервісу.
|
|Можливо не пройшла авторизація, вказано неправильну адресу вебсервісу 
|або інформаційна база не опублікована на вебсервері.
|
