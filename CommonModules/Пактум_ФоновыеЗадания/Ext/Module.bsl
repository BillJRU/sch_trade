...
Процедура ЗаполнитьКонтактнуюИнформацию(КонтрагентJSON, Реквизиты)
	...
	СтруктураКИ.КонтактнаяИнформация = УправлениеКонтактнойИнформациейСлужебныйВызовСервера.КонтактнаяИнформацияПоПредставлению(СтруктураКИ.Представление, Справочники.ВидыКонтактнойИнформации.ЮрАдресКонтрагента);
	Реквизиты.ЮридическийАдрес = СтруктураКИ;
    
    Телефоны = КонтрагентJSON.Phone;
	Телефоны = СтрЗаменить(Телефоны, "(", "");
	Телефоны = СтрЗаменить(Телефоны, ")", "");
	Телефоны = СтрЗаменить(Телефоны, "-", "");
	...
	Если ЗначениеЗаполнено(НомерТелефона) Тогда
        ...
        КИ.Представление = УправлениеКонтактнойИнформациейКлиентСервер.СформироватьПредставлениеТелефона(КодСтраны, 
