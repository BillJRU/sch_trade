...
Процедура ОбработатьПодтверждения(УчетнаяСистема, ДанныеПодтверждений)
    ...
    Для Каждого Подтверждение Из ДанныеПодтверждений[Словарь.ПолеРезультат()] Цикл
		...
		ДанныеПодтверждения.Вставить("ДополнительнаяИнформация");
		Подтверждение.Свойство(Словарь.ПолеДополнительнаяИнформация(), ДанныеПодтверждения.ДополнительнаяИнформация);
