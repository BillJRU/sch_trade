...
//
// Параметры:
//  ДеревоОперандов  - ДанныеФормыДерево    - Дерево, в котором два уровня, операнд получается посредством склеивания
//                                            идентификаторов строк верхнего и нижнего уровня.
//                                            см. ОбщаяФорма.КонструкторФормул.ДеревоОперандов
// 
// Возвращаемое значение:
