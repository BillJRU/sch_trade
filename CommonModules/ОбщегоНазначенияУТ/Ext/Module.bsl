...
// Параметры:
// 	МенеджерВременныхТаблиц - МенеджерВременныхТаблиц -
//	ВалютыДляПересчета - Структура - 
//  ИмяТаблицыТоваров - Строка - 
...
//							- Неопределено - если передана таблица значений, то проверяется она, иначе - Объект или ТЧ по ИмяТЧ
//
...
//  ПараметрыОкругления - см. ОбщегоНазначенияУТ.ПараметрыОкругленияКоличестваШтучныхТоваров -
