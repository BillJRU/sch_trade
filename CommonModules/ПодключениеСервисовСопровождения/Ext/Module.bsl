...
//
// Параметры:
//  Идентификаторы - Массив из Строка - содержит идентификаторы сервисов в системе Портал ИТС.
//
// Возвращаемое значение:
...
Функция ИмяСобытияЖурналаРегистрации()
	...
	Возврат НСтр("ru='Подключение тестовых периодов.';uk='Підключення тестових періодів.'",ОбщегоНазначения.КодОсновногоЯзыка());
