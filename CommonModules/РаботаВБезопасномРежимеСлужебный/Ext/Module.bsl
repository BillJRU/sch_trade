...
Функция КонтрольныеСуммыФайловКомплектаВнешнейКомпоненты(Знач ИмяМакета) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru='Работа в безопасном режиме.Не удалось удалить временный файл';uk='Робота в безпечному режимі.Не вдалося вилучити тимчасовий файл'",ОбщегоНазначения.КодОсновногоЯзыка()), 
...
Процедура ЗаполнитьРазрешенияНаЦентрЗащитыОбновлений(ЗапросыРазрешений)
	...
	Разрешение = РаботаВБезопасномРежиме.РазрешениеНаИспользованиеИнтернетРесурса("HTTPS", "1cv8update.eu",, 
		НСтр("ru='Сайт для проверки правомерности использования и обновления программного продукта.';uk='Сайт для перевірки правомірності використання та оновлення програмного продукту.'"));
