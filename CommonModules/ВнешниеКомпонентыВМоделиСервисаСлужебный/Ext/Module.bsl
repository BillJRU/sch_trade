...
Процедура ОбновитьОбщуюКомпоненту(ОписаниеКомпоненты) Экспорт
	...
	ЗаписьЖурналаРегистрации(НСтр("ru='Поставляемые внешние компоненты.Загрузка поставляемой компоненты';uk='Зовнішні компоненти, що постачаються.Завантаження компоненти, що постачається'",ОбщегоНазначения.КодОсновногоЯзыка()),
		...
		Если Не Информация.Разобрано Тогда 
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Поставляемую компоненту не удалось разобрать
                           |по причине:
                           |%1'
                           |;uk='Постачаєму компоненту не вдалося розібрати
                           |через:
                           |%1'"),
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Поставляемые внешние компоненты.Загрузка поставляемой компоненты';uk='Зовнішні компоненти, що постачаються.Завантаження компоненти, що постачається'",ОбщегоНазначения.КодОсновногоЯзыка()),
