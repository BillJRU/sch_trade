...
// версий внешних компонент из сервиса Портала ИТС. См функцию
...
//                    - "НетДоступаКПрограмме" - отсутствует доступ к программе на Портале ИТС;
...
//	СтрокаРезультат.Наименование  = "Сканеры штрихкода (NativeApi)";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если Не ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Обработчик.Комментарий         = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='%1. Обновление настроек получения внешних компонент.';uk='%1. Оновлення настройок отримання зовнішніх компонент.'"),
...
Процедура ОбновитьНастройкиПолучениеВнешнихКомпонент(Параметры) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru='Обновление настроек подсистемы ""Получение внешних компонент"". Начало обновления.';uk='Оновлення настройок підсистеми ""Отримання зовнішніх компонент"". Початок оновлення.'"),
		Ложь);
	
	ДобавитьРегламентноеЗаданиеОбновления();
	
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru='Обновление настроек подсистемы ""Получение внешних компонент"". Успешно завершено.';uk='Оновлення настройок підсистеми ""Отримання зовнішніх компонент"". Успішно завершено.'"),
		Ложь);
...
Процедура ДобавитьРегламентноеЗаданиеОбновления()
	...
	Если Не ОбщегоНазначения.РазделениеВключено()
		...
		Если ЗаданияОбновления.Количество() = 0 Тогда
			...
			ПараметрыЗадания.Вставить("Наименование",  НСтр("ru='Обновление внешних компонент';uk='Оновлення зовнішніх компонент'"));
			
			РегламентныеЗаданияСервер.ДобавитьЗадание(ПараметрыЗадания);
			
			ЗаписатьИнформациюВЖурналРегистрации(
				НСтр("ru='Создано регламентное задание обновления внешних компонент.';uk='Створено регламентне завдання оновлення зовнішніх компонент.'"),
				Ложь,
				Метаданные.РегламентныеЗадания.ОбновлениеВнешнихКомпонент);
		КонецЕсли;
...
Процедура УдалитьРегламентноеЗаданиеОбновления()
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru='Удалено регламентное задание обновления внешних компонент';uk='Вилучено регламентне завдання оновлення зовнішніх компонент'"),
		Ложь,
		Метаданные.РегламентныеЗадания.ОбновлениеВнешнихКомпонент);
...
Функция ИнформацияОбАктуальныхВерсияхВнешнихКомпонент(ОписаниеВнешнихКомпонент)
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Начало получения информации об актуальных версиях внешних компонент: %1';uk='Початок отримання інформації про актуальні версї зовнішніх компонент: %1'"),
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось получить актуальные версии внешних компонент.
                    ...
                    |%4'
                    |;uk='Не вдалося отримати актуальні версії зовнішніх компонент.
                    |
                    |%1
                    |
                    |Технічна інформація про помилку:
                    |При отриманні інформації про актуальні версії зовнішніх компонент сервіс повернув помилку.
                    |URL: %2
                    |Код помилки: %3
                    |Детальна інформація:
                    |%4'"),
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Завершено получение актуальных версий внешних компонент: %1';uk='Завершено отримання актуальних версій зовнішніх компонент: %1'"),
		СтрСоединить(Идентификаторы, ","));
...
Функция ИнформацияОВерсияхВнешнихКомпонент(ОписаниеВнешнихКомпонент)
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Начало получения информации о версиях внешних компонент: %1';uk='Початок отримання інформації про версії зовнішніх компонент: %1'"),
		СтрСоединить(Идентификаторы, ","));
		...
		РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось получить информацию о версиях внешних компонент.
                    ...
                    |Подробная информация:
                    |%3'
                    |;uk='Не вдалося отримати інформацію про версії зовнішніх компонент.
                    |
                    |При отриманні інформації про версії зовнішніх компонент сервіс повернув помилку
                    |
                    |Технічна інформація про помилку:
                    |При отриманні інформації про версії зовнішніх компонент сервіс повернув помилку.
                    |URL: %1
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Завершено получение версий внешних компонент: %1';uk='Завершено отримання версій зовнішніх компонент: %1'"),
		СтрСоединить(Идентификаторы, ","));
...
Процедура ОбработатьОтветСервиса(
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Получен ответ Сервиса внешних компонент:
            |%1'
            |;uk='Отримано відповідь Сервісу зовнішніх компонент:
            |%1'"),
		ТелоJSON);
			...
			ИначеЕсли ЧтениеОтвета.ТекущееЗначение = "errorCode" Тогда
				...
				Если ЗначениеЗаполнено(ОписательВерсии.КодОшибки) Тогда
					ТекстОшибки = ТекстОшибки + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='- при загрузке внешней компоненты %1 сервис вернул ошибку %2;';uk='- при завантаженні зовнішньої компоненти %1 сервіс повернув помилку %2;'"),
	...
	Если ЗначениеЗаполнено(ТекстОшибки) Тогда
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибки при получении информации о внешних компонентах:
                |%1'
                |;uk='Помилки при отриманні інформації про зовнішні компоненти:
                |%1'"),
			ТекстОшибки);
	...
	Для Каждого ОписательВерсии Из ДанныеВнешнихКомпонент Цикл
		Если Не ЗначениеЗаполнено(ОписательВерсии.Идентификатор) Тогда
			...
			СообщениеОбОшибке = НСтр("ru='Неверный формат ответа Сервиса внешних компонент.';uk='Невірний формат відповіді Сервісу зовнішніх компонент.'");
		...
		Если Прав(НРег(СокрЛП(СтруктураURI.Хост)), 6) <> Прав(НРег(СокрЛП(ХостСервиса)), 6) Тогда
			...
			СообщениеОбОшибке = НСтр("ru='Неверный адрес файла обновления внешней компоненты.';uk='Не правильна адреса файлу оновлення зовнішньої компоненти.'");
			ЗаписатьИнформациюВЖурналРегистрации(СообщениеОбОшибке);
			ВызватьИсключение СообщениеОбОшибке;
...
Процедура ЗагрузитьФайлыВнешнихКомпонент(РезультатОперации)
	...
	Для Каждого ОписаниеВнешнейКомпоненты Из РезультатОперации.ДанныеВнешнихКомпонент Цикл
		...
		ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Получение файла внешней компоненты: %1';uk='Отримання файлу зовнішньої компоненти: %1'"),
		...
		Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
			...
			РезультатОперации.СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Ошибка при получении файла внешней компоненты %1: 
                    |%2'
                    |;uk='Помилка при отриманні файлу зовнішньої компоненти %1:
                    |%2'"),
			...
			РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось получить файл внешней компоненты %1.
                    ...
                    |Подробная информация:
                    |%5'
                    |;uk='Не вдалося отримати файл зовнішньої компоненти %1.
                    |%2
                    |
                    |Технічна інформація про помилку:
                    |Під час завантаження файлу сервіс повернув помилку.
                    |Код помилки: %3.
                    |URL файлу: %4
                    |Детальна інформація:
                    |%5'"),
		...
		Если ОписаниеВнешнейКомпоненты.КонтрольнаяСумма <> КонтрольнаяСуммаФайл Тогда
			...
			РезультатОперации.СообщениеОбОшибке  = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Ошибка при получении файла внешней компоненты %1: 
                    ...
                    |%2'"),
				ОписаниеВнешнейКомпоненты.Идентификатор,
				НСтр("ru='Получен некорректный файл.';uk='Отримано некоректний файл.'"));
				
			РезультатОперации.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось получить файл внешней компоненты %1.
                    |Контрольная сумма полученного файла отличается от ожидаемой.'
                    |;uk='Не вдалося отримати файл зовнішньої компоненти %1.
                    |Контрольна сума отриманого файлу відрізняється від очікуваної.'"),
				ОписаниеВнешнейКомпоненты.Идентификатор);
...
Функция ПереопределитьСообщениеПользователю(КодОшибки)
	...
	Если КодОшибки = "НетДоступаКПрограмме" Тогда
		Возврат СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
			НСтр("ru='Доступ к обновлениям внешних компонент невозможен, так как ваша программа не находится на <a href = ""https://portal.bas-soft.eu/support/"">официальной поддержке</a>.';uk='Доступ до оновлень зовнішніх компонент неможливий, так як ваша програма не перебуває на <a href = ""https://portal.bas-soft.eu/support/"">офіційній підтримці</a>.'"));
	ИначеЕсли КодОшибки = "НеверныйЛогинИлиПароль" Тогда
		Возврат НСтр("ru='Ошибка авторизации на Портале ИТС.
            |Подробнее см. в журнале регистрации.'
            |;uk='Помилка авторизації на Порталі ІТС.
            |Детальніше див. в журналі реєстрації.'");
	ИначеЕсли КодОшибки = "ПревышеноКоличествоПопыток" Тогда
		Возврат НСтр("ru='Превышено количество попыток ввода логина и пароля.
            ...
            |Перевірте правильність даних авторизації і спробуйте
            |ще раз через 30 хвилин.'");
...
Функция ДанныеАутентификации()
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		ВызватьИсключение НСтр("ru='При работе в модели сервиса информация о внешних компонентах
            ...
            |;uk='При роботі в моделі сервісу інформація про зовнішні компоненти
            |завантажується з даних що поставляються.'");
	...
	Иначе
		...
		Если Результат.ДанныеАутентификации = Неопределено Тогда
			...
			Результат.ИнформацияОбОшибке =
				НСтр("ru='Для обновления внешних компонент необходимо подключить Интернет-поддержку пользователей.';uk='Для оновлення зовнішніх компонент необхідно підключити Інтернет-підтримку користувачів.'");
...
Процедура ПроверитьДоступностьЗагрузки()
	...
	Если Не ДоступнаЗагрузкаВнешнихКомпонент() Тогда
		ТекстИсключения = НСтр("ru='Получение внешних компонент недоступно при работе в модели сервиса.';uk='Отримання зовнішніх компонент недоступно при роботі в моделі сервісу.'");
...
Функция ПроверитьЗаполнениеДанныхВнешнихКомпонент(ОписаниеВнешнихКомпонент)
	...
	Для Каждого ОписаниеКомпоненты Из ОписаниеВнешнихКомпонент Цикл
		Если Не ЗначениеЗаполнено(ОписаниеКомпоненты.Идентификатор) Тогда
			СообщениеОбОшибке = НСтр("ru='В запросе на загрузку внешних компонент отсутствует индентификатор компоненты. Заполните идентификатор и повторите загрузку.';uk='У запиті на завантаження зовнішніх компонент відсутній індентіфікатор компоненти. Заповніть ідентифікатор і повторіть завантаження.'");
			Прервать;
		КонецЕсли;
	КонецЦикла;
...
Функция ИмяСобытияЖурналаРегистрации()
	...
	Возврат НСтр("ru='Получение внешних компонент.';uk='Отримання зовнішніх компонент.'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ЗначениеСвойстваJSON(ЧтениеОбъектаJSON, ЗначениеПоУмолчанию = Неопределено)
	...
	Иначе
		ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось прочитать значение свойства %1. Некорректный тип значения свойства (%2).';uk='Не вдалося розпізнати значення властивості %1. Некоректний тип значення властивості (%2).'"),
			ИмяСвойства,
