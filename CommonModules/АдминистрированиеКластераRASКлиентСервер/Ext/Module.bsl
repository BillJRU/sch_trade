	...
	Если Не ФайлКлиента.Существует() Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Невозможно выполнить операцию администрирования кластера серверов по причине: файл %1 не найден.
                  ...
                  |Для его установки:
                  |- Для компьютеров с ОС Windows требуется переустановить платформу, установив компонент ""Администрирование сервера BAF"";
                  ...
                  |Для його установки:
                  |- Для комп''ютерів з ОС Windows потрібно перевстановити платформу, встановивши компонент ""Адміністрування сервера BAF"";
