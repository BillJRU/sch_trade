...
Процедура АктОРасхожденияхСписокОбработатьПараметрОснования(Форма, ЭтоАктыОРасхожденияПослеОтгрузки) Экспорт
	...
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ОтгрузкаТоваровСХранения Тогда
		...
		Форма.Заголовок = НСтр("ru='Акты о расхождениях после отгрузки товаров с хранения';uk='Акти про розбіжності після відвантаження товарів зі зберігання'");
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "Партнер", "Заголовок", НСтр("ru='Поставщик';uk='Постачальник'"));
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Форма.Список, "СтатусИзменение", НСтр("ru='Изменение отгрузки';uk='Зміна відвантаження'"));
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы,"СпособОтраженияРасхождений", "Видимость", Ложь);
		
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаТоваровХранителю Тогда
		
		Форма.Заголовок = НСтр("ru='Акты о расхождениях после передачи товаров хранителю';uk='Акти про розбіжності після передачі товарів зберігачу'");
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "Партнер", "Заголовок", НСтр("ru='Партнер';uk='Партнер'"));
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Форма.Список, "СтатусИзменение", НСтр("ru='Изменение передачи';uk='Зміна передачі'"));
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы,"СпособОтраженияРасхождений", "Видимость", Ложь);
		
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
		
		Форма.Заголовок = НСтр("ru='Акты о расхождениях после приемки товаров с хранения';uk='Акти про розбіжності після приймання товарів з зберігання'");
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "Партнер", "Заголовок", НСтр("ru='Поставщик';uk='Постачальник'"));
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Форма.Список, "СтатусИзменение", НСтр("ru='Изменение приемки';uk='Зміна приймання'"));
...
//
// Параметры:
//  Элемент							 - ЭлементыФормы - Элемент формы "ДокументыОснованиеПредставление"
...
Процедура ЗаполнитьПоОснованиям(Форма, ВызыватьУправлениеДоступностью = Истина) Экспорт
	...
	Иначе
		...
		ИначеЕсли Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(Форма.Объект.ТипОснованияАктаОРасхождении) Тогда
			...
			|	ТоварыПередачи.СуммаНДС              КАК СуммаНДСПоДокументу,
			|	ТоварыПередачи.СуммаСНДС             КАК СуммаСНДСПоДокументу,
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПоступлениеТоваровОтХранителя(Форма.Объект.ТипОснованияАктаОРасхождении) Тогда
			...
			|	ТаблицаТовары.СуммаНДС            КАК СуммаНДСПоДокументу,
			|	ТаблицаТовары.СуммаСНДС           КАК СуммаСНДСПоДокументу,
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровСХранения(Форма.Объект.ТипОснованияАктаОРасхождении) Тогда
			...
			|	ОтгрузкаТоваровСХраненияТовары.СуммаНДС            КАК СуммаНДС,
			|	ОтгрузкаТоваровСХраненияТовары.СуммаСНДС           КАК СуммаСНДС,
			...
			|	ОтгрузкаТоваровСХраненияТовары.СуммаНДС            КАК СуммаНДСПоДокументу,
			|	ОтгрузкаТоваровСХраненияТовары.СуммаСНДС           КАК СуммаСНДСПоДокументу,
...
Процедура ОбработкаВыбораПодборНаСервере(Форма, КэшированныеЗначения, ВыбранноеЗначение, ЭтоАктОРасхожденияПослеОтгрузки) Экспорт
	...
	Для каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		СтруктураДействий.Вставить("ЗаполнитьСтавкуНДС",
 			Новый Структура("НалогообложениеНДС, Дата", Форма.НалогообложениеНДСПоУмолчанию, Форма.Объект.Дата));
...
Процедура УправлениеВидимостьюНДС(Форма) Экспорт
 	...
 	ВидимостьНалогообложениеНДС = УчетНДСУПКлиентСервер.ОтображатьНДСВИтогахДокументаПродажи(Форма.НалогообложениеНДСПоУмолчанию);
	...
	Иначе
		...
		Иначе
			...
			ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(Форма.Объект.ТипОснованияАктаОРасхождении) Тогда
				...
				ТекстПредставление = ТекстПредставление + " " + НСтр("ru='передач';uk='передач'");
			...
			ИначеЕсли РасхожденияКлиентСервер.ТипОснованияВозвратПоставщику(Форма.Объект.ТипОснованияАктаОРасхождении) Тогда
				...
				ТекстПредставление = ТекстПредставление + " " + НСтр("ru='отгрузок';uk='відвантажень'");
				
			ИначеЕсли Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриобретениеТоваровУслуг
				Или Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя
				Или Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
...
Процедура ИзменитьОснованиеАкта(АктОРасхождениях, Основание, ТаблицаИзменяемыхСтрок, ТаблицаИзменяемыхСерий)
	...
	Если ДокументОснование.Товары.Количество() = 0 Тогда
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='После изменения в документе %1 будут отсутствовать товары. Документ переоформлен не будет.';uk='Після зміни в документі %1 будуть відсутні товари. Документ переоформлений не буде.'"), 
...
Функция  ШапкаАктаИОснованиеСоответствуют(РезультатЗапросаПоШапке, АктОРасхождениях, Основание) 
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки")
		...
		ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ОтгрузкаТоваровСХранения") Тогда
			...
			Если Не РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровСХранения(ВыборкаАкт.ТипОснованияАктаОРасхождении) Тогда
				Возврат Ложь;
			КонецЕсли;
		...
		ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ПриемкаТоваровНаХранение") Тогда
			...
			Если ВыборкаАкт.ТипОснованияАктаОРасхождении <> Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
				Возврат Ложь;
			КонецЕсли;
...
Функция ТекстЗапросаПоШапкеПоступлениеТоваровОтХранителя(Основание)
	...
	|	ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратОтХранителя)      КАК ХозяйственнаяОперация,
...
Функция ТекстЗапросаТабличныеЧастиАктаОРасхожденияхПослеОтгрузкиИОтгрузкиСХранения(АктОРасхождениях, Основание, СтруктураВозврата, ИзменениеДокумента)
	...
	|	ОтгрузкаТоваровСХраненияТовары.СтавкаНДС,
	...
	|				И АктОРасхожденияхПослеОтгрузкиТовары.СтавкаНДС = ОтгрузкаТоваровСХраненияТовары.СтавкаНДС
	...
	|				И ОтгрузкаТоваровСХраненияТовары.СтавкаНДС = АктОРасхожденияхПослеОтгрузкиТовары.СтавкаНДС
	...
	|	ТоварыСостояния.СтавкаНДС                        КАК СтавкаНДС,
...
Функция ТекстЗапросаТабличныеЧастиАктаОРасхожденияхПослеОтгрузкиИПередачиХранителю(АктОРасхождениях,
	...
	|				И АктОРасхожденияхПослеОтгрузкиТовары.СтавкаНДС = ПередачаТоваров.СтавкаНДС
...
Функция ТекстЗапросаТабличныеЧастиАктаОРасхожденияхПослеПриемкиИПриемкиТоваровНаХранение(АктОРасхождениях, Основание, СтруктураВозврата, ИзменениеДокумента)
	...
	|	ПриемкаТоваровНаХранениеТовары.НоменклатураПоставщика,
	...
	|				И АктОРасхожденияхТовары.НоменклатураПоставщика = ПриемкаТоваровНаХранениеТовары.НоменклатураПоставщика
	...
	|				И ПриемкаТоваровНаХранениеТовары.НоменклатураПоставщика = АктОРасхожденияхТовары.НоменклатураПоставщика
	...
	|ВЫБРАТЬ
	|	ТоварыСостояния.Номенклатура                     КАК Номенклатура,
	|	ТоварыСостояния.НоменклатураПоставщика           КАК НоменклатураПоставщика,
	|	ТоварыСостояния.Характеристика                   КАК Характеристика,
	|	ТоварыСостояния.Назначение                       КАК Назначение,
	|	ТоварыСостояния.Упаковка                         КАК Упаковка,
	|	ЕСТЬNULL(&ТекстЗапросаКоэффициентУпаковки, 1)    КАК КоэффициентУпаковки,
...
Процедура СообщитьОшибкиДобавленияИзлишкаВНакладную(Акт, СтрокиСОшибками, ИмяПоляЗаказ, ИменаПолейУникальности, Отказ)
	...
	Для Каждого Строка Из СтрокиСОшибками Цикл
		...
		Если НайденныеСтроки.Количество() > 0 Тогда
			СтрокаНакладной = НайденныеСтроки[0]; // СтрокаТабличнойЧасти
		Иначе
			Продолжить;
		КонецЕсли;
