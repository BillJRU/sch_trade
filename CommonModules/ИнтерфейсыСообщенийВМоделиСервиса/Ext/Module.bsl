...
//  Массив Из Строка - номера поддерживаемых версий в формате РР.{П|ПП}.ЗЗ.СС.
//
...
Функция ВерсияИнтерфейсаКорреспондента(Знач ИнтерфейсСообщения, Знач ПараметрыПодключения, Знач ПредставлениеПолучателя, Знач ИнтерфейсТекущейИБ = "") Экспорт
	...
	ИнтеграцияПодсистемБТС.ПриОпределенииВерсииИнтерфейсаКорреспондента(
			ИнтерфейсСообщения,
...
//
// Возвращаемое значение:
//  Массив Из ТипОбъектаXDTO - типы сообщений найденные в пакете.
//
...
Функция ПолучитьОбработчикиИнтерфейсовОтправляемыхСообщений() Экспорт
	...
	ИнтеграцияПодсистемБТС.РегистрацияИнтерфейсовОтправляемыхСообщений(МассивОбработчиков);
...
Функция ПолучитьОбработчикиИнтерфейсовПринимаемыхСообщений() Экспорт
	...
	ИнтеграцияПодсистемБТС.РегистрацияИнтерфейсовПринимаемыхСообщений(МассивОбработчиков);
...
//  ВерсииКорреспондента - Массив Из Строка - версии интерфейса-сообщений,
