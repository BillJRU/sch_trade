...
Функция ПодставитьДомен(Текст, Знач ДоменнаяЗона = Неопределено) Экспорт
	...
	Результат = СтрЗаменить(Текст, "webits-info@"+Символ(49)+Символ(99)+Символ(46)+Символ(114)+Символ(117), "webits-info@bas-soft.eu");
	Результат = СтрЗаменить(Результат, "webits-info@"+Символ(49)+Символ(99)+Символ(46)+Символ(117)+Символ(97), "webits-info@bas-soft.eu");
	Результат = СтрЗаменить(Результат, "webits-info@"+Символ(49)+Символ(99)+Символ(46)+Символ(101)+Символ(117), "webits-info@bas-soft.eu");
	Результат = СтрЗаменить(Результат, Символ(46)+Символ(49)+Символ(99)+Символ(46)+Символ(114)+Символ(117), ".bas-soft.eu");
	Результат = СтрЗаменить(Результат, Символ(46)+Символ(49)+Символ(99)+Символ(46)+Символ(117)+Символ(97), ".bas-soft.eu");
	Результат = СтрЗаменить(Результат, Символ(46)+Символ(49)+Символ(99)+Символ(46)+Символ(101)+Символ(117), ".bas-soft.eu");
	Возврат Результат;
