...
Функция СформироватьСписокПолучателейРассылки(Знач ПараметрыПолучателей) Экспорт
	...
	ПараметрыЖурнала.ИмяСобытия   = НСтр("ru='Рассылка отчетов. Формирование списка получателей';uk='Розсилка звітів. Формування списку одержувачів'",ОбщегоНазначения.КодОсновногоЯзыка());
