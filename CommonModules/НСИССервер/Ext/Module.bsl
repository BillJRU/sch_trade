...
//Сдвиг времени старта задания на случайное количество минут, для балансировки нагрузки сервера
//
Процедура ПервичнаяНастройкаРасписания() Экспорт
	...
	Сдвиг = ГСЧ.СлучайноеЧисло(0, 15);
	
	Сдвиг = Сдвиг * ?(ГСЧ.СлучайноеЧисло(0, 1) = 0, -1, 1);
	
	РЗ = РегламентныеЗадания.НайтиПредопределенное("НСИСОбновлениеДанных");
	РЗ.Расписание.ВремяНачала = РЗ.Расписание.ВремяНачала + Сдвиг*60;
	РЗ.Записать();
