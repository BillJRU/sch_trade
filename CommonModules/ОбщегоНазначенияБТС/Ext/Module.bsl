...
Процедура ЗаписьТехнологическогоЖурнала(Событие, Контекст) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='ЗаписьТехнологическогоЖурнала';uk='ЗаписьТехнологическогоЖурнала'",ОбщегоНазначения.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
