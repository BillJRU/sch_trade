...
// в качестве параметров ОписаниеИсходнойВерсии и ОписаниеРезультирующейВерсии процедуры НайтиЦепочкиТрансляции().
//
// Параметры:
...
//  Структура:
//  * Номер - Строка - номер версии сообщения.
//  * Пакет - Строка - пространство имен версии сообщения.
//
...
//
// Возвращаемое значение:
//   Строка - представление версии интерфейса.
//
...
//
// Параметры:
//  ОбработчикиТрансляции - ТаблицаЗначений - см. СформироватьТаблицуОбработчиковТрансляции(), 
...
//      обработчиков в таблице трансляции.
//    Поля структуры:
//    * Номер - Строка - результирующая версия сообщения в формате РР.{П|ПП}.ЗЗ.СС,
//    * Пакет - Строка - пространство имен результирующей версии сообщения,
...
//  ТекущаяЦепочка - Соответствие - служебный параметр, используемый при рекурсивном выполнении процедуры,
