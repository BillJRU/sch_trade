...
Функция ПредставлениеВремени(Знач Время, ПолноеПредставление = Истина, ВыводитьСекунды = Истина) Экспорт
	...
	ПредставлениеНедель = НСтр("ru=';%1 неделю;;%1 недели;%1 недель;%1 недели';uk=';%1 тиждень;;%1 тижня;%1 тижнів;%1 тижня'");
	ПредставлениеДней   = НСтр("ru=';%1 день;;%1 дня;%1 дней;%1 дня';uk=';%1 день;;%1 дня;%1 днів;%1 дня'");
	...
	ПредставлениеСекунд = НСтр("ru=';%1 секунду;;%1 секунды;%1 секунд;%1 секунды';uk=';%1 секунду;;%1 секунди;%1 секунд;%1 секунди'");
...
Функция ЗаменитьЕдиницуИзмеренияНаМножитель(Знач Единица)
	...
	ДопустимыеСимволы = "абвгдеёжзийклмнопрстуфхцчшщъыьэюяіїє";
	...
	СловоформыНедели = СтрРазделить("тиж,т,нед,н", ",", Ложь);
	СловоформыДня = СтрРазделить("ден,дні,дня,дн,д,дне", ",", Ложь);
	СловоформыЧаса = СтрРазделить("год,г,час,ч", ",", Ложь);
	СловоформыМинуты = СтрРазделить("хви,х,мин,м", ",", Ложь);
	СловоформыСекунды = СтрРазделить("сек,с", ",", Ложь); 
