...
#Область ЗаголовокПротокола
	...
	Если БылиОшибки Тогда
		...
		Протокол.ДобавитьСтроку(НСтр("ru='ВНИМАНИЕ !';uk='УВАГА !'",ОбщегоНазначения.КодОсновногоЯзыка()));
		Протокол.ДобавитьСтроку(ПредставлениеОшибокРасчета(
			ПротоколРасчета,
			НСтр("ru='В ходе расчета были диагностированы ошибки:';uk='В ході розрахунку були діагностовані помилки:'",ОбщегоНазначения.КодОсновногоЯзыка()),
			Символы.ПС + "	- "));
		Протокол.ДобавитьСтроку(НСтр("ru='Подробное описание ошибок можно найти (Ctrl-F) в тексте протокола по символу ""!"".';uk='Детальний опис помилок можна знайти (Ctrl-F) у тексті протоколу за символом ""!"".'",ОбщегоНазначения.КодОсновногоЯзыка()));
		
		Если БылиОшибкиДвижений ИЛИ БылиОшибкиЗаписи Тогда
			Протокол.ДобавитьСтроку(НСтр("ru='Расчет завершился аварийно.';uk='Розрахунок завершився аварійно.'",ОбщегоНазначения.КодОсновногоЯзыка()));
		КонецЕсли;
	...
	Протокол.ДобавитьСтроку(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Протокол расчета (идентификатор %1)';uk='Протокол розрахунку (ідентифікатор %1)'",ОбщегоНазначения.КодОсновногоЯзыка()),
		ПротоколРасчета.Идентификатор));
	Протокол.ДобавитьСтроку(НСтр("ru='Платформа:';uk='Платформа:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + СистемнаяИнформация.ВерсияПриложения);
	Протокол.ДобавитьСтроку(НСтр("ru='Конфигурация:';uk='Конфігурація:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + ПредставлениеЗначения(Метаданные.Имя)
		+ ", " + НСтр("ru='версия:';uk='версія:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + ПредставлениеЗначения(Метаданные.Версия));
	Протокол.ДобавитьСтроку(НСтр("ru='Информационная база:';uk='Інформаційна база:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " 
		+ ПредставлениеЗначения(ПараметрыРасчета.СтрокаСоединенияИБ));
	Протокол.ДобавитьСтроку(НСтр("ru='Начало расчета:';uk='Початок розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + ПредставлениеЗначения(ПротоколРасчета.ДатаНачала)
		+ ", " + НСтр("ru='длительность:';uk='тривалість:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + ПредставлениеЗначения(ПротоколРасчета.Длительность));
	Протокол.ДобавитьСтроку(НСтр("ru='Место вызова расчета:';uk='Місце виклику розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " 
		+ ПредставлениеЗначения(ПараметрыРасчета.МестоВызоваРасчета));
	
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(НСтр("ru='Вариант расчета:';uk='Варіант розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " 
		+ ПредставлениеЗначения(ПараметрыРасчета.ВариантРасчета));
	Протокол.ДобавитьСтроку(НСтр("ru='Период расчета:';uk='Період розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
	...
	Протокол.ДобавитьСтроку(НСтр("ru='Организации для расчета:';uk='Організації для розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()));
	Для Каждого ТекущаяОрганизация Из ОрганизацииДляПротокола Цикл
		Протокол.ДобавитьСтроку("	- "	+ ПредставлениеЗначения(ТекущаяОрганизация)
			+ ", " + НСтр("ru='метод оценки стоимости:';uk='метод оцінки вартості:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " 
	...
	Если ЗначениеЗаполнено(ПараметрыРасчета.ИзмененоДокументов) Тогда
		Протокол.ДобавитьСтроку(НСтр("ru='Изменено документов в ИБ после прошлого расчета:';uk='Змінено документів в ІБ після минулого розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
			+ ПредставлениеЗначения(ПараметрыРасчета.ИзмененоДокументов));
	КонецЕсли;
	
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
	Протокол.ДобавитьСтроку(НСтр("ru='Функциональные опции, влияющие на результат расчета:';uk='Функціональні опції, що впливають на результат розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
	Протокол.ДобавитьСтроку(НСтр("ru='Технологические параметры расчета:';uk='Технологічні параметри розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()));
	Протокол.ДобавитьСтроку("");
	...
	Для Каждого ТекущаяГруппа Из ОписаниеГруппПараметров Цикл
		...
		Для Каждого ТекущийПараметр Из ПараметрыГруппы Цикл
			...
			Если ТекущееЗначениеПараметра <> ТекущийПараметр.ЗначениеПоУмолчанию Тогда
				ДополнениеКОписанию = "; (" + НСтр("ru='значение по умолчанию';uk='значення по умовчанню'",ОбщегоНазначения.КодОсновногоЯзыка()) + ": "
	...
	Если ПараметрыРасчета.Свойство("Движения") Тогда
		...
		Протокол.ДобавитьСтроку("");
		Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
		Протокол.ДобавитьСтроку(НСтр("ru='Обслуживаемые регистры:';uk='Регістри, що обслуговуються:'",ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		Для Каждого ОписаниеРегистра Из ПараметрыРасчета.Движения Цикл
			Протокол.ДобавитьСтроку("	- " + ОписаниеРегистра.Значение.ПолноеИмяРегистра
				+ ?(ПараметрыРасчета.РегистрыСРасчетнымиОборотами.Свойство(ОписаниеРегистра.Ключ),
					" (" + НСтр("ru='кэш оборотов';uk='кеш оборотів'",ОбщегоНазначения.КодОсновногоЯзыка()) + ")", "")
				+ ?(ПараметрыРасчета.РегистрыСРасчетнымиОстатками.Свойство(ОписаниеРегистра.Ключ),
					" (" + НСтр("ru='кэш остатков';uk='кеш залишків'",ОбщегоНазначения.КодОсновногоЯзыка()) + ")", ""));
		КонецЦикла;
...
#Область ЭтапыРасчета
	...
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
	Протокол.ДобавитьСтроку(НСтр("ru='Протокол выполнения этапов расчета:';uk='Протокол виконання етапів розрахунку:'",ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Для Каждого ОписаниеЭтапа Из ПротоколРасчета.Этапы Цикл
		...
		Протокол.ДобавитьСтроку(НСтр("ru='Начало этапа:';uk='Початок етапу:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + ПредставлениеЗначения(ОписаниеЭтапа.ДатаНачала)
			+ ", " + НСтр("ru='длительность:';uk='тривалість:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " " + ПредставлениеВремениВыполнения(ОписаниеЭтапа, ПротоколРасчета));
		
		Если ЗначениеЗаполнено(ОписаниеЭтапа.СформированныеДвижения) Тогда
			Протокол.ДобавитьСтроку(НСтр("ru='Сформированы движения по регистрам (всего / уникальных):';uk='Сформовані рухи по регістрах (всього / унікальних):'",ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		Если ЗначениеЗаполнено(ОписаниеЭтапа.СформированныеСтрокиВТ) Тогда
			Протокол.ДобавитьСтроку(НСтр("ru='Сформированы строки вспомогательных временных таблиц (всего / уникальных):';uk='Сформовано рядки допоміжних тимчасових таблиць (усього / унікальних):'",ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		Если ЗначениеЗаполнено(ОписаниеЭтапа.ВременныеТаблицы) Тогда
			...
			Протокол.ДобавитьСтроку(НСтр("ru='Сформированы временные таблицы (размер / время (% времени этапа) / уточнение / исходные таблицы):';uk='Сформовані тимчасові таблиці (розмір / час (% часу етапу) / уточнення / вихідні таблиці):'",ОбщегоНазначения.КодОсновногоЯзыка()));
			...
			Если ЗначениеЗаполнено(ВремяФормированияВсехТаблиц.ОбщееВремя) Тогда
				Протокол.ДобавитьСтроку(НСтр("ru='Общее время формирования таблиц:';uk='Загальний час формування таблиць:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
		...
		Если ЗначениеЗаполнено(ОписаниеЭтапа.ЗамерыВыполненияКода) Тогда
			...
			Протокол.ДобавитьСтроку(НСтр("ru='Выполнены замеры фрагментов кода (время (% времени этапа) / уточнение):';uk='Виконано виміри фрагментів коду (час (% часу етапу) / уточнення):'",ОбщегоНазначения.КодОсновногоЯзыка()));
			...
			Протокол.ДобавитьСтроку(НСтр("ru='Общее время замеров выполнения кода:';uk='Загальний час замірів виконання коду:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
		...
		Если ЗначениеЗаполнено(ОписаниеЭтапа.ДополнительнаяИнформация) Тогда
			...
			Протокол.ДобавитьСтроку(" ");
			Протокол.ДобавитьСтроку(НСтр("ru='Дополнительная информация об этапе:';uk='Додаткова інформація про етап:'",ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		Если ЗначениеЗаполнено(ОписаниеЭтапа.ИнформацияОбОшибках) Тогда
			ВывестиИнформациюОбОшибках(
				...
				НСтр("ru='При выполнении этапа расчета обнаружены ошибки';uk='При виконанні етапу розрахунку виявлені помилки'",ОбщегоНазначения.КодОсновногоЯзыка()),
...
#Область ИтоговыеПоказатели
	...
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
	Протокол.ДобавитьСтроку(НСтр("ru='Итоговая информация о длительности этапов (абсолютная (относительная)):';uk='Підсумкова інформація про тривалість етапів (абсолютна (відносна)):'",ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Для Каждого ОписаниеЭтапа Из ПротоколРасчета.Этапы Цикл
		...
		НоваяСтрока.Этап = НСтр("ru='Этап';uk='Етап'",ОбщегоНазначения.КодОсновногоЯзыка()) + " №" + СокрЛП(Счетчик) + ". " + ОписаниеЭтапа.ПредставлениеЭтапа;
	...
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(НСтр("ru='ТОП-10 самых длительных этапов:';uk='ТОП-10 найбільш тривалих етапів:'",ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
	Протокол.ДобавитьСтроку(НСтр("ru='Итоговая информация о сформированных движениях по регистрам (всего / уникальных):';uk='Підсумкова інформація про сформовані рухи по регістрах (всього / унікальних):'",ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	Если ЗначениеЗаполнено(ПротоколРасчета.СформированныеДвижения) Тогда
		Для Каждого ОписаниеДвижений Из ПротоколРасчета.СформированныеДвижения Цикл
			...
			Если ОписаниеДвижений.Значение.Ошибочных > 0 Тогда
				...
				Протокол.ДобавитьСтроку("		- " + НСтр("ru='в т.ч. ошибочных:';uk='в т. ч. помилкових:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
		...
		КонецЦикла;
	Иначе
		Протокол.ДобавитьСтроку(НСтр("ru='Нет сформированных движений.';uk='Немає сформованих рухів.'",ОбщегоНазначения.КодОсновногоЯзыка()));
	КонецЕсли;
	...
	Если БылиОшибкиДвижений Тогда
		ВывестиИнформациюОбОшибках(
			...
			НСтр("ru='Формирование движений выполнено с ошибками';uk='Формування рухів виконано з помилками'",ОбщегоНазначения.КодОсновногоЯзыка()));
	КонецЕсли;
	
	// Записанные движения
	Протокол.ДобавитьСтроку("");
	Протокол.ДобавитьСтроку(РазделительЧастейПротокола());
	Протокол.ДобавитьСтроку(НСтр("ru='Итоговая информация о записанных движениях по регистрам (документов / записей / время записи):';uk='Підсумкова інформація про записані рухи по регістрах (документів / записів / час запису):'",ОбщегоНазначения.КодОсновногоЯзыка())); // количество записей - с учетом "первичных"
	...
	Если ПараметрыРасчета.ОбщееКоличествоФЗЗаписи > 0 Тогда
		...
		Протокол.ДобавитьСтроку("");
		Протокол.ДобавитьСтроку(НСтр("ru='Всего запущено фоновых заданий записи движений:';uk='Всього запущено фонових завдань запису рухів:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
	...
	Если НЕ БылиОшибкиЗаписи Тогда
		...
		Если ЗначениеЗаполнено(ПротоколРасчета.СформированныеДвижения)
		 И ПротоколРасчета.ЗаписьДвижений.Свойство("СформированныеДвижения") Тогда
			...
			Если КоличествоЗаписей > 0 Тогда
				Протокол.ДобавитьСтроку(НСтр("ru='Всего записано движений по регистрам:';uk='Всього записано рухів по регістрах:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
		...
		Если КоличествоЗаписей = 0 Тогда
			Протокол.ДобавитьСтроку(НСтр("ru='Запись движений не выполнялась - нет измененных движений.';uk='Запис рухів не виконувався - немає змінених рухів.'",ОбщегоНазначения.КодОсновногоЯзыка()));
		КонецЕсли;
	...
	Иначе
		ВывестиИнформациюОбОшибках(
			...
			НСтр("ru='Запись движений выполнена с ошибками';uk='Запис рухів виконано з помилками'",ОбщегоНазначения.КодОсновногоЯзыка()));
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ПротоколРасчета.ЗаписьДвижений) Тогда
		Протокол.ДобавитьСтроку("");
		Протокол.ДобавитьСтроку(НСтр("ru='Длительность операций записи:';uk='Тривалість операцій запису:'",ОбщегоНазначения.КодОсновногоЯзыка()) + " "
...
|Докладніше див. у Журналі реєстрації'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура НачалоЭтапаРасчета(ПараметрыРасчета, ПредставлениеЭтапа, УровеньЭтапа = 1) Экспорт
	...
	ПолноеПредставлениеЭтапа =
		?(ПараметрыРасчета.ИдетРасчетПартий, НСтр("ru='Партионный учет';uk='Партіонний облік'",ОбщегоНазначения.КодОсновногоЯзыка()), НСтр("ru='Расчет себестоимости';uk='Розрахунок собівартості'",ОбщегоНазначения.КодОсновногоЯзыка()))
		+ ": " + ПредставлениеЭтапа;
...
Процедура ОкончаниеВыполненияФрагментаКода(ПараметрыРасчета, КоличествоДанныхДляЗамераПроизводительности = 0) Экспорт
	...
	ПротоколРасчета 	= ПараметрыРасчета.ПротоколРасчета; // см. РасчетСебестоимостиПротоколРасчета.ИнициализироватьПротоколРасчета 
	ОписаниеЭтапа 		= ОписаниеТекущегоЭтапа(ПараметрыРасчета);
	ОписаниеЗамера		= ПротоколРасчета.ВыполнениеФрагментаКода.Получить(ПротоколРасчета.ВыполнениеФрагментаКода.Количество() - 1); // см. РасчетСебестоимостиПротоколРасчета.ИнициализироватьОписаниеВыполненияФрагментаКода
...
Процедура ОтметкаВЖурналеРегистрации(ПараметрыРасчета, ПредставлениеЭтапа, Уровень = Неопределено, Комментарий = "")
	...
	Если НЕ ЗначениеЗаполнено(Комментарий) Тогда
		Комментарий = НСтр("ru='Начало выполнения этапа.';uk='Початок виконання етапу.'",ОбщегоНазначения.КодОсновногоЯзыка());
	КонецЕсли;
	
	ЗаписьЖурналаРегистрации(
		РасчетСебестоимостиПрикладныеАлгоритмы.ИмяСобытияЖурналаРегистрации(
			ПараметрыРасчета, НСтр("ru='Этап';uk='Етап'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()) + "." + ПредставлениеЭтапа),
		Уровень,
		,
		,
		Комментарий);
...
Функция ПредставлениеПериодаРасчета(ПараметрыРасчетаИлиПериод) Экспорт
    ...
    Возврат Формат(Дата, НСтр("ru='Л=ru; ДФ=''ММММ гггг''';uk='Л=uk; ДФ=''ММММ гггг'''", ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ПредставлениеЗначения(Значение, ПредставлениеДатыКакПериодРасчета = Ложь) Экспорт
	...
	Если ТипЗнч(Значение) = Тип("Булево") Тогда
		...
		Возврат Формат(Значение, НСтр("ru='БЛ=Нет; БИ=Да';uk='БЛ=Ні; БИ=Так'",ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	ИначеЕсли ТипЗнч(Значение) = Тип("ПеречислениеСсылка.МетодыОценкиСтоимостиТоваров") Тогда
		...
		Если НЕ ЗначениеЗаполнено(Значение) Тогда
			Возврат "<" + НСтр("ru='Не используется';uk='Не використовується'",ОбщегоНазначения.КодОсновногоЯзыка()) + ">";
		КонецЕсли;
		
	ИначеЕсли ТипЗнч(Значение) = Тип("ПеречислениеСсылка.ТипыЗаписейПартий") Тогда
		
		Если НЕ ЗначениеЗаполнено(Значение) Тогда
			Возврат "<" + НСтр("ru='Пустой тип записи партии';uk='Порожній тип запису партії'",ОбщегоНазначения.КодОсновногоЯзыка()) + ">";
		КонецЕсли;
...
Функция ПредставлениеВремени(Значение, СДолямиСекунд = Истина) Экспорт
	...
	ПредставлениеВремени = ""
		+ ?(Часы = 0, "", ПредставлениеЗначения(Часы) + " " + НСтр("ru='ч.';uk='год.'",ОбщегоНазначения.КодОсновногоЯзыка()) + " ")
		+ ?(Минуты = 0, "", ПредставлениеЗначения(Минуты) + " " + НСтр("ru='мин.';uk='хв.'",ОбщегоНазначения.КодОсновногоЯзыка()) + " ")
		+ ПредставлениеЗначения(Секунды) + " " + НСтр("ru='сек.';uk='сек.'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция ПредставлениеОшибокРасчета(ПротоколРасчета, Заголовок = Неопределено, Разделитель = Неопределено)
	...
	Если Заголовок = Неопределено Тогда
		Заголовок = НСтр("ru='Обнаружены ошибки';uk='Виявлено помилки'",ОбщегоНазначения.КодОсновногоЯзыка());
	КонецЕсли;
    ...
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВИсходныхДанныхДляРасчета,
        НСтр("ru='в исходных данных для расчета';uk='у вихідних даних для розрахунку'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаИнициализацииПараметровРасчета,
        НСтр("ru='при инициализации параметров расчета';uk='при ініціалізації параметрів розрахунку'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВУчетныхПолитикахОрганизаций,
        НСтр("ru='в учетных политиках организаций';uk='в облікових політиках організацій'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВосстановленияДвиженийДокументов,
        НСтр("ru='при восстановлении движений документов';uk='при відновленні рухів документів'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаИнициализацииДокументовРасчетаСебестоимости,
        НСтр("ru='при инициализации документов расчета себестоимости';uk='при ініціалізації документів розрахунку собівартості'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаРаспределенияПартий,
        НСтр("ru='при распределении партий';uk='при розподілі партій'",ОбщегоНазначения.КодОсновногоЯзыка()));
	ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаКорректировкиНалоговогоНазначенияКапитальныхИнвестиций,
	    НСтр("ru='при корректировке налоговых назначений капитальных инвестиций';uk='при коригуванні податкових призначень капітальних інвестицій'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВыполненияРегламентныхОпераций,
        НСтр("ru='при выполнении связанных регламентных операций закрытия месяца';uk='при виконанні пов''язаних регламентних операцій закриття місяця'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаФормированияДвиженийПоРегистрам,
        НСтр("ru='при формировании движений по регистрам';uk='при формуванні рухів по регістрах'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаЗаписиДвиженийПоРегистрам,
        НСтр("ru='при записи движений по регистрам';uk='при запису рухів по регістрах'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВОстаткахПослеРасчета,
        НСтр("ru='в остатках после расчета';uk='в залишках після розрахунку'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВремениВыполнения,
        НСтр("ru='при выполнения кода (run-time error)';uk='при виконанні коду (run-time error)'",ОбщегоНазначения.КодОсновногоЯзыка()));
    ТипыОшибок.Вставить(Перечисления.ТипыОшибокПартионногоУчетаИСебестоимости.ОшибкаВНачальныхОстаткахПУ22,
        НСтр("ru='в начальных остатках при переходе на партионный учет версии 2.5';uk='в початкових залишках при переході на партіонний облік версії 2.5'",ОбщегоНазначения.КодОсновногоЯзыка()));
...
Функция ЗаголовокПротоколаПриВыводе(ПериодРасчета) Экспорт
	...
	ТекстЗаголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Протокол расчета периода %1';uk='Протокол розрахунку періоду %1'",ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура ВывестиИнформациюОбОшибках(ПараметрыРасчета, Протокол, ДанныеОшибок, Заголовок, ПредставлениеЭтапа = Неопределено)
	...
	Для Каждого КлючИЗначение Из СоответствиеОшибок Цикл
		...
		Если СоответствиеОшибок.Количество() > 1 Тогда
			...
			ОписаниеОшибок = ОписаниеОшибок + ?(ОписаниеОшибок = "", "", "
				|") + НСтр("ru='Тип ошибки';uk='Тип помилки'",ОбщегоНазначения.КодОсновногоЯзыка()) + ": """ + ПредставлениеЗначения(КлючИЗначение.Ключ) + """.";
		КонецЕсли;
	...
	ОписаниеОшибок =
		Заголовок
		+ ?(НомерОшибки > 0,  " (" + ПредставлениеЗначения(НомерОшибки) + " " + НСтр("ru='шт.';uk='шт.'",ОбщегоНазначения.КодОсновногоЯзыка()) + ")", "")
