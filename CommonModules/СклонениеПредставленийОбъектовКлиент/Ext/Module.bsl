...
|;uk='Метод СклонениеПредставленийОбъектовКлиент.ПриИзмененииПредставления більш не підтримується.
|Замість нього слід використовувати СклонениеПредставленийОбъектовКлиент.ПросклонятьПредставление'");
...
|%1'
|;uk='Не вдалося виконати відмінювання за відмінками через: %1'"), Результат.КраткоеПредставлениеОшибки);
