...
//
// Параметры:
//   Объект - ДанныеФормыСтруктура, Структура - документ, для которого необходимо осуществлять проверку.
...
//
// Параметры:
//	Объект              - ДанныеФормыСтруктура, Структура - документ, для выдачи сообщения об ошибках
...
Процедура ОповеститьОбОкончанииЗаполненияДатПоступления(ДатаПоступления, ЗаполнениеВыделенныхСтрок) Экспорт
	...
	Если ЗаполнениеВыделенныхСтрок Тогда
		...
		ПоказатьОповещениеПользователя(
			...
			,
			СтрЗаменить(НСтр("ru='Для выделенных строк установлена дата поступления %ДатаПоступления%';uk='Для виділених рядків встановлена дата надходження %ДатаПоступления%'"), "%ДатаПоступления%", Формат(ДатаПоступления, "ДЛФ=D")),
			БиблиотекаКартинок.Информация32);
	...
	Иначе
		...
		ПоказатьОповещениеПользователя(
			НСтр("ru='Дата поступления заполнена';uk='Дата надходження заповнена'"),
			,
			СтрЗаменить(НСтр("ru='Для всех строк установлена дата поступления %ДатаПоступления%';uk='Для всіх рядків встановлена дата надходження %ДатаПоступления%'"), "%ДатаПоступления%", Формат(ДатаПоступления, "ДЛФ=D")),
			БиблиотекаКартинок.Информация32);
...
Процедура ОткрытьОтчетПоДинамикеЦенПоставщика(Форма) Экспорт
	...
	ПараметрыФормы.Вставить("КлючНазначенияИспользования", НСтр("ru='Динамика изменения цен по номенклатуре (Диаграмма)';uk='Динаміка зміни цін по номенклатурі (Діаграма)'"));
	ПараметрыФормы.Вставить("КлючВарианта", НСтр("ru='Динамика изменения цен по номенклатуре (Диаграмма)';uk='Динаміка зміни цін по номенклатурі (Діаграма)'"));
