...
// Определяет версию приложения платформы BAF, которая требуется для работы автономного рабочего
...
//
// Параметры:
//	Версия - Строка - Версия требуемого приложения платформы BAF в формате
