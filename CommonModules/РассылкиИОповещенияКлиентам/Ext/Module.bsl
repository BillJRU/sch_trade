...
Процедура ФормированиеСообщенийПоОповещениямКлиентов() Экспорт
	...
	ТекстЗаписи = НСтр("ru='Начало формирования сообщений по очереди оповещений для клиентов';uk='Початок формування сповіщень за чергою сповіщень для клієнтів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ОтменитьТранзакцию();
			ТекстЗаписи = НСтр("ru='Ошибка при формировании сообщений по оповещениям клиентов';uk='Помилка при формуванні повідомлень за сповіщеннями клієнтів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()) + " : ";
...
|;uk='Коли це можливо, сповіщення буде відправлено контактній особі, вказаній в об''єкті, що є 
|джерелом сповіщення. Наприклад, сповіщення зі зміни становища ""Замовлення клієнта"" буде 
|послано контактній особі, вказаній в документі.'");
...
Функция ТаблицаПараметровСообщения(СтрокаДанныхШаблона, ДанныеШаблона, ДанныеТипаСобытия)
	...
	СоответствиеПараметровТекстаСообщения = СоответствиеПараметровСообщения(ДанныеШаблона);
	...
	СоответствиеОбщихРеквизитов = СоответствиеПараметровТекстаСообщения[ИмяУзлаОбщихРеквизитов];
