...
Функция АрхивСИнформациейДляТехПоддержки(КонтекстОперации, ТехническаяИнформация)
	...
	Для каждого Ошибка Из КонтекстОперации.Диагностика.Ошибки Цикл
		МассивПредставленийОшибок.Добавить(СтрШаблон(НСтр("ru='Вид операции: %1';uk='Вид операції: %1'"), Ошибка.ВидОперации));
		МассивПредставленийОшибок.Добавить(СтрШаблон(НСтр("ru='Краткое представление ошибки: %1';uk='Короткий опис помилки: %1'"),
			Ошибка.КраткоеПредставлениеОшибки));
		МассивПредставленийОшибок.Добавить(СтрШаблон(НСтр("ru='Подробное представление ошибки: %1';uk='Детальний опис помилки: %1'"),
			Ошибка.ПодробноеПредставлениеОшибки));
		МассивПредставленийОшибок.Добавить(Символы.ПС);
	КонецЦикла;
	
	Текст = Текст + Символы.ПС + НСтр("ru='Ошибки:';uk='Помилки:'")
