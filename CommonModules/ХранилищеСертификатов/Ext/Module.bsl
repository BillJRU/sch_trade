...
Процедура ЗарегистрироватьОбработчикиОбновления(Знач Обработчики) Экспорт
	...
	Обработчик.Версия 			= "1.2.2.25";
	Обработчик.МонопольныйРежим = Ложь;
	Обработчик.ОбщиеДанные      = Ложь;
	Обработчик.Процедура 		= "ХранилищеСертификатов.УдалитьРольДобавлениеИзменениеСертификатовВХранилище";
	Обработчик.РежимВыполнения 	= "Оперативно";
	
КонецПроцедуры

// Удаляет роль ДобавлениеИзменениеСертификатовВХранилище из всех профилей, в которые она входит.
Процедура УдалитьРольДобавлениеИзменениеСертификатовВХранилище() Экспорт
    ...
    ЗаменяемыеРоли.Вставить("? ДобавлениеИзменениеСертификатовВХранилище", НовыеРоли);
...
Функция ИмяСобытияУдалениеФайла()
	...
	Возврат НСтр("ru='Хранилище сертификатов.Удаление файла';uk='Сховище сертифікатів.Вилучення файлу'",ОбщегоНазначения.КодОсновногоЯзыка());
