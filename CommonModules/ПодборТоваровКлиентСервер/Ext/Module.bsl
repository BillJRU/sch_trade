...
Процедура УстановитьТекстИнформационнойНадписи(Форма) Экспорт
	...
	ФорматнаяСтрока = НСтр("ru='Л = ru_RU; НП = Истина; НД = Ложь; ДП = Ложь';uk='Л = uk_UA; НП = Истина; НД = Ложь; ДП = Ложь'");
	
	Сумма = Формат(Корзина.Итог("Сумма"), "ЧДЦ=2; ЧН=");
	Количество = НРег(ЧислоПрописью(Корзина.Количество(), ФорматнаяСтрока, НСтр("ru='позиция,позиции,позиций,ж,,,,,0';uk='позиція,позиції,позицій,ж,,,,,0'")));
