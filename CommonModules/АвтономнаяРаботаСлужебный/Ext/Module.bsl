...
Функция СобытиеЖурналаРегистрацииСозданиеАвтономногоРабочегоМеста() Экспорт
	...
	Возврат НСтр("ru='Автономная работа.Создание автономного рабочего места';uk='Автономна робота.Створення автономного робочого місця'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Функция СобытиеЖурналаРегистрацииУдалениеАвтономногоРабочегоМеста() Экспорт
	...
	Возврат НСтр("ru='Автономная работа.Удаление автономного рабочего места';uk='Автономна робота.Вилучення автономного робочого місця'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура СинхронизироватьДанныеСПриложениемВИнтернете() Экспорт
	...
	Если Не ЭтоАвтономноеРабочееМесто() Тогда
		...
		ПодробноеПредставлениеОшибкиДляЖурналаРегистрации =
			НСтр("ru='Эта информационная база не является автономным рабочим местом. Синхронизация данных отменена.';uk='Ця інформаційна база не є автономним робочим місцем. Синхронізація даних скасована.'",ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ВыполнитьНастройкуАвтономногоРабочегоМестаПриПервомЗапуске() Экспорт
	...
	Если Не ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
		ВызватьИсключение НСтр("ru='Первый запуск автономного рабочего места должен выполняться в файловой информационной базе.';uk='Перший запуск автономного робочого місця повинен виконуватися в файлової інформаційній базі.'");
	КонецЕсли;
...
Функция СобытиеЖурналаРегистрацииСинхронизацияДанных()
	...
	Возврат НСтр("ru='Автономная работа.Синхронизация данных';uk='Автономна робота.Синхронізація даних'",ОбщегоНазначения.КодОсновногоЯзыка());
