...
Функция ЗафиксироватьДлительностьКлючевыхОпераций(ЗамерыДляЗаписи) Экспорт
	...
	Если НаборЗаписейТехнологический.Количество() > 0 Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru='Не удалось сохранить технологические замеры производительности';uk='Не вдалося зберегти технологічні заміри продуктивності'",ОценкаПроизводительностиСлужебный.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
    КонецЕсли;
