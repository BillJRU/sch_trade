...
|;uk='Для комплектуючої в рядку %НомерСтроки% списку ""Товари"" ведеться облік по ВМД.
|Такі позиції неприпустимі, якщо для  комплекту що розбирається не ведеться облік по ВМД.'");
...
Функция ПроверитьИзменениеРеквизитовДокументаСписание(МенеджерВременныхТаблиц)
 	...
 	ИменаРеквизитов = "Организация, Дата, Склад, Статус, НалоговоеНазначение";
