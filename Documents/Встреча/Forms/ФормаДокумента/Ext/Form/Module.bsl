...
Процедура ВремяОкончанияПриИзменении(Элемент)
	...
	Если НачалоДня(Объект.ДатаОкончания) + ВыделитьВремя(ВремяОкончания) < Объект.ДатаНачала Тогда
		ОчиститьСообщения();
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Время окончания не может быть меньше времени начала.';uk='Час закінчення не може бути менше часу початку.'"),,"ВремяОкончания");
...
Процедура ДатаОкончанияПриИзменении(Элемент)
	...
	Если НачалоДня(ДатаОкончания) + ВыделитьВремя(ВремяОкончания) < Объект.ДатаНачала Тогда
		...
		Если НачалоДня(ДатаОкончания) < НачалоДня(ДатаНачала) Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Дата окончания не может быть меньше даты начала.';uk='Дата закінчення не може бути менша дати початку.'"),,"ДатаОкончания");
		Иначе
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Время окончания не может быть меньше времени начала.';uk='Час закінчення не може бути менше часу початку.'"),,"ВремяОкончания");
		КонецЕсли;
