...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Пока Выборка.Следующий() Цикл
		...
		НоваяСтрока.ПредставлениеДокументаЗакупки = СтрШаблон(" %1 " + НСтр("ru='от %2';uk='від %2'"), Выборка.Номер, Формат(Выборка.Дата, "ДЛФ=D"));
	КонецЦикла;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<Мультивалютный>';uk='<Мультивалютний>'"));
...
Функция ВыборкаДокументовЗакупки(Параметры)
	...
	|ГДЕ
	|	ДанныеДокумента.Проведен = ИСТИНА
	|
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|	И ДанныеДокумента.Проведен = ИСТИНА
	|
	|";
