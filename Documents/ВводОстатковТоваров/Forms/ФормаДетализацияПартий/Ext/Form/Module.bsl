...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЗавершениеРаботы И Модифицированность Тогда
		Отказ = Истина;
		ТекстПредупреждения = НСтр("ru='Данные не были перенесены в ввод остатков. После закрытия, сделанные изменения сохранены не будут.';uk='Дані не були перенесені в введення залишків. Після закриття, зроблені зміни збережені не будуть.'");
		Возврат;
	КонецЕсли;
