...
Процедура ЗагрузитьИзВнешнегоФайла(Команда)
	...
	ПараметрыЗагрузки.НалогообложениеНДС = ?(Объект.НалоговоеНазначение = ПредопределенноеЗначение("Справочник.НалоговыеНазначенияАктивовИЗатрат.НДС_Облагаемая"), 
...
Процедура УстановитьВидимость()
	...
	Элементы.СобственныеТоварыУказатьДокументыПоступления.Видимость = Ложь;
	...
	ВидимостьРеквизитовСумм = Объект.ОтражатьСебестоимость 
		Или Объект.ОтражатьВБУиНУ Или Объект.ОтражатьВУУ;
	...
	Элементы.СобственныеТоварыСуммаНДС.Видимость        = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр;
	Элементы.СобственныеТоварыСуммаСНДС.Видимость       = ВидимостьРеквизитовСумм;
	Элементы.СобственныеТоварыСуммаРегл.Видимость       = ВидимостьРеквизитовСумм;
	Элементы.СобственныеТоварыНДСРегл.Видимость         = ВидимостьРеквизитовСумм;
	Элементы.СобственныеТоварыЦенаВключаетНДС.Видимость = ВидимостьРеквизитовСумм;
	...
	Элементы.СобственныеТоварыУказатьДокументыПоступления.Видимость = Истина;
	Элементы.СобственныеТоварыДетализацияПартий.Видимость           = Истина;
...
Процедура ЗаполнитьОстаткамиТоваровНаПустомПомещенииСервер()
	...
	НоменклатураСервер.ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВКоллекции(Объект.Товары,
		СтруктураДействийПоОбновлениюВспомогательныхРеквизитовСтроки());
...
&НаКлиентеНаСервереБезКонтекста
Функция СтруктураДействийПоОбновлениюВспомогательныхРеквизитовСтроки()
