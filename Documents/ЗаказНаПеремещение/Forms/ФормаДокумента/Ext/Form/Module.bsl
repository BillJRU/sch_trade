...
Процедура ОбработкаВыбораПодборНаСервере(ВыбранноеЗначение)
	...
	ОбеспечениеСервер.ЗаполнитьСлужебныеРеквизиты(
		Объект.Товары, ПараметрыЗаполнения, ДатаОтгрузкиОбязательна, СкладОбязателен);
...
Процедура УстановитьВидимостьЭлементовИспользованияДлительности()
	...
	Если Объект.ИспользоватьДлительностьПеремещения Тогда
		Элементы.ТоварыНачалоОтгрузки.Заголовок = НСтр("ru='Начало отгрузки';uk='Початок відвантаження'");
	Иначе
		Элементы.ТоварыНачалоОтгрузки.Заголовок = НСтр("ru='Дата отгрузки';uk='Дата відвантаження'");
	КонецЕсли;
