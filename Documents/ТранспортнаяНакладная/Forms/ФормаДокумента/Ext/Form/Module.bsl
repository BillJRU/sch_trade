...
&НаКлиенте
Процедура АвтомобильМассаПриИзменении(Элемент)
	РассчитатьОбщуюМассу(Объект);
КонецПроцедуры
...
Процедура ПерезаполнитьМассыПоДокументамОснованиям(Команда)
	Если Объект.ДокументыОснования.Количество() = 0 Тогда
		ТекстСообщения = НСтр("ru='Перед выполнением команды необходимо заполнить список документов-оснований.';uk='Перед виконанням команди необхідно заповнити список документів-підстав.'");
...
Процедура ЗаполнитьСпискиВыбораВодителейИТС()
	...
	|	ТранспортнаяНакладная.ДолжностьВодителя КАК ДолжностьВодителя, 
	...
	|	ТранспортнаяНакладная.ДолжностьВодителя, 
	...
	|	ТранспортнаяНакладная.АвтомобильМасса КАК АвтомобильМасса,
	|	ТранспортнаяНакладная.АвтомобильВместимостьВКубическихМетрах КАК АвтомобильВместимостьВКубическихМетрах,
	|	ТранспортнаяНакладная.АвтомобильДлина КАК АвтомобильДлина,
	|	ТранспортнаяНакладная.АвтомобильШирина КАК АвтомобильШирина,
	|	ТранспортнаяНакладная.АвтомобильВысота КАК АвтомобильВысота,
	...
	|	ТранспортнаяНакладная.АвтомобильМасса,
	|	ТранспортнаяНакладная.АвтомобильВместимостьВКубическихМетрах,
	|	ТранспортнаяНакладная.АвтомобильДлина,
	|	ТранспортнаяНакладная.АвтомобильШирина,
	|	ТранспортнаяНакладная.АвтомобильВысота,
	...
	Пока РезультатЗапроса.Следующий() Цикл
		ИнформацияТранспортногоСредства = Новый Структура("АвтомобильГосударственныйНомер, АвтомобильМарка, АвтомобильТип,
															...
															|АвтомобильМасса, 
															|АвтомобильДлина, АвтомобильШирина, АвтомобильВысота,
...
Процедура ЗаполнитьСписокВыбораМестоСоставленияДокумента()
	...
	|	ТранспортнаяНакладная.МестоСоставленияДокумента КАК МестоСоставленияДокумента,
	|	ТранспортнаяНакладная.МоментВремени КАК МоментВремени
	|ИЗ
	|	Документ.ТранспортнаяНакладная КАК ТранспортнаяНакладная
	|ГДЕ
	|	ТранспортнаяНакладная.Организация = &Организация
	|	И ТранспортнаяНакладная.МестоСоставленияДокумента <> """"
	|	И ТранспортнаяНакладная.Проведен = ИСТИНА
	|
	|УПОРЯДОЧИТЬ ПО
	|	ТранспортнаяНакладная.МоментВремени УБЫВ";
	...
	Пока РезультатЗапроса.Следующий() Цикл
		Элементы.МестоСоставленияДокумента.СписокВыбора.Добавить(СокрЛП(РезультатЗапроса.МестоСоставленияДокумента));
	КонецЦикла;
...
Процедура РассчитатьОбщуюМассу(Объект)
	...
	Объект.АвтомобильОбщаяМасса = Объект.АвтомобильМасса + Объект.МассаБрутто / 1000;
