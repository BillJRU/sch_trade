...
// по одному документу-основанию, то кэшированные значения обновлятся. Если по нескольким, то действие зависит от того, 
...
Функция ТекстТТН(Форма) Экспорт
	...
	Если СпособыДоставкиПоЗаданиюНаПеревозку.Найти(СпособДоставки) = Неопределено
		...
		Иначе
			ЧастиФорматированнойСтроки.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='Оформить ТТН';uk='Оформити ТТН'"),,,,"ОформитьТТН"));
		КонецЕсли;
	...
	СокращенноеНазваниеНакладной  = НСтр("ru='ТТН';uk='ТТН'");
	...
	Если КоличествоКорректныхНакладных = 1 Тогда
		...
		ПредставлениеТТН = ОбщегоНазначенияУТКлиентСервер.СформироватьЗаголовокДокумента(ШапкаНакладной, СокращенноеНазваниеНакладной, МультиязычностьУкр.КодЯзыкаИнтерфейса());
...
Функция СформироватьГиперссылкуСмТакжеВРаботе(Параметры) Экспорт
	...
	ТекстГиперссылки = НСтр("ru='ТТН';uk='ТТН'");
...
Функция ПроверитьДокументыОснования(ПроверяемыеОбъекты, ВыделенныеСтрокиАдресов = Неопределено, ВыдаватьСообщения = Истина) Экспорт
	...
	ИначеЕсли ТипЗнч(ПроверяемыеОбъекты) = Тип("ДокументОбъект.ТранспортнаяНакладная") Тогда
		...
		ПроверяемаяНакладная = ПроверяемыеОбъекты;	
	Иначе
		ТекстИсключения = НСтр("ru='Неподдерживаемый тип параметра ПроверяемыеОбъекты';uk='Непідтримуваний тип параметра ПроверяемыеОбъекты'");
	...
	Если ПроверкаСоставаТранспортнойНакладной Тогда
		ШаблонСообщенияНакладнаяСпособДоставки = НСтр("ru='Документ ""%Документ%"" со способом доставки ""%СпособДоставки%"" может быть добавлен только в транспортную накладную по заданию на перевозку.';uk='Документ ""%Документ%"" зі способом доставки ""%СпособДоставки%"" може бути доданий тільки в транспортну накладну за завданням на перевезення.'");
		ШаблонСообщенияЗаказСпособДоставки     = НСтр("ru='В заказе, по которому создан документ ""%Документ%"" указан способ доставки ""%СпособДоставки%"". Документ может быть добавлен только в транспортную накладную по заданию на перевозку.';uk='У замовленні, за яким створено документ ""%Документ%"" зазначений спосіб доставки ""%СпособДоставки%"". Документ може бути доданий тільки в транспортну накладну за завданням на перевезення.'");
	Иначе	
		ШаблонСообщенияНакладнаяСпособДоставки = НСтр("ru='По документу ""%Документ%"" не сформированы транспортные накладные, при этом указан способ доставки ""%СпособДоставки%"". Транспортные накладные нужно сформировать из задания на перевозку.';uk='За документом ""%Документ%"" не сформовані транспортні накладні, при цьому зазначений спосіб доставки ""%СпособДоставки%"". Транспортні накладні потрібно сформувати з завдання на перевезення.'");
		ШаблонСообщенияЗаказСпособДоставки     = НСтр("ru='По документу ""%Документ%"" не сформированы транспортные накладные, при этом в заказе, по которому создан этот документ указан способ доставки ""%СпособДоставки%"". Транспортные накладные нужно сформировать из задания на перевозку.';uk='За документом ""%Документ%"" не сформовані транспортні накладні, при цьому в замовленні, за яким створено цей документ зазначений спосіб доставки ""%СпособДоставки%"". Транспортні накладні потрібно сформувати з завдання на перевезення.'");
	КонецЕсли;
	
	ШаблонСообщенияНетТоваров              = НСтр("ru='В документе ""%Документ%"" нет номенклатуры с типом ""Товар"" или ""Многооборотная тара"". Создание и печать транспортных накладных по этому документу не требуется.';uk='У документі ""%Документ%"" немає номенклатури з типом ""Товар""; або ""Багатооборотна тара"". Створення та друк транспортних накладних за цим документом не потрібні.'");
	ШаблонСообщенияОснованиеНеПроведен     = НСтр("ru='Документ ""%Документ%"" не проведен. Создание и печать транспортных накладных по этому документу не возможна.';uk='Документ ""%Документ%"" не проведений. Створення та друк транспортних накладних з цього документу не можливе.'");
		...
		Для Каждого СтрМас Из Результат.ОбъектыПоКоторымСоздаватьТранспортныеНакладныеНельзя Цикл
			...
			Для Каждого СтрМас Из НайденныеСтроки Цикл
				...
				Если ИндексЗадания <> Неопределено Тогда
					...
					Если ВыдаватьСообщения Тогда
						ТекстСообщения = НСтр("ru='Из-за проблем в оформлении документов-оснований транспортные накладные по заданию на перевозку ""%ЗаданиеНаПеревозку%"" не формировались.';uk='Через проблеми в оформленні документів-підстав транспортні накладні за завданням на перевезення ""%ЗаданиеНаПеревозку%"" не формувалися.'");
...
//
Функция СоздатьТранспортныеНакладные(МассивОбъектов, ВыделенныеСтрокиАдресов = Неопределено, ТранспортнаяНакладнаяОбъект = Неопределено) Экспорт
	...
	Если МассивОбъектов.Количество() > 1
		...
		ТекстИсключения = НСтр("ru='В режиме, когда нужно заполнить переданный объект транспортной накладной, может быть передан только один документ-основание.';uk='У режимі, коли потрібно заповнити переданий об''єкт транспортної накладної, може бути переданий тільки один документ-підстава.'");
		ВызватьИсключение ТекстИсключения;
	КонецЕсли;
	...
	Пока Выборка.Следующий() Цикл
		...
		ТранспортнаяНакладнаяОбъект.АвтомобильОбщаяМасса = ТранспортнаяНакладнаяОбъект.АвтомобильМасса + ТранспортнаяНакладнаяОбъект.МассаБрутто/1000;	
...
Функция ОбъектыКоторыеМожноПечатать(МассивОбъектов) Экспорт
	...
	Для Каждого СтрМас Из РезультатПроверки.ОбъектыПоКоторымМожноИНужноСоздатьТранспортныеНакладные Цикл
		...
		ТекстСообщения = НСтр("ru='По документу %Документ% транспортная накладная не напечатана: необходимо сначала создать документ ""Транспортная накладная"".';uk='За документом %Документ% транспортна накладна не надрукована: необхідно спочатку створити документ ""Транспортна накладна"".'");
	...
	Для Каждого СтрМас Из РезультатПроверки.ОбъектыПоКоторымСоздаватьТранспортныеНакладныеНельзя Цикл
		...
		ТекстСообщения = НСтр("ru='По документу %Документ% транспортная накладная не напечатана: не создан документ ""Транспортная накладная"" и его не возможно создать.';uk='За документом %Документ% транспортна накладна не надрукована: не створений документ ""Транспортна накладна"" і його не можливо створити.'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Документ%", СтрМас);
		ОбщегоНазначения.СообщитьПользователю(ТекстСообщения, СтрМас); 
...
Процедура ЗаписатьТранспортнуюНакладнуюПриСоздании(СозданныеТранспортныеНакладные, ТранспортнаяНакладнаяОбъект)
	...
	Если ТранспортнаяНакладнаяОбъект <> Неопределено Тогда
		...
		Если ТранспортнаяНакладнаяОбъект.ПометкаУдаления Тогда
			ТекстИсключения = НСтр("ru='Документ, на основании которого создается транспортная накладная, помечен на удаление. Создание транспортных накладных по помеченным на удаление документам не поддерживается.';uk='Документ, на підставі якого створюється транспортна накладна, позначена на вилучення. Створення транспортних накладних за позначеними на вилучення документами не підтримується.'");
			ВызватьИсключение ТекстИсключения;
		КонецЕсли;
...
Функция СформироватьПечатнуюФормуТТН(МассивОбъектов, ОбъектыПечати, ПараметрыПечати) Экспорт
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.ДолжностьВодителя КАК ДолжностьВодителя,
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильДлина КАК Длина,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильШирина КАК Ширина,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильВысота КАК Высота,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильОбщаяМассаТекст КАК ОбщаяМассаТекст,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильОбщаяМасса КАК ОбщаяМасса,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.МестоСоставленияДокумента КАК МестоСоставления,
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.ВыводитьМассуБруттоПрописьюПолностью КАК ВыводитьМассуБруттоПрописьюПолностью,
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.ДолжностьВодителя,
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильДлина,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильШирина,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильВысота,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильОбщаяМассаТекст,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.АвтомобильОбщаяМасса,
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.МестоСоставленияДокумента,
	...
	|	ТаблицаТранспортныхНакладных.ТранспортнаяНакладная.ВыводитьМассуБруттоПрописьюПолностью,
	...
	|		КОГДА &ВыводитьБазовыеЕдиницыИзмерения
	|			ТОГДА ТаблицаТоваров.КоличествоУпаковок
	|		ИНАЧЕ ЕСТЬNULL(ТаблицаТоваров.Количество / КоэффициентыУпаковок.КоэффициентВложеннойУпаковки, ТаблицаТоваров.КоличествоУпаковок)
...
Функция ПредставлениеНакладной(ДокументСсылка)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		...
		НазваниеДокумента, НомерНаПечать, Формат(ДанныеДокумента.Дата, "ДЛФ=D;Л="+МультиязычностьУкр.ОпределитьКодЯзыкаДляФормат(КодЯзыкаПечать)));
...
Процедура ЗаполнитьНомераНакладныхВСтрокеТовараТТН(ДанныеПечати, ВыборкаНомеровТН, ДанныеСтроки, ОбластьМакета, После2014)		
	...
	Пока ВыборкаНомеровТН.НайтиСледующий(СтруктураПоиска) Цикл
		...
		ПредставленияНакладных.Добавить(ОбщегоНазначенияУТКлиентСервер.СформироватьЗаголовокДокумента(СтруктураШапки,,"uk"));
	КонецЦикла;
...
Процедура ЗаполнитьТабличныйДокументТТН(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Если ДанныеПечати.Дата < Дата("20140114") Тогда
			Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ТранспортнаяНакладная.ПФ_MXL_UK_ТТН");
			НоваяФорма = Ложь;
		ИначеЕсли ДанныеПечати.Дата < Дата("20180910") Тогда
			Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ТранспортнаяНакладная.ПФ_MXL_UK_ТТН_2014");
			НоваяФорма = Истина;
		ИначеЕсли ДанныеПечати.Дата < Дата("20190712") Тогда
			Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ТранспортнаяНакладная.ПФ_MXL_UK_ТТН_2018");
			НоваяФорма = Истина;
		ИначеЕсли ИспользоватьПечатнуюФормуТТН_2024(ДанныеПечати.Дата) Тогда
			Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ТранспортнаяНакладная.ПФ_MXL_UK_ТТН_2024");
			НоваяФорма = Истина;
		Иначе
			Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ТранспортнаяНакладная.ПФ_MXL_UK_ТТН_2019");
			НоваяФорма = Истина;
		КонецЕсли;
...
Функция ПоляЗаполняемыеПоЗаданиямНаПеревозку()
	...
	ПоляЗаполняемыеПоЗаданиямНаПеревозку.Вставить("ДолжностьВодителя",                        "ДолжностьВодителя");
	...
	ПоляЗаполняемыеПоЗаданиямНаПеревозку.Вставить("АвтомобильМасса",        		  		  "АвтомобильМасса");
	ПоляЗаполняемыеПоЗаданиямНаПеревозку.Вставить("АвтомобильДлина",        				  "АвтомобильДлина");
	ПоляЗаполняемыеПоЗаданиямНаПеревозку.Вставить("АвтомобильШирина",        				  "АвтомобильШирина");
	ПоляЗаполняемыеПоЗаданиямНаПеревозку.Вставить("АвтомобильВысота",        				  "АвтомобильВысота");
...
Функция ПодготовитьПечатьТТНиТН(МенеджерВременныхТаблиц, МассивОбъектов)
	...
	Для Каждого КлючЗначение Из ТипыОбъектов Цикл
		...
		Если ТипДокументов = Тип("ДокументСсылка.ЗаданиеНаПеревозку") Тогда
			...
			ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ОснованияДляВычисленияТранспортныхНакладных, 
														РезультатЗапроса[РезультатЗапроса.ВГраница() - 1].Выгрузить().ВыгрузитьКолонку("Накладная"));
	...
	Если ОснованияДляВычисленияТранспортныхНакладных.Количество() > 0 Тогда
		...
		Для Каждого СтрМас Из ОснованияДляВычисленияТранспортныхНакладных Цикл
			...
			Если ДокументыОснованияТранспортныеНакладные.Найти(СтрМас, "ДокументОснование") = Неопределено Тогда
				ТекстСообщения = НСтр("ru='Для документа %ДокументОснование% не создана транспортная накладная. Печать транспортной накладной невозможна.';uk='Для документа %ДокументОснование% не створена транспортна накладна. Друк транспортної накладної неможливий.'");
	...
	Если ТранспортныеНакладныеДляПечати.Количество() = 0 Тогда
		ТекстИсключения = НСтр("ru='Нет транспортных накладных для печати.';uk='Немає транспортних накладних для друку.'");
		ВызватьИсключение ТекстИсключения;
	КонецЕсли;
...
Функция ТекстЗапросаВыборкиТранспортныхНакладныхПоДокументуОснованию(ПараметрыФормированияТранспортныхНакладных, ПолноеИмяДокумента, ВернутьЗапросДляВычисленияПриЗаписи, ЕстьСпособДоставки)
	...
	СвойстваКоторыеОбязательноДолжныСовпадать =
		"Организация,Грузоотправитель,Грузополучатель,ПометкаУдаления,Проведен";
...
Функция ТекстВТМассыИзОснований(ТипыОбъектов, Запрос) Экспорт
	...
	Для Каждого КлючЗначение Из ТипыОбъектов Цикл
		...
		|	ДокументТовары.Ссылка КАК Ссылка " +
		?(ЭтоПервыйТипОснования, "ПОМЕСТИТЬ МассыИзОснований", "") + "
		|ИЗ
		|	" + ПолноеИмяОснования + "." + ПараметрыФормированияТранспортныхНакладных.ИмяТЧТовары + " КАК ДокументТовары
		|ГДЕ
		|	ДокументТовары.Ссылка В(&МассивОбъектов)
		...
		ТекстВыборкиМассы = СтрЗаменить(ТекстВыборкиМассы,
										"&МассивОбъектов",
		...
		ТекстыВыборкиМассы.Добавить(ТекстВыборкиМассы);
	...
	ТекстВыборкиМассы = СтрСоединить(ТекстыВыборкиМассы, ОбщегоНазначенияУТ.РазделительЗапросовВОбъединении());
...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	//++ Локализация
		+ "Документ.ТранспортнаяНакладная"
	//-- Локализация
	;
    ...
    |;uk='Виправляє значення службового реквізиту ""Адреса доставки значення полів"".
    |Поки обробник не виконано, можливі помилки при зміні наявних документів.'");
