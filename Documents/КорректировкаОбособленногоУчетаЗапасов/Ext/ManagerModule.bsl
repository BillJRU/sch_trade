...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет реквизиты ""Вид запасов оприходование"" в табличной части ""Виды запасов"" документов ""Корректировка обособленного учета запасов"".';uk='Заповнює реквізити ""Вид запасів оприбуткування"" у табличній частині ""Види запасів"" документів ""Коригування відокремленого обліку запасів"".'");
