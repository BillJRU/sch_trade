...
Процедура УправлениеФормой()
	...
	Если ТипРасчетов = 0 Тогда //клиент
		Если ВариантУчастия = 0 Тогда
			Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет отгрузок выбранному клиенту (дебиторская задолженность) и его авансов (кредиторская задолженность).';uk='Взаємозалік відвантажень вибраного клієнта (дебіторська заборгованість) та його авансів (кредиторська заборгованість).'");
		ИначеЕсли ВариантУчастия = 1 Тогда
			Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет отгрузок одному клиенту (дебиторская задолженность) и авансов другого клиента (кредиторская задолженность).';uk='Взаємозалік відвантажень одному клієнту (дебіторська заборгованість) та авансів іншого клієнта (кредиторська заборгованість).'");
		ИначеЕсли ВариантУчастия = 2 Тогда
			Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет отгрузок клиенту от одной организации и его авансов другой организации.';uk='Взаємозалік відвантажень клієнта від однієї організації і його авансів іншій організації.'");
		КонецЕсли;
	ИначеЕсли ТипРасчетов = 1 Тогда //поставщик
		Если ВариантУчастия = 0 Тогда
			Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет поступлений от выбранного поставщика (кредиторская задолженность) и авансов ему (дебиторская задолженность).';uk='Взаємозалік надходжень від обраного постачальника (кредиторська заборгованість) та авансів йому (дебіторська заборгованість).'");
		ИначеЕсли ВариантУчастия = 1 Тогда
			Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет поступлений от одного поставщика (кредиторская задолженность) и авансов другому поставщику (дебиторская задолженность).';uk='Взаємозалік надходжень від одного постачальника (кредиторська заборгованість) та авансів іншого постачальника (дебіторська заборгованість).'");
		ИначеЕсли ВариантУчастия = 2 Тогда
			Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет поступлений от поставщика одной организации и авансов ему от другой организации.';uk='Взаємозалік надходжень від постачальника однієї організації і авансів йому від іншої організації.'");
		КонецЕсли;
	Иначе //бартер
		Элементы.ДекорацияПояснение.Заголовок = НСтр("ru='Взаимозачет кредиторской задолженности организации перед контрагентом как поставщиком и дебиторской задолженности контрагента как клиента перед организацией.';uk='Взаємозалік кредиторської заборгованості організації перед контрагентом як постачальником і дебіторської заборгованості контрагента як клієнта перед організацією.'");
	КонецЕсли;
