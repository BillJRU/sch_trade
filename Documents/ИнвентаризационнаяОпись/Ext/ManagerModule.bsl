...
Функция ДанныеИнвентаризации(ДокументСсылка) Экспорт
	...
	ДанныеДокумента = ПолучитьДанныеДляПечатнойФормыМ21(Неопределено, ДокументСсылка);
...
// Используется при получении данных для печатной формы М21 и для выгрузки данных при обмене.
// 
// Возвращаемое значение:
// 	Структура - Описание:
