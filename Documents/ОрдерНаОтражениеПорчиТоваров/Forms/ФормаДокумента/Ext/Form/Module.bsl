...
Процедура ЗаполнитьОстаткамиТоваровВЯчейках(Команда)
	...
	Если Объект.Товары.Количество() > 0 Тогда
		...
		ТекстСообщения = НСтр("ru='Табличная часть будет очищена и заполнена товарами, по которым нужно оформить порчу. Продолжить?';uk='Таблична частина буде очищена і заповнена товарами, за якими потрібно оформити псування. Продовжити?'");
