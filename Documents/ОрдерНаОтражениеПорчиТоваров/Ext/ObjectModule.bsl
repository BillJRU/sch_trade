...
Процедура СверитьКоличествоВБазовыхЕдиницах(Отказ)
	...
	ШаблонТекстаСообщения = НСтр("ru='Количество номенклатуры исходного качества ""%НоменклатураСписания%"" в строке ""%НомерСтроки%"" списка ""Товары"" отличается от количества испорченной номенклатуры ""%НоменклатураОприходования%"" на ""%Количество%"" единиц хранения';uk='Кількість номенклатури вихідного якості ""%НоменклатураСписания%"" в рядку ""%НомерСтроки%"" списку ""Товари"" відрізняється від кількості зіпсованої номенклатури ""%НоменклатураОприходования%"" на ""%Количество%"" одиниць зберігання'");
