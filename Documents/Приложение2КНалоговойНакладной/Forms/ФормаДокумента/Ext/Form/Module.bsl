...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыВыбораСтатейИАналитик = Документы.Приложение2КНалоговойНакладной.ПараметрыВыбораСтатейИАналитик(Объект.ВидОперации);
...
Процедура ДоговорНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ПоставкаСобственнойОрганизации Тогда
		...
		СтруктураОтбора.Вставить("ОрганизацияПолучатель", Объект.Контрагент);
...
Процедура ТоварыСтавкаНДСПриИзменении(Элемент)
	...
	ЗаполнитьСтатьюДекларацииНДСНалоговыеОбязательстваСервер(ТекущаяСтрока.СтатьяДекларацииНДСНалоговыеОбязательства, ТекущаяСтрока.КодПричины);
...
&НаКлиенте
Процедура ТоварыКодПричиныПриИзменении(Элемент)
...
Процедура ТоварыПоДаннымПользователяПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда
		Элемент.ТекущиеДанные.ЭтоКорректировкаКоличества = Не Объект.Переоценка;
	КонецЕсли;
	ДоходыИРасходыКлиентСервер.ПриДобавленииСтрокиВТаблицу(ЭтотОбъект, Элемент.ТекущиеДанные, "Объект.ТоварыПоДаннымПользователя");
...
&НаКлиенте
Процедура ТоварыПоДаннымПользователяСтатьяРасходовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ТоварыПоДаннымПользователяКодПричиныПриИзменении(Элемент)
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	ИначеЕсли Элемент.Имя = "ТоварыКодПричины" Тогда
		ТоварыКодПричиныПриИзменении(Элемент);
	...
	ИначеЕсли Элемент.Имя = "ТоварыПоДаннымПользователяКодПричины" Тогда
		ТоварыПоДаннымПользователяКодПричиныПриИзменении(Элемент);
...
&НаСервере
Процедура ЗаполнитьСтатьюДекларацииНДСНалоговыеОбязательстваСервер(СтатьяДекларацииНДСНалоговыеОбязательства, КодПричины)
	
	Документы.Приложение2КНалоговойНакладной.ЗаполнитьСтатьюДекларацииНДСНалоговыеОбязательства(Объект.ВидОперации, СтатьяДекларацииНДСНалоговыеОбязательства, Объект.ТипПричиныНевыдачиПокупателю, КодПричины);
