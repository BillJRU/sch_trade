...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.НазначениеОпросов") Тогда
		...
		Если РеквизитыОпроса.ТипРеспондентов = Справочники.Пользователи.ПустаяСсылка() Тогда
			ВызватьИсключение НСтр("ru='Рассылку клиентам нельзя создать на основании опроса, проводимого среди пользователей.';uk='Розсилку клієнтам не можна створити на підставі опитування, проведеного серед користувачів.'")
		КонецЕсли;
