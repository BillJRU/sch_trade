...
Процедура СформироватьОтчет()
	...
	Если ТипЗнч(ДанныеРассылки.Основание) = Тип("ДокументСсылка.НазначениеОпросов") И ЗначениеЗаполнено(ДанныеРассылки.Основание) Тогда
		...
		Если ДанныеОснования.ТипРеспондентов = Справочники.Пользователи.ПустаяСсылка() Тогда
			ВызватьИсключение НСтр("ru='В ""Назначении опросов"" указан некорректный тип респондентов. Для пользователей не может использоваться рассылка клиентам.';uk='В ""Призначенні опитувань"" вказано некоректний тип респондентів. Для користувачів не може використовуватися розсилка клієнтам.'");
		КонецЕсли
	Иначе
...
|;uk='Розсилка знаходиться в статусі ""До відправки"" і запланована %1
|У звіт виведені можливі адресати розсилки иа їх контактна інформація.
|У разі якщо контактна інформація не зазначена або вказана в некоректному форматі, розсилка даним адресатам 
|виконана не буде. Ви ще можете змінити контактну інформацію необхідного виду, виконавши ""подвійний клік"" на одержувачі розсилки.'");
		...
		Если ДанныеРассылки.ДатаАктуальности = Дата(1, 1, 1) Тогда
			ТекстПериод = НСтр("ru='на';uk='на'") + " " + Формат(ДанныеРассылки.ДатаРассылки,"ДЛФ=DD");
		Иначе
...
|В отчет выведены возможные адресаты рассылки и их контактная информация.'
|;uk='Розсилка знаходиться в статусі ""До відправки"" і була запланована %1
|Дата актуальності розсилки минула і виконана не буде.
|У звіт виведені можливі адресати розсилки та їх контактна інформація.'");
			КонецЕсли;
			
			ТекстПериод = НСтр("ru='на период с %1 по %2';uk='на період з %1 по %2'");
