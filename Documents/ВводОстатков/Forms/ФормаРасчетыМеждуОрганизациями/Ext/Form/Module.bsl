...
Процедура УстановитьУсловноеОформление()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(ГруппаОтбора, "Объект.РасчетыМеждуОрганизациями.ТипРасчетов", НСтр("ru='Договор с контрагентом';uk='Договір з контрагентом'"));
	...
	Иначе
		...
		Если ТипЗнч(СтрокаТаблицы.ОбъектРасчетов) <> ТипЗнч(ВыбранноеЗначение) Тогда
			...
			Если ВыбранноеЗначение = ПредопределенноеЗначение("Перечисление.ТипыДоговоровМеждуОрганизациями.КупляПродажа") Тогда
				СтрокаТаблицы.ТипРасчетов = НСтр("ru='Договор купли-продажи';uk='Договір купівлі-продажу'");
			ИначеЕсли ВыбранноеЗначение = ПредопределенноеЗначение("Перечисление.ТипыДоговоровМеждуОрганизациями.Комиссионный") Тогда
				СтрокаТаблицы.ТипРасчетов = НСтр("ru='Договор комиссии';uk='Договір комісії'");
			Иначе
...
Процедура ЗаполнитьСпискиВыбораТипаРасчетов()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьДоговорыМеждуОрганизациями") Тогда
		СписокВыбора.Добавить(Перечисления.ТипыДоговоровМеждуОрганизациями.КупляПродажа, НСтр("ru='Договор купли-продажи';uk='Договір купівлі-продажу'"));
		СписокВыбора.Добавить(Перечисления.ТипыДоговоровМеждуОрганизациями.Комиссионный, НСтр("ru='Договор комиссии';uk='Договір комісії'"));
	КонецЕсли;
