...
Процедура УстановитьВидимость()
	...
	Элементы.СобственныеТоварыУказатьДокументыПоступления.Видимость = НЕ Объект.ВводОстатков22; 
	Элементы.СобственныеТоварыДетализацияПартий.Видимость = НЕ Объект.ВводОстатков22;
