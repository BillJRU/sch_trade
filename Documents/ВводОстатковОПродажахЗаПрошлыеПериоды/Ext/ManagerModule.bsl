...
Функция ТекстЗапросаТаблицаФинансовыеРезультаты(Запрос, ТекстыЗапроса, Регистры)
    ...
    |	ТаблицаДоходы.СуммаДоходовРеглБезНДС  КАК ДоходыРеглБезНДС,
    |	ТаблицаДоходы.СуммаДоходовУпрБезНДС   КАК ДоходыУпрБезНДС,
    ...
    |	ТаблицаРасходы.СуммаРасходовРеглБезНДС КАК РасходыРеглБезНДС,
    |	ТаблицаРасходы.СуммаРасходовУпрБезНДС  КАК РасходыУпрБезНДС,
...
Функция ТекстЗапросаТаблицаРеестрДокументов(Запрос, ТекстыЗапроса, Регистры)
	...
	|		+ ЕСТЬNULL(ДанныеТабличнойЧастиПодарочныеСертификаты.СуммаВВалютеСертификата, 0)
	|		+ ЕСТЬNULL(ДанныеТабличнойЧастиОптовыеПродажи.Сумма, 0) 
	|		+ ЕСТЬNULL(ДанныеТабличнойЧастиРозничныеПродажи.Сумма, 0)) КАК Сумма,
	|	&Валюта                             КАК Валюта,
