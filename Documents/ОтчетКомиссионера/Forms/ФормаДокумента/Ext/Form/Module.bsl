...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыВзаиморасчеты= Документы.ОтчетКомиссионера.ПараметрыВзаиморасчеты(Объект.УдержатьВознаграждение);
...
Процедура ЗаполнитьСписокВыбораГрузоотправитель()
	...
	ОрганизацияГрузоотправитель = НСтр("ru='Организация: %1';uk='Організація: %1'");
