		...
		Если СтрокаТЧ.ОбъектРасчетовОтправитель = Справочники.ОбъектыРасчетов.ПустаяСсылка() 
			...
			Если ЗначениеЗаполнено(ИсточникОбъектаРасчетов) Тогда
				...
				Иначе
					...
					ПараметрыВзаиморасчеты = ОбъектыРасчетовСервер.ПараметрыВзаиморасчетовОбъектаРасчетов(ОбъектИсточник);
					...
					Если ОбъектыРасчетовСервер.СсылкаЯвляетсяОбъектомРасчетов(ОбъектИсточник, ПараметрыВзаиморасчеты) Тогда
						СсылкаОбъектРасчетов = ОбъектыРасчетовСервер.ПроверитьЗаполнитьОбъектРасчетовПоСтруктуре(ОбъектИсточник, ПараметрыВзаиморасчеты,,РежимЗаписи);
