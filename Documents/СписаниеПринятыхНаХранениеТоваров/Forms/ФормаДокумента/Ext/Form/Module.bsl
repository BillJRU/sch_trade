...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыВыбораСтатейИАналитик = Документы.СписаниеПринятыхНаХранениеТоваров.ПараметрыВыбораСтатейИАналитик(
	...
	ПараметрыВзаиморасчеты = Документы.СписаниеПринятыхНаХранениеТоваров.ПараметрыВзаиморасчеты(Объект.ХозяйственнаяОперация,
		Объект.Договор);
...
&НаКлиенте
Процедура ДекорацияСостояниеРасчетовНажатие(Элемент)
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Списание товаров, хранящихся на складе';uk='Списання товарів, що зберігаються на складі'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Списание товаров, переданных в производство';uk='Списання товарів, переданих у виробництво'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Списание товаров, переданных на хранение';uk='Списання товарів, переданих на зберігання'"));
...
Процедура ЗаполнитьТоварыИзВременногоХранилищаСервер(АдресВоВременномХранилище)
	...
	ТаблицаТоваров = ПолучитьИзВременногоХранилища(АдресВоВременномХранилище); // ДокументТабличнаяЧасть.СписаниеПринятыхНаХранениеТоваров.Товары
