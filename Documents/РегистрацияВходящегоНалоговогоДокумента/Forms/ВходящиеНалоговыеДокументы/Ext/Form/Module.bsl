...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
		...
		Элементы.ДатаАктуальностиРасчетов.Видимость = Ложь;
		Элементы.ГруппаОбновитьДатаАктуальностиРасчетов.Видимость = Ложь;
...
Процедура АктуализироватьРасчетыСервер()
	...
	РаспределениеВзаиморасчетовВызовСервера.РаспределитьВсеРасчетыСПоставщиками(ОкончаниеПериодаРасчета);
