...
Процедура СформироватьЗависимыеОтТипаОснованияЗаголовки()
	...
	Если Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриобретениеТоваровУслуг Тогда
		...
		Элементы.Договор.Подсказка = НСтр("ru='Договор, в рамках которого оформлено приобретение';uk='Договір, в рамках якого оформлено придбання'");
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтКлиента Тогда
		...
		Элементы.Договор.Подсказка = НСтр("ru='Договор, в рамках которого оформлен возврат';uk='Договір, в рамках якого оформлено повернення'");
		Элементы.Соглашение.Подсказка = НСтр("ru='Соглашение, по которому был реализован товар.';uk='Оферта, за якою був реалізований товар.'");
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
		Заголовок = НСтр("ru='Акт о расхождениях после приемки товаров на хранение (Создание)';uk='Акт про розбіжності після приймання товарів на зберігання (Створення)'");
		Элементы.Договор.Подсказка = НСтр("ru='Договор, в рамках которого оформлена приемка';uk='Договір, в рамках якого оформлена приймання'");
		Элементы.Соглашение.Подсказка = НСтр("ru='Соглашение, по которому был принят товар.';uk='Оферта, за якою був прийнятий товар.'");
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя Тогда
		Заголовок = НСтр("ru='Акт о расхождениях после поступления товаров от хранителя (Создание)';uk='Акт про розбіжності після надходження товарів від зберігача (Створення)'");
		Элементы.Договор.Подсказка = НСтр("ru='Договор, в рамках которого оформлено поступление';uk='Договір, в рамках якого оформлено надходження'");
		Элементы.Соглашение.Подсказка = НСтр("ru='Соглашение, по которому был передан товар.';uk='Оферта, за якj. був переданий товар.'");
	КонецЕсли;
...
Процедура СоглашениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Объект.ТипОснованияАктаОРасхождении = ПредопределенноеЗначение("Перечисление.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтКлиента")
		Или Объект.ТипОснованияАктаОРасхождении = ПредопределенноеЗначение("Перечисление.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя") Тогда
...
Процедура ПартнерПриИзмененииНаСервере()
	...
	Если Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтКлиента
		Или Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	ТипыОснованийАктаОРасхождении.Добавить(Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя);
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Списать недостачи';uk='Списати нестачі'"));
...
Процедура УстановитьВидимостьЭлементовПоОперацииСервер()
	...
	ТипыАктовХранения.Добавить(Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя);
	...
	Если ТипыАктовХранения.Найти(Объект.ТипОснованияАктаОРасхождении) <> Неопределено Тогда
 		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "НалогообложениеНДСПоУмолчанию", "Видимость", Ложь);
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении <> Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтКлиента Тогда
...
Процедура УправлениеРеквизитамиФормыВЗависимостиОтТипаОснования()
	...
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение Тогда
		...
		//Итоги
		Элементы.ПоОснованиям.Заголовок = НСтр("ru='По приемкам';uk='За прийманнями'");
		
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя Тогда
		
		//Партнер
		ПараметрВыбораПартнера = Новый ПараметрВыбора("Отбор.Клиент", Истина);
		
		МассивПараметровВыбора = Новый Массив;
		МассивПараметровВыбора.Добавить(ПараметрВыбораПартнера);
		
		Элементы.Партнер.ПараметрыВыбора = Новый ФиксированныйМассив(МассивПараметровВыбора);
		Элементы.Партнер.Заголовок       = НСтр("ru='Партнер';uk='Партнер'");
		
		Элементы.ТоварыКомментарийПоставщикаПодвал.Заголовок = НСтр("ru='Комментарии партнера по расхождениям в строке';uk='Коментарі партнера з розбіжностей в рядку'");
		Элементы.ТоварыЕстьКомментарийПоставщика.Заголовок   = НСтр("ru='партнера';uk='партнера'");
		...
		СписокВыбораХозяйственныеОперации.Очистить();
		СписокВыбораХозяйственныеОперации.Добавить(Перечисления.ХозяйственныеОперации.ВозвратОтХранителя);
		
		//Товары
		Элементы.ТоварыЗаполнитьПоОснованиям.Заголовок  = НСтр("ru='По поступлениям от хранителя';uk='За надходженнями від зберігача'");
		Элементы.ТоварыНоменклатураПоставщика.Видимость = Ложь;
		Элементы.ТоварыВидЦеныПоставщика.Видимость      = Ложь;
		Элементы.ТоварыДокументОснование.Заголовок      = НСтр("ru='Поступление от хранителя';uk='Надходження від зберігача'");
		Элементы.ТоварыАналитикаРасходов.Видимость      = Ложь;
		Элементы.ТоварыСтатьяРасходов.Видимость         = Ложь;
		Элементы.ТоварыСписатьНаРасходы.Видимость       = Ложь;
		Элементы.ТоварыПодразделение.Видимость          = Ложь;
		...
		//Итоги
		Элементы.ПоОснованиям.Заголовок = НСтр("ru='По поступлениям';uk='За надходженнями'");
...
Функция ЗаполнитьПоПриемкеСервер()
	...
	КолонкаЗаказПоставщику.Имя = "Заказ";
	...
	КолонкаЗаказ     = ТаблицаЗаказы.Колонки.Заказ; // КолонкаТаблицыЗначений
...
Процедура ЗаполнитьНалогообложениеНДС(НалогообложениеНДСПродажи = Истина, НалогообложениеНДСЗакупки = Истина)
	...
	Если РасхожденияКлиентСервер.ТипОснованияПриобретениеТоваровУслуг(Объект.ТипОснованияАктаОРасхождении) И НалогообложениеНДСЗакупки Тогда
		...
		УчетНДСУП.ЗаполнитьСписокВыбораНалогообложенияНДСЗакупки(Элементы.НалогообложениеНДСПоУмолчанию, НалогообложениеНДСПоУмолчанию, ПараметрыЗаполнения, УчетНДСКэшированныеЗначенияПараметров); 
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Если Объект.ТипОснованияАктаОРасхождении = ПредопределенноеЗначение("Перечисление.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтХранителя") Тогда
		Объект.ХозяйственнаяОперация = ПредопределенноеЗначение(
			"Перечисление.ХозяйственныеОперации.ВозвратОтХранителя");
	КонецЕсли;
