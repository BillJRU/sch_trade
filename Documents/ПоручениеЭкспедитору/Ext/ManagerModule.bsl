...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Поручение экспедитору';uk='Доручення експедитору'");
...
Процедура ЗаполнитьТабличныйДокументПоручениеЭкспедитору(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, ПараметрыВывода)
	...
	Если ДанныеДляПечатиСтрока.СпособДоставки = Перечисления.СпособыДоставки.ПоручениеЭкспедиторуСоСклада
		...
		СтруктураДанныхОткуда.Вставить("Направление", НСтр("ru='Откуда';uk='Звідки'",КодЯзыкаПечать));
		...
		СтруктураДанныхКуда.Вставить("Направление", НСтр("ru='Куда';uk='Куди'",КодЯзыкаПечать));		
	...
	Иначе
		...
		СтруктураДанныхНаправление.Вставить("Направление", НСтр("ru='Где';uk='Де'",КодЯзыкаПечать));
