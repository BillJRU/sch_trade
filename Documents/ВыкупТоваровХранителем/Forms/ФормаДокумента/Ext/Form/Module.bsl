...
Процедура ОткрытьПодбор(Команда)
	...
	Иначе
		ПараметрЗаголовок = СтрЗаменить(ПараметрЗаголовок, "%Документ%", НСтр("ru='выкуп товаров хранителем';uk='викуп товарів зберігачем'"));
	КонецЕсли;
...
Процедура ПолучитьСтрокиИзБуфераОбмена()
	...
	СтруктураДействий = Новый Структура("ЗаполнитьСтавкуНДС",
