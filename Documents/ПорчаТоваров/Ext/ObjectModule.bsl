...
Процедура ЗаполнитьНалоговоеНазначение()
	...
	ПараметрыЗаполнения = Документы.ПорчаТоваров.ПараметрыЗаполненияНалоговогоНазначения(ЭтотОбъект);
...
Процедура ЗаполнитьНоменклатуруОприходованиеВидовЗапасов(Отказ) Экспорт
	...
	ЗапасыСервер.ЗаполнитьНоменклатуруГТДОприходованиеВидовЗапасов(Ссылка, ВидыЗапасов, Отказ, Ложь, "АналитикаУчетаНоменклатурыОприходование", "АналитикаУчетаНоменклатурыОприходование.Номенклатура");
...
Функция ПараметрыЗаполненияВидовЗапасов()
    ...
    ПараметрыЗаполнения.НалоговоеНазначение = НалоговоеНазначение;
