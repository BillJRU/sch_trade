...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ТолькоПросмотр", Истина);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<перемещение не по заказу>';uk='<переміщення не за замовленням>'"));
...
Процедура ЗаполнитьПоПриемкеСервер()
	...
	Для Каждого КлючЗначение Из ДействияСПолученнымиТаблицами Цикл
		...
		Условие = "[КоличествоМаксимум], НЕ [КоличествоВЗаказе]";
