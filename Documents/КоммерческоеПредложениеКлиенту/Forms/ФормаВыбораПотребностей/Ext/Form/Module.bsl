...
Процедура НастроитьЭлементыФормы()
	...
	МассивСтрок.Добавить(НСтр("ru='Выбор потребностей из';uk='Вибір потреб з'"));
	...
	ПредставлениеЗапросаКП = СтрШаблон(НСтр("ru='Запроса № %1 от %2';uk='Запиту № %1 від %2'"),
	...
	ИначеЕсли РеквизитыДокументаОснования.ВариантУказанияСрокаПоставки = Перечисления.ВариантыСроковПоставкиКоммерческихПредложений.УказываетсяВДняхСМоментаЗаказа Тогда
		...
		Элементы.СрокПоставки.Заголовок = НСтр("ru='Срок поставки (дн.)';uk='Строк поставки (дн.)'");
	...
	ИначеЕсли РеквизитыДокументаОснования.ВариантУказанияСрокаПоставки = Перечисления.ВариантыСроковПоставкиКоммерческихПредложений.УказываетсяНаОпределеннуюДату Тогда
		...
		Элементы.СрокПоставки.Заголовок = НСтр("ru='Поставить к дате';uk='Поставити до дати'");
...
#Область УжеДобавленнаяСтрока
	...
	Элемент.Представление = НСтр("ru='Выделение цветом уже подобранных строк.';uk='Виділення кольором вже підібраних рядків.'");
...
#Область СнятаСРассмотрения
	...
	Элемент = СписокУсловноеОформление.Элементы.Добавить();
	Элемент.Представление = НСтр("ru='Зачеркивание снятых с рассмотрения строк.';uk='Закреслення знятих з розгляду рядків.'");
