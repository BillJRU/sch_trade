...
Функция СоздатьДокументыБлокировкиНормативовНаСервере(ДатаНачалаДействия)
	...
	Для каждого ВыбраннаяСтрока Из Элементы.Нормативы.ВыделенныеСтроки Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru='Данные.Проведение';uk='Дані. Проведення'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),УровеньЖурналаРегистрации.Ошибка, Документы.НормативРаспределенияПлановПродажПоКатегориям,, ОписаниеОшибки());
		КонецПопытки; 
