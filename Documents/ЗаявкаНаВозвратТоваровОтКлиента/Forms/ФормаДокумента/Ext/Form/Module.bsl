...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры_Взаиморасчеты = Документы.ЗаявкаНаВозвратТоваровОтКлиента.ПараметрыВзаиморасчеты(Объект.ХозяйственнаяОперация, Объект.СпособКомпенсации);
...
Процедура ЗаполнитьРеализацииИЦены(Команда)
	...
	Если Объект["ВозвращаемыеТовары"].Количество() = 0 Тогда
		...
		ТекстПредупреждения = НСтр("ru='В документе не заполнен список Возвращаемые товары.  Документы продажи и цены не могут быть заполнены.';uk='У документі не заповнений список Повернуті товари. Документи продажу і ціни не можуть бути заповнені.'");
