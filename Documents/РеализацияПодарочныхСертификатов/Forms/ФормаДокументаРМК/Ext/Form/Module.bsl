...
Функция ПараметрыОперацииФискализацииЧека()
	...
	// Готовим данные
			...
			СтавкаНДССтрокой    = НДСОбщегоНазначенияКлиентСервер.ПолучитьСтавкуНДССтрокой(ПредопределенноеЗначение("Справочник.СтавкиНДС.НеНДС"));
			...
			Для Каждого СтрокаТЧ Из Объект.ПодарочныеСертификаты Цикл
				...
				СтрокаТаблицыТоваров.Добавить("");       		 	  		 // 22 - Штрихкод Товара
			...
			ОбщиеПараметры.Добавить(Ложь);					 // 20 - несколько акцизных марок
