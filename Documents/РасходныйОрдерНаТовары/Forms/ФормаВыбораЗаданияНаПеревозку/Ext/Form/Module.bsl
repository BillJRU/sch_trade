...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлементВыбора.Представление = СтрЗаменить(ЭлементВыбора.Представление, "%Ордер%",
		?(Ордера.Количество() > 1, НСтр("ru='ордера';uk='ордери'"), НСтр("ru='ордер';uk='ордер'")));
	...
	ЭлементВыбора.Представление = СтрЗаменить(ЭлементВыбора.Представление, "%Зона%",
		?(ЗоныДоставки.Количество() > 1, НСтр("ru='зонам';uk='зонам'"), НСтр("ru='зоне';uk='зоні'")));
...
Процедура ЗаполнитьСписокЗаданий()
	...
	Если ОтборПоРаспоряжениям = "ЗаданияПоРаспоряжениям" Тогда
		...
		ТекстСообщения = НСтр("ru='Нет доступных заданий для выбора, распоряжениями которых являются распоряжения, указанные в %ПредставлениеОрдеров%.';uk='Немає доступних завдань для вибору, розпорядженнями яких є розпорядження, зазначені в %ПредставлениеОрдеров%.'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПредставлениеОрдеров%",
			?(ЗначениеЗаполнено(СтатусОрдера),
				НСтр("ru='выбранном ордере';uk='вибраному ордері'"),
				НСтр("ru='выбранных ордерах';uk='вибраних ордерах'")));
	...
	ИначеЕсли ОтборПоРаспоряжениям = "ЗаданияПоПолучателю" Тогда
		...
		ТекстСообщения = НСтр("ru='Нет доступных заданий для выбора. В ордерах указаны различные получатели.';uk='Немає доступних завдань для вибору. В ордерах вказані різні одержувачі.'");
	...
	ИначеЕсли ОтборПоРаспоряжениям = "ЗаданияПоЗонеДоставки" Тогда 
		...
		ТекстСообщения = НСтр("ru='Нет доступных заданий для выбора по %Зона% доставки.';uk='Немає доступних завдань для вибору по %Зона% доставки.'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Зона%",
			?(ЗоныДоставки.Количество() > 1,
				НСтр("ru='зонам';uk='зонам'"),
				НСтр("ru='зоне';uk='зоні'")));
