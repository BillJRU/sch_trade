...
&НаКлиенте
Процедура ДанныеОтраженияСтатьяПолучательНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
Процедура ПодборОстатковПолучателя(Команда)
	...
	ДоходыИРасходыКлиентСервер.СтатьяПриИзменении(ЭтотОбъект, Элементы.ДанныеОтраженияСтатьяПолучатель);
...
Процедура УправлениеЭлементамиФормы()
	...
	Элементы.ДанныеОтраженияНаправлениеПолучатель.Заголовок	= НСтр("ru='Направление деятельности';uk='Напрям діяльності'") + " " + ДанныеПолучателя.Имя;
	...
	Элементы.ДанныеОтраженияНаправлениеИсточник.Заголовок	= НСтр("ru='Направление деятельности';uk='Напрям діяльності'") + " " + ДанныеИсточника.Имя;
...
Процедура ЗаполнитьПредставлениеИсточников()
	...
	Если Получатель = Перечисления.ТипыСтатейАктивовПассивов.СтатьяАктивов Тогда
		...
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяАктивов,  НСтр("ru='уменьшение других активов';uk='зменшення інших активів'"));
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяПассивов, НСтр("ru='увеличение пассивов';uk='збільшення пасивів'"));
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяРасходов, НСтр("ru='уменьшения расходов';uk='зменшення витрат'"));
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяДоходов,  НСтр("ru='возникновение доходов';uk='виникнення доходів'"));
	...
	ИначеЕсли Получатель = Перечисления.ТипыСтатейАктивовПассивов.СтатьяПассивов Тогда
		...
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяПассивов, НСтр("ru='уменьшение других пассивов';uk='зменшення інших пасивів'"));
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяРасходов, НСтр("ru='возникновение расходов';uk='виникнення витрат'"));
		СписокВыбора.Добавить(Перечисления.ТипыСтатейАктивовПассивов.СтатьяДоходов,  НСтр("ru='уменьшение доходов';uk='зменшення доходів'"));
		Объект.Получатель = СписокВыбора[0].Значение;
