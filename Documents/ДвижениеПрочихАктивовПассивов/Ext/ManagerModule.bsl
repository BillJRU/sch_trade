...
Функция ОписаниеДвижений() Экспорт
	...
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяАктивов, ТипыСтатей.СтатьяАктивов),
					НСтр("ru='Выполняется увеличение активов и уменьшение других активов';uk='Виконується збільшення активів і зменшення інших активів'"));
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяАктивов, ТипыСтатей.СтатьяПассивов),
					НСтр("ru='Выполняется увеличение активов и увеличение пассивов';uk='Виконується збільшення активів і збільшення пасивів'"));
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяАктивов, ТипыСтатей.СтатьяРасходов),
					НСтр("ru='Выполняется увеличение активов и уменьшение расходов';uk='Виконується збільшення активів і зменшення витрат'"));
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяАктивов, ТипыСтатей.СтатьяДоходов),
					НСтр("ru='Выполняется увеличение активов и возникновение доходов';uk='Виконується збільшення активів і виникнення доходів'"));
	// Увеличение пассивов
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяПассивов, ТипыСтатей.СтатьяПассивов),
					НСтр("ru='Выполняется увеличение пассивов и уменьшение других пассивов';uk='Виконується збільшення пасивів і зменшення інших пасивів'"));
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяПассивов, ТипыСтатей.СтатьяРасходов),
					НСтр("ru='Выполняется увеличение пассивов и возникновение расходов';uk='Виконується збільшення пасивів і виникнення витрат'"));
	Описания.Вставить(Индетификатор(ТипыСтатей.СтатьяПассивов, ТипыСтатей.СтатьяДоходов),
					НСтр("ru='Выполняется увеличение пассивов и уменьшение доходов';uk='Виконується збільшення пасивів і зменшення доходів'"));
	Возврат Описания;
