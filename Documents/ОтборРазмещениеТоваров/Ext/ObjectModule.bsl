...
Процедура СверитьКоличествоВБазовыхЕдиницах(Отказ)
	...
	Иначе
		...
		Для Каждого СтрТабл Из ТаблицаПроверки Цикл
			...
			Если СтрТабл.Количество > 0 Тогда
				ТекстСообщения = НСтр("ru='Запланированное к отбору количество номенклатуры ""%ПредставлениеНоменклатуры%"" меньше, чем размещенное на %Количество% единиц хранения';uk='Запланована до відбору кількість номенклатури ""%ПредставлениеНоменклатуры%"" менше, ніж розміщена на %Количество% одиниць зберігання'");
				Количество = СтрТабл.Количество;
			ИначеЕсли СтрТабл.Количество < 0 Тогда
				ТекстСообщения = НСтр("ru='Запланированное к отбору количество номенклатуры ""%ПредставлениеНоменклатуры%"" больше, чем размещенное на %Количество% единиц хранения';uk='Запланована до відбору кількість номенклатури ""%ПредставлениеНоменклатуры%"" більше, ніж розміщена на %Количество% одиниць зберігання'");
				Количество = - СтрТабл.Количество;
			КонецЕсли;
