...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если РежимЗаписи = РежимЗаписиДокумента.Проведение И АвторасчетНДС И НДСИсходящийСервер.НуженАвторасчетНДС(Услуги) Тогда
	...
	Параметры_Взаиморасчеты = Документы.АктВыполненныхРабот.ПараметрыВзаиморасчеты(АктПоЗаказам, ЕстьКорректировки);
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(ОплатаВВалюте) Тогда
		...
		ОплатаВВалюте = ВзаиморасчетыСервер.ПолучитьОплатуВВалютеПоУмолчанию(ВалютаОплаты);
	КонецЕсли;
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Параметры_Взаиморасчеты = Документы.АктВыполненныхРабот.ПараметрыВзаиморасчеты(АктПоЗаказам, Ложь);
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	УчетНДСУП.ЗаполнитьНалогообложениеНДСПродажи(НалогообложениеНДСПоУмолчанию, Документы.АктВыполненныхРабот.ПараметрыЗаполненияНалогообложенияНДСПродажи(ЭтотОбъект));
...
Функция ПоместитьСуммыПоЗаказамВоВременноеХранилище() Экспорт
	...
	Запрос.УстановитьПараметр("Таблица",                   Услуги);
	Запрос.УстановитьПараметр("ПоЗаказам",                 АктПоЗаказам);
