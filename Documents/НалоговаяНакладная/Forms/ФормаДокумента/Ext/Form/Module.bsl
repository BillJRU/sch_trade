...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыВыбораСтатейИАналитик = Документы.НалоговаяНакладная.ПараметрыВыбораСтатейИАналитик(Объект.ВидОперации);
...
Процедура ВалютаПриИзменении(Элемент)
	...
	УстановитьВидимостьСуммРегл(ЭтаФорма);
...
Процедура ТоварыСуммаБезНДСПриИзменении(Элемент)
	...
	ПроцентНДС = УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС);
...
Процедура ТоварыКодУКТВЭДПриИзменении(Элемент)
	...
	ТоварыКодУКТВЭДПриИзмененииСервер(ТекущаяСтрока.ПолучитьИдентификатор(), КэшированныеЗначения);
...
Процедура ТоварыКодНоменклатурыПоКлассификаторуПриИзменении(Элемент)
	...
	ТоварыКодНоменклатурыПоКлассификаторуПриИзмененииСервер(Элементы.Товары.ТекущиеДанные.ПолучитьИдентификатор(), КэшированныеЗначения);
...
Процедура ТоварыПослеУдаления(Элемент)
	...
	ЗаполнитьТипПричиныНевыдачиНаСервере();
    УстановитьВидимостьВеса(ЭтаФорма);
...
Процедура ТоварыЕдиницаИзмеренияПриИзменении(Элемент)
	...
	СтруктураДействий = Новый Структура;
	СтруктураДействий.Вставить("ПересчитатьВесКГ");
	НДСИсходящийКлиент.ОбработатьСтрокуТЧ(Элементы.Товары.ТекущиеДанные, СтруктураДействий, КэшированныеЗначения);
...
Процедура ТоварыПоДаннымПользователяПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	ДоходыИРасходыКлиентСервер.ПриДобавленииСтрокиВТаблицу(ЭтотОбъект, ТекущаяСтрока, "Объект.ТоварыПоДаннымПользователя");
...
Процедура ТоварыПоДаннымПользователяКодУКТВЭДПриИзменении(Элемент)
	...
	ТоварыПоДаннымПользователяКодУКТВЭДПриИзмененииСервер(ТекущаяСтрока.ПолучитьИдентификатор(), КэшированныеЗначения);
...
Процедура ТоварыПоДаннымПользователяКодНоменклатурыПоКлассификаторуПриИзменении(Элемент)
	...
	ТоварыПоДаннымПользователяКодНоменклатурыПоКлассификаторуПриИзмененииСервер(Элементы.ТоварыПоДаннымПользователя.ТекущиеДанные.ПолучитьИдентификатор(), КэшированныеЗначения);
...
&НаКлиенте
Процедура ТоварыПоДаннымПользователяСтатьяРасходовУсловнаяПродажаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ТоварыПоДаннымПользователяЕдиницаИзмеренияПриИзменении(Элемент)

	СтруктураДействий = Новый Структура;
	СтруктураДействий.Вставить("ПересчитатьВесКГ");
	НДСИсходящийКлиент.ОбработатьСтрокуТЧ(Элементы.ТоварыПоДаннымПользователя.ТекущиеДанные, СтруктураДействий, КэшированныеЗначения);
...
&НаКлиенте
Процедура ИзменитьВидимостьСуммРегл(Команда)
	
	ПоказыватьСуммыРегл = НЕ ПоказыватьСуммыРегл;
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	ИначеЕсли Элемент.Имя = "ТоварыЕдиницаИзмерения" Тогда
	...
	ИначеЕсли Элемент.Имя = "ТоварыПоДаннымПользователяЕдиницаИзмерения" Тогда
		ТоварыПоДаннымПользователяЕдиницаИзмеренияПриИзменении(Элемент);
	...
	Если ВидОперации = Перечисления.ВидыОперацийНалоговыхДокументов.ПродажаНижеОбычнойЦены И 
		...
		Если ЗначениеЗаполнено(Объект.Договор) И ЗначениеЗаполнено(Объект.Валюта) 
		   И Объект.Договор.ВалютаВзаиморасчетов <> Объект.Валюта Тогда
			...
			Объект.Договор = Новый(ТипЗнч(Объект.Договор));		
...
Процедура ОбщееНоменклатураПриИзмененииСервер(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения)
	...
	ЗаполнитьРежимЭкспортногоОбеспечения(ТекущаяСтрока);
	УстановитьВидимостьВеса(ЭтаФорма);
...
&НаСервере
Процедура ТоварыКодУКТВЭДПриИзмененииСервер(ИдентификаторСтроки, КэшированныеЗначения)
	
	ТекущаяСтрока = Объект.Товары.НайтиПоИдентификатору(ИдентификаторСтроки);

	ОбщееТоварыКодУКТВЭДПриИзмененииСервер(ТекущаяСтрока, КэшированныеЗначения);
	
КонецПроцедуры

&НаСервере
Процедура ТоварыПоДаннымПользователяКодУКТВЭДПриИзмененииСервер(ИдентификаторСтроки, КэшированныеЗначения)
...
&НаСервере
Процедура ОбщееТоварыКодУКТВЭДПриИзмененииСервер(ТекущаяСтрока, КэшированныеЗначения)
	...
	ОбщееКодНоменклатурыПоКлассификаторуПриИзмененииСервер(ТекущаяСтрока, КэшированныеЗначения);
	
КонецПроцедуры   

&НаСервере
Процедура ТоварыКодНоменклатурыПоКлассификаторуПриИзмененииСервер(ИдентификаторСтроки, КэшированныеЗначения)
...
&НаСервере
Процедура ТоварыПоДаннымПользователяКодНоменклатурыПоКлассификаторуПриИзмененииСервер(ИдентификаторСтроки, КэшированныеЗначения)
...
&НаСервере
Процедура ОбщееКодНоменклатурыПоКлассификаторуПриИзмененииСервер(ТекущаяСтрока, КэшированныеЗначения)
...
Функция ПересчитатьСуммуНДСПревышения(ТекущаяСтрока)
	...
	ПроцентНДС = УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС);
	ТекущаяСтрока.СуммаНДСПревышения = ТекущаяСтрока.СуммаПревышения * ПроцентНДС / 100;
...
// ГруппаШапка
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Договор", "Видимость", ВидимостьВзаиморасчетов);
	...
	Если ПоставкаСобственнойОрганизации Тогда
		МассивСвязей.Добавить(Новый СвязьПараметраВыбора("Отбор.ОрганизацияПолучатель", "Объект.Контрагент", РежимИзмененияСвязанногоЗначения.Очищать));
	Иначе
	...
	Если НЕ ПродажаНижеОбычнойЦены Тогда
		МассивСвязей.Добавить(Новый СвязьПараметраВыбора("Отбор.ВалютаВзаиморасчетов", "Объект.Валюта", РежимИзмененияСвязанногоЗначения.Очищать));
	КонецЕсли;
	...
	Если Объект.ВидОперации = Перечисления.ВидыОперацийНалоговыхДокументов.РаботыОтНерезидента Тогда
		...
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Партнер", "Заголовок", НСтр("ru='Поставщик';uk='Постачальник'"));
...
// ГруппаСтраницыДополнительно	
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДатаГТД", "Доступность", Объект.ПодтверждаетсяГТД);
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЛьготаНДСОписание", "Видимость", ПоказыватьЛьготу);
...
Функция ОпределитьДопустимыеСтавкиНДС() Экспорт
	...
	Для каждого ЭлементСписка Из СписокСтавокНДС Цикл
		ЭлементСписка.Значение =  НДСКлиентСерверПовтИсп.СтавкаНДСПоЗначениюПеречисления(ЭлементСписка.Значение);
	КонецЦикла;
...
Функция ЗаполнитьСтавкуНДС(Номенклатура)
	...
	Если СписокДопустимыхСтавокНДС.Количество() > 1 Тогда
		Если СписокДопустимыхСтавокНДС.НайтиПоЗначению(Номенклатура.СтавкаНДС) = Неопределено Тогда 
			...
			СтавкаНДСНовая = Справочники.СтавкиНДС.ПустаяСсылка();
		Иначе
...
Функция ЗаполнитьСписокВыбораТекстДополнения(ОсновнаяНалоговаяПриПродажеНижеОбычнойЦены, Дата, ВернутьМассивом = Ложь)
	...
	Если Дата < '2015-01-01' Тогда
		...
		НоменНН = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(ОсновнаяНалоговаяПриПродажеНижеОбычнойЦены.Номер, Истина, Истина);
	...
	Иначе
		...
		Если ЗначениеЗаполнено(ОсновнаяНалоговаяПриПродажеНижеОбычнойЦены) Тогда
			...
			ТекНомер = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(ОсновнаяНалоговаяПриПродажеНижеОбычнойЦены.Номер, Истина, Истина);
...
Процедура ЗаполнитьПоПревышениямОбычнойЦеныЗаПериодСервер(СтандартныйПериод)
	...
	|	И НалоговаяНакладнаяТовары.СтавкаНДС.Ставка > 0
    ...
    |	НалоговаяНакладная.Дата МЕЖДУ &НачалоПериода И &КонецПериода
	|	И НалоговаяНакладная.Проведен
	|	И НалоговаяНакладнаяТоварыПоДаннымПользователя.СтавкаНДС.Ставка > 0
	|	И НалоговаяНакладная.СтатусАвтокорректировки = ЗНАЧЕНИЕ(Перечисление.СтатусыАвтокорректировкиНалоговыхДокументов.ИсправлятьТехническуюТЧ)
	...
	|	СУММА((ВложенныйЗапрос.ЦенаОбычнаяРегл - ВложенныйЗапрос.ЦенаРегл) * ВложенныйЗапрос.КоличествоУпаковок * ВложенныйЗапрос.СтавкаНДС.Ставка / 100) КАК СуммаНДСПревышения,
	|	СУММА((ВложенныйЗапрос.ЦенаОбычнаяРегл - ВложенныйЗапрос.ЦенаРегл) * ВложенныйЗапрос.КоличествоУпаковок * ВложенныйЗапрос.СтавкаНДС.Ставка / 100) КАК СуммаНДСРегл
	|ИЗ
	|	(ВЫБРАТЬ
...
Процедура ПересчитатьСуммыСервер(ИмяТабЧасти, ПересчитатьВалютныеСуммы)
	...
	Для Каждого ТекущаяСтрока ИЗ Объект[ИмяТабЧасти] Цикл
		...
		Если ПересчитатьВалютныеСуммы Тогда
			...
			ТекущаяСтрока.Цена = РаботаСКурсамиВалютКлиентСервер.ПересчитатьПоКурсу(
				ТекущаяСтрока.Цена,
			...
			ТекущаяСтрока.СуммаНДС	  = ТекущаяСтрока.СуммаБезНДС * ПроцентНДС / 100;
			ТекущаяСтрока.СуммаСНДС	  = ТекущаяСтрока.СуммаБезНДС + ТекущаяСтрока.СуммаНДС;
			...
			Если ИмяТабЧасти = "ТоварыПоДаннымПользователя" И Объект.ВидОперации = Перечисления.ВидыОперацийНалоговыхДокументов.ПродажаНижеОбычнойЦены Тогда
				ТекущаяСтрока.ЦенаОбычная = РаботаСКурсамиВалютКлиентСервер.ПересчитатьПоКурсу(
...
Процедура ЗаполнитьСлужебныеРеквизитыПоНоменклатуре()
	...
	Для каждого СтрокаТаблицы Из Объект.Товары Цикл
		ЗаполнитьРежимЭкспортногоОбеспечения(СтрокаТаблицы);
	КонецЦикла;
	Для каждого СтрокаТаблицы Из Объект.ТоварыПоДаннымПользователя Цикл
		ЗаполнитьРежимЭкспортногоОбеспечения(СтрокаТаблицы);
	КонецЦикла;
	УстановитьВидимостьВеса(ЭтаФорма);
...
Процедура ЗаполнитьНоменклатуруГТДПоУмолчанию(СтрокаТовары)
	...
	Если ЗначениеЗаполнено(СтрокаТовары.Номенклатура) Тогда
		...
		Иначе
			СтрокаТовары.НомерГТД = Справочники.НоменклатураГТД.ПустаяСсылка();
		КонецЕсли;
	Иначе
		СтрокаТовары.НомерГТД = Справочники.НоменклатураГТД.ПустаяСсылка();
	КонецЕсли;
...
Процедура ПроверитьСтатьюДекларацииНДС22ВСтроке(Объект, ТекущаяСтрока)
	...
	Если Объект.ТипПричиныНевыдачиПокупателю = 22 Тогда
		ТекущаяСтрока.СтатьяДекларацииНДСНалоговыеОбязательства = ПредопределенноеЗначение("Справочник.СтатьиНалоговыхДеклараций.НДС_НОЭкспортОтдВидовСХПродукции");
	КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьВеса(Форма)
	
	Форма.Элементы.ТоварыВес.Видимость = Форма.Объект.Товары.НайтиСтроки(Новый Структура("РежимЭкспортногоОбеспечения", Истина)).Количество() > 0;
	Форма.Элементы.ТоварыПоДаннымПользователяВес.Видимость = Форма.Объект.ТоварыПоДаннымПользователя.НайтиСтроки(Новый Структура("РежимЭкспортногоОбеспечения", Истина)).Количество() > 0;
	
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура ЗаполнитьРежимЭкспортногоОбеспечения(СтрокаТаблицы)
	
	СтрокаТаблицы.РежимЭкспортногоОбеспечения = ОбщегоНазначенияУТВызовСервера.ЗначениеРеквизитаОбъекта(СтрокаТаблицы.КодНоменклатурыПоКлассификатору, "РежимЭкспортногоОбеспечения");
	
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьСуммРегл(Форма)

	ЭтоГрн = Форма.Объект.Валюта = Форма.ВалютаРегламентированногоУчета;
	Если НЕ ЭтоГрн Тогда
		Форма.ПоказыватьСуммыРегл = Истина;
	КонецЕсли;                             
    ПоказыватьСуммыРегл = Форма.ПоказыватьСуммыРегл;
	
	Форма.Элементы.ТоварыПоДаннымПользователяИзменитьВидимостьСуммРегл.Видимость = ЭтоГрн;
	Форма.Элементы.ТоварыИзменитьВидимостьСуммРегл.Видимость = ЭтоГрн;
	
	Форма.Элементы.ТоварыПоДаннымПользователяИзменитьВидимостьСуммРегл.Пометка = ПоказыватьСуммыРегл;
	Форма.Элементы.ТоварыИзменитьВидимостьСуммРегл.Пометка = ПоказыватьСуммыРегл;
	
	Форма.Элементы.ТоварыЦенаРегл.Видимость = ПоказыватьСуммыРегл;
	Форма.Элементы.ТоварыСуммаБезНДСРегл.Видимость = ПоказыватьСуммыРегл;
	Форма.Элементы.ТоварыСуммаНДСРегл.Видимость = ПоказыватьСуммыРегл;
	
	Форма.Элементы.ТоварыПоДаннымПользователяЦенаРегл.Видимость = ПоказыватьСуммыРегл;
	Форма.Элементы.ТоварыПоДаннымПользователяСуммаБезНДСРегл.Видимость = ПоказыватьСуммыРегл;
	Форма.Элементы.ТоварыПоДаннымПользователяСуммаНДСРегл.Видимость = ПоказыватьСуммыРегл;
