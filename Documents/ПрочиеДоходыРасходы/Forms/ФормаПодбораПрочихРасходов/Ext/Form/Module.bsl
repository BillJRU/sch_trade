...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТаблицаРасходовСумма.Заголовок =
		СтрШаблон(НСтр("ru='Упр. учет с НДС (%1)';uk='Упр. облік з ПДВ (%1)'"), ВалютаУправленческогоУчета);
	Элементы.ТаблицаРасходовСуммаБезНДС.Заголовок =
		СтрШаблон(НСтр("ru='Упр. учет без НДС (%1)';uk='Упр. облік без ПДВ (%1)'"), ВалютаУправленческогоУчета);
	...
	Элементы.ТаблицаРасходовНДСРегл.Заголовок =
...
Процедура ТаблицаРасходовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	НаОткрытие.Вставить("ТаблицаРасходовНалоговоеНазначение", "НалоговоеНазначение");
...
Процедура ЗаполнитьТаблицуРасходов()
	...
	Колонки = "Подразделение, НаправлениеДеятельности, НалоговоеНазначение, СтатьяРасходов, АналитикаРасходов";
