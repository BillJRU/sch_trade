...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Представление = НСтр("ru='Отражение недостачи / Списание';uk='Відображення нестачі / cписання'");
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Отражение недостачи / Списание';uk='Відображення нестачі / cписання'"));
	
	//
	Элемент = СписокУсловноеОформление.Элементы.Добавить();
	Элемент.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных("ХозяйственнаяОперация");
	Элемент.Представление = НСтр("ru='Отражение излишка';uk='Відображення надлишку'");
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Отражение излишка';uk='Відображення надлишку'"));
