...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Операция <> Перечисления.ОперацииКорректировкиРегистров.РучнаяКорректировка И НЕ Пользователи.РолиДоступны("ПолныеПрава") Тогда
		ТекстОшибки = НСтр("ru='Текущему пользователю запрещено изменять корректировки регистров, сформированные автоматически.';uk='Поточному користувачу заборонено змінювати коригування регістрів, сформовані автоматично.'");
