...
#Область ПланыРазборкиКомплекты
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План разборки (комплекты)';uk='План розбирання (комплекти)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыСборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьПланыСборки);
	ДопПараметр.Вставить("ЗаголовокОперанда",	НСтр("ru='План разборки (комплекты)';uk='План розбирання (комплекти)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланСборкиРазборки");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ПланыРазборкиКомплектующие
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План разборки (комплектующие)';uk='План розбирання (комплектуючі)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыСборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьПланыСборки);
	ДопПараметр.Вставить("ЗаголовокОперанда",	НСтр("ru='План разборки (комплектующие)';uk='План розбирання (комплектуючі)'"));
	ДопПараметр.Вставить("Расшифровка", 		"Документ.ПланСборкиРазборки");
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыПланы");
...
#Область ФактыСборкиКомплекты
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт сборки (комплекты)*';uk='Факт збирання (комплекти)*'"), 
		НСтр("ru='Факт сборки (комплекты)';uk='Факт збирання (комплекти)'")));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", ?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт сборки (комплекты)*';uk='Факт збирання (комплекти)*'"), 
		НСтр("ru='Факт сборки (комплекты)';uk='Факт збирання (комплекти)'")));
...
#Область ФактыСборкиКомплектующие
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт сборки (комплектующие)*';uk='Факт збирання (комплектуючі)*'"), 
		НСтр("ru='Факт сборки (комплектующие)';uk='Факт збирання (комплектуючі)'")));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьСборкуРазборку И ЧтениеФактаСборкиРазборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд",  ИспользоватьСборкуРазборку И ЧтениеФактаСборкиРазборки);
	ДопПараметр.Вставить("ЗаголовокОперанда", ?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт сборки (комплектующие)*';uk='Факт збирання (комплектуючі)*'"), 
		НСтр("ru='Факт сборки (комплектующие)';uk='Факт збирання (комплектуючі)'")));
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыФакты");
...
#Область ФактыРазборкиКомплекты
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт разборки (комплекты)*';uk='Факт розбирання (комплекти)*'"), 
		НСтр("ru='Факт разборки (комплекты)';uk='Факт розбирання (комплекти)'")));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьСборкуРазборку И ЧтениеФактаСборкиРазборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд",  ИспользоватьСборкуРазборку И ЧтениеФактаСборкиРазборки);
	ДопПараметр.Вставить("ЗаголовокОперанда", ?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт разборки (комплекты)*';uk='Факт розбирання (комплекти)*'"), 
		НСтр("ru='Факт разборки (комплекты)';uk='Факт розбирання (комплекти)'")));
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыФакты");
...
#Область ФактыРазборкиКомплектующие
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт разборки (комплектующие)*';uk='Факт розбирання (комплектуючі)*'"), 
		НСтр("ru='Факт разборки (комплектующие)';uk='Факт розбирання (комплектуючі)'")));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьСборкуРазборку И ЧтениеФактаСборкиРазборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Общие свойства
	ДопПараметр.Вставить("СоздаватьОперанд",  ИспользоватьСборкуРазборку И ЧтениеФактаСборкиРазборки);
	ДопПараметр.Вставить("ЗаголовокОперанда", ?(СоздаватьРеквизитСОтбором, НСтр("ru='Факт разборки (комплектующие)*';uk='Факт розбирання (комплектуючі)*'"), 
		НСтр("ru='Факт разборки (комплектующие)';uk='Факт розбирання (комплектуючі)'")));
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыФакты");
...
Функция СформироватьПечатнуюФормуПлана(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Если ДанныеПечати.ПланированиеПоНазначениям
			...
			СтруктураДопПоля.Вставить("Заголовок", НСтр("ru='Назначение';uk='Призначення'"));
...
Функция СоздатьПрисоединенныйФайлExcel(ДокументСсылка, ИдентификаторФормы) Экспорт
	...
	ПараметрыВывода.Вставить("КодЯзыкаДляМногоязычныхПечатныхФорм", МультиязычностьУкр.ПолучитьЯзыкФормированияПечатныхФорм());
...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсию22
	...
	Обработчик.Процедура = "Документы.ПланСборкиРазборки.ОбработатьДанныеДляПереходаНаНовуюВерсию22";
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Документы.ПланСборкиРазборки.ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию22";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("55d23183-47be-46a6-8d1e-2e8b0a5c64bc");
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет реквизит ""Хозяйственная операция"". Пока работа обработчика не завершена, информация в документе некорректна.';uk='Заповнює реквізит ""Господарська операція"". Поки робота обробника не завершена, інформація у документі некоректна.'");
...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Версия = "3.5.4.400";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("c82c2063-f6fe-4bc7-b47f-8ced425d62be");
...
|- в планах в статусе ""Утвержден"" отмечается флаг ""ЗамещенКЗаказу"", если для плана есть планы в статусе ""Утвержден""
| - в планах в статусе ""Утвержден"" отмечается флаг ""Замещен"", если для плана есть планы в статусе ""В работе""
| - в планах в статусе ""Отменен"" снимается флаг ""Замещен""'
|;uk='Виконує заміщення планів збирання (розбирання): 
|- в планах у статусі ""Затверджено"" зазначається прапор ""Заміщено до замовлення"", якщо для плану є плани в статусі ""Затверджено"" 
|- в планах у статусі ""Затверджено"" зазначається прапор ""Заміщено"", якщо для плану є плани в статусі ""В роботі"" 
|- в планах у статусі ""Скасовано"" знімається прапор ""Заміщено""'");
	...
	Изменяемые.Добавить(Метаданные.Документы.ПланСборкиРазборки.ПолноеИмя());
	Изменяемые.Добавить(Метаданные.РегистрыСведений.ЗамещениеПланов.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
	
	Блокируемые = Новый Массив;
	Блокируемые.Добавить(Метаданные.Документы.ПланСборкиРазборки.ПолноеИмя());
	...
	НоваяСтрока = Обработчик.ПриоритетыВыполнения.Добавить();
	НоваяСтрока.Процедура = "РегистрыСведений.ЗамещениеПланов.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	НоваяСтрока.Порядок = "До";
...
Функция ТекстЗапросаДанныеКОбработке(ВыбратьДляРегистрацииДвиженийОборотыДвижений = Ложь) Экспорт
	...
	|	ПланСборкиРазборки.Статус КАК Статус,
	...
	|	ВЫБОР 
	|		КОГДА ПланСборкиРазборки.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПустаяСсылка)
	|			ТОГДА ВЫБОР 
	|				КОГДА ПланСборкиРазборки.УдалитьТипОперации = ЗНАЧЕНИЕ(Перечисление.УдалитьТипыОперацийЗаказаНаСборку.СборкаИзКомплектующих) 
	...
	|           КОНЕЦ
	|   	ИНАЧЕ ПланСборкиРазборки.ХозяйственнаяОперация
	...
	|	ПланыСборкиРазборки.Статус КАК СтатусЗамещения
	...
	|			И (ПланыСборкиРазборки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.НаУтверждении)
	|					И ПланыСборкиРазборки1.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден)
	|				ИЛИ ПланыСборкиРазборки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден)
	|					И ПланыСборкиРазборки1.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Утвержден))
	...
	|ПОМЕСТИТЬ ПланыСборкиРазборкиКОбработке
	|ИЗ
	...
	|			И ЗамещающиеИЗамещенныеПланыСборкиРазборки.СтатусЗамещения = ЗамещениеПланов.СтатусЗамещения
	|ГДЕ
	...
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПланыСборкиРазборки.Ссылка
	|ИЗ
	|	ПланыСборкиРазборки КАК ПланыСборкиРазборки
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ЗамещениеПланов КАК ЗамещениеПланов
	|		ПО (ЗамещениеПланов.ЗамещенныйПлан = ПланыСборкиРазборки.Ссылка)
	|ГДЕ
	|	ПланыСборкиРазборки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПланов.Отменен)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|ИЗ
	|	Документ.ПланСборкиРазборки КАК ПланСборкиРазборки
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВидыПлановКРазделению КАК ВидыПлановКРазделению
	|		ПО ПланСборкиРазборки.ВидПлана = ВидыПлановКРазделению.ВидПлана
	|ГДЕ
	|	ВидыПлановКРазделению.КоличествоОпераций > 1
	|	И (ПланСборкиРазборки.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РазборкаТоваров)
	|     ИЛИ ПланСборкиРазборки.УдалитьТипОперации = ЗНАЧЕНИЕ(Перечисление.УдалитьТипыОперацийЗаказаНаСборку.РазборкаНаКомплектующие) 
	|   )
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПланыСборкиРазборкиКОбработке.Ссылка КАК Ссылка
	|ИЗ
	|	ПланыСборкиРазборкиКОбработке КАК ПланыСборкиРазборкиКОбработке
	|ГДЕ
	|	&УсловиеОтбораДляРегистрацииДвиженийОборотыБюджетов
	|";
		
	Если ВыбратьДляРегистрацииДвиженийОборотыДвижений Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеОтбораДляРегистрацииДвиженийОборотыБюджетов", "ПланыСборкиРазборкиКОбработке.Ссылка.ОтражаетсяВБюджетировании");
	Иначе
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеОтбораДляРегистрацииДвиженийОборотыБюджетов", "ИСТИНА");
	КонецЕсли;
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	КОбработке.Ссылка.Дата КАК Дата
	...
	|	ВидыПланов.УдалитьВидПланаНовый КАК УдалитьВидПланаНовый,
	|	КОбработке.Дата КАК Дата
	|ИЗ
	...
	|		ПО КОбработке.ВидПлана = ВидыПланов.Ссылка
	|ГДЕ
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		Попытка
			...
			Если ДокументОбъект <> Неопределено Тогда
				...
				Если ЗначениеЗаполнено(ВыборкаПоДокументам.УдалитьВидПланаНовый)
					И ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.РазборкаТоваров Тогда
					ДокументОбъект.ВидПлана = ВыборкаПоДокументам.УдалитьВидПланаНовый;
				КонецЕсли;
				
				Если ДокументОбъект.Замещающий
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию22(Параметры) Экспорт
	...
	|	Документ.ПланСборкиРазборки КАК ПланСборкиРазборки
	|ГДЕ
	|	ПланСборкиРазборки.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПустаяСсылка)
	|";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию22(Параметры) Экспорт
	...
	ПолноеИмяОбъекта = "Документ.ПланСборкиРазборки";
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			Блокировка = Новый БлокировкаДанных;
			ЭлементБлокировки = Блокировка.Добавить("Документ.ПланСборкиРазборки");
		...
		Исключение
			ОтменитьТранзакцию();
			ТекстСообщения = НСтр("ru='Не удалось обработать: %ПланСборкиРазборки% по причине: %Причина%';uk='Не вдалося обробити: %ПланСборкиРазборки% через: %Причина%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПланСборкиРазборки%", Выборка.Ссылка);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Причина%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			ЗаписьЖурналаРегистрации(
				ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), 
				УровеньЖурналаРегистрации.Предупреждение,
				Метаданные.Документы.ПланСборкиРазборки, 
				ТекстСообщения
			);
		КонецПопытки;
	КонецЦикла;
	
	Параметры.ОбработкаЗавершена = Не ОбновлениеИнформационнойБазы.ЕстьДанныеДляОбработки(Параметры.Очередь, "Документ.ПланСборкиРазборки");
