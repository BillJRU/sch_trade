...
Процедура ДобавитьШаблоныФормулРасчетаПлановогоКоличества(Дерево, ГруппаОператоров)
	...
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru='План продаж +15%';uk='План продажів +15%'"),
		"[ПланыПродаж] * 1.15");

	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров,
		НСтр("ru='План продаж с учетом корректировки по факту продаж';uk='План продажів з урахуванням коригування за фактом продажу'"),
	...
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров,
		НСтр("ru='Факт продаж с учетом наличия товаров на остатках';uk='Факт продажів з урахуванням наявності товарів на залишках'"),
