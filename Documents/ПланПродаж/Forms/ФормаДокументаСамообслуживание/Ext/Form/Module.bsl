	...
	Если ТоварыПоПериодам.Количество() > 0 Тогда
		...
		Если ЗадаватьВопрос Тогда
			...
			ПоказатьВопрос(
				...
				НСтр("ru='Изменение периода плана приведет к удалению данных в некоторых периодах. Удалить периоды?';uk='Зміна періоду плану призведе до вилучення даних в деяких періодах. Вилучити періоди?'"), 
				Кнопки);
			Возврат;
