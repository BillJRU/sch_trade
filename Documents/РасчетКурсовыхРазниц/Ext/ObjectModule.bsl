...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не ДополнительныеСвойства.Свойство("ВыполненРасчет") Тогда
		...
		Если ЭтоРасчеты И НоваяАрхитектураРасчетов Тогда
			Документы.РасчетКурсовыхРазниц.РассчитатьКурсовыеРазницыПоСрокам(Организация, Дата, ХозяйственнаяОперация);
		Иначе
...
|по организации ""%2""'
|;uk='Для скасування проведення ""%1"" необхідно 
|зняти з проведення всі документи, що формують валютні залишки
|по організації ""%2""'");
...
|;uk='Для організації ""%1"" в поточному місяці %2 вже існує аналогічний документ ""%3"". 
|Позначте на вилучення всі непроведені документи розрахунку курсових різниць.'");
