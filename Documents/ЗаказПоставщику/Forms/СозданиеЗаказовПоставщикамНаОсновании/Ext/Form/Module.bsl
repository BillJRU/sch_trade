...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МенеджерОбъекта = ОбщегоНазначения.МенеджерОбъектаПоСсылке(ДокументОснование);
	ИмяПоляЖелаемаяДатаОтгрузки = МенеджерОбъекта.ИмяПоляЖелаемаяДатаОтгрузки();
	
	РеквизитыОснования = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументОснование,
		"Представление, " + ИмяПоляЖелаемаяДатаОтгрузки);
	
	Заголовок = РеквизитыОснования.Представление;
	ЭтаФорма.ЖелаемаяДатаОтгрузки = РеквизитыОснования[ИмяПоляЖелаемаяДатаОтгрузки];
