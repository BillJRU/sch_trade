...
Функция СтруктураДействийПриЗагрузкеИзExcel()
	...
	Иначе
		...
		КолонкиПоиска.Добавить(НСтр("ru='Дата поступления';uk='Дата надходження'"),"ДатаОстатка");
...
Процедура ДобавитьШаблоныФормулРасчетаПлановогоКоличества(Дерево, ГруппаОператоров)
	...
	РаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, НСтр("ru='План остатков +15%';uk='План залишків + 15%'"),
		"[ПланыОстатков] * 1.15");
