...
#Область ПланыОстатков
	...
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='План остатков';uk='План залишків'"));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда",	НСтр("ru='План остатков';uk='План залишків'"));
...
#Область СвободныеОстатки
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='Доступный остаток';uk='Доступний залишок'"));
...
#Область ФактическиеНачальныеОстатки
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			?(СоздаватьРеквизитСОтбором, НСтр("ru='Фактический начальный остаток*';uk='Фактичний початковий залишок*'"),
		НСтр("ru='Фактический начальный остаток';uk='Фактичний початковий залишок'")));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	Истина);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Свойства операнда
	ДопПараметр.Вставить("СоздаватьОперанд", 	Истина);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	?(СоздаватьРеквизитСОтбором, НСтр("ru='Фактический начальный остаток*';uk='Фактичний початковий залишок*'"),
		НСтр("ru='Фактический начальный остаток';uk='Фактичний початковий залишок'")));
	ДопПараметр.Вставить("ВходитВОперанд",		"ДополнительныеОперандыФакты");
...
#Область ПланируемыеНачальныеОстатки
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='Планируемый начальный остаток';uk='Планований початковий залишок'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыОстатков);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Свойства операнда
	ДопПараметр.Вставить("СоздаватьОперанд", 	ИспользоватьПланыОстатков);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='Планируемый начальный остаток';uk='Планований початковий залишок'"));
...
#Область ПланируемыеКонечныеОстатки
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='Планируемый конечный остаток';uk='Планований кінцевий залишок'"));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='Планируемый конечный остаток';uk='Планований кінцевий залишок'"));
	ДопПараметр.Вставить("ВходитВОперанд",		"ОсновныеОперанды");
...
#Область ПланируемыйКонечныйДефицит
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='Планируемый конечный дефицит';uk='Планований кінцевий дефіцит'"));
	...
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='Планируемый конечный дефицит';uk='Планований кінцевий дефіцит'"));
	ДопПараметр.Вставить("ВходитВОперанд",		"ОсновныеОперанды");
...
#Область НакопленныйПланируемыйКонечныйДефицит
	...
	ДопПараметр.Вставить("Тип", 				Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	ДопПараметр.Вставить("Путь", 				ПутьКРеквизиту);
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru='Накопленный планируемый конечный дефицит';uk='Накопичений планований кінцевий дефіцит'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыОстатков);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
	
	// Свойства операнда
	ДопПараметр.Вставить("СоздаватьОперанд", 	Ложь);
	ДопПараметр.Вставить("ЗаголовокОперанда", 	НСтр("ru='Накопленный планируемый конечный дефицит';uk='Накопичений планований кінцевий дефіцит'"));
	ДопПараметр.Вставить("ВходитВОперанд",		"ОсновныеОперанды");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='План остатков';uk='План залишків'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПланОстатков") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			"ПланОстатков",
			НСтр("ru='План остатков';uk='План залишків'"),
			СформироватьПечатнуюФормуПлана(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода),,,, Истина);
	КонецЕсли;
...
Функция СформироватьПечатнуюФормуПлана(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ПараметрыВывода)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ПланОстатков.ПФ_MXL_ПланОстатков", КодЯзыкаПечать);
		...
		Если ВыводитьШапку Тогда
			...
			ТекстЗаголовка = ОбщегоНазначенияУТКлиентСервер.СформироватьЗаголовокДокумента(ДанныеПечати, НСтр("ru='План остатков';uk='План залишків'",КодЯзыкаПечать), КодЯзыкаПечать);
			...
			Если ВыводитьСценарий Тогда
				...
				ПредставлениеСценария                          = Строка(ДанныеПечати.Сценарий) + ", "
																 + Строка(МультиязычностьУкр.ПолучитьЛокализованныйСинонимОбъекта(ДанныеПечати.Периодичность, КодЯзыкаПечать));
			...
			Если ВыводитьПериодСтатус Тогда
				...
				ОбластьМакета.Параметры.Статус = Строка(МультиязычностьУкр.ПолучитьЛокализованныйСинонимОбъекта(ДанныеПечати.Статус, КодЯзыкаПечать));
				ТабличныйДокумент.Вывести(ОбластьМакета);
			КонецЕсли;
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Дело.Представление  = НСтр("ru='Планы остатков';uk='Плани залишків'");
