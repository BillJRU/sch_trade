...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Анкетирование.УстановитьЭлементДереваРазделовАнкетыВступлениеЗаключение(ДеревоРазделов, НСтр("ru='Вступление';uk='Вступ'"), "Вступление");
	Анкетирование.ЗаполнитьДеревоРазделов(ЭтотОбъект,ДеревоРазделов);
	Анкетирование.УстановитьЭлементДереваРазделовАнкетыВступлениеЗаключение(ДеревоРазделов, НСтр("ru='Заключение';uk='Висновок'"), "Заключение");
...
Функция ПроверитьЗаполнениеАнкеты()
	...
	Пока Выборка.Следующий() Цикл
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Не указан ответ на вопрос';uk='Не вказано відповідь на питання'") + "- "+ СтрЗаменить(Выборка.Ссылка.ПолныйКод(),"/",".") + " " + Выборка.Формулировка);
	КонецЦикла;
...
Процедура УстановитьЗначенияРеквизитовСогласноОпросу(РеквизитыОпрос)
	...
	Заключение                            = ?(ПустаяСтрока(РеквизитыОпрос.Заключение),
	                                         НСтр("ru='Спасибо за то, что заполнили анкету.';uk='Дякуємо за те, що заповнили анкету.'"),
