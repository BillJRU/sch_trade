...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ТекстСообщенияОНекорректномСоздании = НСтр("ru='Приходный ордер на товары нужно вводить из формы ""Приемка"".';uk='Прибутковий ордер на товари потрібно вводити з форми ""Приймання"".'");
...
|;uk='Немає товарів для заповнення за розпорядженням ""%Распоряжение%"".
|Можливо ще не створений видатковий ордер зі складу ""%Отправитель%"".'");
	...
	Если ВидЗаполнения = "Номенклатура"
		...
		Иначе
			ТекстСообщения = НСтр("ru='Нет товаров для заполнения по распоряжению ""%Распоряжение%"" от отправителя %Отправитель%.';uk='Немає товарів для заповнення за розпорядженням ""%Распоряжение%"" від відправника %Отправитель%.'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Распоряжение%",	Распоряжение);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Отправитель%",	Отправитель);
