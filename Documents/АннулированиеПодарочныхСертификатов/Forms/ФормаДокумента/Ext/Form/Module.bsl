...
Процедура ПодарочныеСертификатыСуммаПриИзменении(Элемент)
	...
	Если ДанныеСертификата.СуммаВВалютеСертификата < ТекущиеДанные.СуммаВВалютеСертификата Тогда
		...
		ТекстСообщения = НСтр("ru='Сумма аннулирования превышает остаточную сумму сертификата. Значение изменено на максимально возможное.';uk='Сума анулювання перевищує залишкову суму сертифіката. Значення змінено на максимально можливе.'");
