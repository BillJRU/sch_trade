...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьКредитыДепозиты И НЕ ИспользоватьЛизинг Тогда
		Элементы.ДетализацияФинансовыхИнструментов.Заголовок = НСтр("ru='по кредитам, депозитам';uk='по кредитах, депозитах'");
		
	ИначеЕсли НЕ ИспользоватьКредитыДепозиты И ИспользоватьЛизинг Тогда
		Элементы.ДетализацияФинансовыхИнструментов.Заголовок = НСтр("ru='по лизингу';uk='по лізингу'");
	...
	Если Параметры.Свойство("Печать") Тогда
		Элементы.Сохранить.Заголовок = НСтр("ru='Печать';uk='Друк'");
	КонецЕсли;
