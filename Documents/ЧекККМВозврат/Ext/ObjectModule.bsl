...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Иначе
		...
		Иначе
			ВызватьИсключение НСтр("ru='Для текущего рабочего места не настроено подключаемое оборудование: Фискальное устройство';uk='Для поточного робочого місця не налаштоване підключене обладнання: Фіскальний пристрій'");
		КонецЕсли;
