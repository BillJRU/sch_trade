...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Наименование				= НСтр("ru='Обмен с';uk='Обмін з'") + " " + ДанныеЗаполнения.АдресСайта;
	...
	НовСтр.Каталог = НСтр("ru='Основной каталог товаров';uk='Основний каталог товарів'");
	...
	КонецЕсли;
	СписокГрупп.Добавить(ПустаяСсылкаНаВидНоменклатуры, НСтр("ru='(Все)';uk='(Всі)'"));
...
Функция НаименованиеРегламентногоЗадания()
	...
	НаименованиеШаблон = НСтр("ru='Обмен с сайтом № %1';uk='Обмін з сайтом № %1'");
