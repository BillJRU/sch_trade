...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена          	= НСтр("ru='Настройка синхронизации с BAS Документооборотом КОРП, ред. 2.1';uk='Настройка синхронізації з BAS Документообігом КОРП, ред. 2.1'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена                  	= НСтр("ru='Синхронизация с BAS Документооборотом КОРП, ред. 2.1';uk='Синхронізація з BAS Документообіг КОРП, ред. 2.1'");
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника              	= "Exchange settings ERP-DocMng";
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену					= НСтр("ru='Позволяет синхронизировать данные с конфигурацией ""BAS Документооборот КОРП""';uk='Дозволяє синхронізувати дані з конфігурацією ""BAS Документообіг КОРП""'");
	ОписаниеВарианта.ПодробнаяИнформацияПоОбмену				= "ПланОбмена.ОбменУправлениеТорговлейДокументооборот21.Форма.ПодробнаяИнформация";
	ОписаниеВарианта.ИмяКонфигурацииКорреспондента            	= НСтр("ru='Документооборот';uk='Документообіг'");
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru='BAS Документооборот КОРП, ред. 2.1';uk='BAS Документообіг КОРП, ред. 2.1'");
