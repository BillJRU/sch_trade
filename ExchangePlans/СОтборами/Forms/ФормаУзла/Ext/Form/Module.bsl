...
Процедура ВыбратьПодразделения(Команда)
	...
	ПараметрыФормы.Вставить("ЗаголовокФормыВыбора",     НСтр("ru = 'Подразделения, по которым будет происходить фильтрация данных'; uk = 'Підрозділи, по яким буде відбуватися фільтрація даних'"));
