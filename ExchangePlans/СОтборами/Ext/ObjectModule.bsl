		...
		Если НЕ РезультатЗапроса.Пустой() Тогда
			...
			Пока Выборка.Следующий() Цикл
				...
				Если Не Выборка.ПометкаУдаления Тогда
					...
					Исключение
						ИмяСобытияЖурналРегистрации = НСтр("ru = 'Получение данных в РИБ.'; uk = 'Отримання даних в РІБ.'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
"%1'; uk = 'Під час спроби позначити на видалення дублі елементів довідника СтроковыеКонтактыВзаимодействия сталася помилка."
"%1'");
