...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок =
		НСтр("ru='Настройка синхронизации реквизитов объектов для обмена с мобильным приложением ""Заказы""';uk='Настройка синхронізації реквізитів об''єктів для обміну з мобільним додатком ""Замовлення""'");
...
Процедура ЗаписатьНастройки(Отказ)
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru='Запись настроек';uk='Запис настройок'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ЗаполнитьДеревоОбъектовОбмена()
	...
	СтрокаСправочники.Представление = НСтр("ru='Справочники';uk='Довідники'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	СтрокаОбъекты.Представление = НСтр("ru='Номенклатура';uk='Номенклатура'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаОбъекты = КоллекцияОбъектовСправочников.Добавить();
	СтрокаОбъекты.ОбъектОбмена = "Справочник.Партнеры";
	СтрокаОбъекты.Представление = НСтр("ru='Партнеры';uk='Партнери'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаОбъекты = КоллекцияОбъектовСправочников.Добавить();
	СтрокаОбъекты.ОбъектОбмена = "Справочник.Организации";
	СтрокаОбъекты.Представление = НСтр("ru='Организации';uk='Організації'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаДокументы = КоллекцияОбъектовОбмена.Добавить();
	СтрокаДокументы.ОбъектОбмена = "Документы";
	СтрокаДокументы.Представление = НСтр("ru='Документы';uk='Документи'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	СтрокаОбъекты.Представление = НСтр("ru='Заказ клиента';uk='Замовлення клієнта'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	СтрокаОбъекты = КоллекцияОбъектовДокументы.Добавить();
	СтрокаОбъекты.ОбъектОбмена = "Документ.ЗаявкаНаВозвратТоваровОтКлиента";
	СтрокаОбъекты.Представление = НСтр("ru='Заявка на возврат товаров от клиента';uk='Заявка на повернення товарів від клієнта'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
КонецПроцедуры
