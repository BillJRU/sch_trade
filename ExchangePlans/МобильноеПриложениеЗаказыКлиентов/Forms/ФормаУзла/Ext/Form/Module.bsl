...
Процедура ТаблицаНастроекКомпоновкиПриИзменении(Элемент)
	...
	Если ТекущаяНастройкаНастройка = НСтр("ru='Сегмент партнеров';uk='Сегмент партнерів'")
		ИЛИ ТекущаяНастройкаНастройка = НСтр("ru='Организация';uk='Організація'")
		ИЛИ ТекущаяНастройкаНастройка = НСтр("ru='Соглашение';uk='Оферта'") Тогда
